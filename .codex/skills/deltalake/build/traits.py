...
EXTENSION_POINTS = (
    # Storage and the commit log: where a new backend plugs in.
    "LogStore",
    "LogStoreFactory",
    "ObjectStoreFactory",
    "ObjectStoreRegistry",
    ...
    "DeltaDataReader",
    "DeltaDataReaderExt",
    # Validation and log actions.
    "DataCheck",
    "FileAction",
    # The DataFusion seam.
    "DataFusionMixins",
    # Extension traits that add capability to kernel types: invisible unless imported, which
    # makes them the single easiest thing to miss in this library.
    "StructTypeExt",
    "TablePropertiesExt",
    "MetadataExt",
    "ScalarExt",
    "StructDataExt",
    # The kernel engine: implement these to run Delta on something other than the default.
    "Engine",
    "EngineData",
    "JsonHandler",
    "ParquetHandler",
