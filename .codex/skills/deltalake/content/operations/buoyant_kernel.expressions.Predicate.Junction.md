# `buoyant_kernel::expressions::Predicate::Junction`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.Predicate.Junction.json).

<a id="op-3fe408c38690fd42739ed576"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::Predicate::Junction::0` · buoyant_kernel 1.0.0+58f07cd6
