# `buoyant_kernel::schema::MetadataValue::Other`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.schema.MetadataValue.Other.json).

<a id="op-f2ea49499c26add088e6c7cf"></a>
## 0

`struct_field` · `buoyant_kernel::schema::MetadataValue::Other::0` · buoyant_kernel 1.0.0+58f07cd6
