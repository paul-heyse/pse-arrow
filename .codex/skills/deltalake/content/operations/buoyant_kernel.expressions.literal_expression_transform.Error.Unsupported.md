# `buoyant_kernel::expressions::literal_expression_transform::Error::Unsupported`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.literal_expression_transform.Error.Unsupported.json).

<a id="op-7c3fbd859d1b4c92450a8865"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::literal_expression_transform::Error::Unsupported::0` · buoyant_kernel 1.0.0+58f07cd6
