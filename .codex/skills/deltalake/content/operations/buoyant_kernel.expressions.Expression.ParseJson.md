# `buoyant_kernel::expressions::Expression::ParseJson`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.Expression.ParseJson.json).

<a id="op-8c6f18dd053df6a72ff12af4"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::Expression::ParseJson::0` · buoyant_kernel 1.0.0+58f07cd6

Access: **internal_field**. Canonical source location is not automatically a valid import path.

```rust
0: ParseJsonExpression
```
