# `buoyant_kernel::expressions::Expression::Unknown`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.Expression.Unknown.json).

<a id="op-131d0c5b0518a9ea4f4f4f80"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::Expression::Unknown::0` · buoyant_kernel 1.0.0+58f07cd6
