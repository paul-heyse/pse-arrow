# `buoyant_kernel::table_properties::deserialize::ParseIntervalError::ParseIntError`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.table_properties.deserialize.ParseIntervalError.ParseIntError.json).

<a id="op-2c776ab87630450daca2788a"></a>
## 0

`struct_field` · `buoyant_kernel::table_properties::deserialize::ParseIntervalError::ParseIntError::0` · buoyant_kernel 1.0.0+58f07cd6
