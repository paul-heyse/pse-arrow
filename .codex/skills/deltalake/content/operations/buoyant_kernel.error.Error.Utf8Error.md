# `buoyant_kernel::error::Error::Utf8Error`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.Utf8Error.json).

<a id="op-ec8017b97028fe40c80e038d"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::Utf8Error::0` · buoyant_kernel 1.0.0+58f07cd6
