# `buoyant_kernel::error::Error::MissingData`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.MissingData.json).

<a id="op-87c8bf2b5e07a7a14e2d33b8"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::MissingData::0` · buoyant_kernel 1.0.0+58f07cd6
