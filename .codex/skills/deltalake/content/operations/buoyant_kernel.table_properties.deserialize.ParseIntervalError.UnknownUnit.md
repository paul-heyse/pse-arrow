# `buoyant_kernel::table_properties::deserialize::ParseIntervalError::UnknownUnit`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.table_properties.deserialize.ParseIntervalError.UnknownUnit.json).

<a id="op-dd4c82dff8ba3e5277dad54c"></a>
## 0

`struct_field` · `buoyant_kernel::table_properties::deserialize::ParseIntervalError::UnknownUnit::0` · buoyant_kernel 1.0.0+58f07cd6
