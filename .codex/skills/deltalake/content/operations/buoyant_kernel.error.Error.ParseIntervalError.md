# `buoyant_kernel::error::Error::ParseIntervalError`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.ParseIntervalError.json).

<a id="op-b5a97d7c37c3260f0a50107c"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::ParseIntervalError::0` · buoyant_kernel 1.0.0+58f07cd6

Access: **internal_field**. Canonical source location is not automatically a valid import path.

```rust
0: table_properties::ParseIntervalError
```
