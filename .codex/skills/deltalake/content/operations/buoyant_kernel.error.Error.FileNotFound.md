# `buoyant_kernel::error::Error::FileNotFound`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.FileNotFound.json).

<a id="op-1d1454c02eafe56227cf24b8"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::FileNotFound::0` · buoyant_kernel 1.0.0+58f07cd6
