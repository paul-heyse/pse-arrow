# `buoyant_kernel::table_features::TableFeature::Unknown`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.table_features.TableFeature.Unknown.json).

<a id="op-38941956b91c407d489a629a"></a>
## 0

`struct_field` · `buoyant_kernel::table_features::TableFeature::Unknown::0` · buoyant_kernel 1.0.0+58f07cd6
