# `buoyant_kernel::expressions::scalars::Scalar::Map`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.Map.json).

<a id="op-52d447a35a77af15af409bdc"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::Map::0` · buoyant_kernel 1.0.0+58f07cd6
