# `buoyant_kernel::schema::MetadataValue::String`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.schema.MetadataValue.String.json).

<a id="op-e3841f53651e39681c67f5e8"></a>
## 0

`struct_field` · `buoyant_kernel::schema::MetadataValue::String::0` · buoyant_kernel 1.0.0+58f07cd6
