# `buoyant_kernel::expressions::scalars::Scalar::TimestampNanosNtz`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.TimestampNanosNtz.json).

<a id="op-35db42a7a222aa6213a4754a"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::TimestampNanosNtz::0` · buoyant_kernel 1.0.0+58f07cd6
