# `buoyant_kernel::history_manager::error::NearestTimestamp::Earliest`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.history_manager.error.NearestTimestamp.Earliest.json).

<a id="op-2359ef567dce44bee7245c3d"></a>
## 0

`struct_field` · `buoyant_kernel::history_manager::error::NearestTimestamp::Earliest::0` · buoyant_kernel 1.0.0+58f07cd6
