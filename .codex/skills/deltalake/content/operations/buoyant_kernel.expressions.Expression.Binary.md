# `buoyant_kernel::expressions::Expression::Binary`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.Expression.Binary.json).

<a id="op-a6047408bf0135ff543dff8d"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::Expression::Binary::0` · buoyant_kernel 1.0.0+58f07cd6
