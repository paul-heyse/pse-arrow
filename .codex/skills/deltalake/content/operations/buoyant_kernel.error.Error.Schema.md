# `buoyant_kernel::error::Error::Schema`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.Schema.json).

<a id="op-f2c78b0ae1a51f564fee2ec6"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::Schema::0` · buoyant_kernel 1.0.0+58f07cd6
