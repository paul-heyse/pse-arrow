# `buoyant_kernel::expressions::scalars::Scalar::TimestampNtz`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.TimestampNtz.json).

<a id="op-6c64b32860cd1335eda47ab7"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::TimestampNtz::0` · buoyant_kernel 1.0.0+58f07cd6
