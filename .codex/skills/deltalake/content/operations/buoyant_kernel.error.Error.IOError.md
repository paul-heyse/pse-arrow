# `buoyant_kernel::error::Error::IOError`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.IOError.json).

<a id="op-11069f2800aba446cc783bb9"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::IOError::0` · buoyant_kernel 1.0.0+58f07cd6
