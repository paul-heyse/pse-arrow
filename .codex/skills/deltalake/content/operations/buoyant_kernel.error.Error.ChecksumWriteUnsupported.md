# `buoyant_kernel::error::Error::ChecksumWriteUnsupported`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.ChecksumWriteUnsupported.json).

<a id="op-4b5f79a9faab2f5ecdeaf22b"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::ChecksumWriteUnsupported::0` · buoyant_kernel 1.0.0+58f07cd6
