# `buoyant_kernel::expressions::scalars::Scalar::Byte`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.Byte.json).

<a id="op-7aee3744f7d134b0fec2c6cf"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::Byte::0` · buoyant_kernel 1.0.0+58f07cd6
