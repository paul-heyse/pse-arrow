# `buoyant_kernel::error::Error::CheckpointWrite`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.CheckpointWrite.json).

<a id="op-a6a0f154017f47866c0b0741"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::CheckpointWrite::0` · buoyant_kernel 1.0.0+58f07cd6
