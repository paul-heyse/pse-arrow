# `buoyant_kernel::expressions::literal_expression_transform::Error::Schema`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.literal_expression_transform.Error.Schema.json).

<a id="op-10d0ccc6f2ab9ce72e02f532"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::literal_expression_transform::Error::Schema::0` · buoyant_kernel 1.0.0+58f07cd6
