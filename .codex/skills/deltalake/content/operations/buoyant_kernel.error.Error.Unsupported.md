# `buoyant_kernel::error::Error::Unsupported`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.Unsupported.json).

<a id="op-143e43b2864eb2978f710acf"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::Unsupported::0` · buoyant_kernel 1.0.0+58f07cd6
