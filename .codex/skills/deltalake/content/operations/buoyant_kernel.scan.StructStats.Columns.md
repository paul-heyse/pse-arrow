# `buoyant_kernel::scan::StructStats::Columns`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.scan.StructStats.Columns.json).

<a id="op-2f53a09ad925a2a03611d6e0"></a>
## 0

`struct_field` · `buoyant_kernel::scan::StructStats::Columns::0` · buoyant_kernel 1.0.0+58f07cd6
