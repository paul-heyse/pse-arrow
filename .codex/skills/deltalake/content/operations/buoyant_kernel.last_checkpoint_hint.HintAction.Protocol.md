# `buoyant_kernel::last_checkpoint_hint::HintAction::Protocol`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.last_checkpoint_hint.HintAction.Protocol.json).

<a id="op-2c073610473b989613bd46c3"></a>
## 0

`struct_field` · `buoyant_kernel::last_checkpoint_hint::HintAction::Protocol::0` · buoyant_kernel 1.0.0+58f07cd6
