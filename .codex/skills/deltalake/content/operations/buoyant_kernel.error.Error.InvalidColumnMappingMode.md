# `buoyant_kernel::error::Error::InvalidColumnMappingMode`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.InvalidColumnMappingMode.json).

<a id="op-6356e6c289ee5bb442bfbef4"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::InvalidColumnMappingMode::0` · buoyant_kernel 1.0.0+58f07cd6
