# `buoyant_kernel::expressions::scalars::Scalar::Decimal`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.Decimal.json).

<a id="op-5a784cf167eb9f4d4918a52e"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::Decimal::0` · buoyant_kernel 1.0.0+58f07cd6
