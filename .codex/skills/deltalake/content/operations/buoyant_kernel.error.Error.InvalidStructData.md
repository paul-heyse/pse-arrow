# `buoyant_kernel::error::Error::InvalidStructData`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.InvalidStructData.json).

<a id="op-8cc2972ab1a23963ce4fa17b"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::InvalidStructData::0` · buoyant_kernel 1.0.0+58f07cd6
