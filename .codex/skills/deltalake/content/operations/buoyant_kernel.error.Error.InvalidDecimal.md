# `buoyant_kernel::error::Error::InvalidDecimal`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.InvalidDecimal.json).

<a id="op-0d488535eff0f4a7091485d9"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::InvalidDecimal::0` · buoyant_kernel 1.0.0+58f07cd6
