# `buoyant_kernel::error::Error::InvalidLogPath`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.InvalidLogPath.json).

<a id="op-348b41c747f053e7dedf8264"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::InvalidLogPath::0` · buoyant_kernel 1.0.0+58f07cd6
