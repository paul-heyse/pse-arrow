# `buoyant_kernel::schema::MetadataValue::Boolean`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.schema.MetadataValue.Boolean.json).

<a id="op-c2285ab97d181a8988097a74"></a>
## 0

`struct_field` · `buoyant_kernel::schema::MetadataValue::Boolean::0` · buoyant_kernel 1.0.0+58f07cd6
