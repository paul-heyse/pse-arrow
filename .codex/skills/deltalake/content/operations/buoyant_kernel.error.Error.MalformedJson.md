# `buoyant_kernel::error::Error::MalformedJson`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.MalformedJson.json).

<a id="op-57c3b0a67a9bacac867cafa6"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::MalformedJson::0` · buoyant_kernel 1.0.0+58f07cd6
