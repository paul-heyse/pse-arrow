# `buoyant_kernel::error::Error::UnexpectedColumnType`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.UnexpectedColumnType.json).

<a id="op-29fcd343174ce3e0c5665572"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::UnexpectedColumnType::0` · buoyant_kernel 1.0.0+58f07cd6
