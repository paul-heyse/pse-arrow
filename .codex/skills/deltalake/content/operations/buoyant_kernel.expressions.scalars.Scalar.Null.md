# `buoyant_kernel::expressions::scalars::Scalar::Null`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.Null.json).

<a id="op-d0f861b6a2001e27e8b44622"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::Null::0` · buoyant_kernel 1.0.0+58f07cd6
