# `buoyant_kernel::expressions::Predicate::Unknown`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.Predicate.Unknown.json).

<a id="op-811d93ee6c873e83581e642d"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::Predicate::Unknown::0` · buoyant_kernel 1.0.0+58f07cd6
