# `buoyant_kernel::history_manager::error::NearestTimestamp::Latest`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.history_manager.error.NearestTimestamp.Latest.json).

<a id="op-7930043c2fadd3a6456de20b"></a>
## 0

`struct_field` · `buoyant_kernel::history_manager::error::NearestTimestamp::Latest::0` · buoyant_kernel 1.0.0+58f07cd6
