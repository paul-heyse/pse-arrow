# `buoyant_kernel::expressions::scalars::Scalar::Long`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.Long.json).

<a id="op-4794da4da86f0cdbd88ec758"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::Long::0` · buoyant_kernel 1.0.0+58f07cd6
