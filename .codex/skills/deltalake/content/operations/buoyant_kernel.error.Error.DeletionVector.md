# `buoyant_kernel::error::Error::DeletionVector`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.DeletionVector.json).

<a id="op-bd56c10e28b6640fb50149f8"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::DeletionVector::0` · buoyant_kernel 1.0.0+58f07cd6
