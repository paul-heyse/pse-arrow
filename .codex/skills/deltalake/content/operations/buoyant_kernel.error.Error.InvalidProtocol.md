# `buoyant_kernel::error::Error::InvalidProtocol`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.InvalidProtocol.json).

<a id="op-d5389ff166c9ced7e8a5e8de"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::InvalidProtocol::0` · buoyant_kernel 1.0.0+58f07cd6
