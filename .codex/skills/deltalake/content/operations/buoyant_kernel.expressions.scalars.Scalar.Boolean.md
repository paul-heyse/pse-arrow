# `buoyant_kernel::expressions::scalars::Scalar::Boolean`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.Boolean.json).

<a id="op-20ceaa7f22fed216d152b775"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::Boolean::0` · buoyant_kernel 1.0.0+58f07cd6
