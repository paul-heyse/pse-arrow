# `buoyant_kernel::expressions::scalars::Scalar::Integer`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.Integer.json).

<a id="op-7b9786d3bb62d5288c64de69"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::Integer::0` · buoyant_kernel 1.0.0+58f07cd6
