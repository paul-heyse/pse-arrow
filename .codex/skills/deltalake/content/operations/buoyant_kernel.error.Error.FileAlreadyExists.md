# `buoyant_kernel::error::Error::FileAlreadyExists`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.FileAlreadyExists.json).

<a id="op-4276942079669ea25fc5cfa8"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::FileAlreadyExists::0` · buoyant_kernel 1.0.0+58f07cd6
