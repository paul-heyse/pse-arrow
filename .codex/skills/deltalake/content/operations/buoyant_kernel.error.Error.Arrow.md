# `buoyant_kernel::error::Error::Arrow`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.Arrow.json).

<a id="op-7a9388429e25992fdfb44162"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::Arrow::0` · buoyant_kernel 1.0.0+58f07cd6
