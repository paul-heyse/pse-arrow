# `buoyant_kernel::error::Error::Generic`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.Generic.json).

<a id="op-858d98c56b7fa80b0ddee996"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::Generic::0` · buoyant_kernel 1.0.0+58f07cd6
