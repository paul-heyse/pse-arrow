# `buoyant_kernel::expressions::scalars::Scalar::Short`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.scalars.Scalar.Short.json).

<a id="op-93309d55df0b6533e285eb91"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::scalars::Scalar::Short::0` · buoyant_kernel 1.0.0+58f07cd6
