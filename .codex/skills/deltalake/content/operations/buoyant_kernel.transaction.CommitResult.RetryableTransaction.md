# `buoyant_kernel::transaction::CommitResult::RetryableTransaction`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.transaction.CommitResult.RetryableTransaction.json).

<a id="op-c87a4e0d746bf6e398c23621"></a>
## 0

`struct_field` · `buoyant_kernel::transaction::CommitResult::RetryableTransaction::0` · buoyant_kernel 1.0.0+58f07cd6

Access: **internal_field**. Canonical source location is not automatically a valid import path.

```rust
0: RetryableTransaction<S>
```
