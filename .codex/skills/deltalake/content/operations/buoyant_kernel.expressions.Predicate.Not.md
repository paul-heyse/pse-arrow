# `buoyant_kernel::expressions::Predicate::Not`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.expressions.Predicate.Not.json).

<a id="op-cc79b34f703f04a9bbe8c6ea"></a>
## 0

`struct_field` · `buoyant_kernel::expressions::Predicate::Not::0` · buoyant_kernel 1.0.0+58f07cd6
