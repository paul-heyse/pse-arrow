# `buoyant_kernel::error::Error::InvalidPartitionValues`

Full upstream contracts; raw type trees and source locators in [structured records](buoyant_kernel.error.Error.InvalidPartitionValues.json).

<a id="op-3c6ba481bc053f5ef1af9cc1"></a>
## 0

`struct_field` · `buoyant_kernel::error::Error::InvalidPartitionValues::0` · buoyant_kernel 1.0.0+58f07cd6
