...
`datafusion_expr::expr::Expr` lives in `model/datafusion_expr.expr.json` and
`api/datafusion_expr.expr.md`, and an agent can construct either without consulting an index.
"""
