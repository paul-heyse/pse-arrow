...
Crate `object_store` · 2 public items · structured records in [`model/object_store.aws.json`](../model/object_store.aws.json)

## AmazonS3

`struct` · `object_store::aws::AmazonS3`
...
`type_alias` · `object_store::aws::AwsCredentialProvider`
