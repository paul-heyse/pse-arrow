...
Crate `datafusion-spark` · 6 public items · structured records in [`model/datafusion_spark.function.array.json`](../model/datafusion_spark.function.array.json)

## array

`function` · `datafusion_spark::function::array::array`
...
`function` · `datafusion_spark::function::array::array_repeat`
...
`function` · `datafusion_spark::function::array::functions`
...
`function` · `datafusion_spark::function::array::shuffle`
...
`function` · `datafusion_spark::function::array::slice`
...
`function` · `datafusion_spark::function::array::spark_array_contains`
