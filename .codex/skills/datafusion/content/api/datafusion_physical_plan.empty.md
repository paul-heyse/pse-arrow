# `datafusion_physical_plan::empty`

Crate `datafusion-physical-plan` · 1 public items · structured records in [`model/datafusion_physical_plan.empty.json`](../model/datafusion_physical_plan.empty.json)

## EmptyExec

`struct` · `datafusion_physical_plan::empty::EmptyExec`
...
[Full member, field, variant and typed contracts](../operations/datafusion_physical_plan.empty.EmptyExec.md).
