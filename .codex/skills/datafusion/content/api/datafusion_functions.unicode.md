...
Crate `datafusion-functions` · 14 public items · structured records in [`model/datafusion_functions.unicode.json`](../model/datafusion_functions.unicode.json)

## character_length

`function` · `datafusion_functions::unicode::character_length`
...
`function` · `datafusion_functions::unicode::find_in_set`
...
`function` · `datafusion_functions::unicode::functions`
...
`function` · `datafusion_functions::unicode::initcap`
...
`function` · `datafusion_functions::unicode::left`
...
`function` · `datafusion_functions::unicode::lpad`
...
`function` · `datafusion_functions::unicode::reverse`
...
`function` · `datafusion_functions::unicode::right`
...
`function` · `datafusion_functions::unicode::rpad`
...
`function` · `datafusion_functions::unicode::strpos`
...
`function` · `datafusion_functions::unicode::substr`
...
`function` · `datafusion_functions::unicode::substr_index`
...
`function` · `datafusion_functions::unicode::substring`
...
`function` · `datafusion_functions::unicode::translate`
