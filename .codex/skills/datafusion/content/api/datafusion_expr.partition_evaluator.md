...
Crate `datafusion-expr` · 1 public items · structured records in [`model/datafusion_expr.partition_evaluator.json`](../model/datafusion_expr.partition_evaluator.json)

## PartitionEvaluator

`trait` · `datafusion_expr::partition_evaluator::PartitionEvaluator`
