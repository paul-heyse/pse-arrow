...
Crate `datafusion-functions` · 1 public items · structured records in [`model/datafusion_functions.string.concat.json`](../model/datafusion_functions.string.concat.json)

## ConcatFunc

`struct` · `datafusion_functions::string::concat::ConcatFunc`
