...
Crate `datafusion-physical-expr` · 2 public items · structured records in [`model/datafusion_physical_expr.expressions.is_null.json`](../model/datafusion_physical_expr.expressions.is_null.json)

## is_null

`function` · `datafusion_physical_expr::expressions::is_null::is_null`

Also reachable as `datafusion_physical_expr::expressions::is_null`, `datafusion_physical_plan::execution_plan::expressions::is_null`, `datafusion_physical_plan::expressions::is_null`
...
`struct` · `datafusion_physical_expr::expressions::is_null::IsNullExpr`

Also reachable as `datafusion_physical_expr::expressions::IsNullExpr`, `datafusion_physical_plan::execution_plan::expressions::IsNullExpr`, `datafusion_physical_plan::expressions::IsNullExpr`
