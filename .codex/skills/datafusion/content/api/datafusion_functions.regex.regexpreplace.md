...
Crate `datafusion-functions` · 2 public items · structured records in [`model/datafusion_functions.regex.regexpreplace.json`](../model/datafusion_functions.regex.regexpreplace.json)

## regexp_replace

`function` · `datafusion_functions::regex::regexpreplace::regexp_replace`
...
`struct` · `datafusion_functions::regex::regexpreplace::RegexpReplaceFunc`
