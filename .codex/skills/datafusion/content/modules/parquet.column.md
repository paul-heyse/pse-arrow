...
Full upstream contracts; raw type trees and source locators in [structured records](parquet.column.json).

<a id="op-a3b712261433211946b80977"></a>
## column

`module` · `parquet::column` · parquet 59.3.0

```rust
mod column
```

Source: `src/column/mod.rs:18`. [Exact documentation build](https://docs.rs/crate/parquet/59.3.0/json).
