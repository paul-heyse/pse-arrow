...
Full upstream contracts; raw type trees and source locators in [structured records](datafusion.json).

<a id="op-c1ae05e54111e7c2676afbb1"></a>
## datafusion

`module` · `datafusion` · datafusion 55.1.0

```rust
mod datafusion
```

Source: `src/lib.rs:18`. [Exact documentation build](https://docs.rs/crate/datafusion/55.1.0/json).
...
* define your own catalogs, schemas, and table lists ([`catalog`](../modules/datafusion.catalog.md#op-dde61e0c18d1b513feece77f) and [`CatalogProvider`])
...
format, making heavy use of functions from the [arrow](../modules/arrow.md#op-8619314d4974dbb571ec9d30)
...
* [datafusion_common](../modules/datafusion_common.md#op-713d43d01c402be2866507b4): Common traits and types
* [datafusion_catalog](../modules/datafusion_catalog.md#op-e3265a7460be841db22db9cd): Catalog APIs such as [`SchemaProvider`] and [`CatalogProvider`]
* [datafusion_datasource](../modules/datafusion_datasource.md#op-b437ad859720c4011188d838): File and Data IO such as [`FileSource`] and [`DataSink`]
* [datafusion_session](../modules/datafusion_session.md#op-53ba55e8326daf52cce4b573): [`Session`] and related structures
* [datafusion_execution](../modules/datafusion_execution.md#op-cc47c90ceaa9e8197b5600e0): State and structures needed for execution
* [datafusion_expr](../modules/datafusion_expr.md#op-5006abb37765a7bae842342b): [`LogicalPlan`], [`Expr`] and related logical planning structure
* [datafusion_functions](../modules/datafusion_functions.md#op-0819c5e775f1c71025669776): Scalar function packages
* [datafusion_functions_aggregate](../modules/datafusion_functions_aggregate.md#op-ce94f648cdfcacc6630ed836): Aggregate functions such as `MIN`, `MAX`, `SUM`, etc
* [datafusion_functions_nested](../modules/datafusion_functions_nested.md#op-62e123b86dc626428c056ad5): Scalar function packages for `ARRAY`s, `MAP`s and `STRUCT`s
* [datafusion_functions_table](../modules/datafusion_functions_table.md#op-45cfc1bc3c17b8de743ecac3): Table Functions such as `GENERATE_SERIES`
* [datafusion_functions_window](../modules/datafusion_functions_window.md#op-b2f35f3fcb3a23029030199b): Window functions such as `ROW_NUMBER`, `RANK`, etc
* [datafusion_optimizer](../modules/datafusion_optimizer.md#op-d31764067ba192ffdae27b04): [`OptimizerRule`]s and [`AnalyzerRule`]s
* [datafusion_physical_expr](../modules/datafusion_physical_expr.md#op-f4912008a33c318308d44be3): [`PhysicalExpr`] and related expressions
* [datafusion_physical_plan](../modules/datafusion_physical_plan.md#op-503a211a64f81e70efd078bb): [`ExecutionPlan`] and related expressions
* [datafusion_physical_optimizer](../modules/datafusion_physical_optimizer.md#op-d34bcf30b0030009f523e5bd): [`ExecutionPlan`] and related expressions
* [datafusion_sql](../modules/datafusion_sql.md#op-22f32c632cae0eb354be0e76): SQL planner ([`SqlToRel`])
...
Unresolved upstream links (retained, not inferred): `futures::stream::Stream`, ``tokio::task::spawn_blocking``, `futures::StreamExt::next`, `tokio::task`, `tokio::runtime::Runtime`.
