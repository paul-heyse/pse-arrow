...
Full upstream contracts; raw type trees and source locators in [structured records](arrow_array.json).

<a id="op-0c2c16239480a33e475f29a9"></a>
## arrow_array

`module` · `arrow_array` · arrow-array 59.3.0

```rust
mod arrow_array
```

Source: `src/lib.rs:18`. [Exact documentation build](https://docs.rs/crate/arrow-array/59.3.0/json).
 ...
 well as an [`Array`](../operations/arrow_array.array.Array.md#op-cabb9fba5e3e968cee823d21) trait that can be used for type-erasure.

 # Building an Array

 Most [`Array`](../operations/arrow_array.array.Array.md#op-cabb9fba5e3e968cee823d21) implementations can be constructed directly from iterators or [`Vec`]
 ...
 For example, the type [`Int16Array`](../operations/arrow_array.array.primitive_array.Int16Array.md#op-108df9d5f08803e85fa8c02b) represents an array of 16-bit integers and consists of:

 * An optional [`NullBuffer`] identifying any null values
 * A contiguous [`ScalarBuffer<i16>`] of values

 Similarly, the type [`StringArray`](../operations/arrow_array.array.string_array.StringArray.md#op-5d32f770159d415652a55945) represents an array of UTF-8 strings and consists of:
 ...
 * A values [`Buffer`] of UTF-8 encoded string data
 ...
 Array constructors such as [`PrimitiveArray::try_new`](../operations/arrow_array.array.primitive_array.PrimitiveArray.md#op-0a9ccb6e6beb6b7d0956cadd) provide the ability to cheaply
 construct an array from these parts, with functions such as [`PrimitiveArray::into_parts`](../operations/arrow_array.array.primitive_array.PrimitiveArray.md#op-8ba43a22c166c01024087889)
 ...
 Given an [`Array`](../operations/arrow_array.array.Array.md#op-cabb9fba5e3e968cee823d21) of arbitrary length, it is possible to create an owned slice of this
 ...
 Arrays are often passed around as a dynamically typed [`&dyn Array`] or [`ArrayRef`](../operations/arrow_array.array.ArrayRef.md#op-657cc3ff3d24afcacda590e1).
 For example, [`RecordBatch`](`crate::RecordBatch`) stores columns as [`ArrayRef`](../operations/arrow_array.array.ArrayRef.md#op-657cc3ff3d24afcacda590e1).
 ...
 The [`cast::AsArray`](../operations/arrow_array.cast.AsArray.md#op-687c2dc0675984bae2049af6) extension trait can make this more ergonomic
