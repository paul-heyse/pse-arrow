...
Prose: [`api/datafusion_session.session.md`](../api/datafusion_session.session.md#session) · records: [`model/datafusion_session.session.json`](../model/datafusion_session.session.json)
