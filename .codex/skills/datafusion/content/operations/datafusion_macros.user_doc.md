...
Full upstream contracts; raw type trees and source locators in [structured records](datafusion_macros.user_doc.json).

<a id="op-d180806e65ea7e3580e74e4a"></a>
## user_doc

`proc_macro` · `datafusion_macros::user_doc` · datafusion-macros 55.1.0

```rust
macro user_doc
```

Source: `src/user_doc.rs:106`. [Exact documentation build](https://docs.rs/crate/datafusion-macros/55.1.0/json).
