# `datafusion_physical_plan::joins::array_map::ArrayMap`

Full upstream contracts; raw type trees and source locators in [structured records](datafusion_physical_plan.joins.array_map.ArrayMap.json).

<a id="op-1ef6fc1a0cd369e0c95a3ce2"></a>
## ArrayMap

`struct` · `datafusion_physical_plan::joins::array_map::ArrayMap` · datafusion-physical-plan 55.1.0

```rust
struct ArrayMap
```

Source: `src/joins/array_map.rs:103`. [Exact documentation build](https://docs.rs/crate/datafusion-physical-plan/55.1.0/json).
