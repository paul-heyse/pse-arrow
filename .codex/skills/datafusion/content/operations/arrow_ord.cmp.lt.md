...
Full upstream contracts; raw type trees and source locators in [structured records](arrow_ord.cmp.lt.json).

<a id="op-ddb89f8634c0158756fa3ff8"></a>
## lt

`function` · `arrow_ord::cmp::lt` · arrow-ord 59.3.0

```rust
fn lt(lhs: &dyn Datum, rhs: &dyn Datum) -> Result<arrow_array::BooleanArray, arrow_schema::ArrowError>
```

Source: `src/cmp.rs:113`. [Exact documentation build](https://docs.rs/crate/arrow-ord/59.3.0/json).
