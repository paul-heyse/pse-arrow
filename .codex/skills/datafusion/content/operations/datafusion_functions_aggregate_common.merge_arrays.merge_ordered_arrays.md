# `datafusion_functions_aggregate_common::merge_arrays::merge_ordered_arrays`

Full upstream contracts; raw type trees and source locators in [structured records](datafusion_functions_aggregate_common.merge_arrays.merge_ordered_arrays.json).

<a id="op-8c121276bfb0e2edcb26afbc"></a>
## merge_ordered_arrays

`function` · `datafusion_functions_aggregate_common::merge_arrays::merge_ordered_arrays` · datafusion-functions-aggregate-common 55.1.0
...
Source: `src/merge_arrays.rs:112`. [Exact documentation build](https://docs.rs/crate/datafusion-functions-aggregate-common/55.1.0/json).
