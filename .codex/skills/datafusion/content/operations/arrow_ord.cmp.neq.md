...
Full upstream contracts; raw type trees and source locators in [structured records](arrow_ord.cmp.neq.json).

<a id="op-12e2c5bc948547865761dc22"></a>
## neq

`function` · `arrow_ord::cmp::neq` · arrow-ord 59.3.0

```rust
fn neq(lhs: &dyn Datum, rhs: &dyn Datum) -> Result<arrow_array::BooleanArray, arrow_schema::ArrowError>
```

Source: `src/cmp.rs:96`. [Exact documentation build](https://docs.rs/crate/arrow-ord/59.3.0/json).
