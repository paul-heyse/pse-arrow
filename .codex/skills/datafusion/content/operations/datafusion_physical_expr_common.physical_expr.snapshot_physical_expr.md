...
Full upstream contracts; raw type trees and source locators in [structured records](datafusion_physical_expr_common.physical_expr.snapshot_physical_expr.json).

<a id="op-9112be2d6306fc04a981dae3"></a>
## snapshot_physical_expr

`function` · `datafusion_physical_expr_common::physical_expr::snapshot_physical_expr` · datafusion-physical-expr-common 55.1.0

```rust
fn snapshot_physical_expr(expr: std::sync::Arc<dyn PhysicalExpr>) -> datafusion_common::Result<std::sync::Arc<dyn PhysicalExpr>>
```

Source: `src/physical_expr.rs:943`. [Exact documentation build](https://docs.rs/crate/datafusion-physical-expr-common/55.1.0/json).
