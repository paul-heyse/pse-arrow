...
Full upstream contracts; raw type trees and source locators in [structured records](arrow_ord.cmp.eq.json).

<a id="op-bb67c631d08cd3a9244030d0"></a>
## eq

`function` · `arrow_ord::cmp::eq` · arrow-ord 59.3.0

```rust
fn eq(lhs: &dyn Datum, rhs: &dyn Datum) -> Result<arrow_array::BooleanArray, arrow_schema::ArrowError>
```

Source: `src/cmp.rs:79`. [Exact documentation build](https://docs.rs/crate/arrow-ord/59.3.0/json).
