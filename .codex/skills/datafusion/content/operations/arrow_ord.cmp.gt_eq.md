...
Full upstream contracts; raw type trees and source locators in [structured records](arrow_ord.cmp.gt_eq.json).

<a id="op-80727cd55f68369c47c82f25"></a>
## gt_eq

`function` · `arrow_ord::cmp::gt_eq` · arrow-ord 59.3.0

```rust
fn gt_eq(lhs: &dyn Datum, rhs: &dyn Datum) -> Result<arrow_array::BooleanArray, arrow_schema::ArrowError>
```

Source: `src/cmp.rs:164`. [Exact documentation build](https://docs.rs/crate/arrow-ord/59.3.0/json).
