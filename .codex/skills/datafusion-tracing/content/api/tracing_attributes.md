...
Crate `tracing-attributes` · 1 public items · structured records in [`model/tracing_attributes.json`](../model/tracing_attributes.json)

## instrument

`proc_macro` · `tracing_attributes::instrument`
