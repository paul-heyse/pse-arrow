# Planning instrumentation: selected

Builder selectors choose particular phase and rule detail.
...
Claim `tracing.rules.selected.1`; source_observation; evidence: source.
...
Claim `tracing.rules.selected.2`; source_observation; evidence: source.

**Executed scope.** The publicly reached phase builder restricted to physical optimization emits exactly optimize_physical_plan for the workload.
Claim `tracing.rules.selected.observed`; runtime_observation; evidence: consumer.
...
- [source](../../content/corpus/source/datafusion-tracing/rule_options.rs): Retained exact-release source or documentation; local runtime assertions are linked separately.
  Tests: 
- [consumer](../../skill_improvement/evidence/implementation/probe-results.json): The publicly reached phase builder restricted to physical optimization emits exactly optimize_physical_plan for the workload.
