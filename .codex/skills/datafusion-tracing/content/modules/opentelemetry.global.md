...
Full upstream contracts; raw type trees and source locators in [structured records](opentelemetry.global.json).

<a id="op-a047a0fcd9c3b7e9a73e328c"></a>
## global

`module` · `opentelemetry::global` · opentelemetry 0.31.0
...
Source: `src/global/mod.rs:1`. [Exact documentation build](https://docs.rs/crate/opentelemetry/0.31.0/json).
...
or calling [`set_tracer_provider`](../operations/opentelemetry.global.trace.set_tracer_provider.md#op-1838068eed0349336444df04).
