...
Full upstream contracts; raw type trees and source locators in [structured records](tracing.json).

<a id="op-9c1f7d23f358e3a0a8455190"></a>
## tracing

`module` · `tracing` · tracing 0.1.44
...
Source: `src/lib.rs:1`. [Exact documentation build](https://docs.rs/crate/tracing/0.1.44/json).
...
```
  ...
  **Warning**: In asynchronous code that uses async/await syntax,
  ...
  [the method documentation][Span#in-asynchronous-code](../operations/tracing.span.Span.md#op-1283b08586edf8ae3649f1c6) for details.

 </pre></div>

 ## Events

 An [`Event`](../operations/tracing_core.event.Event.md#op-7ee85389e31294d1a098f039) represents a _moment_ in time. It signifies something that
...
```
 ...
 The [`Event` struct][`Event`](../operations/tracing_core.event.Event.md#op-7ee85389e31294d1a098f039) documentation provides further details on using
 events.
 ...
 record a span. The [`Span::enter`](../operations/tracing.span.Span.md#op-0ac1698dc0d740afb9e61b4b) method on that struct records that the
 ...
 [`Event`](../operations/tracing_core.event.Event.md#op-7ee85389e31294d1a098f039)s are recorded using the [`event!`] macro:
 ...
 Both macros require a [`Level`](../operations/tracing_core.metadata.Level.md#op-f8804717be954252aadd54ff) specifying the verbosity of the span or
...
```
 ...
 similarly to the [`event!`] macro, but with the [`Level`](../operations/tracing_core.metadata.Level.md#op-f8804717be954252aadd54ff) argument already
 ...
 `tracing` [`Subscriber`]s to consume `log` records as `tracing` [`Event`](../operations/tracing_core.event.Event.md#op-7ee85389e31294d1a098f039)s.
...
Unresolved upstream links (retained, not inferred): `std::fmt#usage`, `Metadata::target`, `std::fmt::Debug`, `span::Attributes::is_contextual`, `std::fmt::Display`, `span::Attributes::parent`.
