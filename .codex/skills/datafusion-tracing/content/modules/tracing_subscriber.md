...
Full upstream contracts; raw type trees and source locators in [structured records](tracing_subscriber.json).

<a id="op-142f5fbb810835359ad5d716"></a>
## tracing_subscriber

`module` · `tracing_subscriber` · tracing-subscriber 0.3.23
...
Source: `src/lib.rs:1`. [Exact documentation build](https://docs.rs/crate/tracing-subscriber/0.3.23/json).
