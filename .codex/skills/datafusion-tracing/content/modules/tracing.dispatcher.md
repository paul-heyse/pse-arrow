...
Full upstream contracts; raw type trees and source locators in [structured records](tracing.dispatcher.json).

<a id="op-ad4cec090ca0a26cbe94a168"></a>
## dispatcher

`module` · `tracing::dispatcher` · tracing 0.1.44
...
Source: `src/dispatcher.rs:1`. [Exact documentation build](https://docs.rs/crate/tracing/0.1.44/json).
