...
Full upstream contracts; raw type trees and source locators in [structured records](opentelemetry.json).

<a id="op-82f51df0c389cf739d2f6461"></a>
## opentelemetry

`module` · `opentelemetry` · opentelemetry 0.31.0
...
Source: `src/lib.rs:1`. [Exact documentation build](https://docs.rs/crate/opentelemetry/0.31.0/json).
...
The [`trace`](../modules/opentelemetry.trace.md#op-860b44a9d0353bc997e5d841) module includes types for tracking the progression of a single
...
See the [`trace`](../modules/opentelemetry.trace.md#op-860b44a9d0353bc997e5d841) module docs for more information on creating and managing
spans.
...
The [`metrics`](../modules/opentelemetry.metrics.md#op-90240d71d0a57ae249e23ab7) module provides types for recording measurements about a
...
See the [`metrics`](../modules/opentelemetry.metrics.md#op-90240d71d0a57ae249e23ab7) module docs for more information on creating and
managing instruments.


# Getting Started with Logs

 The [`logs`](../modules/opentelemetry.logs.md#op-65fa9de49f164822d54da084) module contains the Logs Bridge API. It is not intended to be
