...
Full upstream contracts; raw type trees and source locators in [structured records](tracing_opentelemetry.json).

<a id="op-f3bd0a15539e4a5c28c16abe"></a>
## tracing_opentelemetry

`module` · `tracing_opentelemetry` · tracing-opentelemetry 0.32.0
...
Source: `src/lib.rs:1`. [Exact documentation build](https://docs.rs/crate/tracing-opentelemetry/0.32.0/json).
...
- `metrics`: Enables the [`MetricsLayer`](../operations/tracing_opentelemetry.metrics.MetricsLayer.md#op-89f067ec31171359b3c6376e) type, a [layer] that
