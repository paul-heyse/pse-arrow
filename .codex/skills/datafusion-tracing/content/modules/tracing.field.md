...
Full upstream contracts; raw type trees and source locators in [structured records](tracing.field.json).

<a id="op-0ea37d75ae03563c04f411dc"></a>
## field

`module` · `tracing::field` · tracing 0.1.44
...
Source: `src/field.rs:1`. [Exact documentation build](https://docs.rs/crate/tracing/0.1.44/json).
...
a `&str` but represented internally as an array index) to a [`Value`](../operations/tracing_core.field.Value.md#op-3bdffa798a494864d07fca1b).
...
recorded as typed data by calling the [`Value::record`](../operations/tracing_core.field.Value.md#op-95b4d7e923013aac166173fc) method on these
trait objects with a _visitor_ implementing the [`Visit`](../operations/tracing_core.field.Visit.md#op-5756ad7dac310ca14da0016b) trait. This trait
...
`tracing`'s [`Value`](../operations/tracing_core.field.Value.md#op-3bdffa798a494864d07fca1b) trait is intentionally minimalist: it supports only a small
...
Alternatively, the [`valuable()`](../operations/tracing_core.field.valuable.md#op-87eb250a15d063ef506bcd78) function may be used to convert a type
implementing [`Valuable`] into a `tracing` field value.

When the `valuable` feature is enabled, the [`Visit`](../operations/tracing_core.field.Visit.md#op-5756ad7dac310ca14da0016b) trait will include an
