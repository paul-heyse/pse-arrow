...
Full upstream contracts; raw type trees and source locators in [structured records](tracing_attributes.instrument.json).

<a id="op-500c292d24d29b3397643254"></a>
## instrument

`proc_macro` · `tracing_attributes::instrument` · tracing-attributes 0.1.31
...
Source: `src/lib.rs:576`. [Exact documentation build](https://docs.rs/crate/tracing-attributes/0.1.31/json).
...
Unresolved upstream links (retained, not inferred): `std::fmt::Debug`, ``std::fmt::Debug``, ``Result::Ok``, ``std::fmt::Display``, ``Result::Err``.
