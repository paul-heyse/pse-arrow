...
Full upstream contracts; raw type trees and source locators in [structured records](datafusion_tracing.instrument_with_debug_spans.json).

<a id="op-1ddd95294965df6d7daf554b"></a>
## instrument_with_debug_spans

`macro` · `datafusion_tracing::instrument_with_debug_spans` · datafusion-tracing 55.0.0
...
Source: `src/exec_instrument_macros.rs:309`. [Exact documentation build](https://docs.rs/crate/datafusion-tracing/55.0.0/json).
...
<a id="op-3bd5eef86f73ce0a274e77e8"></a>
## instrument_with_debug_spans
...
Source: `src/exec_instrument_macros.rs:309`. [Exact documentation build](../../build/acquired/rustdoc/datafusion-tracing@55.0.0.private.json.zst).
