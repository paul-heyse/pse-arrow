...
q18 AS (
    SELECT
        ...
        "selections"."is_default" AS c8,
        "selections"."scope_kind" AS c10,
        "selections"."property_kind_id" AS c12,
...
q78 AS (
    SELECT
        ...
        q19.c7 AS c1,
        q19.c14 AS c2
    FROM q19 LEFT ANTI JOIN q29 ON (q19.c0 = q29.c0) AND (q19.c7 = q29.c1) AND (q19.c14 = q29.c2) LEFT ANTI JOIN q51 ON (q19.c0 = q51.c0) AND (q19.c7 = q51.c1) AND (q19.c14 = q51.c2) LEFT ANTI JOIN q73 ON (q19.c0 = q73.c0) AND (q19.c7 = q73.c1) AND (q19.c14 = q73.c2) JOIN "reference"."method_precedence" AS "precedence" ON (q19.c8 = "precedence"."is_default") AND (q19.c10 = "precedence"."scope_kind")
    WHERE ((("precedence"."property_specific" = (q19.c12 IS NOT NULL))))
),
q80 AS (
    SELECT
        q19.c0 AS c0,
        ...
        q19.c16 AS c6
    FROM q19 LEFT ANTI JOIN q29 ON (q19.c0 = q29.c0) AND (q19.c7 = q29.c1) AND (q19.c14 = q29.c2) LEFT ANTI JOIN q51 ON (q19.c0 = q51.c0) AND (q19.c7 = q51.c1) AND (q19.c14 = q51.c2) LEFT ANTI JOIN q73 ON (q19.c0 = q73.c0) AND (q19.c7 = q73.c1) AND (q19.c14 = q73.c2) LEFT ANTI JOIN q78 ON (q19.c0 = q78.c0) AND (q19.c7 = q78.c1) AND (q19.c14 = q78.c2)
)
SELECT
    q80.c0 AS "requirement_id",
    q80.c1 AS "selection_id",
    q80.c2 AS "method_id",
    q80.c3 AS "applicable",
    q80.c4 AS "rank",
    q80.c5 AS "reason",
    q80.c6 AS "derivation_id"
FROM q80
