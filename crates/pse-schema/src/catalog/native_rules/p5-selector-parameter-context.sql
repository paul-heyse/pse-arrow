...
q6 AS (
    SELECT
        ...
        "targets"."target_entity_id" AS c5,
        "nodes"."entity_kind" AS c6,
        "nodes"."constant" AS c7,
        "nodes"."node_id" AS c8
    FROM "inferred"."scope_candidates" AS "scopes" JOIN "normalized"."selector_nodes" AS "nodes" ON ("scopes"."scope_decl_id" = "nodes"."scope_decl_id") JOIN "inferred"."selector_parameter_targets" AS "targets" ON ("scopes"."scope_id" = "targets"."scope_id") AND ("nodes"."node_id" = "targets"."node_id")
