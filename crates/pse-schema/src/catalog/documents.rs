...
//! The authoring document shapes the package loader parses into (blueprint §22.1).
//!
//! Packet A-6 fills this module. It is declared and wired into
...
/// Declares nothing yet; packet A-6 fills it.
