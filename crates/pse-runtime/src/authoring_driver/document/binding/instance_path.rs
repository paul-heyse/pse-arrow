...
use super::{BoundInstancePath, BoundPath, Context, InstancePathSegment, PathMeaning, paths};
use crate::authoring_driver::{DriverError, SourceSpan, document::load::contract, dsl};
...
pub(super) fn bind(
    ...
    context: &Context,
    at: SourceSpan,
) -> Result<Option<BoundPath>, DriverError> {
...
fn descend(
    ...
    context: &Context,
    at: SourceSpan,
) -> Result<(Vec<Owner>, bool), DriverError> {
...
fn members(
    ...
    context: &Context,
    at: SourceSpan,
) -> Result<(Vec<SemanticId>, Option<SemanticId>), DriverError> {
