...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    226u8, 49u8, 3u8, 82u8, 177u8, 2u8, 39u8, 152u8, 122u8, 79u8, 192u8, 208u8, 203u8,
    223u8, 234u8, 185u8, 47u8, 15u8, 111u8, 106u8, 216u8, 47u8, 185u8, 237u8, 201u8,
    149u8, 153u8, 9u8, 163u8, 221u8, 244u8, 162u8,
]);
...
impl crate::columnar::RelationRow for ReferenceMethodStateParametersRow {
    ...
    fn builder_allocation_size() -> usize {
        26_312_usize + size_of::<Self::Builder>()
    }
