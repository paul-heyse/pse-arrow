...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    99u8, 44u8, 108u8, 212u8, 172u8, 66u8, 253u8, 254u8, 122u8, 65u8, 99u8, 54u8, 140u8,
    72u8, 9u8, 67u8, 65u8, 205u8, 168u8, 101u8, 171u8, 94u8, 219u8, 26u8, 16u8, 128u8,
    117u8, 137u8, 46u8, 178u8, 117u8, 39u8,
]);
...
impl crate::columnar::RelationRow for ReferenceSchemaEnumsRow {
    ...
    fn builder_allocation_size() -> usize {
        52_280_usize + size_of::<Self::Builder>()
    }
