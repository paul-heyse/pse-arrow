...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    140u8, 184u8, 250u8, 117u8, 43u8, 158u8, 235u8, 39u8, 231u8, 38u8, 213u8, 184u8,
    113u8, 8u8, 11u8, 203u8, 21u8, 180u8, 32u8, 5u8, 227u8, 219u8, 168u8, 5u8, 94u8,
    247u8, 154u8, 60u8, 148u8, 63u8, 225u8, 54u8,
]);
...
impl crate::columnar::RelationRow for ReferenceRuleGroupKeysRow {
    ...
    fn builder_allocation_size() -> usize {
        27_088_usize + size_of::<Self::Builder>()
    }
