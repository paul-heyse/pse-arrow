...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    227u8, 18u8, 43u8, 24u8, 39u8, 86u8, 169u8, 83u8, 247u8, 153u8, 0u8, 194u8, 253u8,
    216u8, 187u8, 224u8, 176u8, 141u8, 150u8, 77u8, 55u8, 64u8, 139u8, 65u8, 119u8, 92u8,
    97u8, 154u8, 98u8, 203u8, 127u8, 122u8,
]);
...
impl crate::columnar::RelationRow for ReferenceReferenceStatesRow {
    ...
    fn builder_allocation_size() -> usize {
        67_664_usize + size_of::<Self::Builder>()
    }
