...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    53u8, 221u8, 147u8, 23u8, 72u8, 156u8, 237u8, 111u8, 63u8, 47u8, 13u8, 158u8, 120u8,
    31u8, 73u8, 227u8, 169u8, 32u8, 18u8, 33u8, 214u8, 79u8, 250u8, 4u8, 217u8, 186u8,
    211u8, 36u8, 38u8, 118u8, 81u8, 230u8,
]);
...
impl crate::columnar::RelationRow for ReferenceRuleExprNodesRow {
    ...
    fn builder_allocation_size() -> usize {
        153_936_usize + size_of::<Self::Builder>()
    }
