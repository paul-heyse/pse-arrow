...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    56u8, 241u8, 93u8, 172u8, 3u8, 126u8, 200u8, 163u8, 184u8, 152u8, 106u8, 234u8,
    239u8, 154u8, 222u8, 58u8, 192u8, 225u8, 113u8, 183u8, 142u8, 52u8, 44u8, 162u8,
    179u8, 142u8, 9u8, 39u8, 125u8, 158u8, 25u8, 185u8,
]);
    ...
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#atomic_mass),
            ],
        )
    }
...
impl crate::columnar::RelationRow for ReferenceElementsRow {
    ...
    fn builder_allocation_size() -> usize {
        32_712_usize + size_of::<Self::Builder>()
    }
