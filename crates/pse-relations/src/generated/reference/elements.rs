...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    232u8, 208u8, 234u8, 219u8, 151u8, 25u8, 83u8, 80u8, 217u8, 63u8, 154u8, 189u8,
    153u8, 28u8, 3u8, 19u8, 48u8, 228u8, 97u8, 44u8, 232u8, 136u8, 112u8, 73u8, 211u8,
    65u8, 205u8, 201u8, 88u8, 253u8, 99u8, 251u8,
]);
...
impl crate::columnar::RelationRow for ReferenceElementsRow {
    ...
    fn builder_allocation_size() -> usize {
        32_248_usize + size_of::<Self::Builder>()
    }
