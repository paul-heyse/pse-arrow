...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    27u8, 46u8, 170u8, 251u8, 134u8, 152u8, 176u8, 109u8, 129u8, 19u8, 226u8, 90u8,
    252u8, 74u8, 17u8, 242u8, 27u8, 3u8, 229u8, 241u8, 25u8, 48u8, 105u8, 38u8, 95u8,
    102u8, 204u8, 220u8, 164u8, 94u8, 50u8, 47u8,
]);
...
impl crate::columnar::RelationRow for ReferenceElementsRow {
    ...
    fn builder_allocation_size() -> usize {
        34_472_usize + size_of::<Self::Builder>()
    }
