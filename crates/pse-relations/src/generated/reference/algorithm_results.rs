...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    34u8, 91u8, 18u8, 103u8, 243u8, 41u8, 15u8, 162u8, 113u8, 216u8, 145u8, 240u8, 77u8,
    194u8, 126u8, 106u8, 26u8, 68u8, 13u8, 57u8, 184u8, 134u8, 37u8, 15u8, 192u8, 240u8,
    157u8, 109u8, 105u8, 149u8, 60u8, 235u8,
]);
...
impl crate::typed::CellCodec for ReferenceAlgorithmResultsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(ReferenceAlgorithmResultsRow)));
        };
            ...
            r#algorithm_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ReferenceAlgorithmResultsRow),
                    ))?,
            )?,
...
impl ReferenceAlgorithmResultsRow {
...
impl crate::columnar::RelationRow for ReferenceAlgorithmResultsRow {
    ...
    fn builder_allocation_size() -> usize {
        33_936_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ReferenceAlgorithmResultsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ReferenceAlgorithmResultsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ReferenceAlgorithmResultsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ReferenceAlgorithmResultsView<'_>,
    ) -> Result<(), crate::RelationError> {
