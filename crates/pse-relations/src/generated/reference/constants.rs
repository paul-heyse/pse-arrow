...
pub use pse_model::generated::r#reference::r#constants::{ReferenceConstantsRow, Row};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    254u8, 254u8, 58u8, 38u8, 243u8, 244u8, 170u8, 59u8, 118u8, 137u8, 246u8, 201u8,
    78u8, 96u8, 193u8, 107u8, 0u8, 39u8, 109u8, 61u8, 246u8, 212u8, 42u8, 17u8, 123u8,
    63u8, 31u8, 97u8, 82u8, 225u8, 139u8, 248u8,
]);
...
impl crate::columnar::RelationRow for ReferenceConstantsRow {
    ...
    fn rows_at(
        ...
        let view = ReferenceConstantsView::from_checked(batch)?;
...
pub mod columns {
    ///constant_id
    pub const CONSTANT_ID: crate::columnar::ColumnReference = super::COLUMNS[0usize];
    ///name
    pub const NAME: crate::columnar::ColumnReference = super::COLUMNS[1usize];
    ///idaes_name
    pub const IDAES_NAME: crate::columnar::ColumnReference = super::COLUMNS[2usize];
    ///value
    ...
    ///quantity_kind_id
    pub const QUANTITY_KIND_ID: crate::columnar::ColumnReference = super::COLUMNS[5usize];
    ///doc
...
pub type ReferenceConstantsBuilder = crate::columnar::RowBuilder<ReferenceConstantsRow>;
impl crate::columnar::RelationView for ReferenceConstantsView<'_> {
    type Row = ReferenceConstantsRow;
