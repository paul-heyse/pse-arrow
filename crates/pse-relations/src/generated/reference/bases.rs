...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    103u8, 152u8, 21u8, 194u8, 167u8, 119u8, 231u8, 26u8, 134u8, 255u8, 138u8, 151u8,
    155u8, 69u8, 36u8, 87u8, 10u8, 37u8, 212u8, 236u8, 26u8, 247u8, 165u8, 159u8, 50u8,
    85u8, 162u8, 3u8, 220u8, 11u8, 114u8, 11u8,
]);
...
impl crate::columnar::RelationRow for ReferenceBasesRow {
    ...
    fn builder_allocation_size() -> usize {
        76_608_usize + size_of::<Self::Builder>()
    }
