...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    33u8, 186u8, 239u8, 147u8, 225u8, 156u8, 135u8, 176u8, 39u8, 230u8, 183u8, 91u8,
    117u8, 48u8, 190u8, 245u8, 65u8, 18u8, 19u8, 84u8, 21u8, 177u8, 181u8, 165u8, 132u8,
    90u8, 137u8, 162u8, 31u8, 14u8, 189u8, 253u8,
]);
...
impl crate::columnar::RelationRow for ReferenceBasesRow {
    ...
    fn builder_allocation_size() -> usize {
        74_848_usize + size_of::<Self::Builder>()
    }
