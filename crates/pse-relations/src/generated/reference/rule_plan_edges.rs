...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    199u8, 135u8, 123u8, 245u8, 91u8, 85u8, 32u8, 93u8, 58u8, 63u8, 110u8, 104u8, 249u8,
    207u8, 2u8, 189u8, 55u8, 67u8, 52u8, 201u8, 236u8, 118u8, 81u8, 145u8, 18u8, 192u8,
    73u8, 238u8, 187u8, 193u8, 151u8, 180u8,
]);
...
impl crate::columnar::RelationRow for ReferenceRulePlanEdgesRow {
    ...
    fn builder_allocation_size() -> usize {
        32_376_usize + size_of::<Self::Builder>()
    }
