...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    96u8, 148u8, 44u8, 79u8, 33u8, 251u8, 232u8, 154u8, 116u8, 75u8, 114u8, 195u8, 199u8,
    182u8, 117u8, 135u8, 116u8, 252u8, 78u8, 144u8, 230u8, 59u8, 209u8, 95u8, 45u8,
    195u8, 126u8, 30u8, 31u8, 50u8, 191u8, 248u8,
]);
