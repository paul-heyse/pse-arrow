...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    43u8, 72u8, 246u8, 128u8, 252u8, 115u8, 0u8, 131u8, 103u8, 143u8, 228u8, 7u8, 55u8,
    188u8, 174u8, 59u8, 120u8, 162u8, 102u8, 241u8, 122u8, 177u8, 73u8, 55u8, 9u8, 252u8,
    70u8, 249u8, 71u8, 24u8, 206u8, 118u8,
]);
...
impl crate::columnar::RelationRow for ReferenceSchemaLogicalTypesRow {
    ...
    fn builder_allocation_size() -> usize {
        43_584_usize + size_of::<Self::Builder>()
    }
