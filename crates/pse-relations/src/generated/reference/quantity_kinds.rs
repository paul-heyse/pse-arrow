...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    48u8, 55u8, 46u8, 134u8, 138u8, 142u8, 131u8, 178u8, 114u8, 237u8, 93u8, 210u8,
    242u8, 20u8, 139u8, 232u8, 238u8, 11u8, 190u8, 187u8, 187u8, 160u8, 191u8, 50u8,
    201u8, 180u8, 43u8, 193u8, 70u8, 32u8, 107u8, 58u8,
]);
...
impl crate::columnar::RelationRow for ReferenceQuantityKindsRow {
    ...
    fn builder_allocation_size() -> usize {
        111_824_usize + size_of::<Self::Builder>()
    }
