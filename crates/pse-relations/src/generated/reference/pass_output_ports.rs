...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    11u8, 167u8, 128u8, 8u8, 76u8, 39u8, 227u8, 30u8, 99u8, 53u8, 16u8, 4u8, 26u8, 8u8,
    191u8, 224u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "pass_output_ports";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    204u8, 123u8, 131u8, 169u8, 200u8, 159u8, 109u8, 55u8, 220u8, 98u8, 252u8, 0u8,
    246u8, 129u8, 106u8, 26u8, 55u8, 153u8, 217u8, 206u8, 138u8, 40u8, 103u8, 123u8,
    222u8, 210u8, 49u8, 46u8, 148u8, 56u8, 53u8, 18u8,
]);
...
pub struct ReferencePassOutputPortsRow {
    ///pass_id
...
impl crate::typed::CellCodec for ReferencePassOutputPortsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(ReferencePassOutputPortsRow)));
        };
            ...
            r#pass_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ReferencePassOutputPortsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ReferencePassOutputPortsRow {
    fn append(
        &self,
...
pub type Row = ReferencePassOutputPortsRow;
/// The concrete generated relation view.
pub type View<'a> = ReferencePassOutputPortsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ReferencePassOutputPortsBuilder;
impl ReferencePassOutputPortsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "reference.pass_output_ports".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ReferencePassOutputPortsRow {
    type Builder = ReferencePassOutputPortsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ReferencePassOutputPortsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ReferencePassOutputPortsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        31_552_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ReferencePassOutputPortsView<'a> {
...
impl<'a> ReferencePassOutputPortsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ReferencePassOutputPortsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ReferencePassOutputPortsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ReferencePassOutputPortsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ReferencePassOutputPortsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ReferencePassOutputPortsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ReferencePassOutputPortsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ReferencePassOutputPortsView<'_>,
    ) -> Result<(), crate::RelationError> {
