...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    89u8, 121u8, 210u8, 169u8, 246u8, 21u8, 222u8, 254u8, 254u8, 138u8, 83u8, 2u8, 65u8,
    113u8, 162u8, 80u8, 146u8, 241u8, 138u8, 32u8, 76u8, 90u8, 63u8, 73u8, 57u8, 166u8,
    211u8, 86u8, 70u8, 50u8, 64u8, 203u8,
]);
    ...
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                ::typed::CellCodec::into_cell(self.r#relation_id)
            ],
        )
    }
...
impl<'a> ReferencePassOutputPortsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(ReferencePassOutputPortsRow::from_cells)
            .collect()
    }
}
...
pub struct ReferencePassOutputPortsBuilder {
    rows: Vec<ReferencePassOutputPortsRow>,
}
impl ReferencePassOutputPortsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(ReferencePassOutputPortsRow::into_cells)
            .collect::<Vec<_>>();
