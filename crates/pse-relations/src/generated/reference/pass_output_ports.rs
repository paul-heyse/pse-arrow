...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    1u8, 40u8, 169u8, 172u8, 150u8, 251u8, 51u8, 99u8, 179u8, 243u8, 18u8, 80u8, 65u8,
    162u8, 147u8, 119u8, 213u8, 219u8, 163u8, 125u8, 212u8, 4u8, 73u8, 51u8, 70u8, 247u8,
    217u8, 83u8, 88u8, 216u8, 218u8, 111u8,
]);
...
impl crate::columnar::RelationRow for ReferencePassOutputPortsRow {
    ...
    fn builder_allocation_size() -> usize {
        32_016_usize + size_of::<Self::Builder>()
    }
