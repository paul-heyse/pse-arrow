...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    190u8, 146u8, 226u8, 227u8, 147u8, 89u8, 141u8, 82u8, 42u8, 201u8, 70u8, 249u8,
    134u8, 237u8, 187u8, 70u8, 69u8, 66u8, 223u8, 125u8, 24u8, 25u8, 196u8, 42u8, 23u8,
    37u8, 210u8, 157u8, 143u8, 127u8, 126u8, 112u8,
]);
...
impl crate::typed::CellCodec for ReferenceQuantityOperationReductionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ReferenceQuantityOperationReductionsRow),
                ),
            );
        };
...
impl ReferenceQuantityOperationReductionsRow {
...
impl crate::columnar::RelationRow for ReferenceQuantityOperationReductionsRow {
    ...
    fn builder_allocation_size() -> usize {
        38_864_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ReferenceQuantityOperationReductionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ReferenceQuantityOperationReductionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ReferenceQuantityOperationReductionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ReferenceQuantityOperationReductionsView<'_>,
    ) -> Result<(), crate::RelationError> {
