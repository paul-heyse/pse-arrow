...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    106u8, 200u8, 163u8, 115u8, 149u8, 220u8, 31u8, 216u8, 66u8, 69u8, 68u8, 169u8, 28u8,
    128u8, 43u8, 8u8, 141u8, 223u8, 48u8, 31u8, 6u8, 17u8, 38u8, 64u8, 6u8, 174u8, 42u8,
    186u8, 134u8, 94u8, 201u8, 118u8,
]);
...
impl crate::typed::CellCodec for ReferenceRuleExprEdgesRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                crate ::typed::CellCodec::into_cell(self.r#parent_expr_id), crate
                ::typed::CellCodec::into_cell(self.r#ordinal), crate
                ::typed::CellCodec::into_cell(self.r#child_expr_id)
            ],
        )
    }
...
const COMPILED_DECLARATION: &str = "[\"struct\",[[\"text\",\"compiled_relation_v1\"],[\"id\",\"d3441a3bac27119c63056dad40114f80\"],[\"struct\",[[\"text\",\"reference\"],[\"text\",\"rule_expr_edges\"],[\"u64\",1]]],[\"text\",\"reference\"],[\"text\",\"model\"],[\"null\",null],[\"text\",\"evolving\"],[\"list\",[[\"text\",\"parent_expr_id\"],[\"text\",\"ordinal\"]]],[\"list\",[[\"struct\",[[\"text\",\"parent_expr_id\"],[\"struct\",[[\"text\",\"extension\"],[\"text\",\"semantic_id\"],[\"text\",\"pse.semantic_id\"],[\"struct\",[[\"text\",\"FixedSizeBinary\"],[\"i64\",16]]],[\"text\",\"version_only\"],[\"u64\",1],[\"text\",\"{\\\"v\\\":1}\"],[\"null\",null],[\"text\",\"128-bit semantic identity (blueprint §5.1).\"]]],[\"bool\",false],[\"struct\",[[\"text\",\"none\"]]],[\"null\",null],[\"text\",\"key\"],[\"text\",\"parent_expr_id\"],[\"struct\",[[\"text\",\"parent_expr_id\"],[\"struct\",[[\"text\",\"FixedSizeBinary\"],[\"i64\",16]]],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"ARROW:extension:metadata\"],[\"text\",\"{\\\"v\\\":1}\"]]],[\"struct\",[[\"text\",\"ARROW:extension:name\"],[\"text\",\"pse.semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"key\"]]]]]]]]],[\"struct\",[[\"text\",\"ordinal\"],[\"struct\",[[\"text\",\"u32\"],[\"text\",\"UInt32\"]]],[\"bool\",false],[\"struct\",[[\"text\",\"none\"]]],[\"null\",null],[\"text\",\"key\"],[\"text\",\"ordinal\"],[\"struct\",[[\"text\",\"ordinal\"],[\"text\",\"UInt32\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"u32\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"key\"]]]]]]]]],[\"struct\",[[\"text\",\"child_expr_id\"],[\"struct\",[[\"text\",\"extension\"],[\"text\",\"semantic_id\"],[\"text\",\"pse.semantic_id\"],[\"struct\",[[\"text\",\"FixedSizeBinary\"],[\"i64\",16]]],[\"text\",\"version_only\"],[\"u64\",1],[\"text\",\"{\\\"v\\\":1}\"],[\"null\",null],[\"text\",\"128-bit semantic identity (blueprint §5.1).\"]]],[\"bool\",false],[\"struct\",[[\"text\",\"none\"]]],[\"null\",null],[\"text\",\"payload\"],[\"text\",\"child_expr_id\"],[\"struct\",[[\"text\",\"child_expr_id\"],[\"struct\",[[\"text\",\"FixedSizeBinary\"],[\"i64\",16]]],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"ARROW:extension:metadata\"],[\"text\",\"{\\\"v\\\":1}\"]]],[\"struct\",[[\"text\",\"ARROW:extension:name\"],[\"text\",\"pse.semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"payload\"]]]]]]]]]]],[\"text\",\"blueprint §6.11 numerical and rule: rule_expr_edges.\"],[\"list\",[[\"struct\",[[\"text\",\"pse.contract.id\"],[\"text\",\"d3441a3bac27119c63056dad40114f80\"]]],[\"struct\",[[\"text\",\"pse.contract.version\"],[\"text\",\"1\"]]],[\"struct\",[[\"text\",\"pse.namespace\"],[\"text\",\"reference\"]]]]]]]";
...
impl<'a> ReferenceRuleExprEdgesView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<ReferenceRuleExprEdgesRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(ReferenceRuleExprEdgesRow::from_cells)
            .collect()
    }
}
...
pub struct ReferenceRuleExprEdgesBuilder {
    rows: Vec<ReferenceRuleExprEdgesRow>,
}
impl ReferenceRuleExprEdgesBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(ReferenceRuleExprEdgesRow::into_cells)
            .collect::<Vec<_>>();
