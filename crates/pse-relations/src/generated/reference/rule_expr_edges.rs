...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    78u8, 170u8, 133u8, 206u8, 221u8, 127u8, 73u8, 196u8, 165u8, 153u8, 8u8, 181u8,
    160u8, 89u8, 79u8, 20u8, 229u8, 11u8, 44u8, 114u8, 120u8, 38u8, 32u8, 83u8, 70u8,
    13u8, 219u8, 132u8, 179u8, 131u8, 238u8, 3u8,
]);
