...
pub use pse_model::generated::r#reference::r#dimensions::{ReferenceDimensionsRow, Row};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    89u8, 19u8, 122u8, 73u8, 253u8, 103u8, 97u8, 160u8, 112u8, 122u8, 218u8, 6u8, 220u8,
    135u8, 162u8, 145u8, 105u8, 166u8, 246u8, 71u8, 143u8, 97u8, 133u8, 247u8, 209u8,
    241u8, 36u8, 235u8, 235u8, 187u8, 229u8, 161u8,
]);
...
impl crate::columnar::RelationRow for ReferenceDimensionsRow {
    ...
    fn append_columns(
        ...
        crate::columnar::ArrowValue::append(&self.r#ordinal, columns[0usize].as_mut())?;
    ...
    fn rows_at(
        ...
        let view = ReferenceDimensionsView::from_checked(batch)?;
...
pub mod columns {
    ///ordinal
    pub const ORDINAL: crate::columnar::ColumnReference = super::COLUMNS[0usize];
    ///name
...
pub type ReferenceDimensionsBuilder = crate::columnar::RowBuilder<
    ReferenceDimensionsRow,
>;
impl crate::columnar::RelationView for ReferenceDimensionsView<'_> {
    type Row = ReferenceDimensionsRow;
