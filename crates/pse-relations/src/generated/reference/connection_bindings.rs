...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    203u8, 19u8, 218u8, 53u8, 196u8, 199u8, 177u8, 49u8, 166u8, 140u8, 206u8, 28u8, 21u8,
    192u8, 120u8, 251u8, 37u8, 252u8, 166u8, 86u8, 95u8, 200u8, 117u8, 119u8, 136u8,
    171u8, 12u8, 193u8, 159u8, 119u8, 137u8, 233u8,
]);
...
impl crate::columnar::RelationRow for ReferenceConnectionBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        32_136_usize + size_of::<Self::Builder>()
    }
