...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    23u8, 246u8, 130u8, 192u8, 165u8, 185u8, 0u8, 102u8, 237u8, 134u8, 198u8, 140u8,
    41u8, 233u8, 144u8, 157u8, 242u8, 114u8, 201u8, 243u8, 122u8, 172u8, 213u8, 250u8,
    44u8, 248u8, 163u8, 45u8, 5u8, 4u8, 11u8, 45u8,
]);
...
impl crate::columnar::RelationRow for ReferenceConnectionBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        33_896_usize + size_of::<Self::Builder>()
    }
