...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    63u8, 222u8, 32u8, 71u8, 164u8, 155u8, 26u8, 143u8, 168u8, 27u8, 96u8, 90u8, 241u8,
    136u8, 229u8, 231u8, 201u8, 17u8, 117u8, 58u8, 213u8, 161u8, 242u8, 133u8, 179u8,
    1u8, 88u8, 86u8, 21u8, 195u8, 148u8, 157u8,
]);
...
impl crate::typed::CellCodec for ReferenceMethodKernelInputsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#input_name),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ReferenceMethodKernelInputsRow)),
            );
        };
        ...
        Ok(Self {
            ...
            r#input_name: <String as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ReferenceMethodKernelInputsRow),
...
impl ReferenceMethodKernelInputsRow {
...
impl crate::columnar::RelationRow for ReferenceMethodKernelInputsRow {
    ...
    fn builder_allocation_size() -> usize {
        30_304_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ReferenceMethodKernelInputsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ReferenceMethodKernelInputsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &ReferenceMethodKernelInputsView<'_>,
    ) -> Result<(), crate::RelationError> {
