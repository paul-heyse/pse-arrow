...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    32u8, 219u8, 191u8, 138u8, 231u8, 100u8, 203u8, 240u8, 180u8, 234u8, 161u8, 59u8,
    100u8, 74u8, 213u8, 205u8, 113u8, 18u8, 29u8, 67u8, 14u8, 230u8, 215u8, 73u8, 193u8,
    234u8, 139u8, 227u8, 146u8, 164u8, 75u8, 205u8,
]);
...
impl crate::columnar::RelationRow for ReferenceMethodProvisionsRow {
    ...
    fn builder_allocation_size() -> usize {
        120_024_usize + size_of::<Self::Builder>()
    }
