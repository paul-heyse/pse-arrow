...
pub use pse_model::generated::r#reference::r#schema_invariants::{
    ReferenceSchemaInvariantsRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    121u8, 143u8, 24u8, 162u8, 180u8, 176u8, 175u8, 123u8, 212u8, 169u8, 202u8, 11u8,
    81u8, 17u8, 93u8, 226u8, 168u8, 80u8, 15u8, 67u8, 110u8, 47u8, 197u8, 72u8, 154u8,
    238u8, 143u8, 181u8, 163u8, 165u8, 122u8, 54u8,
]);
...
impl crate::columnar::RelationRow for ReferenceSchemaInvariantsRow {
    ...
    fn append_columns(
        ...
        crate::columnar::ArrowValue::append(&self.r#query, columns[3usize].as_mut())?;
        crate::columnar::ArrowValue::append(&self.r#inputs, columns[4usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#key_columns,
            columns[5usize].as_mut(),
        )?;
        crate::columnar::ArrowValue::append(&self.r#severity, columns[6usize].as_mut())?;
    ...
    fn rows_at(
        ...
        let view = ReferenceSchemaInvariantsView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///query
    pub const QUERY: crate::columnar::ColumnReference = super::COLUMNS[3usize];
    ///inputs
    pub const INPUTS: crate::columnar::ColumnReference = super::COLUMNS[4usize];
    ///key_columns
    pub const KEY_COLUMNS: crate::columnar::ColumnReference = super::COLUMNS[5usize];
    ///severity
    pub const SEVERITY: crate::columnar::ColumnReference = super::COLUMNS[6usize];
    ///doc
...
pub type ReferenceSchemaInvariantsBuilder = crate::columnar::RowBuilder<
    ReferenceSchemaInvariantsRow,
>;
impl crate::columnar::RelationView for ReferenceSchemaInvariantsView<'_> {
    type Row = ReferenceSchemaInvariantsRow;
