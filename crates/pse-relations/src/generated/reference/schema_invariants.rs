...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    106u8, 225u8, 166u8, 6u8, 145u8, 174u8, 229u8, 109u8, 51u8, 216u8, 14u8, 20u8, 122u8,
    204u8, 100u8, 152u8, 128u8, 242u8, 134u8, 26u8, 234u8, 142u8, 147u8, 60u8, 245u8,
    145u8, 22u8, 225u8, 229u8, 211u8, 146u8, 42u8,
]);
...
impl crate::columnar::RelationRow for ReferenceSchemaInvariantsRow {
    ...
    fn builder_allocation_size() -> usize {
        75_632_usize + size_of::<Self::Builder>()
    }
