...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    249u8, 237u8, 150u8, 126u8, 56u8, 46u8, 95u8, 99u8, 228u8, 194u8, 10u8, 79u8, 248u8,
    237u8, 15u8, 123u8, 114u8, 187u8, 245u8, 228u8, 32u8, 16u8, 211u8, 49u8, 16u8, 234u8,
    234u8, 119u8, 126u8, 227u8, 120u8, 122u8,
]);
...
impl crate::columnar::RelationRow for ReferenceSchemaDocumentsRow {
    ...
    fn builder_allocation_size() -> usize {
        28_352_usize + size_of::<Self::Builder>()
    }
