...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    218u8, 217u8, 222u8, 135u8, 178u8, 43u8, 189u8, 81u8, 101u8, 13u8, 98u8, 234u8,
    118u8, 148u8, 67u8, 32u8, 182u8, 241u8, 10u8, 95u8, 104u8, 16u8, 57u8, 227u8, 54u8,
    36u8, 41u8, 38u8, 216u8, 162u8, 71u8, 84u8,
]);
...
impl crate::columnar::RelationRow for ReferenceSchemaMigrationsRow {
    ...
    fn builder_allocation_size() -> usize {
        47_232_usize + size_of::<Self::Builder>()
    }
