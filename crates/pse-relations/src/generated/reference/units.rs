...
pub use pse_model::generated::r#reference::r#units::{ReferenceUnitsRow, Row};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    250u8, 185u8, 117u8, 10u8, 117u8, 20u8, 219u8, 25u8, 75u8, 2u8, 69u8, 250u8, 113u8,
    55u8, 163u8, 73u8, 88u8, 55u8, 39u8, 19u8, 31u8, 162u8, 119u8, 47u8, 65u8, 149u8,
    209u8, 38u8, 227u8, 177u8, 22u8, 50u8,
]);
...
impl crate::columnar::RelationRow for ReferenceUnitsRow {
    ...
    fn rows_at(
        ...
        let view = ReferenceUnitsView::from_checked(batch)?;
        positions.iter().map(|&position| view.row(position)).collect()
    }
    fn builder_allocation_size() -> usize {
        62_464_usize + size_of::<Self::Builder>()
    }
...
pub type ReferenceUnitsBuilder = crate::columnar::RowBuilder<ReferenceUnitsRow>;
impl crate::columnar::RelationView for ReferenceUnitsView<'_> {
    type Row = ReferenceUnitsRow;
