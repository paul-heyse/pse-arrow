...
pub use pse_model::generated::r#reference::r#method_parameters::{
    ReferenceMethodParametersRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    221u8, 76u8, 40u8, 73u8, 138u8, 109u8, 83u8, 45u8, 197u8, 222u8, 242u8, 114u8, 83u8,
    142u8, 99u8, 117u8, 195u8, 131u8, 89u8, 190u8, 40u8, 65u8, 126u8, 247u8, 230u8,
    133u8, 147u8, 42u8, 180u8, 56u8, 126u8, 29u8,
]);
...
impl crate::columnar::RelationRow for ReferenceMethodParametersRow {
    ...
    fn rows_at(
        ...
        let view = ReferenceMethodParametersView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///natural_unit_id
    pub const NATURAL_UNIT_ID: crate::columnar::ColumnReference = super::COLUMNS[3usize];
    ///indexed_by
    pub const INDEXED_BY: crate::columnar::ColumnReference = super::COLUMNS[4usize];
    ///required
...
pub type ReferenceMethodParametersBuilder = crate::columnar::RowBuilder<
    ReferenceMethodParametersRow,
>;
impl crate::columnar::RelationView for ReferenceMethodParametersView<'_> {
    type Row = ReferenceMethodParametersRow;
