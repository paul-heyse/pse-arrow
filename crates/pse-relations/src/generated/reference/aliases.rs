...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    75u8, 68u8, 220u8, 54u8, 197u8, 67u8, 112u8, 244u8, 207u8, 196u8, 70u8, 69u8, 84u8,
    202u8, 247u8, 211u8, 5u8, 237u8, 120u8, 223u8, 78u8, 65u8, 53u8, 110u8, 242u8, 246u8,
    187u8, 74u8, 108u8, 77u8, 138u8, 111u8,
]);
