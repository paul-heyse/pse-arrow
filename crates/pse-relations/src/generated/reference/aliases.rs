...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    19u8, 223u8, 197u8, 176u8, 122u8, 245u8, 45u8, 198u8, 230u8, 143u8, 163u8, 241u8,
    203u8, 204u8, 133u8, 187u8, 164u8, 131u8, 58u8, 10u8, 65u8, 236u8, 38u8, 140u8,
    217u8, 86u8, 49u8, 82u8, 143u8, 166u8, 225u8, 210u8,
]);
