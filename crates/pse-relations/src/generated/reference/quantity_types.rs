...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    217u8, 72u8, 21u8, 18u8, 112u8, 92u8, 92u8, 10u8, 83u8, 101u8, 15u8, 82u8, 143u8,
    77u8, 179u8, 77u8, 202u8, 175u8, 173u8, 38u8, 52u8, 113u8, 180u8, 117u8, 8u8, 157u8,
    95u8, 171u8, 234u8, 118u8, 221u8, 113u8,
]);
...
impl crate::columnar::RelationRow for ReferenceQuantityTypesRow {
    ...
    fn builder_allocation_size() -> usize {
        146_656_usize + size_of::<Self::Builder>()
    }
