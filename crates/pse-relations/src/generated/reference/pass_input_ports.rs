...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    133u8, 33u8, 255u8, 235u8, 52u8, 158u8, 78u8, 86u8, 133u8, 88u8, 70u8, 208u8, 225u8,
    198u8, 232u8, 200u8, 225u8, 3u8, 115u8, 180u8, 205u8, 167u8, 131u8, 15u8, 248u8,
    121u8, 156u8, 17u8, 140u8, 226u8, 1u8, 154u8,
]);
    ...
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#source_pass_id),
...
impl crate::columnar::ArrowValue for ReferencePassInputPortsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for ReferencePassInputPortsRow {
    type Builder = ReferencePassInputPortsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ReferencePassInputPortsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ReferencePassInputPortsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        54_528_usize + size_of::<Self::Builder>()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            if (self.r#source_pass_id).is_some() {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            if let Some(value) = (self.r#source_port).as_ref() {
                crate::columnar::allocation_add(
                    1,
...
pub struct ReferencePassInputPortsView<'a> {
    ...
    source_pass_id_column: &'a arrow_array::FixedSizeBinaryArray,
...
impl<'a> ReferencePassInputPortsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            source_pass_id_column: crate::columnar::array::<
                arrow_array::FixedSizeBinaryArray,
    ...
    pub const fn source_pass_id_column(&self) -> &'a arrow_array::FixedSizeBinaryArray {
        self.source_pass_id_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "source_pass_id", "`.")]
    pub fn source_pass_id_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ReferencePassInputPortsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ReferencePassInputPortsRow {
            ...
            r#source_pass_id: crate::columnar::ArrowValue::read(
                self.source_pass_id_column,
                index,
            )?,
...
impl ReferencePassInputPortsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &ReferencePassInputPortsView<'_>,
    ) -> Result<(), crate::RelationError> {
