...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    85u8, 31u8, 94u8, 122u8, 53u8, 190u8, 104u8, 98u8, 81u8, 32u8, 2u8, 139u8, 115u8,
    107u8, 93u8, 207u8, 88u8, 21u8, 223u8, 99u8, 162u8, 217u8, 147u8, 173u8, 230u8,
    184u8, 108u8, 67u8, 36u8, 186u8, 159u8, 5u8,
]);
...
impl crate::columnar::RelationRow for ReferencePassInputPortsRow {
    ...
    fn builder_allocation_size() -> usize {
        54_064_usize + size_of::<Self::Builder>()
    }
