...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    20u8, 68u8, 65u8, 210u8, 116u8, 141u8, 21u8, 251u8, 132u8, 169u8, 27u8, 64u8, 212u8,
    195u8, 157u8, 176u8, 178u8, 208u8, 133u8, 105u8, 148u8, 229u8, 14u8, 248u8, 26u8,
    147u8, 165u8, 17u8, 221u8, 101u8, 78u8, 68u8,
]);
...
impl crate::columnar::RelationRow for ReferenceMathContextRow {
    ...
    fn builder_allocation_size() -> usize {
        45_528_usize + size_of::<Self::Builder>()
    }
