...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    181u8, 80u8, 221u8, 216u8, 170u8, 234u8, 96u8, 4u8, 158u8, 159u8, 169u8, 128u8,
    253u8, 132u8, 155u8, 251u8, 136u8, 78u8, 242u8, 241u8, 60u8, 215u8, 58u8, 211u8,
    208u8, 41u8, 197u8, 239u8, 250u8, 210u8, 197u8, 45u8,
]);
...
impl crate::columnar::RelationRow for ReferenceMathContextRow {
    ...
    fn builder_allocation_size() -> usize {
        47_752_usize + size_of::<Self::Builder>()
    }
