...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    110u8, 52u8, 227u8, 100u8, 106u8, 124u8, 173u8, 205u8, 23u8, 35u8, 167u8, 6u8, 224u8,
    13u8, 229u8, 140u8, 106u8, 139u8, 86u8, 40u8, 247u8, 152u8, 153u8, 171u8, 183u8,
    110u8, 213u8, 48u8, 214u8, 146u8, 187u8, 20u8,
]);
    ...
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#mode),
...
impl crate::columnar::ArrowValue for ReferenceRuleDependenciesRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#stratum, children[4usize].as_mut())?;
        crate::columnar::ArrowValue::append(
    ...
    fn append_null(
        ...
        <crate::generated::enums::DependencyMode as crate::columnar::ArrowValue>::append_null(
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#mode: <crate::generated::enums::DependencyMode as crate::columnar::ArrowValue>::read(
...
impl crate::columnar::RelationRow for ReferenceRuleDependenciesRow {
    type Builder = ReferenceRuleDependenciesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ReferenceRuleDependenciesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ReferenceRuleDependenciesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        63_288_usize + size_of::<Self::Builder>()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            crate::columnar::allocation_add(8, (self.r#mode).as_str().len())?,
        )?;
        bytes = crate::columnar::allocation_add(
            bytes,
...
pub struct ReferenceRuleDependenciesView<'a> {
    ...
    mode_column: &'a arrow_array::StringArray,
...
impl<'a> ReferenceRuleDependenciesView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            mode_column: crate::columnar::array::<
                arrow_array::StringArray,
    ...
    pub const fn mode_column(&self) -> &'a arrow_array::StringArray {
        self.mode_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "mode", "`.")]
    pub fn mode_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ReferenceRuleDependenciesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ReferenceRuleDependenciesRow {
            ...
            r#mode: crate::columnar::ArrowValue::read(self.mode_column, index)?,
...
impl ReferenceRuleDependenciesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &ReferenceRuleDependenciesView<'_>,
    ) -> Result<(), crate::RelationError> {
