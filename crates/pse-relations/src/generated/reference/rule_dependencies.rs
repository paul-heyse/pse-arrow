...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    74u8, 38u8, 113u8, 49u8, 203u8, 53u8, 75u8, 108u8, 0u8, 19u8, 120u8, 133u8, 141u8,
    97u8, 46u8, 196u8, 206u8, 142u8, 86u8, 62u8, 235u8, 54u8, 121u8, 181u8, 121u8, 26u8,
    235u8, 60u8, 53u8, 218u8, 158u8, 88u8,
]);
...
impl crate::columnar::RelationRow for ReferenceRuleDependenciesRow {
    ...
    fn builder_allocation_size() -> usize {
        62_824_usize + size_of::<Self::Builder>()
    }
