...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    15u8, 215u8, 233u8, 25u8, 237u8, 130u8, 246u8, 155u8, 121u8, 34u8, 49u8, 37u8, 221u8,
    192u8, 39u8, 196u8, 42u8, 20u8, 123u8, 33u8, 29u8, 159u8, 191u8, 201u8, 5u8, 69u8,
    69u8, 101u8, 241u8, 242u8, 153u8, 10u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateGuardsRow {
    ...
    fn builder_allocation_size() -> usize {
        43_952_usize + size_of::<Self::Builder>()
    }
