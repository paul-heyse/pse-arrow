...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    64u8, 29u8, 120u8, 39u8, 4u8, 249u8, 98u8, 117u8, 102u8, 142u8, 105u8, 103u8, 51u8,
    247u8, 215u8, 95u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_guards";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    161u8, 112u8, 83u8, 23u8, 222u8, 137u8, 173u8, 56u8, 192u8, 103u8, 94u8, 217u8,
    131u8, 185u8, 96u8, 213u8, 212u8, 18u8, 179u8, 132u8, 78u8, 179u8, 28u8, 194u8,
    226u8, 42u8, 241u8, 53u8, 129u8, 201u8, 176u8, 214u8,
]);
...
pub struct NormalizedTemplateGuardsRow {
    ///guard_id
...
impl crate::typed::CellCodec for NormalizedTemplateGuardsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedTemplateGuardsRow)));
        };
        ...
        Ok(Self {
            r#guard_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateGuardsRow),
                    ))?,
            )?,
            ...
            r#predicate: <String as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateGuardsRow),
...
impl crate::columnar::ArrowValue for NormalizedTemplateGuardsRow {
    fn append(
        &self,
    ...
    fn read(
        ...
        Ok(Self {
            r#guard_id: <pse_ids::SemanticId as crate::columnar::ArrowValue>::read(
            ...
            r#predicate: <String as crate::columnar::ArrowValue>::read(
...
pub type Row = NormalizedTemplateGuardsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateGuardsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateGuardsBuilder;
impl NormalizedTemplateGuardsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_guards".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateGuardsRow {
    type Builder = NormalizedTemplateGuardsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateGuardsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateGuardsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        43_488_usize + size_of::<Self::Builder>()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            crate::columnar::allocation_add(8, (self.r#predicate).len())?,
        )?;
        bytes = crate::columnar::allocation_add(
            bytes,
...
#[derive(Debug)]
pub struct NormalizedTemplateGuardsView<'a> {
    ...
    predicate_column: &'a arrow_array::StringArray,
    doc_column: &'a arrow_array::StringArray,
}
impl<'a> NormalizedTemplateGuardsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            predicate_column: crate::columnar::array::<
    ...
    pub const fn predicate_column(&self) -> &'a arrow_array::StringArray {
        self.predicate_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "predicate", "`.")]
    pub fn predicate_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateGuardsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateGuardsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateGuardsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateGuardsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateGuardsView<'_>,
    ) -> Result<(), crate::RelationError> {
