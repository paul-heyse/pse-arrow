...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    250u8, 185u8, 244u8, 126u8, 48u8, 58u8, 50u8, 160u8, 243u8, 213u8, 40u8, 30u8, 107u8,
    183u8, 136u8, 136u8, 98u8, 35u8, 209u8, 220u8, 45u8, 112u8, 30u8, 201u8, 231u8, 66u8,
    54u8, 2u8, 252u8, 73u8, 113u8, 58u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedGuardExprKernelCallsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedGuardExprKernelCallsRow {
    type Builder = NormalizedGuardExprKernelCallsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprKernelCallsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprKernelCallsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        26_976_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedGuardExprKernelCallsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprKernelCallsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprKernelCallsRow {
...
impl NormalizedGuardExprKernelCallsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprKernelCallsView<'_>,
    ) -> Result<(), crate::RelationError> {
