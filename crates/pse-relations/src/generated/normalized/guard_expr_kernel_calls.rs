...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    130u8, 7u8, 230u8, 187u8, 51u8, 123u8, 59u8, 246u8, 243u8, 73u8, 226u8, 188u8, 251u8,
    135u8, 118u8, 124u8, 61u8, 216u8, 4u8, 48u8, 161u8, 55u8, 48u8, 11u8, 65u8, 123u8,
    61u8, 243u8, 185u8, 197u8, 62u8, 109u8,
]);
...
impl crate::columnar::RelationRow for NormalizedGuardExprKernelCallsRow {
    ...
    fn builder_allocation_size() -> usize {
        27_440_usize + size_of::<Self::Builder>()
    }
