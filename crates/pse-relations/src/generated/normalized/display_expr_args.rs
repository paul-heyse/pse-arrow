...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    200u8, 20u8, 153u8, 142u8, 136u8, 99u8, 143u8, 68u8, 230u8, 60u8, 31u8, 120u8, 109u8,
    121u8, 107u8, 160u8, 197u8, 4u8, 225u8, 81u8, 69u8, 202u8, 225u8, 103u8, 3u8, 18u8,
    238u8, 219u8, 79u8, 63u8, 121u8, 210u8,
]);
...
impl<'a> NormalizedDisplayExprArgsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedDisplayExprArgsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedDisplayExprArgsBuilder {
    rows: Vec<NormalizedDisplayExprArgsRow>,
}
impl NormalizedDisplayExprArgsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedDisplayExprArgsRow::into_cells)
            .collect::<Vec<_>>();
