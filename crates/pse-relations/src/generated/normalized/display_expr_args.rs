...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    226u8, 138u8, 185u8, 43u8, 212u8, 112u8, 166u8, 201u8, 252u8, 214u8, 211u8, 73u8,
    197u8, 216u8, 45u8, 175u8, 7u8, 34u8, 211u8, 92u8, 115u8, 8u8, 14u8, 178u8, 235u8,
    243u8, 134u8, 114u8, 69u8, 119u8, 36u8, 92u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprArgsRow {
    ...
    fn builder_allocation_size() -> usize {
        22_368_usize + size_of::<Self::Builder>()
    }
