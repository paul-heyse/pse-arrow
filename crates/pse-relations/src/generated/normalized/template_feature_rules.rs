...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    210u8, 188u8, 177u8, 181u8, 115u8, 128u8, 161u8, 241u8, 39u8, 70u8, 23u8, 81u8,
    212u8, 220u8, 14u8, 136u8, 167u8, 20u8, 137u8, 55u8, 119u8, 12u8, 127u8, 220u8, 68u8,
    20u8, 199u8, 116u8, 12u8, 252u8, 42u8, 105u8,
]);
