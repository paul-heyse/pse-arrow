...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    243u8, 238u8, 186u8, 72u8, 32u8, 89u8, 103u8, 234u8, 140u8, 163u8, 174u8, 234u8,
    178u8, 3u8, 88u8, 208u8, 59u8, 87u8, 136u8, 23u8, 80u8, 217u8, 32u8, 181u8, 193u8,
    32u8, 206u8, 53u8, 140u8, 164u8, 218u8, 141u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateFeatureRulesRow {
    ...
    fn builder_allocation_size() -> usize {
        43_752_usize + size_of::<Self::Builder>()
    }
