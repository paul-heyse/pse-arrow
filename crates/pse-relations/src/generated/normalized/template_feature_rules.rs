...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    19u8, 115u8, 175u8, 97u8, 254u8, 68u8, 0u8, 127u8, 125u8, 162u8, 130u8, 225u8, 241u8,
    137u8, 13u8, 214u8, 145u8, 55u8, 21u8, 31u8, 83u8, 16u8, 224u8, 78u8, 136u8, 85u8,
    79u8, 231u8, 236u8, 111u8, 231u8, 28u8,
]);
...
impl<'a> NormalizedTemplateFeatureRulesView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedTemplateFeatureRulesRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedTemplateFeatureRulesBuilder {
    rows: Vec<NormalizedTemplateFeatureRulesRow>,
}
impl NormalizedTemplateFeatureRulesBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedTemplateFeatureRulesRow::into_cells)
            .collect::<Vec<_>>();
