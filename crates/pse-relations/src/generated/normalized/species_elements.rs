...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    102u8, 69u8, 33u8, 196u8, 162u8, 84u8, 214u8, 14u8, 112u8, 101u8, 189u8, 205u8, 74u8,
    198u8, 165u8, 174u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    41u8, 99u8, 4u8, 141u8, 155u8, 151u8, 215u8, 210u8, 229u8, 56u8, 37u8, 241u8, 125u8,
    78u8, 45u8, 179u8, 156u8, 209u8, 161u8, 125u8, 0u8, 247u8, 222u8, 60u8, 119u8, 27u8,
    238u8, 223u8, 252u8, 200u8, 77u8, 76u8,
]);
...
pub struct NormalizedSpeciesElementsRow {
    ///species_id
...
impl crate::typed::CellCodec for NormalizedSpeciesElementsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedSpeciesElementsRow)));
        };
            ...
            r#species_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedSpeciesElementsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedSpeciesElementsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#count, children[2usize].as_mut())?;
        output.append(true);
        Ok(())
    }
    fn append_null(
...
pub type Row = NormalizedSpeciesElementsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedSpeciesElementsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedSpeciesElementsBuilder;
impl NormalizedSpeciesElementsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.species_elements".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedSpeciesElementsRow {
    type Builder = NormalizedSpeciesElementsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedSpeciesElementsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedSpeciesElementsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        36_888_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedSpeciesElementsView<'a> {
...
impl<'a> NormalizedSpeciesElementsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedSpeciesElementsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedSpeciesElementsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedSpeciesElementsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedSpeciesElementsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedSpeciesElementsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedSpeciesElementsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedSpeciesElementsView<'_>,
    ) -> Result<(), crate::RelationError> {
