...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    74u8, 75u8, 55u8, 7u8, 143u8, 201u8, 162u8, 183u8, 191u8, 75u8, 80u8, 56u8, 158u8,
    81u8, 214u8, 134u8, 254u8, 38u8, 149u8, 192u8, 72u8, 140u8, 64u8, 228u8, 3u8, 242u8,
    28u8, 32u8, 141u8, 204u8, 38u8, 128u8,
]);
...
impl<'a> NormalizedSpeciesElementsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedSpeciesElementsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedSpeciesElementsBuilder {
    rows: Vec<NormalizedSpeciesElementsRow>,
}
impl NormalizedSpeciesElementsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedSpeciesElementsRow::into_cells)
            .collect::<Vec<_>>();
