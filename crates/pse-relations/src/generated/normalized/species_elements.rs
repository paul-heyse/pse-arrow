...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    84u8, 97u8, 87u8, 123u8, 67u8, 165u8, 2u8, 155u8, 159u8, 189u8, 223u8, 39u8, 15u8,
    143u8, 88u8, 221u8, 255u8, 64u8, 168u8, 149u8, 185u8, 249u8, 223u8, 34u8, 153u8,
    80u8, 234u8, 85u8, 53u8, 164u8, 71u8, 241u8,
]);
...
impl crate::columnar::RelationRow for NormalizedSpeciesElementsRow {
    ...
    fn builder_allocation_size() -> usize {
        37_352_usize + size_of::<Self::Builder>()
    }
