...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    36u8, 111u8, 89u8, 15u8, 147u8, 39u8, 136u8, 32u8, 180u8, 195u8, 46u8, 30u8, 62u8,
    17u8, 117u8, 58u8, 125u8, 146u8, 124u8, 101u8, 122u8, 73u8, 193u8, 45u8, 20u8, 141u8,
    142u8, 128u8, 158u8, 56u8, 207u8, 232u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedReactionsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedReactionsRow {
    type Builder = NormalizedReactionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedReactionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedReactionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        98_088_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedReactionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedReactionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedReactionsRow {
...
impl NormalizedReactionsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedReactionsView<'_>,
    ) -> Result<(), crate::RelationError> {
