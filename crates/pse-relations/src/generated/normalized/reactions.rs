...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    219u8, 121u8, 20u8, 35u8, 9u8, 35u8, 249u8, 135u8, 60u8, 131u8, 1u8, 13u8, 10u8,
    68u8, 163u8, 80u8, 98u8, 64u8, 154u8, 117u8, 59u8, 81u8, 214u8, 226u8, 16u8, 164u8,
    59u8, 65u8, 112u8, 64u8, 67u8, 38u8,
]);
...
impl crate::columnar::RelationRow for NormalizedReactionsRow {
    ...
    fn builder_allocation_size() -> usize {
        99_848_usize + size_of::<Self::Builder>()
    }
