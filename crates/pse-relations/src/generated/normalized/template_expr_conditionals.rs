...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    116u8, 172u8, 1u8, 112u8, 178u8, 84u8, 128u8, 59u8, 80u8, 241u8, 40u8, 161u8, 93u8,
    184u8, 164u8, 26u8, 63u8, 40u8, 206u8, 2u8, 93u8, 65u8, 127u8, 237u8, 222u8, 165u8,
    117u8, 198u8, 39u8, 152u8, 186u8, 105u8,
]);
