...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    85u8, 214u8, 252u8, 211u8, 188u8, 131u8, 80u8, 96u8, 17u8, 36u8, 72u8, 154u8, 144u8,
    171u8, 230u8, 194u8, 98u8, 236u8, 160u8, 6u8, 12u8, 229u8, 140u8, 57u8, 42u8, 141u8,
    162u8, 106u8, 36u8, 10u8, 154u8, 254u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprConditionalsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedTemplateExprConditionalsRow {
    type Builder = NormalizedTemplateExprConditionalsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprConditionalsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprConditionalsView::from_checked(batch)?.rows()
    }
...
impl<'a> NormalizedTemplateExprConditionalsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprConditionalsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprConditionalsRow {
...
impl NormalizedTemplateExprConditionalsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprConditionalsView<'_>,
    ) -> Result<(), crate::RelationError> {
