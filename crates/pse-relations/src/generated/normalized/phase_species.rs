...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    197u8, 175u8, 149u8, 81u8, 219u8, 71u8, 131u8, 190u8, 193u8, 203u8, 138u8, 241u8,
    45u8, 201u8, 42u8, 190u8, 219u8, 100u8, 78u8, 43u8, 8u8, 202u8, 62u8, 21u8, 61u8,
    231u8, 69u8, 89u8, 178u8, 95u8, 232u8, 123u8,
]);
...
impl<'a> NormalizedPhaseSpeciesView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<NormalizedPhaseSpeciesRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedPhaseSpeciesRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedPhaseSpeciesBuilder {
    rows: Vec<NormalizedPhaseSpeciesRow>,
}
impl NormalizedPhaseSpeciesBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedPhaseSpeciesRow::into_cells)
            .collect::<Vec<_>>();
