...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    8u8, 158u8, 86u8, 213u8, 10u8, 202u8, 165u8, 178u8, 248u8, 119u8, 231u8, 251u8,
    210u8, 110u8, 34u8, 49u8, 126u8, 140u8, 247u8, 213u8, 6u8, 219u8, 176u8, 143u8, 12u8,
    164u8, 42u8, 192u8, 93u8, 215u8, 228u8, 93u8,
]);
...
impl crate::columnar::RelationRow for NormalizedPhaseSpeciesRow {
    ...
    fn builder_allocation_size() -> usize {
        31_368_usize + size_of::<Self::Builder>()
    }
