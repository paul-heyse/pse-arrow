...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    91u8, 6u8, 194u8, 254u8, 226u8, 163u8, 41u8, 98u8, 89u8, 176u8, 224u8, 37u8, 156u8,
    132u8, 231u8, 168u8, 254u8, 149u8, 28u8, 207u8, 111u8, 54u8, 219u8, 243u8, 225u8,
    36u8, 70u8, 102u8, 14u8, 214u8, 38u8, 190u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprReductionsRow {
    ...
    fn builder_allocation_size() -> usize {
        88_768_usize + size_of::<Self::Builder>()
    }
