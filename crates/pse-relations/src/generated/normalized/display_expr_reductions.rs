...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    5u8, 45u8, 67u8, 50u8, 178u8, 194u8, 21u8, 221u8, 216u8, 233u8, 231u8, 19u8, 246u8,
    128u8, 221u8, 18u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "display_expr_reductions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    57u8, 211u8, 203u8, 201u8, 213u8, 172u8, 244u8, 57u8, 123u8, 229u8, 184u8, 233u8,
    61u8, 80u8, 164u8, 9u8, 249u8, 182u8, 243u8, 131u8, 119u8, 235u8, 43u8, 205u8, 3u8,
    248u8, 126u8, 220u8, 153u8, 227u8, 11u8, 76u8,
]);
...
pub struct NormalizedDisplayExprReductionsRow {
    ///node_id
    pub r#node_id: u64,
    ///kind
...
impl crate::typed::CellCodec for NormalizedDisplayExprReductionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedDisplayExprReductionsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedDisplayExprReductionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprReductionsRow {
    fn append(
        &self,
...
pub type Row = NormalizedDisplayExprReductionsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedDisplayExprReductionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedDisplayExprReductionsBuilder;
impl NormalizedDisplayExprReductionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.display_expr_reductions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedDisplayExprReductionsRow {
    type Builder = NormalizedDisplayExprReductionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprReductionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprReductionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        89_232_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedDisplayExprReductionsView<'a> {
...
impl<'a> NormalizedDisplayExprReductionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprReductionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprReductionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedDisplayExprReductionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedDisplayExprReductionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDisplayExprReductionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedDisplayExprReductionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprReductionsView<'_>,
    ) -> Result<(), crate::RelationError> {
