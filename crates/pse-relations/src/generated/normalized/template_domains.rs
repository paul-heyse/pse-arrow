...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    223u8, 156u8, 43u8, 161u8, 9u8, 55u8, 45u8, 15u8, 188u8, 174u8, 220u8, 119u8, 225u8,
    166u8, 159u8, 103u8, 63u8, 132u8, 8u8, 131u8, 50u8, 41u8, 68u8, 222u8, 46u8, 34u8,
    110u8, 191u8, 113u8, 214u8, 83u8, 210u8,
]);
...
impl<'a> NormalizedTemplateDomainsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedTemplateDomainsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedTemplateDomainsBuilder {
    rows: Vec<NormalizedTemplateDomainsRow>,
}
impl NormalizedTemplateDomainsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedTemplateDomainsRow::into_cells)
            .collect::<Vec<_>>();
