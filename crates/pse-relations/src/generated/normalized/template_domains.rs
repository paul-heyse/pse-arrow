...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    218u8, 20u8, 199u8, 208u8, 108u8, 39u8, 85u8, 12u8, 185u8, 51u8, 172u8, 238u8, 194u8,
    119u8, 77u8, 100u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    142u8, 154u8, 165u8, 171u8, 164u8, 236u8, 48u8, 19u8, 107u8, 57u8, 123u8, 44u8, 80u8,
    47u8, 106u8, 145u8, 42u8, 117u8, 4u8, 179u8, 89u8, 47u8, 215u8, 1u8, 227u8, 86u8,
    4u8, 96u8, 78u8, 147u8, 242u8, 169u8,
]);
...
pub struct NormalizedTemplateDomainsFieldBounds {
    ///lower
    pub r#lower: f64,
    ///upper
    pub r#upper: f64,
}
impl crate::typed::CellCodec for NormalizedTemplateDomainsFieldBounds {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateDomainsFieldBounds)),
            );
        };
            ...
            r#lower: <f64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateDomainsFieldBounds),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedTemplateDomainsFieldBounds {
    fn append(
        &self,
...
pub struct NormalizedTemplateDomainsRow {
    ///template_id
    ...
    ///bounds
    pub r#bounds: Option<NormalizedTemplateDomainsFieldBounds>,
    ///unit_id
    pub r#unit_id: Option<pse_ids::SemanticId>,
}
impl crate::typed::CellCodec for NormalizedTemplateDomainsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedTemplateDomainsRow)));
        };
        ...
        Ok(Self {
            r#template_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateDomainsRow),
                    ))?,
            )?,
            ...
            r#bounds: <Option<
                NormalizedTemplateDomainsFieldBounds,
            > as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
...
impl crate::columnar::ArrowValue for NormalizedTemplateDomainsRow {
    fn append(
        &self,
        output: &mut dyn arrow_array::builder::ArrayBuilder,
    ) -> Result<(), crate::RelationError> {
...
pub type Row = NormalizedTemplateDomainsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateDomainsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateDomainsBuilder;
impl NormalizedTemplateDomainsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_domains".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateDomainsRow {
    type Builder = NormalizedTemplateDomainsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateDomainsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateDomainsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        87_968_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateDomainsView<'a> {
...
impl<'a> NormalizedTemplateDomainsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateDomainsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateDomainsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateDomainsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateDomainsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateDomainsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateDomainsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateDomainsView<'_>,
    ) -> Result<(), crate::RelationError> {
