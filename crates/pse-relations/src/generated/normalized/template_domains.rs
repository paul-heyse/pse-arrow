...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    8u8, 5u8, 136u8, 164u8, 53u8, 173u8, 118u8, 124u8, 80u8, 208u8, 22u8, 168u8, 224u8,
    153u8, 92u8, 157u8, 16u8, 118u8, 14u8, 211u8, 224u8, 4u8, 20u8, 119u8, 8u8, 181u8,
    186u8, 14u8, 227u8, 30u8, 114u8, 30u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        89_728_usize + size_of::<Self::Builder>()
    }
