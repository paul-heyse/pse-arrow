...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    26u8, 40u8, 80u8, 209u8, 94u8, 90u8, 183u8, 239u8, 35u8, 249u8, 204u8, 168u8, 42u8,
    185u8, 85u8, 17u8, 99u8, 187u8, 28u8, 121u8, 181u8, 97u8, 84u8, 87u8, 24u8, 132u8,
    211u8, 14u8, 236u8, 91u8, 178u8, 50u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateDomainBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        59_152_usize + size_of::<Self::Builder>()
    }
