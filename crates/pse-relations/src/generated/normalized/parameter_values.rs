...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    33u8, 200u8, 235u8, 2u8, 134u8, 86u8, 38u8, 55u8, 179u8, 220u8, 194u8, 37u8, 105u8,
    7u8, 200u8, 210u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    108u8, 206u8, 240u8, 39u8, 242u8, 208u8, 156u8, 151u8, 49u8, 137u8, 126u8, 109u8,
    75u8, 161u8, 218u8, 195u8, 19u8, 244u8, 254u8, 32u8, 204u8, 24u8, 126u8, 230u8,
    111u8, 142u8, 253u8, 248u8, 38u8, 30u8, 42u8, 2u8,
]);
...
pub struct NormalizedParameterValuesRow {
    ///owner_entity_id
...
impl crate::typed::CellCodec for NormalizedParameterValuesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedParameterValuesRow)));
        };
            ...
            r#owner_entity_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedParameterValuesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedParameterValuesRow {
    fn append(
        &self,
...
pub type Row = NormalizedParameterValuesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedParameterValuesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedParameterValuesBuilder;
impl NormalizedParameterValuesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.parameter_values".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedParameterValuesRow {
    type Builder = NormalizedParameterValuesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedParameterValuesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedParameterValuesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        73_424_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedParameterValuesView<'a> {
...
impl<'a> NormalizedParameterValuesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedParameterValuesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedParameterValuesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedParameterValuesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedParameterValuesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedParameterValuesBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedParameterValuesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedParameterValuesView<'_>,
    ) -> Result<(), crate::RelationError> {
