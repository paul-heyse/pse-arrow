...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    161u8, 87u8, 12u8, 234u8, 19u8, 88u8, 105u8, 65u8, 223u8, 211u8, 136u8, 143u8, 68u8,
    241u8, 19u8, 152u8, 74u8, 14u8, 37u8, 110u8, 172u8, 245u8, 227u8, 230u8, 22u8, 59u8,
    86u8, 27u8, 74u8, 71u8, 159u8, 212u8,
]);
...
impl crate::columnar::RelationRow for NormalizedParameterValuesRow {
    ...
    fn builder_allocation_size() -> usize {
        75_648_usize + size_of::<Self::Builder>()
    }
