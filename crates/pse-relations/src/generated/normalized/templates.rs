...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    162u8, 182u8, 188u8, 124u8, 86u8, 61u8, 154u8, 34u8, 11u8, 197u8, 9u8, 220u8, 52u8,
    145u8, 136u8, 186u8, 74u8, 9u8, 19u8, 99u8, 129u8, 224u8, 39u8, 10u8, 127u8, 227u8,
    61u8, 180u8, 61u8, 133u8, 74u8, 56u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplatesRow {
    ...
    fn builder_allocation_size() -> usize {
        95_320_usize + size_of::<Self::Builder>()
    }
