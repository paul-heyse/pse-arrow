...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    236u8, 42u8, 79u8, 92u8, 246u8, 6u8, 120u8, 242u8, 210u8, 82u8, 167u8, 227u8, 127u8,
    157u8, 72u8, 28u8, 202u8, 246u8, 114u8, 36u8, 188u8, 188u8, 23u8, 57u8, 7u8, 180u8,
    6u8, 97u8, 171u8, 77u8, 145u8, 188u8,
]);
...
impl crate::columnar::RelationRow for NormalizedGuardExprBroadcastsRow {
    ...
    fn builder_allocation_size() -> usize {
        51_824_usize + size_of::<Self::Builder>()
    }
