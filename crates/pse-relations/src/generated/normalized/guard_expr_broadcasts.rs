...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    191u8, 243u8, 192u8, 248u8, 183u8, 251u8, 149u8, 173u8, 79u8, 3u8, 163u8, 65u8, 8u8,
    6u8, 126u8, 47u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "guard_expr_broadcasts";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    42u8, 113u8, 128u8, 59u8, 116u8, 71u8, 212u8, 201u8, 19u8, 162u8, 243u8, 170u8,
    134u8, 55u8, 74u8, 148u8, 152u8, 109u8, 66u8, 3u8, 6u8, 244u8, 209u8, 204u8, 117u8,
    38u8, 18u8, 76u8, 116u8, 176u8, 103u8, 224u8,
]);
...
pub struct NormalizedGuardExprBroadcastsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for NormalizedGuardExprBroadcastsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedGuardExprBroadcastsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedGuardExprBroadcastsRow),
                    ))?,
            )?,
            r#domain_id: <Option<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedGuardExprBroadcastsRow {
    fn append(
        &self,
...
pub type Row = NormalizedGuardExprBroadcastsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedGuardExprBroadcastsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedGuardExprBroadcastsBuilder;
impl NormalizedGuardExprBroadcastsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.guard_expr_broadcasts".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedGuardExprBroadcastsRow {
    type Builder = NormalizedGuardExprBroadcastsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprBroadcastsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprBroadcastsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        51_360_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedGuardExprBroadcastsView<'a> {
...
impl<'a> NormalizedGuardExprBroadcastsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprBroadcastsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprBroadcastsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedGuardExprBroadcastsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedGuardExprBroadcastsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedGuardExprBroadcastsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedGuardExprBroadcastsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprBroadcastsView<'_>,
    ) -> Result<(), crate::RelationError> {
