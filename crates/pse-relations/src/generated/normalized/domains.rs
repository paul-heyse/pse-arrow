...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    0u8, 74u8, 188u8, 138u8, 34u8, 12u8, 117u8, 197u8, 77u8, 238u8, 58u8, 100u8, 194u8,
    87u8, 209u8, 8u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    117u8, 149u8, 255u8, 127u8, 158u8, 43u8, 33u8, 70u8, 28u8, 120u8, 117u8, 152u8,
    123u8, 119u8, 248u8, 235u8, 222u8, 156u8, 231u8, 103u8, 232u8, 196u8, 207u8, 76u8,
    154u8, 83u8, 238u8, 209u8, 21u8, 89u8, 39u8, 73u8,
]);
...
pub struct NormalizedDomainsRow {
    ///domain_id
...
impl crate::typed::CellCodec for NormalizedDomainsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#parent_domain_id),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedDomainsRow)));
        };
            ...
            r#domain_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedDomainsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedDomainsRow {
    fn append(
        &self,
...
pub type Row = NormalizedDomainsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedDomainsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedDomainsBuilder;
impl NormalizedDomainsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.domains".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedDomainsRow {
    type Builder = NormalizedDomainsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDomainsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDomainsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedDomainsView<'a> {
...
impl<'a> NormalizedDomainsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDomainsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDomainsRow {
    ...
    pub fn rows(&self) -> Result<Vec<NormalizedDomainsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedDomainsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDomainsBuilder {
