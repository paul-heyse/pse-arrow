...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    131u8, 165u8, 77u8, 103u8, 224u8, 156u8, 37u8, 169u8, 249u8, 155u8, 80u8, 100u8,
    26u8, 53u8, 216u8, 33u8, 93u8, 242u8, 30u8, 29u8, 69u8, 72u8, 97u8, 39u8, 54u8, 53u8,
    165u8, 67u8, 144u8, 252u8, 251u8, 180u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        87_016_usize + size_of::<Self::Builder>()
    }
