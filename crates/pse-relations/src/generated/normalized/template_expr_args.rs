...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    121u8, 56u8, 190u8, 30u8, 128u8, 189u8, 37u8, 52u8, 37u8, 202u8, 93u8, 91u8, 145u8,
    166u8, 98u8, 168u8, 134u8, 15u8, 231u8, 0u8, 161u8, 173u8, 31u8, 232u8, 42u8, 78u8,
    134u8, 240u8, 60u8, 3u8, 113u8, 128u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateExprArgsRow {
    ...
    fn builder_allocation_size() -> usize {
        22_840_usize + size_of::<Self::Builder>()
    }
