...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    95u8, 33u8, 23u8, 11u8, 148u8, 64u8, 200u8, 243u8, 226u8, 175u8, 146u8, 202u8, 128u8,
    43u8, 10u8, 103u8, 151u8, 145u8, 225u8, 189u8, 213u8, 82u8, 8u8, 231u8, 235u8, 206u8,
    67u8, 64u8, 125u8, 178u8, 128u8, 154u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprArgsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedTemplateExprArgsRow {
    type Builder = NormalizedTemplateExprArgsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprArgsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprArgsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        22_376_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedTemplateExprArgsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprArgsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprArgsRow {
...
impl NormalizedTemplateExprArgsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprArgsView<'_>,
    ) -> Result<(), crate::RelationError> {
