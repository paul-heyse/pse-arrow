...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    26u8, 92u8, 154u8, 141u8, 54u8, 15u8, 5u8, 204u8, 180u8, 97u8, 199u8, 77u8, 159u8,
    155u8, 78u8, 7u8, 51u8, 97u8, 158u8, 67u8, 61u8, 243u8, 213u8, 98u8, 89u8, 37u8,
    244u8, 135u8, 173u8, 142u8, 246u8, 143u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateDisplayRow {
    ...
    fn builder_allocation_size() -> usize {
        64_840_usize + size_of::<Self::Builder>()
    }
