...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    70u8, 135u8, 76u8, 173u8, 235u8, 59u8, 79u8, 105u8, 27u8, 193u8, 143u8, 28u8, 241u8,
    224u8, 204u8, 4u8, 250u8, 206u8, 70u8, 104u8, 193u8, 222u8, 47u8, 23u8, 29u8, 242u8,
    19u8, 135u8, 197u8, 178u8, 154u8, 11u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedTemplateDisplayRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedTemplateDisplayRow {
    type Builder = NormalizedTemplateDisplayBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateDisplayBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateDisplayView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        67_064_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedTemplateDisplayView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateDisplayRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateDisplayRow {
...
impl NormalizedTemplateDisplayBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateDisplayView<'_>,
    ) -> Result<(), crate::RelationError> {
