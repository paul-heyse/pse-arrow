...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    220u8, 105u8, 115u8, 39u8, 178u8, 197u8, 79u8, 108u8, 76u8, 68u8, 5u8, 208u8, 161u8,
    103u8, 213u8, 131u8, 21u8, 135u8, 60u8, 20u8, 116u8, 11u8, 75u8, 80u8, 36u8, 225u8,
    80u8, 51u8, 27u8, 67u8, 115u8, 138u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateDisplayRow {
    ...
    fn builder_allocation_size() -> usize {
        65_304_usize + size_of::<Self::Builder>()
    }
