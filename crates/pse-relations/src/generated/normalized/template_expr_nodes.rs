...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    152u8, 236u8, 83u8, 136u8, 174u8, 44u8, 94u8, 140u8, 60u8, 189u8, 65u8, 115u8, 178u8,
    251u8, 191u8, 65u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_expr_nodes";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    240u8, 72u8, 202u8, 120u8, 145u8, 217u8, 250u8, 106u8, 7u8, 50u8, 218u8, 217u8,
    171u8, 253u8, 36u8, 58u8, 100u8, 203u8, 166u8, 18u8, 198u8, 68u8, 1u8, 236u8, 201u8,
    23u8, 245u8, 154u8, 175u8, 105u8, 1u8, 109u8,
]);
...
pub struct NormalizedTemplateExprNodesRow {
    ///node_id
    pub r#node_id: u64,
    ///opcode
...
impl crate::typed::CellCodec for NormalizedTemplateExprNodesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateExprNodesRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateExprNodesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprNodesRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateExprNodesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateExprNodesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateExprNodesBuilder;
impl NormalizedTemplateExprNodesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_expr_nodes".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateExprNodesRow {
    type Builder = NormalizedTemplateExprNodesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprNodesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprNodesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        126_784_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateExprNodesView<'a> {
...
impl<'a> NormalizedTemplateExprNodesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprNodesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprNodesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateExprNodesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateExprNodesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateExprNodesBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateExprNodesRow,
    ) -> Result<(), crate::RelationError> {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprNodesView<'_>,
    ) -> Result<(), crate::RelationError> {
