...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    167u8, 213u8, 29u8, 95u8, 178u8, 85u8, 186u8, 154u8, 240u8, 193u8, 40u8, 103u8, 4u8,
    52u8, 205u8, 159u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "display_expr_float_constants";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    189u8, 229u8, 147u8, 20u8, 75u8, 155u8, 162u8, 225u8, 200u8, 112u8, 111u8, 252u8,
    16u8, 229u8, 16u8, 76u8, 223u8, 55u8, 32u8, 149u8, 156u8, 165u8, 158u8, 191u8, 251u8,
    147u8, 112u8, 180u8, 90u8, 139u8, 175u8, 148u8,
]);
...
pub struct NormalizedDisplayExprFloatConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: f64,
...
impl crate::typed::CellCodec for NormalizedDisplayExprFloatConstantsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedDisplayExprFloatConstantsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprFloatConstantsRow {
    fn append(
        &self,
...
pub type Row = NormalizedDisplayExprFloatConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedDisplayExprFloatConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedDisplayExprFloatConstantsBuilder;
impl NormalizedDisplayExprFloatConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.display_expr_float_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedDisplayExprFloatConstantsRow {
    type Builder = NormalizedDisplayExprFloatConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprFloatConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprFloatConstantsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedDisplayExprFloatConstantsView<'a> {
...
impl<'a> NormalizedDisplayExprFloatConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprFloatConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprFloatConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedDisplayExprFloatConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedDisplayExprFloatConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDisplayExprFloatConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedDisplayExprFloatConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprFloatConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
