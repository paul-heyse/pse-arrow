...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    198u8, 181u8, 35u8, 126u8, 53u8, 63u8, 99u8, 189u8, 247u8, 24u8, 155u8, 178u8, 43u8,
    110u8, 1u8, 20u8, 202u8, 150u8, 155u8, 167u8, 246u8, 244u8, 58u8, 111u8, 11u8, 35u8,
    220u8, 126u8, 36u8, 151u8, 22u8, 207u8,
]);
...
impl<'a> NormalizedDisplayExprFloatConstantsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedDisplayExprFloatConstantsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedDisplayExprFloatConstantsBuilder {
    rows: Vec<NormalizedDisplayExprFloatConstantsRow>,
}
impl NormalizedDisplayExprFloatConstantsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedDisplayExprFloatConstantsRow::into_cells)
            .collect::<Vec<_>>();
