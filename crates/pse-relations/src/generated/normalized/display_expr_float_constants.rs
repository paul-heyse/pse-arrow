...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    102u8, 86u8, 212u8, 157u8, 140u8, 226u8, 73u8, 129u8, 106u8, 41u8, 181u8, 151u8,
    214u8, 232u8, 88u8, 162u8, 208u8, 14u8, 33u8, 173u8, 171u8, 100u8, 50u8, 238u8,
    148u8, 125u8, 39u8, 10u8, 107u8, 227u8, 223u8, 169u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprFloatConstantsRow {
    ...
    fn builder_allocation_size() -> usize {
        26_600_usize + size_of::<Self::Builder>()
    }
