...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    157u8, 55u8, 230u8, 63u8, 231u8, 240u8, 12u8, 190u8, 121u8, 192u8, 19u8, 14u8, 12u8,
    183u8, 245u8, 83u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "guard_expr_derivatives";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    112u8, 74u8, 231u8, 131u8, 210u8, 18u8, 79u8, 109u8, 163u8, 111u8, 67u8, 213u8,
    234u8, 214u8, 236u8, 232u8, 208u8, 238u8, 40u8, 118u8, 26u8, 58u8, 140u8, 153u8,
    201u8, 52u8, 166u8, 150u8, 45u8, 84u8, 129u8, 1u8,
]);
...
pub struct NormalizedGuardExprDerivativesRow {
    ///node_id
    pub r#node_id: u64,
    ///wrt_domain_id
...
impl crate::typed::CellCodec for NormalizedGuardExprDerivativesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedGuardExprDerivativesRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedGuardExprDerivativesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedGuardExprDerivativesRow {
    fn append(
        &self,
...
pub type Row = NormalizedGuardExprDerivativesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedGuardExprDerivativesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedGuardExprDerivativesBuilder;
impl NormalizedGuardExprDerivativesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.guard_expr_derivatives".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedGuardExprDerivativesRow {
    type Builder = NormalizedGuardExprDerivativesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprDerivativesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprDerivativesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        46_824_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedGuardExprDerivativesView<'a> {
...
impl<'a> NormalizedGuardExprDerivativesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprDerivativesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprDerivativesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedGuardExprDerivativesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedGuardExprDerivativesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedGuardExprDerivativesBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedGuardExprDerivativesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprDerivativesView<'_>,
    ) -> Result<(), crate::RelationError> {
