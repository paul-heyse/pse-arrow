...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    45u8, 40u8, 66u8, 63u8, 73u8, 251u8, 69u8, 241u8, 113u8, 249u8, 242u8, 4u8, 166u8,
    116u8, 118u8, 208u8, 13u8, 70u8, 39u8, 79u8, 175u8, 143u8, 138u8, 17u8, 144u8, 25u8,
    6u8, 20u8, 172u8, 150u8, 218u8, 185u8,
]);
...
impl crate::columnar::RelationRow for NormalizedGuardExprDerivativesRow {
    ...
    fn builder_allocation_size() -> usize {
        46_360_usize + size_of::<Self::Builder>()
    }
