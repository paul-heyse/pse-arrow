...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    149u8, 40u8, 245u8, 74u8, 30u8, 50u8, 240u8, 242u8, 124u8, 216u8, 220u8, 53u8, 216u8,
    199u8, 3u8, 187u8, 191u8, 251u8, 241u8, 198u8, 243u8, 126u8, 151u8, 137u8, 217u8,
    148u8, 36u8, 252u8, 227u8, 146u8, 168u8, 128u8,
]);
...
impl<'a> NormalizedGuardExprDerivativesView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedGuardExprDerivativesRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedGuardExprDerivativesBuilder {
    rows: Vec<NormalizedGuardExprDerivativesRow>,
}
impl NormalizedGuardExprDerivativesBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedGuardExprDerivativesRow::into_cells)
            .collect::<Vec<_>>();
