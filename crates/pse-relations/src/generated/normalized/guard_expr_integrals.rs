...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    81u8, 174u8, 15u8, 146u8, 156u8, 164u8, 172u8, 54u8, 41u8, 44u8, 102u8, 139u8, 193u8,
    201u8, 162u8, 152u8, 189u8, 68u8, 19u8, 77u8, 242u8, 36u8, 228u8, 145u8, 48u8, 197u8,
    93u8, 157u8, 52u8, 140u8, 191u8, 136u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedGuardExprIntegralsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedGuardExprIntegralsRow {
    type Builder = NormalizedGuardExprIntegralsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprIntegralsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprIntegralsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        85_912_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedGuardExprIntegralsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprIntegralsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprIntegralsRow {
...
impl NormalizedGuardExprIntegralsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprIntegralsView<'_>,
    ) -> Result<(), crate::RelationError> {
