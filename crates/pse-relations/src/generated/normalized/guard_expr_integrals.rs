...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    186u8, 163u8, 138u8, 210u8, 0u8, 99u8, 60u8, 108u8, 121u8, 133u8, 69u8, 40u8, 41u8,
    32u8, 253u8, 30u8, 239u8, 223u8, 51u8, 101u8, 10u8, 230u8, 228u8, 161u8, 128u8, 34u8,
    236u8, 10u8, 132u8, 37u8, 72u8, 52u8,
]);
...
impl crate::columnar::RelationRow for NormalizedGuardExprIntegralsRow {
    ...
    fn builder_allocation_size() -> usize {
        85_448_usize + size_of::<Self::Builder>()
    }
