...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    161u8, 241u8, 77u8, 30u8, 105u8, 30u8, 244u8, 142u8, 147u8, 47u8, 133u8, 76u8, 121u8,
    217u8, 90u8, 32u8, 204u8, 115u8, 145u8, 71u8, 206u8, 192u8, 150u8, 44u8, 201u8,
    155u8, 175u8, 50u8, 89u8, 249u8, 198u8, 118u8,
]);
...
impl<'a> NormalizedContributionExprArgsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedContributionExprArgsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedContributionExprArgsBuilder {
    rows: Vec<NormalizedContributionExprArgsRow>,
}
impl NormalizedContributionExprArgsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedContributionExprArgsRow::into_cells)
            .collect::<Vec<_>>();
