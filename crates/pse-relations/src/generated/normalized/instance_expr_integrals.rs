...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    102u8, 194u8, 170u8, 189u8, 27u8, 23u8, 201u8, 226u8, 187u8, 169u8, 227u8, 58u8,
    141u8, 20u8, 152u8, 131u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_expr_integrals";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    243u8, 47u8, 158u8, 227u8, 123u8, 97u8, 78u8, 176u8, 213u8, 157u8, 92u8, 13u8, 238u8,
    216u8, 207u8, 164u8, 168u8, 48u8, 80u8, 115u8, 131u8, 41u8, 255u8, 7u8, 95u8, 122u8,
    108u8, 208u8, 89u8, 101u8, 131u8, 155u8,
]);
...
pub struct NormalizedInstanceExprIntegralsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for NormalizedInstanceExprIntegralsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedInstanceExprIntegralsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedInstanceExprIntegralsRow),
                    ))?,
            )?,
            r#domain_id: <Option<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprIntegralsRow {
    fn append(
        &self,
...
pub type Row = NormalizedInstanceExprIntegralsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstanceExprIntegralsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstanceExprIntegralsBuilder;
impl NormalizedInstanceExprIntegralsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instance_expr_integrals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstanceExprIntegralsRow {
    type Builder = NormalizedInstanceExprIntegralsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprIntegralsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprIntegralsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedInstanceExprIntegralsView<'a> {
...
impl<'a> NormalizedInstanceExprIntegralsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprIntegralsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprIntegralsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedInstanceExprIntegralsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstanceExprIntegralsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstanceExprIntegralsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedInstanceExprIntegralsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprIntegralsView<'_>,
    ) -> Result<(), crate::RelationError> {
