...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    130u8, 160u8, 242u8, 197u8, 129u8, 133u8, 132u8, 208u8, 179u8, 91u8, 222u8, 185u8,
    15u8, 150u8, 63u8, 8u8, 115u8, 195u8, 201u8, 131u8, 165u8, 114u8, 37u8, 139u8, 38u8,
    114u8, 34u8, 9u8, 31u8, 76u8, 76u8, 127u8,
]);
...
impl crate::columnar::RelationRow for NormalizedStoichiometryRow {
    ...
    fn builder_allocation_size() -> usize {
        50_360_usize + size_of::<Self::Builder>()
    }
