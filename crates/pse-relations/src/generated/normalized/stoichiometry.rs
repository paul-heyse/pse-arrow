...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    71u8, 252u8, 138u8, 81u8, 237u8, 83u8, 64u8, 138u8, 236u8, 244u8, 25u8, 233u8, 217u8,
    232u8, 172u8, 177u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    238u8, 177u8, 151u8, 121u8, 173u8, 131u8, 38u8, 28u8, 152u8, 171u8, 70u8, 189u8,
    150u8, 188u8, 230u8, 89u8, 191u8, 222u8, 229u8, 221u8, 16u8, 99u8, 252u8, 174u8,
    125u8, 225u8, 140u8, 38u8, 107u8, 68u8, 62u8, 153u8,
]);
...
pub struct NormalizedStoichiometryRow {
    ///reaction_id
...
impl crate::typed::CellCodec for NormalizedStoichiometryRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedStoichiometryRow)));
        };
            ...
            r#reaction_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedStoichiometryRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedStoichiometryRow {
    fn append(
        &self,
...
pub type Row = NormalizedStoichiometryRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedStoichiometryView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedStoichiometryBuilder;
impl NormalizedStoichiometryRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.stoichiometry".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedStoichiometryRow {
    type Builder = NormalizedStoichiometryBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedStoichiometryBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedStoichiometryView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        50_824_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedStoichiometryView<'a> {
...
impl<'a> NormalizedStoichiometryView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedStoichiometryRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedStoichiometryRow {
    ...
    pub fn rows(&self) -> Result<Vec<NormalizedStoichiometryRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedStoichiometryBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedStoichiometryBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedStoichiometryRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedStoichiometryView<'_>,
    ) -> Result<(), crate::RelationError> {
