...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    52u8, 24u8, 212u8, 11u8, 128u8, 124u8, 38u8, 31u8, 74u8, 34u8, 13u8, 241u8, 9u8,
    32u8, 120u8, 49u8, 37u8, 93u8, 28u8, 173u8, 243u8, 232u8, 69u8, 95u8, 90u8, 75u8,
    217u8, 190u8, 152u8, 32u8, 255u8, 218u8,
]);
...
impl crate::columnar::RelationRow for NormalizedStoichiometryRow {
    ...
    fn builder_allocation_size() -> usize {
        52_584_usize + size_of::<Self::Builder>()
    }
