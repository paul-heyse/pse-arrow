...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    220u8, 171u8, 140u8, 159u8, 135u8, 228u8, 108u8, 198u8, 88u8, 53u8, 35u8, 132u8,
    134u8, 252u8, 58u8, 246u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "selector_roots";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    127u8, 130u8, 71u8, 31u8, 164u8, 60u8, 50u8, 176u8, 111u8, 169u8, 42u8, 119u8, 98u8,
    213u8, 69u8, 152u8, 54u8, 249u8, 144u8, 140u8, 223u8, 53u8, 151u8, 237u8, 240u8,
    218u8, 132u8, 203u8, 23u8, 138u8, 101u8, 250u8,
]);
...
pub struct NormalizedSelectorRootsRow {
    ///scope_decl_id
...
impl crate::typed::CellCodec for NormalizedSelectorRootsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedSelectorRootsRow)));
        };
            ...
            r#scope_decl_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedSelectorRootsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedSelectorRootsRow {
    fn append(
        &self,
...
pub type Row = NormalizedSelectorRootsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedSelectorRootsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedSelectorRootsBuilder;
impl NormalizedSelectorRootsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.selector_roots".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedSelectorRootsRow {
    type Builder = NormalizedSelectorRootsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedSelectorRootsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedSelectorRootsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedSelectorRootsView<'a> {
...
impl<'a> NormalizedSelectorRootsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedSelectorRootsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedSelectorRootsRow {
    ...
    pub fn rows(&self) -> Result<Vec<NormalizedSelectorRootsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedSelectorRootsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedSelectorRootsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedSelectorRootsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedSelectorRootsView<'_>,
    ) -> Result<(), crate::RelationError> {
