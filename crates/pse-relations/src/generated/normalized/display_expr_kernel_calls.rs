...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    44u8, 83u8, 115u8, 33u8, 66u8, 62u8, 128u8, 160u8, 221u8, 143u8, 118u8, 137u8, 141u8,
    251u8, 232u8, 141u8, 51u8, 27u8, 34u8, 226u8, 76u8, 146u8, 99u8, 132u8, 208u8, 80u8,
    146u8, 106u8, 210u8, 209u8, 15u8, 182u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprKernelCallsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedDisplayExprKernelCallsRow {
    type Builder = NormalizedDisplayExprKernelCallsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprKernelCallsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprKernelCallsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        26_992_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedDisplayExprKernelCallsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprKernelCallsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprKernelCallsRow {
...
impl NormalizedDisplayExprKernelCallsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprKernelCallsView<'_>,
    ) -> Result<(), crate::RelationError> {
