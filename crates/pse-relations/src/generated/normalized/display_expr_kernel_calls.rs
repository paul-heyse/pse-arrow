...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    184u8, 225u8, 16u8, 71u8, 84u8, 4u8, 53u8, 230u8, 5u8, 121u8, 74u8, 109u8, 23u8,
    133u8, 82u8, 8u8, 158u8, 99u8, 25u8, 236u8, 24u8, 82u8, 131u8, 113u8, 39u8, 103u8,
    216u8, 252u8, 170u8, 238u8, 155u8, 253u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprKernelCallsRow {
    ...
    fn builder_allocation_size() -> usize {
        27_456_usize + size_of::<Self::Builder>()
    }
