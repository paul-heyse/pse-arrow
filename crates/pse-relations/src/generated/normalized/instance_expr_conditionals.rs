...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    193u8, 22u8, 235u8, 36u8, 250u8, 218u8, 70u8, 239u8, 105u8, 108u8, 100u8, 198u8,
    60u8, 71u8, 226u8, 39u8, 130u8, 236u8, 7u8, 137u8, 60u8, 42u8, 116u8, 47u8, 94u8,
    103u8, 93u8, 101u8, 27u8, 88u8, 232u8, 128u8,
]);
...
impl crate::columnar::RelationRow for NormalizedInstanceExprConditionalsRow {
    ...
    fn builder_allocation_size() -> usize {
        33_200_usize + size_of::<Self::Builder>()
    }
