...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    46u8, 167u8, 96u8, 67u8, 14u8, 38u8, 208u8, 140u8, 67u8, 60u8, 135u8, 126u8, 136u8,
    66u8, 135u8, 162u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_expr_implicit_refs";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    41u8, 136u8, 38u8, 147u8, 35u8, 232u8, 10u8, 223u8, 130u8, 210u8, 122u8, 242u8,
    163u8, 25u8, 14u8, 127u8, 193u8, 97u8, 140u8, 118u8, 89u8, 16u8, 49u8, 166u8, 78u8,
    214u8, 199u8, 241u8, 194u8, 224u8, 164u8, 82u8,
]);
...
pub struct NormalizedTemplateExprImplicitRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///implicit_system_id
...
impl crate::typed::CellCodec for NormalizedTemplateExprImplicitRefsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateExprImplicitRefsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateExprImplicitRefsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprImplicitRefsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateExprImplicitRefsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateExprImplicitRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateExprImplicitRefsBuilder;
impl NormalizedTemplateExprImplicitRefsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_expr_implicit_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateExprImplicitRefsRow {
    type Builder = NormalizedTemplateExprImplicitRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprImplicitRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprImplicitRefsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_528_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateExprImplicitRefsView<'a> {
...
impl<'a> NormalizedTemplateExprImplicitRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprImplicitRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprImplicitRefsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateExprImplicitRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateExprImplicitRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateExprImplicitRefsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateExprImplicitRefsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprImplicitRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
