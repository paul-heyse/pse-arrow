...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    179u8, 61u8, 254u8, 82u8, 215u8, 42u8, 137u8, 148u8, 114u8, 128u8, 233u8, 42u8,
    160u8, 176u8, 133u8, 156u8, 211u8, 100u8, 187u8, 96u8, 23u8, 136u8, 16u8, 141u8,
    224u8, 233u8, 189u8, 183u8, 13u8, 13u8, 211u8, 107u8,
]);
...
impl<'a> NormalizedTemplateExprImplicitRefsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedTemplateExprImplicitRefsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedTemplateExprImplicitRefsBuilder {
    rows: Vec<NormalizedTemplateExprImplicitRefsRow>,
}
impl NormalizedTemplateExprImplicitRefsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedTemplateExprImplicitRefsRow::into_cells)
            .collect::<Vec<_>>();
