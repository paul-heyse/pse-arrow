...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    226u8, 236u8, 233u8, 91u8, 254u8, 156u8, 33u8, 85u8, 110u8, 253u8, 199u8, 115u8,
    164u8, 4u8, 225u8, 101u8, 19u8, 180u8, 6u8, 64u8, 163u8, 138u8, 158u8, 89u8, 156u8,
    124u8, 95u8, 250u8, 26u8, 9u8, 101u8, 119u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateExprImplicitRefsRow {
    ...
    fn builder_allocation_size() -> usize {
        27_064_usize + size_of::<Self::Builder>()
    }
