...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    172u8, 218u8, 32u8, 31u8, 120u8, 178u8, 165u8, 172u8, 106u8, 84u8, 183u8, 15u8,
    213u8, 27u8, 69u8, 143u8, 95u8, 202u8, 88u8, 200u8, 126u8, 141u8, 68u8, 152u8, 238u8,
    4u8, 152u8, 49u8, 233u8, 243u8, 72u8, 249u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprBroadcastsRow {
    ...
    fn builder_allocation_size() -> usize {
        51_840_usize + size_of::<Self::Builder>()
    }
