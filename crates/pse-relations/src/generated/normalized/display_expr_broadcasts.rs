...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    249u8, 53u8, 202u8, 103u8, 217u8, 173u8, 215u8, 90u8, 158u8, 53u8, 129u8, 80u8,
    231u8, 253u8, 17u8, 0u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "display_expr_broadcasts";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    232u8, 129u8, 88u8, 225u8, 179u8, 214u8, 136u8, 230u8, 155u8, 127u8, 28u8, 133u8,
    110u8, 78u8, 22u8, 106u8, 140u8, 18u8, 85u8, 163u8, 230u8, 78u8, 171u8, 178u8, 96u8,
    192u8, 49u8, 18u8, 202u8, 127u8, 188u8, 131u8,
]);
...
pub struct NormalizedDisplayExprBroadcastsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for NormalizedDisplayExprBroadcastsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedDisplayExprBroadcastsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedDisplayExprBroadcastsRow),
                    ))?,
            )?,
            r#domain_id: <Option<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprBroadcastsRow {
    fn append(
        &self,
...
pub type Row = NormalizedDisplayExprBroadcastsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedDisplayExprBroadcastsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedDisplayExprBroadcastsBuilder;
impl NormalizedDisplayExprBroadcastsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.display_expr_broadcasts".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedDisplayExprBroadcastsRow {
    type Builder = NormalizedDisplayExprBroadcastsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprBroadcastsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprBroadcastsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        51_376_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedDisplayExprBroadcastsView<'a> {
...
impl<'a> NormalizedDisplayExprBroadcastsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprBroadcastsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprBroadcastsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedDisplayExprBroadcastsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedDisplayExprBroadcastsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDisplayExprBroadcastsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedDisplayExprBroadcastsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprBroadcastsView<'_>,
    ) -> Result<(), crate::RelationError> {
