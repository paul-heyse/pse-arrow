...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    251u8, 149u8, 11u8, 76u8, 165u8, 51u8, 211u8, 157u8, 242u8, 134u8, 176u8, 183u8,
    89u8, 146u8, 210u8, 68u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "guard_expr_int_constants";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    158u8, 183u8, 56u8, 159u8, 109u8, 107u8, 192u8, 148u8, 210u8, 185u8, 244u8, 168u8,
    211u8, 19u8, 162u8, 252u8, 68u8, 10u8, 112u8, 66u8, 104u8, 118u8, 42u8, 179u8, 157u8,
    112u8, 181u8, 98u8, 173u8, 85u8, 140u8, 247u8,
]);
...
pub struct NormalizedGuardExprIntConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: i64,
}
impl crate::typed::CellCodec for NormalizedGuardExprIntConstantsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedGuardExprIntConstantsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedGuardExprIntConstantsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedGuardExprIntConstantsRow {
    fn append(
        &self,
...
pub type Row = NormalizedGuardExprIntConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedGuardExprIntConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedGuardExprIntConstantsBuilder;
impl NormalizedGuardExprIntConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.guard_expr_int_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedGuardExprIntConstantsRow {
    type Builder = NormalizedGuardExprIntConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprIntConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprIntConstantsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        15_848_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedGuardExprIntConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprIntConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprIntConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedGuardExprIntConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedGuardExprIntConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedGuardExprIntConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedGuardExprIntConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprIntConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
