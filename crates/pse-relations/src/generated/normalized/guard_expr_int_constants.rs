...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    89u8, 233u8, 137u8, 31u8, 227u8, 226u8, 84u8, 239u8, 15u8, 163u8, 91u8, 179u8, 54u8,
    51u8, 80u8, 109u8, 152u8, 10u8, 145u8, 227u8, 68u8, 48u8, 160u8, 50u8, 155u8, 59u8,
    231u8, 72u8, 155u8, 43u8, 228u8, 239u8,
]);
...
impl<'a> NormalizedGuardExprIntConstantsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedGuardExprIntConstantsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedGuardExprIntConstantsBuilder {
    rows: Vec<NormalizedGuardExprIntConstantsRow>,
}
impl NormalizedGuardExprIntConstantsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedGuardExprIntConstantsRow::into_cells)
            .collect::<Vec<_>>();
