...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    11u8, 77u8, 16u8, 27u8, 79u8, 70u8, 142u8, 63u8, 185u8, 110u8, 234u8, 28u8, 140u8,
    223u8, 210u8, 1u8, 76u8, 211u8, 61u8, 2u8, 123u8, 202u8, 90u8, 178u8, 165u8, 53u8,
    188u8, 33u8, 166u8, 150u8, 33u8, 44u8,
]);
...
impl crate::columnar::RelationRow for NormalizedResolvedSourceOccurrencesRow {
    ...
    fn builder_allocation_size() -> usize {
        84_384_usize + size_of::<Self::Builder>()
    }
