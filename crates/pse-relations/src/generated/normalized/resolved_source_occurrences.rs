...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    119u8, 81u8, 13u8, 223u8, 224u8, 249u8, 60u8, 135u8, 36u8, 34u8, 83u8, 151u8, 218u8,
    223u8, 150u8, 241u8, 150u8, 60u8, 66u8, 142u8, 78u8, 176u8, 7u8, 229u8, 134u8, 177u8,
    42u8, 75u8, 131u8, 48u8, 215u8, 84u8,
]);
