...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    6u8, 97u8, 114u8, 211u8, 217u8, 151u8, 107u8, 65u8, 76u8, 177u8, 43u8, 253u8, 149u8,
    236u8, 155u8, 214u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    89u8, 202u8, 255u8, 204u8, 150u8, 106u8, 214u8, 9u8, 71u8, 41u8, 201u8, 199u8, 215u8,
    239u8, 19u8, 252u8, 169u8, 12u8, 79u8, 17u8, 183u8, 223u8, 215u8, 67u8, 196u8, 40u8,
    176u8, 190u8, 17u8, 110u8, 193u8, 42u8,
]);
...
pub struct NormalizedTemplateSymbolContractsRow {
    ///symbol_decl_id
...
impl crate::typed::CellCodec for NormalizedTemplateSymbolContractsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateSymbolContractsRow)),
            );
        };
            ...
            r#symbol_decl_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateSymbolContractsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedTemplateSymbolContractsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateSymbolContractsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateSymbolContractsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateSymbolContractsBuilder;
impl NormalizedTemplateSymbolContractsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_symbol_contracts".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateSymbolContractsRow {
    type Builder = NormalizedTemplateSymbolContractsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateSymbolContractsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateSymbolContractsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        49_744_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateSymbolContractsView<'a> {
...
impl<'a> NormalizedTemplateSymbolContractsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateSymbolContractsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateSymbolContractsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateSymbolContractsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateSymbolContractsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateSymbolContractsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateSymbolContractsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateSymbolContractsView<'_>,
    ) -> Result<(), crate::RelationError> {
