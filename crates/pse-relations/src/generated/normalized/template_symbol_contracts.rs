...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    26u8, 1u8, 215u8, 63u8, 232u8, 61u8, 58u8, 44u8, 205u8, 231u8, 226u8, 220u8, 28u8,
    62u8, 82u8, 21u8, 97u8, 41u8, 203u8, 78u8, 156u8, 19u8, 58u8, 246u8, 122u8, 212u8,
    31u8, 27u8, 209u8, 45u8, 129u8, 165u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateSymbolContractsRow {
    ...
    fn builder_allocation_size() -> usize {
        50_208_usize + size_of::<Self::Builder>()
    }
