...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    185u8, 75u8, 255u8, 114u8, 27u8, 45u8, 53u8, 192u8, 67u8, 210u8, 33u8, 132u8, 7u8,
    56u8, 57u8, 255u8, 35u8, 50u8, 197u8, 35u8, 156u8, 82u8, 157u8, 192u8, 248u8, 199u8,
    148u8, 245u8, 113u8, 120u8, 56u8, 121u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateSymbolContractsRow {
    ...
    fn builder_allocation_size() -> usize {
        51_968_usize + size_of::<Self::Builder>()
    }
