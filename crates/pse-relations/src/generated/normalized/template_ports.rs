...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    112u8, 55u8, 52u8, 238u8, 51u8, 136u8, 189u8, 19u8, 231u8, 110u8, 160u8, 77u8, 125u8,
    189u8, 90u8, 187u8, 2u8, 225u8, 60u8, 187u8, 119u8, 108u8, 129u8, 133u8, 68u8, 214u8,
    71u8, 116u8, 157u8, 244u8, 37u8, 26u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplatePortsRow {
    ...
    fn builder_allocation_size() -> usize {
        73_752_usize + size_of::<Self::Builder>()
    }
