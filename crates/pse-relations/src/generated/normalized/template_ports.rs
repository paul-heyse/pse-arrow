...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    250u8, 152u8, 26u8, 217u8, 32u8, 82u8, 132u8, 82u8, 149u8, 5u8, 249u8, 13u8, 200u8,
    180u8, 210u8, 242u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    122u8, 217u8, 250u8, 87u8, 19u8, 151u8, 178u8, 254u8, 215u8, 233u8, 13u8, 212u8,
    247u8, 144u8, 171u8, 110u8, 179u8, 246u8, 90u8, 29u8, 95u8, 170u8, 109u8, 184u8,
    148u8, 3u8, 35u8, 18u8, 68u8, 182u8, 173u8, 173u8,
]);
...
pub struct NormalizedTemplatePortsRow {
    ///template_id
...
impl crate::typed::CellCodec for NormalizedTemplatePortsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#bound_to),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedTemplatePortsRow)));
        };
            ...
            r#template_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplatePortsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedTemplatePortsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplatePortsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplatePortsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplatePortsBuilder;
impl NormalizedTemplatePortsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_ports".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplatePortsRow {
    type Builder = NormalizedTemplatePortsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplatePortsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplatePortsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        74_216_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplatePortsView<'a> {
...
impl<'a> NormalizedTemplatePortsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplatePortsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplatePortsRow {
    ...
    pub fn rows(&self) -> Result<Vec<NormalizedTemplatePortsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplatePortsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplatePortsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplatePortsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplatePortsView<'_>,
    ) -> Result<(), crate::RelationError> {
