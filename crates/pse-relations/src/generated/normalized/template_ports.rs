...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    169u8, 149u8, 169u8, 44u8, 43u8, 116u8, 240u8, 22u8, 89u8, 170u8, 183u8, 71u8, 210u8,
    106u8, 118u8, 244u8, 88u8, 197u8, 43u8, 159u8, 139u8, 61u8, 52u8, 221u8, 52u8, 174u8,
    14u8, 108u8, 117u8, 151u8, 67u8, 240u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplatePortsRow {
    ...
    fn builder_allocation_size() -> usize {
        75_976_usize + size_of::<Self::Builder>()
    }
