...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    180u8, 64u8, 170u8, 189u8, 160u8, 8u8, 250u8, 187u8, 14u8, 77u8, 88u8, 122u8, 100u8,
    213u8, 172u8, 1u8, 119u8, 131u8, 24u8, 224u8, 105u8, 103u8, 5u8, 219u8, 33u8, 175u8,
    222u8, 220u8, 221u8, 129u8, 97u8, 1u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDomainProductProjectionsRow {
    ...
    fn builder_allocation_size() -> usize {
        61_488_usize + size_of::<Self::Builder>()
    }
