...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    110u8, 120u8, 145u8, 7u8, 212u8, 250u8, 166u8, 162u8, 170u8, 243u8, 31u8, 116u8,
    187u8, 63u8, 173u8, 38u8, 138u8, 49u8, 110u8, 105u8, 255u8, 182u8, 132u8, 168u8,
    228u8, 187u8, 31u8, 238u8, 107u8, 111u8, 70u8, 189u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprImplicitRefsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedDisplayExprImplicitRefsRow {
    type Builder = NormalizedDisplayExprImplicitRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprImplicitRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprImplicitRefsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_056_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedDisplayExprImplicitRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprImplicitRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprImplicitRefsRow {
...
impl NormalizedDisplayExprImplicitRefsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprImplicitRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
