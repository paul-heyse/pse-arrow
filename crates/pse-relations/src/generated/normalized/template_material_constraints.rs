...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    193u8, 111u8, 117u8, 133u8, 237u8, 118u8, 5u8, 161u8, 118u8, 193u8, 46u8, 247u8,
    54u8, 191u8, 254u8, 158u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    238u8, 18u8, 69u8, 180u8, 52u8, 181u8, 123u8, 188u8, 78u8, 217u8, 30u8, 117u8, 238u8,
    235u8, 140u8, 99u8, 162u8, 132u8, 176u8, 64u8, 36u8, 133u8, 214u8, 196u8, 184u8,
    127u8, 48u8, 205u8, 121u8, 146u8, 132u8, 239u8,
]);
...
pub struct NormalizedTemplateMaterialConstraintsRow {
    ///template_id
...
impl crate::columnar::ArrowValue for NormalizedTemplateMaterialConstraintsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateMaterialConstraintsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateMaterialConstraintsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateMaterialConstraintsBuilder;
impl NormalizedTemplateMaterialConstraintsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_material_constraints".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateMaterialConstraintsRow {
    type Builder = NormalizedTemplateMaterialConstraintsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateMaterialConstraintsBuilder::with_registry(registry, capacity)
    }
...
impl<'a> NormalizedTemplateMaterialConstraintsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateMaterialConstraintsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateMaterialConstraintsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateMaterialConstraintsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateMaterialConstraintsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateMaterialConstraintsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateMaterialConstraintsView<'_>,
    ) -> Result<(), crate::RelationError> {
