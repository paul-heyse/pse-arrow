...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    126u8, 24u8, 140u8, 181u8, 179u8, 183u8, 254u8, 34u8, 142u8, 189u8, 17u8, 156u8,
    83u8, 255u8, 80u8, 234u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "domain_product_sources";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    142u8, 64u8, 150u8, 239u8, 52u8, 113u8, 241u8, 249u8, 121u8, 4u8, 203u8, 216u8, 50u8,
    157u8, 247u8, 151u8, 122u8, 2u8, 195u8, 125u8, 21u8, 150u8, 46u8, 49u8, 178u8, 242u8,
    65u8, 8u8, 36u8, 130u8, 183u8, 38u8,
]);
...
pub struct NormalizedDomainProductSourcesRow {
    ///product_id
...
impl crate::typed::CellCodec for NormalizedDomainProductSourcesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedDomainProductSourcesRow)),
            );
        };
            ...
            r#product_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedDomainProductSourcesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedDomainProductSourcesRow {
    fn append(
        &self,
...
pub type Row = NormalizedDomainProductSourcesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedDomainProductSourcesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedDomainProductSourcesBuilder;
impl NormalizedDomainProductSourcesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.domain_product_sources".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedDomainProductSourcesRow {
    type Builder = NormalizedDomainProductSourcesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDomainProductSourcesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDomainProductSourcesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        56_088_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedDomainProductSourcesView<'a> {
...
impl<'a> NormalizedDomainProductSourcesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDomainProductSourcesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDomainProductSourcesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedDomainProductSourcesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedDomainProductSourcesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDomainProductSourcesBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedDomainProductSourcesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDomainProductSourcesView<'_>,
    ) -> Result<(), crate::RelationError> {
