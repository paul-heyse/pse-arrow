...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    74u8, 226u8, 221u8, 148u8, 150u8, 131u8, 131u8, 68u8, 166u8, 28u8, 187u8, 32u8,
    102u8, 80u8, 102u8, 82u8, 40u8, 190u8, 183u8, 104u8, 33u8, 200u8, 101u8, 23u8, 146u8,
    126u8, 164u8, 234u8, 227u8, 90u8, 10u8, 241u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprDerivativesRow {
    ...
    fn builder_allocation_size() -> usize {
        46_376_usize + size_of::<Self::Builder>()
    }
