...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    148u8, 191u8, 150u8, 164u8, 178u8, 232u8, 172u8, 178u8, 172u8, 204u8, 162u8, 12u8,
    22u8, 240u8, 127u8, 27u8, 131u8, 10u8, 74u8, 176u8, 80u8, 66u8, 143u8, 155u8, 138u8,
    80u8, 106u8, 153u8, 117u8, 58u8, 174u8, 9u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprDerivativesRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedDisplayExprDerivativesRow {
    type Builder = NormalizedDisplayExprDerivativesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprDerivativesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprDerivativesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        46_840_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedDisplayExprDerivativesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprDerivativesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprDerivativesRow {
...
impl NormalizedDisplayExprDerivativesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprDerivativesView<'_>,
    ) -> Result<(), crate::RelationError> {
