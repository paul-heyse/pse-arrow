...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    21u8, 160u8, 168u8, 148u8, 200u8, 212u8, 131u8, 23u8, 21u8, 68u8, 255u8, 24u8, 154u8,
    173u8, 191u8, 79u8, 218u8, 104u8, 102u8, 191u8, 227u8, 238u8, 177u8, 242u8, 150u8,
    245u8, 133u8, 94u8, 19u8, 117u8, 147u8, 3u8,
]);
...
impl crate::columnar::RelationRow for NormalizedFeatureInheritanceRow {
    ...
    fn builder_allocation_size() -> usize {
        78_408_usize + size_of::<Self::Builder>()
    }
