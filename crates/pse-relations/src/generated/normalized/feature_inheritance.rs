...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    228u8, 156u8, 166u8, 212u8, 133u8, 110u8, 173u8, 108u8, 130u8, 70u8, 165u8, 146u8,
    163u8, 121u8, 127u8, 113u8, 99u8, 25u8, 21u8, 175u8, 12u8, 123u8, 62u8, 42u8, 59u8,
    129u8, 200u8, 72u8, 133u8, 116u8, 239u8, 37u8,
]);
...
impl crate::columnar::RelationRow for NormalizedFeatureInheritanceRow {
    ...
    fn builder_allocation_size() -> usize {
        65_720_usize + size_of::<Self::Builder>()
    }
