...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    220u8, 79u8, 110u8, 230u8, 95u8, 79u8, 17u8, 31u8, 206u8, 135u8, 72u8, 144u8, 215u8,
    93u8, 58u8, 240u8, 95u8, 223u8, 2u8, 85u8, 92u8, 67u8, 160u8, 10u8, 179u8, 89u8,
    16u8, 236u8, 18u8, 94u8, 197u8, 64u8,
]);
