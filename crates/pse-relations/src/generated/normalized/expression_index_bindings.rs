...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    137u8, 229u8, 218u8, 130u8, 122u8, 180u8, 33u8, 91u8, 207u8, 159u8, 143u8, 189u8,
    217u8, 5u8, 142u8, 255u8, 210u8, 65u8, 178u8, 73u8, 187u8, 53u8, 52u8, 239u8, 31u8,
    108u8, 21u8, 30u8, 226u8, 221u8, 63u8, 58u8,
]);
...
impl crate::columnar::RelationRow for NormalizedExpressionIndexBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        67_976_usize + size_of::<Self::Builder>()
    }
