...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    47u8, 211u8, 230u8, 196u8, 161u8, 97u8, 211u8, 149u8, 98u8, 216u8, 210u8, 122u8,
    77u8, 156u8, 26u8, 227u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_binding_products";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    204u8, 55u8, 43u8, 152u8, 191u8, 23u8, 116u8, 61u8, 126u8, 88u8, 103u8, 56u8, 215u8,
    194u8, 122u8, 190u8, 71u8, 17u8, 135u8, 37u8, 210u8, 25u8, 223u8, 36u8, 186u8, 234u8,
    247u8, 89u8, 244u8, 129u8, 155u8, 166u8,
]);
...
pub struct NormalizedInstanceBindingProductsRow {
    ///instance_id
...
impl crate::typed::CellCodec for NormalizedInstanceBindingProductsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedInstanceBindingProductsRow)),
            );
        };
            ...
            r#instance_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedInstanceBindingProductsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedInstanceBindingProductsRow {
    fn append(
        &self,
...
pub type Row = NormalizedInstanceBindingProductsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstanceBindingProductsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstanceBindingProductsBuilder;
impl NormalizedInstanceBindingProductsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instance_binding_products".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstanceBindingProductsRow {
    type Builder = NormalizedInstanceBindingProductsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceBindingProductsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceBindingProductsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedInstanceBindingProductsView<'a> {
...
impl<'a> NormalizedInstanceBindingProductsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceBindingProductsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceBindingProductsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedInstanceBindingProductsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstanceBindingProductsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstanceBindingProductsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedInstanceBindingProductsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceBindingProductsView<'_>,
    ) -> Result<(), crate::RelationError> {
