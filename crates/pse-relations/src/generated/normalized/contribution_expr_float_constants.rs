...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    212u8, 176u8, 201u8, 77u8, 53u8, 62u8, 34u8, 100u8, 145u8, 113u8, 85u8, 192u8, 170u8,
    13u8, 192u8, 64u8, 128u8, 203u8, 89u8, 140u8, 80u8, 151u8, 236u8, 133u8, 141u8,
    139u8, 161u8, 43u8, 89u8, 169u8, 226u8, 141u8,
]);
...
impl<'a> NormalizedContributionExprFloatConstantsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedContributionExprFloatConstantsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedContributionExprFloatConstantsBuilder {
    rows: Vec<NormalizedContributionExprFloatConstantsRow>,
}
impl NormalizedContributionExprFloatConstantsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedContributionExprFloatConstantsRow::into_cells)
            .collect::<Vec<_>>();
