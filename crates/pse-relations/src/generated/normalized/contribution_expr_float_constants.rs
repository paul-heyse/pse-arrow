...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    176u8, 192u8, 165u8, 16u8, 133u8, 191u8, 118u8, 203u8, 16u8, 45u8, 68u8, 129u8,
    196u8, 99u8, 13u8, 249u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "contribution_expr_float_constants";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    105u8, 191u8, 101u8, 189u8, 173u8, 241u8, 126u8, 48u8, 99u8, 151u8, 71u8, 209u8,
    107u8, 3u8, 111u8, 235u8, 101u8, 229u8, 128u8, 89u8, 171u8, 4u8, 82u8, 151u8, 3u8,
    32u8, 196u8, 206u8, 106u8, 195u8, 206u8, 222u8,
]);
...
pub struct NormalizedContributionExprFloatConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: f64,
...
impl crate::typed::CellCodec for NormalizedContributionExprFloatConstantsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedContributionExprFloatConstantsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedContributionExprFloatConstantsRow {
    fn append(
        &self,
...
pub type Row = NormalizedContributionExprFloatConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedContributionExprFloatConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedContributionExprFloatConstantsBuilder;
impl NormalizedContributionExprFloatConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.contribution_expr_float_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedContributionExprFloatConstantsRow {
    type Builder = NormalizedContributionExprFloatConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedContributionExprFloatConstantsBuilder::with_registry(
            registry,
            capacity,
        )
    }
    ...
    fn rows(
        ...
        NormalizedContributionExprFloatConstantsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_104_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedContributionExprFloatConstantsView<'a> {
...
impl<'a> NormalizedContributionExprFloatConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedContributionExprFloatConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedContributionExprFloatConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedContributionExprFloatConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedContributionExprFloatConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedContributionExprFloatConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedContributionExprFloatConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedContributionExprFloatConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
