...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    211u8, 69u8, 66u8, 48u8, 148u8, 253u8, 32u8, 167u8, 78u8, 83u8, 210u8, 246u8, 205u8,
    43u8, 245u8, 12u8, 57u8, 48u8, 199u8, 114u8, 30u8, 202u8, 114u8, 108u8, 188u8, 198u8,
    226u8, 252u8, 220u8, 254u8, 162u8, 63u8,
]);
...
impl crate::columnar::RelationRow for NormalizedContributionExprFloatConstantsRow {
    ...
    fn builder_allocation_size() -> usize {
        26_640_usize + size_of::<Self::Builder>()
    }
