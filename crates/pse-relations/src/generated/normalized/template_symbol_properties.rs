...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    175u8, 142u8, 96u8, 54u8, 244u8, 255u8, 110u8, 120u8, 224u8, 14u8, 16u8, 243u8,
    160u8, 203u8, 151u8, 66u8, 36u8, 48u8, 97u8, 254u8, 174u8, 13u8, 93u8, 176u8, 222u8,
    223u8, 130u8, 68u8, 140u8, 199u8, 102u8, 247u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedTemplateSymbolPropertiesRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedTemplateSymbolPropertiesRow {
    type Builder = NormalizedTemplateSymbolPropertiesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateSymbolPropertiesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateSymbolPropertiesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        47_920_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedTemplateSymbolPropertiesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateSymbolPropertiesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateSymbolPropertiesRow {
...
impl NormalizedTemplateSymbolPropertiesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateSymbolPropertiesView<'_>,
    ) -> Result<(), crate::RelationError> {
