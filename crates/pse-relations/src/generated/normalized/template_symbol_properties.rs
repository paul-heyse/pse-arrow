...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    75u8, 34u8, 179u8, 117u8, 54u8, 40u8, 158u8, 8u8, 67u8, 116u8, 113u8, 64u8, 205u8,
    31u8, 75u8, 48u8, 158u8, 170u8, 24u8, 33u8, 156u8, 84u8, 31u8, 72u8, 86u8, 84u8,
    32u8, 242u8, 142u8, 81u8, 230u8, 242u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateSymbolPropertiesRow {
    ...
    fn builder_allocation_size() -> usize {
        45_696_usize + size_of::<Self::Builder>()
    }
