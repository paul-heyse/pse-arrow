...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    165u8, 38u8, 248u8, 95u8, 22u8, 37u8, 190u8, 87u8, 198u8, 31u8, 216u8, 52u8, 189u8,
    7u8, 109u8, 234u8, 132u8, 65u8, 202u8, 44u8, 10u8, 243u8, 214u8, 118u8, 159u8, 40u8,
    246u8, 4u8, 129u8, 57u8, 182u8, 208u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateSymbolPropertiesRow {
    ...
    fn builder_allocation_size() -> usize {
        46_160_usize + size_of::<Self::Builder>()
    }
