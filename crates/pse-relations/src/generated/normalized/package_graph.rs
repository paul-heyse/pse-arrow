...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    254u8, 243u8, 84u8, 11u8, 134u8, 184u8, 52u8, 10u8, 107u8, 28u8, 23u8, 213u8, 180u8,
    144u8, 59u8, 52u8, 72u8, 37u8, 10u8, 79u8, 143u8, 106u8, 3u8, 247u8, 129u8, 97u8,
    96u8, 208u8, 203u8, 232u8, 181u8, 157u8,
]);
...
impl crate::columnar::RelationRow for NormalizedPackageGraphRow {
    ...
    fn builder_allocation_size() -> usize {
        82_464_usize + size_of::<Self::Builder>()
    }
