...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    247u8, 93u8, 141u8, 0u8, 38u8, 81u8, 149u8, 68u8, 231u8, 56u8, 242u8, 2u8, 17u8,
    15u8, 248u8, 79u8, 211u8, 245u8, 50u8, 192u8, 76u8, 78u8, 184u8, 36u8, 188u8, 54u8,
    85u8, 187u8, 201u8, 92u8, 2u8, 3u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedPackageGraphRow {
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#depth: <u16 as crate::columnar::ArrowValue>::read(
...
impl crate::columnar::RelationRow for NormalizedPackageGraphRow {
    ...
    fn builder_allocation_size() -> usize {
        75_128_usize + size_of::<Self::Builder>()
    }
...
pub struct NormalizedPackageGraphView<'a> {
    ...
    depth_column: &'a arrow_array::UInt16Array,
...
impl<'a> NormalizedPackageGraphView<'a> {
    ...
    pub const fn depth_column(&self) -> &'a arrow_array::UInt16Array {
        self.depth_column
    }
