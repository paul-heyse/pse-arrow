...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    49u8, 67u8, 235u8, 24u8, 67u8, 127u8, 67u8, 214u8, 45u8, 40u8, 13u8, 155u8, 34u8,
    14u8, 139u8, 44u8, 34u8, 0u8, 96u8, 76u8, 238u8, 114u8, 196u8, 84u8, 119u8, 97u8,
    131u8, 225u8, 100u8, 223u8, 118u8, 21u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateExprKernelCallsRow {
    ...
    fn builder_allocation_size() -> usize {
        27_464_usize + size_of::<Self::Builder>()
    }
