...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    203u8, 47u8, 222u8, 11u8, 43u8, 72u8, 222u8, 95u8, 254u8, 206u8, 247u8, 104u8, 255u8,
    216u8, 184u8, 105u8, 246u8, 239u8, 153u8, 42u8, 202u8, 66u8, 219u8, 39u8, 242u8,
    197u8, 250u8, 23u8, 246u8, 207u8, 1u8, 55u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprKernelCallsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedTemplateExprKernelCallsRow {
    type Builder = NormalizedTemplateExprKernelCallsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprKernelCallsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprKernelCallsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_000_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedTemplateExprKernelCallsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprKernelCallsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprKernelCallsRow {
...
impl NormalizedTemplateExprKernelCallsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprKernelCallsView<'_>,
    ) -> Result<(), crate::RelationError> {
