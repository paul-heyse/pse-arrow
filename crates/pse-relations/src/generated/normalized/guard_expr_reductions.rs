...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    155u8, 238u8, 203u8, 79u8, 146u8, 84u8, 225u8, 7u8, 209u8, 17u8, 143u8, 68u8, 197u8,
    154u8, 228u8, 46u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "guard_expr_reductions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    75u8, 91u8, 144u8, 94u8, 51u8, 243u8, 87u8, 46u8, 145u8, 96u8, 64u8, 83u8, 228u8,
    81u8, 142u8, 244u8, 211u8, 162u8, 212u8, 198u8, 171u8, 235u8, 165u8, 83u8, 244u8,
    167u8, 50u8, 186u8, 68u8, 5u8, 38u8, 192u8,
]);
...
pub struct NormalizedGuardExprReductionsRow {
    ///node_id
    pub r#node_id: u64,
    ///kind
...
impl crate::typed::CellCodec for NormalizedGuardExprReductionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedGuardExprReductionsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedGuardExprReductionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedGuardExprReductionsRow {
    fn append(
        &self,
...
pub type Row = NormalizedGuardExprReductionsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedGuardExprReductionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedGuardExprReductionsBuilder;
impl NormalizedGuardExprReductionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.guard_expr_reductions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedGuardExprReductionsRow {
    type Builder = NormalizedGuardExprReductionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprReductionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprReductionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        89_216_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedGuardExprReductionsView<'a> {
...
impl<'a> NormalizedGuardExprReductionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprReductionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprReductionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedGuardExprReductionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedGuardExprReductionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedGuardExprReductionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedGuardExprReductionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprReductionsView<'_>,
    ) -> Result<(), crate::RelationError> {
