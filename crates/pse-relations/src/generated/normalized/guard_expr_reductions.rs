...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    205u8, 110u8, 138u8, 203u8, 175u8, 46u8, 89u8, 142u8, 90u8, 12u8, 250u8, 52u8, 90u8,
    163u8, 189u8, 221u8, 44u8, 218u8, 44u8, 162u8, 221u8, 128u8, 175u8, 92u8, 162u8, 3u8,
    96u8, 42u8, 33u8, 114u8, 0u8, 212u8,
]);
...
impl crate::columnar::RelationRow for NormalizedGuardExprReductionsRow {
    ...
    fn builder_allocation_size() -> usize {
        88_752_usize + size_of::<Self::Builder>()
    }
