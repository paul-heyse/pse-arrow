...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    242u8, 251u8, 6u8, 69u8, 28u8, 116u8, 252u8, 97u8, 232u8, 215u8, 4u8, 25u8, 140u8,
    179u8, 6u8, 7u8, 100u8, 143u8, 15u8, 73u8, 130u8, 132u8, 226u8, 206u8, 193u8, 6u8,
    181u8, 62u8, 173u8, 151u8, 170u8, 55u8,
]);
