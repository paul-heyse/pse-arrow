...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    22u8, 41u8, 198u8, 228u8, 42u8, 47u8, 118u8, 8u8, 235u8, 16u8, 66u8, 239u8, 208u8,
    61u8, 85u8, 138u8, 135u8, 106u8, 29u8, 232u8, 32u8, 69u8, 251u8, 13u8, 28u8, 129u8,
    123u8, 18u8, 143u8, 213u8, 133u8, 107u8,
]);
...
impl<'a> NormalizedDisplayExprIntConstantsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedDisplayExprIntConstantsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedDisplayExprIntConstantsBuilder {
    rows: Vec<NormalizedDisplayExprIntConstantsRow>,
}
impl NormalizedDisplayExprIntConstantsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedDisplayExprIntConstantsRow::into_cells)
            .collect::<Vec<_>>();
