...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    74u8, 250u8, 226u8, 237u8, 65u8, 234u8, 250u8, 58u8, 188u8, 11u8, 246u8, 169u8, 16u8,
    116u8, 88u8, 49u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "display_expr_int_constants";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    66u8, 17u8, 105u8, 32u8, 153u8, 82u8, 109u8, 148u8, 174u8, 208u8, 137u8, 98u8, 109u8,
    105u8, 161u8, 15u8, 247u8, 102u8, 15u8, 67u8, 207u8, 153u8, 184u8, 211u8, 9u8, 194u8,
    149u8, 70u8, 120u8, 187u8, 16u8, 30u8,
]);
...
pub struct NormalizedDisplayExprIntConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: i64,
}
impl crate::typed::CellCodec for NormalizedDisplayExprIntConstantsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedDisplayExprIntConstantsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedDisplayExprIntConstantsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprIntConstantsRow {
    fn append(
        &self,
...
pub type Row = NormalizedDisplayExprIntConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedDisplayExprIntConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedDisplayExprIntConstantsBuilder;
impl NormalizedDisplayExprIntConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.display_expr_int_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedDisplayExprIntConstantsRow {
    type Builder = NormalizedDisplayExprIntConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprIntConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprIntConstantsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        16_328_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedDisplayExprIntConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprIntConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprIntConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedDisplayExprIntConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedDisplayExprIntConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDisplayExprIntConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedDisplayExprIntConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprIntConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
