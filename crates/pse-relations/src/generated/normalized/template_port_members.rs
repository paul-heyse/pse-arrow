...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    15u8, 236u8, 36u8, 102u8, 2u8, 196u8, 45u8, 214u8, 155u8, 88u8, 204u8, 184u8, 210u8,
    131u8, 35u8, 238u8, 96u8, 9u8, 220u8, 88u8, 245u8, 117u8, 216u8, 182u8, 91u8, 38u8,
    111u8, 118u8, 34u8, 67u8, 67u8, 136u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplatePortMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        43_944_usize + size_of::<Self::Builder>()
    }
