...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    149u8, 214u8, 137u8, 236u8, 112u8, 12u8, 237u8, 113u8, 136u8, 179u8, 237u8, 227u8,
    181u8, 224u8, 7u8, 78u8, 50u8, 77u8, 210u8, 130u8, 41u8, 85u8, 70u8, 16u8, 120u8,
    242u8, 67u8, 255u8, 228u8, 166u8, 65u8, 128u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedGuardExprImplicitRefsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedGuardExprImplicitRefsRow {
    type Builder = NormalizedGuardExprImplicitRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprImplicitRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprImplicitRefsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_040_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedGuardExprImplicitRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprImplicitRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprImplicitRefsRow {
...
impl NormalizedGuardExprImplicitRefsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprImplicitRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
