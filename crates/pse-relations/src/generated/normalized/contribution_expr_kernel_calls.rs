...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    105u8, 44u8, 5u8, 159u8, 68u8, 36u8, 243u8, 88u8, 193u8, 7u8, 19u8, 72u8, 142u8,
    25u8, 189u8, 131u8, 89u8, 206u8, 134u8, 135u8, 142u8, 35u8, 147u8, 106u8, 37u8,
    185u8, 70u8, 198u8, 164u8, 81u8, 136u8, 207u8,
]);
...
impl<'a> NormalizedContributionExprKernelCallsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedContributionExprKernelCallsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedContributionExprKernelCallsBuilder {
    rows: Vec<NormalizedContributionExprKernelCallsRow>,
}
impl NormalizedContributionExprKernelCallsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedContributionExprKernelCallsRow::into_cells)
            .collect::<Vec<_>>();
