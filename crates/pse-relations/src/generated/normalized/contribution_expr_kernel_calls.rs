...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    0u8, 158u8, 138u8, 233u8, 129u8, 230u8, 251u8, 115u8, 37u8, 91u8, 255u8, 85u8, 7u8,
    96u8, 42u8, 48u8, 199u8, 185u8, 53u8, 181u8, 101u8, 44u8, 249u8, 86u8, 222u8, 110u8,
    247u8, 239u8, 175u8, 255u8, 131u8, 99u8,
]);
...
impl crate::columnar::RelationRow for NormalizedContributionExprKernelCallsRow {
    ...
    fn builder_allocation_size() -> usize {
        27_496_usize + size_of::<Self::Builder>()
    }
