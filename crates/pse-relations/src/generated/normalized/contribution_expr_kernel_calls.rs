...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    188u8, 210u8, 39u8, 17u8, 111u8, 193u8, 51u8, 15u8, 166u8, 43u8, 226u8, 129u8, 41u8,
    38u8, 67u8, 69u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "contribution_expr_kernel_calls";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    253u8, 196u8, 250u8, 248u8, 157u8, 152u8, 12u8, 158u8, 197u8, 47u8, 63u8, 117u8,
    119u8, 254u8, 43u8, 20u8, 135u8, 198u8, 233u8, 21u8, 129u8, 26u8, 201u8, 34u8, 78u8,
    100u8, 1u8, 191u8, 136u8, 85u8, 198u8, 33u8,
]);
...
pub struct NormalizedContributionExprKernelCallsRow {
    ///node_id
    pub r#node_id: u64,
    ///kernel_binding_id
...
impl crate::typed::CellCodec for NormalizedContributionExprKernelCallsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedContributionExprKernelCallsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedContributionExprKernelCallsRow {
    fn append(
        &self,
...
pub type Row = NormalizedContributionExprKernelCallsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedContributionExprKernelCallsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedContributionExprKernelCallsBuilder;
impl NormalizedContributionExprKernelCallsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.contribution_expr_kernel_calls".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedContributionExprKernelCallsRow {
    type Builder = NormalizedContributionExprKernelCallsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedContributionExprKernelCallsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedContributionExprKernelCallsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_032_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedContributionExprKernelCallsView<'a> {
...
impl<'a> NormalizedContributionExprKernelCallsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedContributionExprKernelCallsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedContributionExprKernelCallsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedContributionExprKernelCallsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedContributionExprKernelCallsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedContributionExprKernelCallsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedContributionExprKernelCallsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedContributionExprKernelCallsView<'_>,
    ) -> Result<(), crate::RelationError> {
