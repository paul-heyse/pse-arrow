...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    15u8, 253u8, 37u8, 30u8, 103u8, 222u8, 107u8, 173u8, 117u8, 100u8, 20u8, 95u8, 231u8,
    216u8, 121u8, 248u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "guard_expr_smooth_ops";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    240u8, 218u8, 142u8, 121u8, 33u8, 213u8, 8u8, 179u8, 136u8, 111u8, 230u8, 221u8,
    37u8, 243u8, 227u8, 144u8, 220u8, 244u8, 20u8, 207u8, 227u8, 123u8, 24u8, 218u8,
    193u8, 133u8, 39u8, 180u8, 10u8, 9u8, 153u8, 246u8,
]);
...
pub struct NormalizedGuardExprSmoothOpsRow {
    ///node_id
    pub r#node_id: u64,
    ///eps
    pub r#eps: f64,
...
impl crate::typed::CellCodec for NormalizedGuardExprSmoothOpsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedGuardExprSmoothOpsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedGuardExprSmoothOpsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedGuardExprSmoothOpsRow {
    fn append(
        &self,
...
pub type Row = NormalizedGuardExprSmoothOpsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedGuardExprSmoothOpsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedGuardExprSmoothOpsBuilder;
impl NormalizedGuardExprSmoothOpsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.guard_expr_smooth_ops".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedGuardExprSmoothOpsRow {
    type Builder = NormalizedGuardExprSmoothOpsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprSmoothOpsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprSmoothOpsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        41_464_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedGuardExprSmoothOpsView<'a> {
...
impl<'a> NormalizedGuardExprSmoothOpsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprSmoothOpsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprSmoothOpsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedGuardExprSmoothOpsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedGuardExprSmoothOpsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedGuardExprSmoothOpsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedGuardExprSmoothOpsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprSmoothOpsView<'_>,
    ) -> Result<(), crate::RelationError> {
