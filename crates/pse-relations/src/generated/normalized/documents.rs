...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    47u8, 155u8, 2u8, 179u8, 242u8, 83u8, 152u8, 52u8, 154u8, 55u8, 178u8, 140u8, 204u8,
    98u8, 168u8, 161u8, 191u8, 60u8, 193u8, 5u8, 130u8, 143u8, 27u8, 158u8, 109u8, 154u8,
    70u8, 10u8, 20u8, 104u8, 253u8, 19u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDocumentsRow {
    ...
    fn builder_allocation_size() -> usize {
        41_944_usize + size_of::<Self::Builder>()
    }
