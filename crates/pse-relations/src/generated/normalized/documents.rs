...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    223u8, 37u8, 145u8, 219u8, 87u8, 255u8, 112u8, 73u8, 0u8, 234u8, 128u8, 39u8, 24u8,
    113u8, 235u8, 140u8, 194u8, 235u8, 36u8, 11u8, 234u8, 78u8, 89u8, 160u8, 66u8, 152u8,
    233u8, 156u8, 241u8, 173u8, 106u8, 44u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedDocumentsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedDocumentsRow {
    type Builder = NormalizedDocumentsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDocumentsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDocumentsView::from_checked(batch)?.rows()
    }
...
impl<'a> NormalizedDocumentsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDocumentsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDocumentsRow {
...
impl NormalizedDocumentsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDocumentsView<'_>,
    ) -> Result<(), crate::RelationError> {
