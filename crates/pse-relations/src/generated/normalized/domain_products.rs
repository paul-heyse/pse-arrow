...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    124u8, 190u8, 179u8, 160u8, 226u8, 171u8, 193u8, 15u8, 22u8, 158u8, 107u8, 213u8,
    65u8, 250u8, 60u8, 142u8, 56u8, 236u8, 49u8, 17u8, 62u8, 195u8, 105u8, 130u8, 145u8,
    51u8, 224u8, 25u8, 30u8, 185u8, 86u8, 61u8,
]);
...
impl crate::typed::CellCodec for NormalizedDomainProductsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedDomainProductsRow)));
        };
            ...
            r#product_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedDomainProductsRow),
                    ))?,
            )?,
            r#domain_ids: <Vec<
                pse_ids::SemanticId,
...
impl NormalizedDomainProductsRow {
...
impl crate::columnar::RelationRow for NormalizedDomainProductsRow {
    ...
    fn builder_allocation_size() -> usize {
        41_072_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedDomainProductsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDomainProductsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedDomainProductsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDomainProductsView<'_>,
    ) -> Result<(), crate::RelationError> {
