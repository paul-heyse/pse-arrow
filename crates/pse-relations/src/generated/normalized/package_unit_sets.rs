...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    159u8, 189u8, 136u8, 203u8, 231u8, 241u8, 19u8, 150u8, 11u8, 230u8, 84u8, 6u8, 249u8,
    216u8, 122u8, 232u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    88u8, 15u8, 186u8, 128u8, 179u8, 122u8, 222u8, 177u8, 245u8, 115u8, 162u8, 186u8,
    49u8, 97u8, 252u8, 250u8, 209u8, 164u8, 249u8, 218u8, 102u8, 252u8, 186u8, 10u8,
    94u8, 144u8, 84u8, 249u8, 237u8, 54u8, 136u8, 36u8,
]);
...
pub struct NormalizedPackageUnitSetsRow {
    ///package_id
    pub r#package_id: pse_ids::SemanticId,
    ///unit_set_id
    pub r#unit_set_id: pse_ids::SemanticId,
}
impl crate::typed::CellCodec for NormalizedPackageUnitSetsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedPackageUnitSetsRow)));
        };
            ...
            r#package_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedPackageUnitSetsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedPackageUnitSetsRow {
    fn append(
        &self,
...
pub type Row = NormalizedPackageUnitSetsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedPackageUnitSetsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedPackageUnitSetsBuilder;
impl NormalizedPackageUnitSetsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.package_unit_sets".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedPackageUnitSetsRow {
    type Builder = NormalizedPackageUnitSetsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedPackageUnitSetsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedPackageUnitSetsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        33_568_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedPackageUnitSetsView<'a> {
...
impl<'a> NormalizedPackageUnitSetsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedPackageUnitSetsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedPackageUnitSetsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedPackageUnitSetsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedPackageUnitSetsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedPackageUnitSetsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedPackageUnitSetsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedPackageUnitSetsView<'_>,
    ) -> Result<(), crate::RelationError> {
