...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    105u8, 28u8, 139u8, 179u8, 76u8, 94u8, 10u8, 5u8, 20u8, 203u8, 18u8, 245u8, 201u8,
    128u8, 28u8, 73u8, 0u8, 52u8, 57u8, 109u8, 111u8, 143u8, 215u8, 167u8, 247u8, 159u8,
    222u8, 238u8, 111u8, 74u8, 165u8, 221u8,
]);
...
impl crate::columnar::RelationRow for NormalizedPackageUnitSetsRow {
    ...
    fn builder_allocation_size() -> usize {
        31_808_usize + size_of::<Self::Builder>()
    }
