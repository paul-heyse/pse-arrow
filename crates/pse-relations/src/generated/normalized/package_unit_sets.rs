...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    69u8, 113u8, 145u8, 32u8, 84u8, 90u8, 87u8, 204u8, 150u8, 97u8, 186u8, 51u8, 227u8,
    239u8, 66u8, 229u8, 166u8, 162u8, 70u8, 115u8, 68u8, 99u8, 47u8, 160u8, 56u8, 245u8,
    219u8, 83u8, 242u8, 51u8, 74u8, 6u8,
]);
...
impl crate::columnar::RelationRow for NormalizedPackageUnitSetsRow {
    ...
    fn builder_allocation_size() -> usize {
        31_344_usize + size_of::<Self::Builder>()
    }
