...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    195u8, 136u8, 255u8, 105u8, 188u8, 29u8, 106u8, 159u8, 110u8, 155u8, 38u8, 177u8,
    183u8, 152u8, 130u8, 190u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "display_expr_integrals";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    250u8, 107u8, 212u8, 240u8, 122u8, 215u8, 231u8, 146u8, 218u8, 96u8, 195u8, 112u8,
    147u8, 43u8, 32u8, 240u8, 238u8, 173u8, 16u8, 183u8, 3u8, 72u8, 174u8, 206u8, 210u8,
    201u8, 166u8, 22u8, 9u8, 157u8, 252u8, 104u8,
]);
...
pub struct NormalizedDisplayExprIntegralsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for NormalizedDisplayExprIntegralsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedDisplayExprIntegralsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedDisplayExprIntegralsRow),
                    ))?,
            )?,
            r#domain_id: <Option<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprIntegralsRow {
    fn append(
        &self,
...
pub type Row = NormalizedDisplayExprIntegralsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedDisplayExprIntegralsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedDisplayExprIntegralsBuilder;
impl NormalizedDisplayExprIntegralsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.display_expr_integrals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedDisplayExprIntegralsRow {
    type Builder = NormalizedDisplayExprIntegralsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprIntegralsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprIntegralsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        85_928_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedDisplayExprIntegralsView<'a> {
...
impl<'a> NormalizedDisplayExprIntegralsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprIntegralsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprIntegralsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedDisplayExprIntegralsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedDisplayExprIntegralsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDisplayExprIntegralsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedDisplayExprIntegralsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprIntegralsView<'_>,
    ) -> Result<(), crate::RelationError> {
