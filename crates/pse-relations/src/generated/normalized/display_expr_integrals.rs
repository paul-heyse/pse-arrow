...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    155u8, 83u8, 179u8, 37u8, 238u8, 40u8, 191u8, 188u8, 41u8, 242u8, 101u8, 251u8, 65u8,
    55u8, 209u8, 145u8, 159u8, 250u8, 46u8, 146u8, 56u8, 52u8, 201u8, 152u8, 64u8, 206u8,
    52u8, 195u8, 193u8, 40u8, 102u8, 80u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprIntegralsRow {
    ...
    fn builder_allocation_size() -> usize {
        85_464_usize + size_of::<Self::Builder>()
    }
