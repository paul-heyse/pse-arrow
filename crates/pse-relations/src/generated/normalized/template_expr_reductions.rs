...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    115u8, 150u8, 178u8, 161u8, 174u8, 109u8, 28u8, 185u8, 246u8, 177u8, 212u8, 227u8,
    245u8, 201u8, 119u8, 208u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_expr_reductions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    247u8, 191u8, 201u8, 242u8, 172u8, 247u8, 56u8, 141u8, 147u8, 51u8, 216u8, 35u8,
    241u8, 90u8, 157u8, 225u8, 33u8, 92u8, 6u8, 170u8, 137u8, 108u8, 199u8, 78u8, 64u8,
    35u8, 25u8, 23u8, 229u8, 225u8, 5u8, 148u8,
]);
...
pub struct NormalizedTemplateExprReductionsRow {
    ///node_id
    pub r#node_id: u64,
    ///kind
...
impl crate::typed::CellCodec for NormalizedTemplateExprReductionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateExprReductionsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateExprReductionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprReductionsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateExprReductionsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateExprReductionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateExprReductionsBuilder;
impl NormalizedTemplateExprReductionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_expr_reductions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateExprReductionsRow {
    type Builder = NormalizedTemplateExprReductionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprReductionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprReductionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        89_240_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateExprReductionsView<'a> {
...
impl<'a> NormalizedTemplateExprReductionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprReductionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprReductionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateExprReductionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateExprReductionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateExprReductionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateExprReductionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprReductionsView<'_>,
    ) -> Result<(), crate::RelationError> {
