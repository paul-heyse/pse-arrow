...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    189u8, 230u8, 22u8, 196u8, 88u8, 131u8, 158u8, 147u8, 127u8, 106u8, 107u8, 161u8,
    15u8, 3u8, 102u8, 45u8, 179u8, 255u8, 81u8, 122u8, 107u8, 13u8, 2u8, 150u8, 93u8,
    64u8, 192u8, 12u8, 225u8, 3u8, 82u8, 136u8,
]);
...
impl crate::columnar::RelationRow for NormalizedGuardExprArgsRow {
    ...
    fn builder_allocation_size() -> usize {
        22_816_usize + size_of::<Self::Builder>()
    }
