...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    229u8, 37u8, 48u8, 217u8, 225u8, 173u8, 107u8, 38u8, 150u8, 181u8, 204u8, 248u8,
    120u8, 227u8, 112u8, 220u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_expr_implicit_refs";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    205u8, 222u8, 234u8, 168u8, 55u8, 255u8, 85u8, 141u8, 186u8, 130u8, 83u8, 99u8,
    181u8, 14u8, 188u8, 179u8, 167u8, 103u8, 164u8, 56u8, 246u8, 146u8, 155u8, 218u8,
    107u8, 7u8, 4u8, 210u8, 43u8, 201u8, 204u8, 206u8,
]);
...
pub struct NormalizedInstanceExprImplicitRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///implicit_system_id
...
impl crate::typed::CellCodec for NormalizedInstanceExprImplicitRefsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedInstanceExprImplicitRefsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedInstanceExprImplicitRefsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprImplicitRefsRow {
    fn append(
        &self,
...
pub type Row = NormalizedInstanceExprImplicitRefsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstanceExprImplicitRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstanceExprImplicitRefsBuilder;
impl NormalizedInstanceExprImplicitRefsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instance_expr_implicit_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstanceExprImplicitRefsRow {
    type Builder = NormalizedInstanceExprImplicitRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprImplicitRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprImplicitRefsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedInstanceExprImplicitRefsView<'a> {
...
impl<'a> NormalizedInstanceExprImplicitRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprImplicitRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprImplicitRefsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedInstanceExprImplicitRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstanceExprImplicitRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstanceExprImplicitRefsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedInstanceExprImplicitRefsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprImplicitRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
