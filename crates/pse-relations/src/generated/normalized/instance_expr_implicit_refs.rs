...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    139u8, 146u8, 34u8, 196u8, 20u8, 165u8, 233u8, 92u8, 82u8, 83u8, 147u8, 35u8, 35u8,
    43u8, 90u8, 233u8, 215u8, 145u8, 186u8, 123u8, 70u8, 214u8, 96u8, 169u8, 61u8, 232u8,
    35u8, 216u8, 167u8, 209u8, 129u8, 210u8,
]);
...
impl<'a> NormalizedInstanceExprImplicitRefsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedInstanceExprImplicitRefsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedInstanceExprImplicitRefsBuilder {
    rows: Vec<NormalizedInstanceExprImplicitRefsRow>,
}
impl NormalizedInstanceExprImplicitRefsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedInstanceExprImplicitRefsRow::into_cells)
            .collect::<Vec<_>>();
