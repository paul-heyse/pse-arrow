...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    78u8, 237u8, 68u8, 0u8, 222u8, 241u8, 85u8, 236u8, 80u8, 223u8, 210u8, 146u8, 186u8,
    197u8, 156u8, 248u8, 10u8, 223u8, 179u8, 22u8, 225u8, 87u8, 199u8, 24u8, 58u8, 54u8,
    135u8, 3u8, 161u8, 126u8, 176u8, 91u8,
]);
