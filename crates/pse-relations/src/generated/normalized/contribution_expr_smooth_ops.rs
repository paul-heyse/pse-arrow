...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    151u8, 9u8, 91u8, 74u8, 254u8, 98u8, 158u8, 239u8, 176u8, 151u8, 101u8, 69u8, 156u8,
    166u8, 22u8, 195u8, 157u8, 121u8, 125u8, 36u8, 233u8, 201u8, 21u8, 79u8, 162u8, 9u8,
    132u8, 103u8, 60u8, 55u8, 209u8, 33u8,
]);
...
impl crate::columnar::RelationRow for NormalizedContributionExprSmoothOpsRow {
    ...
    fn builder_allocation_size() -> usize {
        41_056_usize + size_of::<Self::Builder>()
    }
