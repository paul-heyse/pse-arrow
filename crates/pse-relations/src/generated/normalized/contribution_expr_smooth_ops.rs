...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    181u8, 150u8, 217u8, 163u8, 118u8, 66u8, 135u8, 159u8, 5u8, 226u8, 240u8, 224u8,
    14u8, 164u8, 220u8, 247u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "contribution_expr_smooth_ops";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    16u8, 227u8, 49u8, 190u8, 101u8, 67u8, 202u8, 55u8, 53u8, 40u8, 14u8, 149u8, 179u8,
    113u8, 193u8, 141u8, 25u8, 71u8, 15u8, 163u8, 194u8, 153u8, 254u8, 62u8, 78u8, 134u8,
    162u8, 76u8, 188u8, 241u8, 146u8, 171u8,
]);
...
pub struct NormalizedContributionExprSmoothOpsRow {
    ///node_id
    pub r#node_id: u64,
    ///eps
    pub r#eps: f64,
...
impl crate::typed::CellCodec for NormalizedContributionExprSmoothOpsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedContributionExprSmoothOpsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedContributionExprSmoothOpsRow {
    fn append(
        &self,
...
pub type Row = NormalizedContributionExprSmoothOpsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedContributionExprSmoothOpsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedContributionExprSmoothOpsBuilder;
impl NormalizedContributionExprSmoothOpsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.contribution_expr_smooth_ops".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedContributionExprSmoothOpsRow {
    type Builder = NormalizedContributionExprSmoothOpsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedContributionExprSmoothOpsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedContributionExprSmoothOpsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        41_520_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedContributionExprSmoothOpsView<'a> {
...
impl<'a> NormalizedContributionExprSmoothOpsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedContributionExprSmoothOpsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedContributionExprSmoothOpsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedContributionExprSmoothOpsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedContributionExprSmoothOpsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedContributionExprSmoothOpsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedContributionExprSmoothOpsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedContributionExprSmoothOpsView<'_>,
    ) -> Result<(), crate::RelationError> {
