...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    119u8, 153u8, 164u8, 139u8, 173u8, 213u8, 41u8, 248u8, 125u8, 74u8, 196u8, 57u8,
    46u8, 183u8, 135u8, 202u8, 239u8, 28u8, 167u8, 5u8, 253u8, 72u8, 216u8, 93u8, 228u8,
    218u8, 38u8, 22u8, 70u8, 41u8, 215u8, 174u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedDefaultScalingRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedDefaultScalingRow {
    type Builder = NormalizedDefaultScalingBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDefaultScalingBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDefaultScalingView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        48_496_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedDefaultScalingView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDefaultScalingRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDefaultScalingRow {
...
impl NormalizedDefaultScalingBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDefaultScalingView<'_>,
    ) -> Result<(), crate::RelationError> {
