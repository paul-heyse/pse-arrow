...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    37u8, 119u8, 173u8, 9u8, 220u8, 216u8, 190u8, 17u8, 68u8, 20u8, 115u8, 4u8, 233u8,
    141u8, 3u8, 43u8, 217u8, 0u8, 233u8, 48u8, 117u8, 210u8, 60u8, 210u8, 82u8, 70u8,
    129u8, 50u8, 191u8, 110u8, 218u8, 55u8,
]);
...
impl crate::columnar::RelationRow for NormalizedHenryDeclarationsRow {
    ...
    fn builder_allocation_size() -> usize {
        58_680_usize + size_of::<Self::Builder>()
    }
