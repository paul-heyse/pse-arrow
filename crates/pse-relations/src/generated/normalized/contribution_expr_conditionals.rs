...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    61u8, 173u8, 16u8, 176u8, 67u8, 196u8, 46u8, 34u8, 185u8, 105u8, 52u8, 128u8, 216u8,
    202u8, 27u8, 15u8, 214u8, 109u8, 69u8, 124u8, 68u8, 209u8, 111u8, 82u8, 101u8, 213u8,
    167u8, 160u8, 7u8, 34u8, 215u8, 154u8,
]);
...
impl<'a> NormalizedContributionExprConditionalsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedContributionExprConditionalsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedContributionExprConditionalsBuilder {
    rows: Vec<NormalizedContributionExprConditionalsRow>,
}
impl NormalizedContributionExprConditionalsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedContributionExprConditionalsRow::into_cells)
            .collect::<Vec<_>>();
