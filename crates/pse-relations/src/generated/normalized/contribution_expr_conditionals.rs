...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    160u8, 132u8, 119u8, 167u8, 96u8, 95u8, 27u8, 150u8, 12u8, 221u8, 206u8, 228u8, 61u8,
    60u8, 25u8, 92u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "contribution_expr_conditionals";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    39u8, 95u8, 64u8, 83u8, 148u8, 153u8, 251u8, 136u8, 209u8, 122u8, 26u8, 142u8, 101u8,
    75u8, 225u8, 183u8, 35u8, 147u8, 75u8, 15u8, 65u8, 243u8, 204u8, 2u8, 164u8, 141u8,
    205u8, 47u8, 169u8, 163u8, 221u8, 78u8,
]);
...
pub struct NormalizedContributionExprConditionalsRow {
    ///node_id
    pub r#node_id: u64,
    ///guard_node_id
...
impl crate::typed::CellCodec for NormalizedContributionExprConditionalsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedContributionExprConditionalsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedContributionExprConditionalsRow {
    fn append(
        &self,
...
pub type Row = NormalizedContributionExprConditionalsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedContributionExprConditionalsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedContributionExprConditionalsBuilder;
impl NormalizedContributionExprConditionalsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.contribution_expr_conditionals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedContributionExprConditionalsRow {
    type Builder = NormalizedContributionExprConditionalsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedContributionExprConditionalsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedContributionExprConditionalsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        33_696_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedContributionExprConditionalsView<'a> {
...
impl<'a> NormalizedContributionExprConditionalsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedContributionExprConditionalsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedContributionExprConditionalsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedContributionExprConditionalsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedContributionExprConditionalsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedContributionExprConditionalsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedContributionExprConditionalsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedContributionExprConditionalsView<'_>,
    ) -> Result<(), crate::RelationError> {
