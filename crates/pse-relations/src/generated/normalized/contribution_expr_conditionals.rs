...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    100u8, 100u8, 99u8, 183u8, 212u8, 33u8, 14u8, 115u8, 9u8, 16u8, 112u8, 24u8, 139u8,
    36u8, 251u8, 77u8, 241u8, 136u8, 141u8, 32u8, 21u8, 3u8, 20u8, 202u8, 227u8, 123u8,
    28u8, 107u8, 215u8, 227u8, 143u8, 154u8,
]);
...
impl crate::columnar::RelationRow for NormalizedContributionExprConditionalsRow {
    ...
    fn builder_allocation_size() -> usize {
        33_232_usize + size_of::<Self::Builder>()
    }
