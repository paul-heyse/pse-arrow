...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    156u8, 88u8, 44u8, 61u8, 114u8, 202u8, 179u8, 157u8, 45u8, 30u8, 59u8, 51u8, 124u8,
    215u8, 146u8, 81u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "contribution_expr_integrals";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    106u8, 223u8, 183u8, 24u8, 162u8, 236u8, 82u8, 150u8, 219u8, 32u8, 41u8, 191u8,
    103u8, 19u8, 176u8, 16u8, 200u8, 3u8, 86u8, 114u8, 238u8, 115u8, 242u8, 13u8, 244u8,
    127u8, 184u8, 121u8, 94u8, 241u8, 171u8, 208u8,
]);
...
pub struct NormalizedContributionExprIntegralsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for NormalizedContributionExprIntegralsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedContributionExprIntegralsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedContributionExprIntegralsRow {
    fn append(
        &self,
...
pub type Row = NormalizedContributionExprIntegralsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedContributionExprIntegralsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedContributionExprIntegralsBuilder;
impl NormalizedContributionExprIntegralsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.contribution_expr_integrals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedContributionExprIntegralsRow {
    type Builder = NormalizedContributionExprIntegralsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedContributionExprIntegralsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedContributionExprIntegralsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        85_968_usize + size_of::<Self::Builder>()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            if (self.r#quadrature_policy_id).is_some() {
                crate::columnar::allocation_add(
                    1,
                    Ok::<usize, crate::RelationError>(16usize)?,
                )
...
impl<'a> NormalizedContributionExprIntegralsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            quadrature_policy_id_column: crate::columnar::array::<
                arrow_array::FixedSizeBinaryArray,
    ...
    pub const fn quadrature_policy_id_column(
        &self,
    ) -> &'a arrow_array::FixedSizeBinaryArray {
        self.quadrature_policy_id_column
    }
    #[doc = concat!(
    ...
    pub fn quadrature_policy_id_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedContributionExprIntegralsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedContributionExprIntegralsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedContributionExprIntegralsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedContributionExprIntegralsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedContributionExprIntegralsView<'_>,
    ) -> Result<(), crate::RelationError> {
