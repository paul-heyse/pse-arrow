...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    242u8, 233u8, 225u8, 79u8, 112u8, 68u8, 0u8, 82u8, 120u8, 80u8, 152u8, 231u8, 104u8,
    220u8, 7u8, 36u8, 71u8, 250u8, 83u8, 126u8, 52u8, 69u8, 216u8, 24u8, 12u8, 43u8,
    108u8, 243u8, 64u8, 122u8, 17u8, 19u8,
]);
...
impl crate::columnar::RelationRow for NormalizedInstanceExprDerivativesRow {
    ...
    fn builder_allocation_size() -> usize {
        46_848_usize + size_of::<Self::Builder>()
    }
