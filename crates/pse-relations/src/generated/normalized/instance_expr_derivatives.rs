...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    29u8, 142u8, 235u8, 246u8, 226u8, 89u8, 78u8, 161u8, 192u8, 150u8, 209u8, 252u8,
    122u8, 3u8, 11u8, 146u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_expr_derivatives";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    191u8, 177u8, 86u8, 161u8, 81u8, 201u8, 117u8, 60u8, 224u8, 111u8, 108u8, 50u8,
    145u8, 225u8, 241u8, 205u8, 149u8, 236u8, 200u8, 167u8, 205u8, 97u8, 66u8, 158u8,
    10u8, 72u8, 16u8, 188u8, 249u8, 83u8, 190u8, 243u8,
]);
...
pub struct NormalizedInstanceExprDerivativesRow {
    ///node_id
    pub r#node_id: u64,
    ///wrt_domain_id
...
impl crate::typed::CellCodec for NormalizedInstanceExprDerivativesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedInstanceExprDerivativesRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedInstanceExprDerivativesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprDerivativesRow {
    fn append(
        &self,
...
pub type Row = NormalizedInstanceExprDerivativesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstanceExprDerivativesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstanceExprDerivativesBuilder;
impl NormalizedInstanceExprDerivativesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instance_expr_derivatives".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstanceExprDerivativesRow {
    type Builder = NormalizedInstanceExprDerivativesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprDerivativesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprDerivativesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        46_384_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedInstanceExprDerivativesView<'a> {
...
impl<'a> NormalizedInstanceExprDerivativesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprDerivativesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprDerivativesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedInstanceExprDerivativesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstanceExprDerivativesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstanceExprDerivativesBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedInstanceExprDerivativesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprDerivativesView<'_>,
    ) -> Result<(), crate::RelationError> {
