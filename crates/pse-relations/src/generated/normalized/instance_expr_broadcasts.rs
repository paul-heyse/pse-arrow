...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    232u8, 116u8, 180u8, 243u8, 63u8, 36u8, 176u8, 194u8, 163u8, 112u8, 28u8, 170u8,
    174u8, 185u8, 11u8, 149u8, 127u8, 185u8, 194u8, 185u8, 150u8, 2u8, 78u8, 209u8, 28u8,
    82u8, 34u8, 196u8, 44u8, 244u8, 179u8, 199u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprBroadcastsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedInstanceExprBroadcastsRow {
    type Builder = NormalizedInstanceExprBroadcastsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprBroadcastsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprBroadcastsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        51_848_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedInstanceExprBroadcastsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprBroadcastsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprBroadcastsRow {
...
impl NormalizedInstanceExprBroadcastsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprBroadcastsView<'_>,
    ) -> Result<(), crate::RelationError> {
