...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    104u8, 244u8, 149u8, 106u8, 62u8, 27u8, 66u8, 172u8, 148u8, 64u8, 229u8, 72u8, 252u8,
    209u8, 226u8, 145u8, 190u8, 78u8, 77u8, 100u8, 168u8, 9u8, 237u8, 30u8, 164u8, 24u8,
    13u8, 22u8, 237u8, 88u8, 103u8, 134u8,
]);
...
impl crate::columnar::RelationRow for NormalizedInstanceExprBroadcastsRow {
    ...
    fn builder_allocation_size() -> usize {
        51_384_usize + size_of::<Self::Builder>()
    }
