...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    173u8, 157u8, 5u8, 5u8, 55u8, 75u8, 9u8, 149u8, 234u8, 176u8, 173u8, 197u8, 83u8,
    103u8, 105u8, 7u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_expr_smooth_ops";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    99u8, 98u8, 211u8, 199u8, 138u8, 67u8, 98u8, 213u8, 237u8, 42u8, 212u8, 159u8, 31u8,
    94u8, 216u8, 159u8, 73u8, 51u8, 179u8, 76u8, 193u8, 158u8, 24u8, 250u8, 4u8, 35u8,
    84u8, 27u8, 67u8, 142u8, 239u8, 56u8,
]);
...
pub struct NormalizedInstanceExprSmoothOpsRow {
    ///node_id
    pub r#node_id: u64,
    ///eps
    pub r#eps: f64,
...
impl crate::typed::CellCodec for NormalizedInstanceExprSmoothOpsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedInstanceExprSmoothOpsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedInstanceExprSmoothOpsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprSmoothOpsRow {
    fn append(
        &self,
...
pub type Row = NormalizedInstanceExprSmoothOpsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstanceExprSmoothOpsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstanceExprSmoothOpsBuilder;
impl NormalizedInstanceExprSmoothOpsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instance_expr_smooth_ops".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstanceExprSmoothOpsRow {
    type Builder = NormalizedInstanceExprSmoothOpsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprSmoothOpsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprSmoothOpsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedInstanceExprSmoothOpsView<'a> {
...
impl<'a> NormalizedInstanceExprSmoothOpsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprSmoothOpsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprSmoothOpsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedInstanceExprSmoothOpsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstanceExprSmoothOpsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstanceExprSmoothOpsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedInstanceExprSmoothOpsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprSmoothOpsView<'_>,
    ) -> Result<(), crate::RelationError> {
