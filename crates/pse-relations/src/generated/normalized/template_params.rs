...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    8u8, 38u8, 24u8, 79u8, 3u8, 229u8, 31u8, 165u8, 249u8, 72u8, 164u8, 72u8, 123u8,
    220u8, 134u8, 227u8, 136u8, 211u8, 104u8, 194u8, 58u8, 33u8, 70u8, 31u8, 165u8,
    192u8, 250u8, 161u8, 120u8, 55u8, 75u8, 109u8,
]);
