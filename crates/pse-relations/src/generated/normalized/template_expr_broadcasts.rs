...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    6u8, 243u8, 218u8, 153u8, 22u8, 3u8, 243u8, 1u8, 222u8, 143u8, 23u8, 76u8, 65u8,
    63u8, 26u8, 214u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_expr_broadcasts";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    81u8, 113u8, 18u8, 189u8, 27u8, 180u8, 42u8, 123u8, 219u8, 60u8, 71u8, 193u8, 179u8,
    12u8, 238u8, 141u8, 78u8, 62u8, 207u8, 101u8, 165u8, 57u8, 189u8, 115u8, 7u8, 243u8,
    212u8, 247u8, 221u8, 229u8, 74u8, 187u8,
]);
...
pub struct NormalizedTemplateExprBroadcastsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for NormalizedTemplateExprBroadcastsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateExprBroadcastsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateExprBroadcastsRow),
                    ))?,
            )?,
            r#domain_id: <Option<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprBroadcastsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateExprBroadcastsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateExprBroadcastsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateExprBroadcastsBuilder;
impl NormalizedTemplateExprBroadcastsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_expr_broadcasts".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateExprBroadcastsRow {
    type Builder = NormalizedTemplateExprBroadcastsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprBroadcastsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprBroadcastsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateExprBroadcastsView<'a> {
...
impl<'a> NormalizedTemplateExprBroadcastsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprBroadcastsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprBroadcastsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateExprBroadcastsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateExprBroadcastsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateExprBroadcastsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateExprBroadcastsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprBroadcastsView<'_>,
    ) -> Result<(), crate::RelationError> {
