...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    169u8, 97u8, 63u8, 187u8, 244u8, 143u8, 240u8, 161u8, 75u8, 125u8, 250u8, 3u8, 9u8,
    226u8, 110u8, 212u8, 218u8, 128u8, 38u8, 178u8, 208u8, 221u8, 96u8, 186u8, 52u8,
    29u8, 110u8, 83u8, 202u8, 241u8, 140u8, 70u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateFeaturesRow {
    ...
    fn builder_allocation_size() -> usize {
        67_384_usize + size_of::<Self::Builder>()
    }
