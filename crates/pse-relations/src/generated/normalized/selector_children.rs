...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    45u8, 108u8, 43u8, 99u8, 12u8, 144u8, 148u8, 89u8, 214u8, 47u8, 97u8, 142u8, 47u8,
    90u8, 208u8, 48u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "selector_children";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    72u8, 40u8, 115u8, 15u8, 35u8, 70u8, 241u8, 219u8, 219u8, 194u8, 83u8, 97u8, 163u8,
    0u8, 50u8, 97u8, 217u8, 132u8, 148u8, 2u8, 100u8, 216u8, 63u8, 249u8, 43u8, 251u8,
    247u8, 167u8, 116u8, 14u8, 96u8, 58u8,
]);
...
pub struct NormalizedSelectorChildrenRow {
    ///source_term_id
...
impl crate::typed::CellCodec for NormalizedSelectorChildrenRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#source_ordinal),
                crate::typed::CellCodec::into_cell(self.r#child_term_id),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedSelectorChildrenRow)),
            );
        };
        ...
        Ok(Self {
            ...
            r#child_term_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedSelectorChildrenRow),
...
impl crate::columnar::ArrowValue for NormalizedSelectorChildrenRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(
            &self.r#source_ordinal,
            children[2usize].as_mut(),
        )?;
        crate::columnar::ArrowValue::append(
            &self.r#child_term_id,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#child_term_id: <pse_ids::SemanticId as crate::columnar::ArrowValue>::read(
...
pub type Row = NormalizedSelectorChildrenRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedSelectorChildrenView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedSelectorChildrenBuilder;
impl NormalizedSelectorChildrenRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.selector_children".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedSelectorChildrenRow {
    type Builder = NormalizedSelectorChildrenBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedSelectorChildrenBuilder::with_registry(registry, capacity)
    }
    ...
    fn builder_allocation_size() -> usize {
        49_056_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedSelectorChildrenView<'a> {
    ...
    pub fn source_ordinal_field(&self) -> &'a crate::FieldRef {
    ...
    pub const fn child_term_id_column(&self) -> &'a arrow_array::FixedSizeBinaryArray {
        self.child_term_id_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "child_term_id", "`.")]
    pub fn child_term_id_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedSelectorChildrenRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedSelectorChildrenRow {
            r#source_term_id: crate::columnar::ArrowValue::read(
                self.source_term_id_column,
                index,
            )?,
            r#position: crate::columnar::ArrowValue::read(self.position_column, index)?,
            r#source_ordinal: crate::columnar::ArrowValue::read(
                self.source_ordinal_column,
                index,
            )?,
            r#child_term_id: crate::columnar::ArrowValue::read(
                self.child_term_id_column,
                index,
            )?,
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedSelectorChildrenRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedSelectorChildrenBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedSelectorChildrenBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedSelectorChildrenView<'_>,
    ) -> Result<(), crate::RelationError> {
