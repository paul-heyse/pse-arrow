...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    62u8, 22u8, 35u8, 33u8, 105u8, 150u8, 7u8, 91u8, 144u8, 158u8, 102u8, 198u8, 118u8,
    156u8, 17u8, 234u8, 191u8, 21u8, 243u8, 39u8, 134u8, 115u8, 159u8, 177u8, 80u8,
    224u8, 31u8, 19u8, 211u8, 129u8, 235u8, 238u8,
]);
...
impl crate::columnar::RelationRow for NormalizedContinuousDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        66_688_usize + size_of::<Self::Builder>()
    }
