...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    78u8, 101u8, 97u8, 182u8, 47u8, 119u8, 218u8, 0u8, 32u8, 251u8, 30u8, 108u8, 11u8,
    251u8, 107u8, 171u8, 108u8, 0u8, 33u8, 56u8, 185u8, 236u8, 10u8, 164u8, 114u8, 7u8,
    196u8, 10u8, 44u8, 127u8, 96u8, 125u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprConditionalsRow {
    ...
    fn builder_allocation_size() -> usize {
        33_192_usize + size_of::<Self::Builder>()
    }
