...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    47u8, 34u8, 52u8, 239u8, 157u8, 94u8, 202u8, 225u8, 171u8, 191u8, 154u8, 13u8, 222u8,
    246u8, 2u8, 132u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "display_expr_conditionals";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    237u8, 5u8, 232u8, 194u8, 238u8, 227u8, 230u8, 124u8, 29u8, 109u8, 213u8, 189u8,
    212u8, 130u8, 255u8, 176u8, 142u8, 236u8, 203u8, 25u8, 218u8, 65u8, 205u8, 192u8,
    32u8, 64u8, 0u8, 1u8, 15u8, 95u8, 224u8, 57u8,
]);
...
pub struct NormalizedDisplayExprConditionalsRow {
    ///node_id
    pub r#node_id: u64,
    ///guard_node_id
...
impl crate::typed::CellCodec for NormalizedDisplayExprConditionalsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedDisplayExprConditionalsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedDisplayExprConditionalsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprConditionalsRow {
    fn append(
        &self,
...
pub type Row = NormalizedDisplayExprConditionalsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedDisplayExprConditionalsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedDisplayExprConditionalsBuilder;
impl NormalizedDisplayExprConditionalsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.display_expr_conditionals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedDisplayExprConditionalsRow {
    type Builder = NormalizedDisplayExprConditionalsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprConditionalsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprConditionalsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        33_656_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedDisplayExprConditionalsView<'a> {
...
impl<'a> NormalizedDisplayExprConditionalsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprConditionalsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprConditionalsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedDisplayExprConditionalsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedDisplayExprConditionalsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDisplayExprConditionalsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedDisplayExprConditionalsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprConditionalsView<'_>,
    ) -> Result<(), crate::RelationError> {
