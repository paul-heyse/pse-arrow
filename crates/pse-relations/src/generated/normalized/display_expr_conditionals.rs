...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    31u8, 111u8, 204u8, 181u8, 141u8, 187u8, 216u8, 32u8, 14u8, 124u8, 173u8, 152u8,
    125u8, 224u8, 216u8, 23u8, 128u8, 5u8, 198u8, 129u8, 39u8, 51u8, 207u8, 226u8, 215u8,
    93u8, 188u8, 118u8, 137u8, 130u8, 159u8, 149u8,
]);
...
impl<'a> NormalizedDisplayExprConditionalsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedDisplayExprConditionalsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedDisplayExprConditionalsBuilder {
    rows: Vec<NormalizedDisplayExprConditionalsRow>,
}
impl NormalizedDisplayExprConditionalsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedDisplayExprConditionalsRow::into_cells)
            .collect::<Vec<_>>();
