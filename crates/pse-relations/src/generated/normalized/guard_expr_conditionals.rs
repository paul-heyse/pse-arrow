...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    181u8, 88u8, 232u8, 0u8, 90u8, 52u8, 70u8, 104u8, 252u8, 195u8, 86u8, 24u8, 102u8,
    198u8, 85u8, 100u8, 76u8, 142u8, 19u8, 237u8, 84u8, 193u8, 50u8, 220u8, 95u8, 91u8,
    47u8, 218u8, 122u8, 81u8, 21u8, 100u8,
]);
...
impl<'a> NormalizedGuardExprConditionalsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedGuardExprConditionalsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedGuardExprConditionalsBuilder {
    rows: Vec<NormalizedGuardExprConditionalsRow>,
}
impl NormalizedGuardExprConditionalsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedGuardExprConditionalsRow::into_cells)
            .collect::<Vec<_>>();
