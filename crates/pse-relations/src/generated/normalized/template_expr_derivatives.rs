...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    132u8, 24u8, 40u8, 57u8, 109u8, 175u8, 134u8, 134u8, 187u8, 203u8, 244u8, 231u8,
    173u8, 14u8, 143u8, 121u8, 119u8, 129u8, 138u8, 241u8, 23u8, 68u8, 31u8, 107u8,
    101u8, 175u8, 65u8, 163u8, 231u8, 237u8, 0u8, 156u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprDerivativesRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedTemplateExprDerivativesRow {
    type Builder = NormalizedTemplateExprDerivativesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprDerivativesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprDerivativesView::from_checked(batch)?.rows()
    }
...
impl<'a> NormalizedTemplateExprDerivativesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprDerivativesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprDerivativesRow {
...
impl NormalizedTemplateExprDerivativesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprDerivativesView<'_>,
    ) -> Result<(), crate::RelationError> {
