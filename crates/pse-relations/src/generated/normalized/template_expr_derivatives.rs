...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    231u8, 74u8, 64u8, 135u8, 105u8, 84u8, 12u8, 166u8, 20u8, 190u8, 169u8, 199u8, 168u8,
    83u8, 7u8, 131u8, 4u8, 252u8, 86u8, 79u8, 37u8, 78u8, 250u8, 0u8, 222u8, 177u8,
    222u8, 111u8, 95u8, 223u8, 139u8, 248u8,
]);
