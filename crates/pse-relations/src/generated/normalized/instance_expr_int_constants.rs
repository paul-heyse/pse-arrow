...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    61u8, 59u8, 25u8, 56u8, 86u8, 154u8, 176u8, 136u8, 210u8, 210u8, 210u8, 92u8, 200u8,
    118u8, 42u8, 241u8, 184u8, 243u8, 165u8, 75u8, 72u8, 196u8, 195u8, 253u8, 172u8,
    141u8, 224u8, 182u8, 226u8, 230u8, 245u8, 97u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprIntConstantsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedInstanceExprIntConstantsRow {
    type Builder = NormalizedInstanceExprIntConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprIntConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprIntConstantsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        16_336_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedInstanceExprIntConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprIntConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprIntConstantsRow {
...
impl NormalizedInstanceExprIntConstantsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprIntConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
