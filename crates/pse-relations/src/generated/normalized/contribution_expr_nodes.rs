...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    65u8, 255u8, 67u8, 204u8, 203u8, 63u8, 90u8, 197u8, 238u8, 217u8, 86u8, 111u8, 124u8,
    209u8, 232u8, 192u8, 14u8, 47u8, 149u8, 121u8, 54u8, 253u8, 175u8, 20u8, 163u8, 25u8,
    13u8, 241u8, 25u8, 231u8, 202u8, 146u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedContributionExprNodesRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedContributionExprNodesRow {
    type Builder = NormalizedContributionExprNodesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedContributionExprNodesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedContributionExprNodesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        126_352_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedContributionExprNodesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedContributionExprNodesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedContributionExprNodesRow {
...
impl NormalizedContributionExprNodesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedContributionExprNodesView<'_>,
    ) -> Result<(), crate::RelationError> {
