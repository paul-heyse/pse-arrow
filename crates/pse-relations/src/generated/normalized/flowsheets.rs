...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    58u8, 231u8, 129u8, 177u8, 70u8, 105u8, 175u8, 3u8, 235u8, 86u8, 141u8, 232u8, 230u8,
    213u8, 172u8, 96u8, 20u8, 157u8, 45u8, 205u8, 103u8, 22u8, 188u8, 141u8, 165u8, 69u8,
    33u8, 111u8, 140u8, 238u8, 32u8, 173u8,
]);
...
impl crate::columnar::RelationRow for NormalizedFlowsheetsRow {
    ...
    fn builder_allocation_size() -> usize {
        53_288_usize + size_of::<Self::Builder>()
    }
