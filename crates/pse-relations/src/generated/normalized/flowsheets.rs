...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    5u8, 142u8, 66u8, 62u8, 60u8, 110u8, 19u8, 249u8, 90u8, 217u8, 99u8, 15u8, 237u8,
    42u8, 100u8, 58u8, 130u8, 90u8, 147u8, 60u8, 207u8, 52u8, 123u8, 147u8, 22u8, 115u8,
    210u8, 87u8, 21u8, 225u8, 166u8, 94u8,
]);
...
impl crate::columnar::RelationRow for NormalizedFlowsheetsRow {
    ...
    fn builder_allocation_size() -> usize {
        53_992_usize + size_of::<Self::Builder>()
    }
