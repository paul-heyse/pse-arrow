...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    42u8, 101u8, 122u8, 106u8, 241u8, 87u8, 65u8, 190u8, 14u8, 21u8, 83u8, 185u8, 47u8,
    255u8, 228u8, 118u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_expr_smooth_ops";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    78u8, 187u8, 141u8, 174u8, 177u8, 248u8, 104u8, 71u8, 123u8, 250u8, 25u8, 251u8,
    26u8, 199u8, 7u8, 183u8, 121u8, 235u8, 157u8, 169u8, 84u8, 119u8, 66u8, 118u8, 218u8,
    109u8, 204u8, 124u8, 49u8, 129u8, 133u8, 224u8,
]);
...
pub struct NormalizedTemplateExprSmoothOpsRow {
    ///node_id
    pub r#node_id: u64,
    ///eps
    pub r#eps: f64,
...
impl crate::typed::CellCodec for NormalizedTemplateExprSmoothOpsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateExprSmoothOpsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateExprSmoothOpsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprSmoothOpsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateExprSmoothOpsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateExprSmoothOpsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateExprSmoothOpsBuilder;
impl NormalizedTemplateExprSmoothOpsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_expr_smooth_ops".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateExprSmoothOpsRow {
    type Builder = NormalizedTemplateExprSmoothOpsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprSmoothOpsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprSmoothOpsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateExprSmoothOpsView<'a> {
...
impl<'a> NormalizedTemplateExprSmoothOpsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprSmoothOpsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprSmoothOpsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateExprSmoothOpsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateExprSmoothOpsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateExprSmoothOpsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateExprSmoothOpsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprSmoothOpsView<'_>,
    ) -> Result<(), crate::RelationError> {
