...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    195u8, 72u8, 141u8, 238u8, 100u8, 126u8, 247u8, 115u8, 31u8, 122u8, 94u8, 57u8,
    227u8, 41u8, 142u8, 39u8, 175u8, 50u8, 225u8, 242u8, 170u8, 222u8, 213u8, 138u8,
    233u8, 239u8, 13u8, 252u8, 152u8, 46u8, 16u8, 36u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateExprSmoothOpsRow {
    ...
    fn builder_allocation_size() -> usize {
        41_024_usize + size_of::<Self::Builder>()
    }
