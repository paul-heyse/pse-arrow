...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    37u8, 196u8, 221u8, 70u8, 194u8, 142u8, 172u8, 245u8, 228u8, 174u8, 120u8, 231u8,
    30u8, 54u8, 224u8, 142u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "candidate_index_tuples";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    172u8, 230u8, 240u8, 48u8, 112u8, 25u8, 226u8, 138u8, 35u8, 48u8, 115u8, 139u8,
    230u8, 225u8, 200u8, 105u8, 226u8, 115u8, 105u8, 33u8, 220u8, 30u8, 89u8, 213u8,
    93u8, 227u8, 183u8, 204u8, 61u8, 174u8, 126u8, 248u8,
]);
...
pub struct NormalizedCandidateIndexTuplesRow {
    ///product_id
...
impl crate::typed::CellCodec for NormalizedCandidateIndexTuplesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedCandidateIndexTuplesRow)),
            );
        };
            ...
            r#product_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedCandidateIndexTuplesRow),
                    ))?,
            )?,
            r#tuple: <Vec<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedCandidateIndexTuplesRow {
    fn append(
        &self,
...
pub type Row = NormalizedCandidateIndexTuplesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedCandidateIndexTuplesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedCandidateIndexTuplesBuilder;
impl NormalizedCandidateIndexTuplesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.candidate_index_tuples".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedCandidateIndexTuplesRow {
    type Builder = NormalizedCandidateIndexTuplesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedCandidateIndexTuplesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedCandidateIndexTuplesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        44_232_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedCandidateIndexTuplesView<'a> {
...
impl<'a> NormalizedCandidateIndexTuplesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedCandidateIndexTuplesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedCandidateIndexTuplesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedCandidateIndexTuplesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedCandidateIndexTuplesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedCandidateIndexTuplesBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedCandidateIndexTuplesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedCandidateIndexTuplesView<'_>,
    ) -> Result<(), crate::RelationError> {
