...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    210u8, 116u8, 234u8, 92u8, 107u8, 173u8, 60u8, 123u8, 14u8, 214u8, 236u8, 164u8,
    52u8, 99u8, 37u8, 59u8, 202u8, 115u8, 234u8, 83u8, 128u8, 178u8, 33u8, 43u8, 109u8,
    26u8, 41u8, 100u8, 217u8, 179u8, 153u8, 229u8,
]);
...
impl crate::columnar::RelationRow for NormalizedCandidateIndexTuplesRow {
    ...
    fn builder_allocation_size() -> usize {
        42_008_usize + size_of::<Self::Builder>()
    }
