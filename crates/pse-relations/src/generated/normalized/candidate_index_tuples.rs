...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    0u8, 82u8, 196u8, 91u8, 250u8, 195u8, 203u8, 62u8, 95u8, 88u8, 222u8, 102u8, 39u8,
    83u8, 91u8, 217u8, 201u8, 10u8, 224u8, 249u8, 85u8, 145u8, 85u8, 143u8, 43u8, 61u8,
    136u8, 20u8, 84u8, 123u8, 135u8, 31u8,
]);
...
impl crate::columnar::RelationRow for NormalizedCandidateIndexTuplesRow {
    ...
    fn builder_allocation_size() -> usize {
        42_472_usize + size_of::<Self::Builder>()
    }
