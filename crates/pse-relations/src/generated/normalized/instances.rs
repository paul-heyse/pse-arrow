...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    195u8, 220u8, 113u8, 123u8, 72u8, 17u8, 120u8, 82u8, 221u8, 10u8, 16u8, 55u8, 89u8,
    205u8, 77u8, 211u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    209u8, 188u8, 55u8, 210u8, 247u8, 223u8, 232u8, 43u8, 75u8, 190u8, 130u8, 214u8,
    156u8, 103u8, 64u8, 189u8, 19u8, 49u8, 253u8, 85u8, 19u8, 158u8, 41u8, 250u8, 81u8,
    82u8, 240u8, 202u8, 115u8, 105u8, 122u8, 218u8,
]);
...
pub struct NormalizedInstancesFieldParamValuesItem {
    ///name
    pub r#name: String,
    ///value
    pub r#value: String,
}
impl crate::typed::CellCodec for NormalizedInstancesFieldParamValuesItem {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedInstancesFieldParamValuesItem),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedInstancesFieldParamValuesItem {
    fn append(
        &self,
...
pub struct NormalizedInstancesFieldFeatureValuesItem {
    ///name
    pub r#name: String,
    ///value
    pub r#value: String,
}
impl crate::typed::CellCodec for NormalizedInstancesFieldFeatureValuesItem {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                crate::typed::CellCodec::into_cell(self.r#name),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedInstancesFieldFeatureValuesItem),
                ),
            );
        };
        if values.len() != 2usize {
...
impl crate::columnar::ArrowValue for NormalizedInstancesFieldFeatureValuesItem {
    fn append(
        &self,
        output: &mut dyn arrow_array::builder::ArrayBuilder,
    ) -> Result<(), crate::RelationError> {
...
pub struct NormalizedInstancesRow {
    ///instance_id
    ...
    pub r#name: String,
    ///param_values
    pub r#param_values: Vec<NormalizedInstancesFieldParamValuesItem>,
    ///feature_values
    pub r#feature_values: Vec<NormalizedInstancesFieldFeatureValuesItem>,
    ///property_package_id
...
impl crate::typed::CellCodec for NormalizedInstancesRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedInstancesRow)));
        };
        ...
        Ok(Self {
            r#instance_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedInstancesRow),
                    ))?,
            )?,
            ...
            r#param_values: <Vec<
                NormalizedInstancesFieldParamValuesItem,
            > as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
            ...
            r#feature_values: <Vec<
                NormalizedInstancesFieldFeatureValuesItem,
            > as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
...
impl crate::columnar::ArrowValue for NormalizedInstancesRow {
    fn append(
        &self,
        output: &mut dyn arrow_array::builder::ArrayBuilder,
    ) -> Result<(), crate::RelationError> {
...
pub type Row = NormalizedInstancesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstancesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstancesBuilder;
impl NormalizedInstancesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instances".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstancesRow {
    type Builder = NormalizedInstancesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstancesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstancesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        151_784_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedInstancesView<'a> {
...
impl<'a> NormalizedInstancesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstancesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstancesRow {
    ...
    pub fn rows(&self) -> Result<Vec<NormalizedInstancesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstancesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstancesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstancesView<'_>,
    ) -> Result<(), crate::RelationError> {
