...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    120u8, 111u8, 163u8, 166u8, 100u8, 187u8, 226u8, 220u8, 170u8, 243u8, 84u8, 65u8,
    3u8, 9u8, 131u8, 42u8, 78u8, 237u8, 136u8, 204u8, 207u8, 91u8, 10u8, 127u8, 251u8,
    86u8, 124u8, 45u8, 160u8, 213u8, 12u8, 252u8,
]);
...
impl crate::columnar::RelationRow for NormalizedPropertyPackagesRow {
    ...
    fn builder_allocation_size() -> usize {
        102_176_usize + size_of::<Self::Builder>()
    }
