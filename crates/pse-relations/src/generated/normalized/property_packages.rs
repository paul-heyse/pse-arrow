...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    184u8, 45u8, 38u8, 248u8, 121u8, 138u8, 236u8, 201u8, 3u8, 193u8, 69u8, 78u8, 153u8,
    94u8, 4u8, 144u8, 45u8, 109u8, 72u8, 33u8, 145u8, 7u8, 54u8, 110u8, 6u8, 64u8, 236u8,
    189u8, 155u8, 254u8, 217u8, 185u8,
]);
...
impl crate::columnar::RelationRow for NormalizedPropertyPackagesRow {
    ...
    fn builder_allocation_size() -> usize {
        102_640_usize + size_of::<Self::Builder>()
    }
