...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    71u8, 121u8, 119u8, 41u8, 142u8, 245u8, 225u8, 171u8, 121u8, 0u8, 209u8, 25u8, 255u8,
    88u8, 71u8, 12u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_expr_float_constants";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    146u8, 161u8, 33u8, 101u8, 177u8, 31u8, 135u8, 83u8, 29u8, 207u8, 111u8, 162u8,
    165u8, 85u8, 248u8, 109u8, 106u8, 118u8, 146u8, 169u8, 192u8, 122u8, 72u8, 114u8,
    29u8, 200u8, 48u8, 223u8, 242u8, 38u8, 117u8, 119u8,
]);
...
pub struct NormalizedInstanceExprFloatConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: f64,
...
impl crate::typed::CellCodec for NormalizedInstanceExprFloatConstantsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedInstanceExprFloatConstantsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprFloatConstantsRow {
    fn append(
        &self,
...
pub type Row = NormalizedInstanceExprFloatConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstanceExprFloatConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstanceExprFloatConstantsBuilder;
impl NormalizedInstanceExprFloatConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instance_expr_float_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstanceExprFloatConstantsRow {
    type Builder = NormalizedInstanceExprFloatConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprFloatConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprFloatConstantsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedInstanceExprFloatConstantsView<'a> {
...
impl<'a> NormalizedInstanceExprFloatConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprFloatConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprFloatConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedInstanceExprFloatConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstanceExprFloatConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstanceExprFloatConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedInstanceExprFloatConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprFloatConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
