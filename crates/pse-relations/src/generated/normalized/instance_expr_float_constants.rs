...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    137u8, 233u8, 85u8, 29u8, 182u8, 184u8, 64u8, 100u8, 143u8, 127u8, 108u8, 181u8,
    13u8, 47u8, 182u8, 254u8, 224u8, 71u8, 84u8, 250u8, 43u8, 2u8, 171u8, 206u8, 137u8,
    212u8, 56u8, 127u8, 159u8, 255u8, 153u8, 26u8,
]);
...
impl<'a> NormalizedInstanceExprFloatConstantsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedInstanceExprFloatConstantsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedInstanceExprFloatConstantsBuilder {
    rows: Vec<NormalizedInstanceExprFloatConstantsRow>,
}
impl NormalizedInstanceExprFloatConstantsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedInstanceExprFloatConstantsRow::into_cells)
            .collect::<Vec<_>>();
