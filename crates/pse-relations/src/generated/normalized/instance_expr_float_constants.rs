...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    115u8, 127u8, 89u8, 167u8, 173u8, 125u8, 27u8, 150u8, 118u8, 10u8, 13u8, 118u8, 96u8,
    20u8, 153u8, 32u8, 24u8, 31u8, 53u8, 157u8, 72u8, 68u8, 209u8, 133u8, 198u8, 160u8,
    115u8, 122u8, 65u8, 124u8, 18u8, 242u8,
]);
