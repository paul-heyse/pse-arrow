...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    234u8, 39u8, 49u8, 185u8, 169u8, 45u8, 163u8, 12u8, 205u8, 233u8, 240u8, 29u8, 78u8,
    197u8, 102u8, 195u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_expr_kernel_calls";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    180u8, 225u8, 84u8, 82u8, 50u8, 98u8, 8u8, 36u8, 116u8, 215u8, 172u8, 14u8, 1u8,
    221u8, 169u8, 212u8, 32u8, 185u8, 219u8, 222u8, 244u8, 253u8, 247u8, 59u8, 95u8,
    165u8, 34u8, 124u8, 34u8, 29u8, 71u8, 137u8,
]);
...
pub struct NormalizedInstanceExprKernelCallsRow {
    ///node_id
    pub r#node_id: u64,
    ///kernel_binding_id
...
impl crate::typed::CellCodec for NormalizedInstanceExprKernelCallsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedInstanceExprKernelCallsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedInstanceExprKernelCallsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprKernelCallsRow {
    fn append(
        &self,
...
pub type Row = NormalizedInstanceExprKernelCallsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstanceExprKernelCallsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstanceExprKernelCallsBuilder;
impl NormalizedInstanceExprKernelCallsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instance_expr_kernel_calls".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstanceExprKernelCallsRow {
    type Builder = NormalizedInstanceExprKernelCallsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprKernelCallsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprKernelCallsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedInstanceExprKernelCallsView<'a> {
...
impl<'a> NormalizedInstanceExprKernelCallsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprKernelCallsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprKernelCallsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedInstanceExprKernelCallsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstanceExprKernelCallsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstanceExprKernelCallsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedInstanceExprKernelCallsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprKernelCallsView<'_>,
    ) -> Result<(), crate::RelationError> {
