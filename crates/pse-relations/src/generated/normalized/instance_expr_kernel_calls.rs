...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    218u8, 5u8, 1u8, 69u8, 232u8, 150u8, 54u8, 230u8, 232u8, 114u8, 69u8, 67u8, 198u8,
    102u8, 56u8, 95u8, 226u8, 49u8, 184u8, 69u8, 110u8, 217u8, 118u8, 108u8, 23u8, 247u8,
    13u8, 37u8, 246u8, 45u8, 133u8, 158u8,
]);
...
impl<'a> NormalizedInstanceExprKernelCallsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedInstanceExprKernelCallsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedInstanceExprKernelCallsBuilder {
    rows: Vec<NormalizedInstanceExprKernelCallsRow>,
}
impl NormalizedInstanceExprKernelCallsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedInstanceExprKernelCallsRow::into_cells)
            .collect::<Vec<_>>();
