...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    93u8, 12u8, 90u8, 197u8, 24u8, 206u8, 42u8, 193u8, 37u8, 133u8, 163u8, 229u8, 243u8,
    220u8, 223u8, 11u8, 254u8, 220u8, 167u8, 4u8, 46u8, 166u8, 23u8, 100u8, 232u8, 116u8,
    246u8, 232u8, 225u8, 94u8, 21u8, 15u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateDisplayIndicesRow {
    ...
    fn builder_allocation_size() -> usize {
        52_376_usize + size_of::<Self::Builder>()
    }
