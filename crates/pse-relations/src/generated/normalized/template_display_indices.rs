...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    78u8, 120u8, 147u8, 108u8, 30u8, 252u8, 84u8, 229u8, 227u8, 238u8, 210u8, 144u8,
    168u8, 255u8, 59u8, 250u8, 241u8, 163u8, 27u8, 209u8, 20u8, 87u8, 130u8, 89u8, 203u8,
    72u8, 22u8, 108u8, 28u8, 190u8, 164u8, 103u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateDisplayIndicesRow {
    ...
    fn builder_allocation_size() -> usize {
        56_816_usize + size_of::<Self::Builder>()
    }
