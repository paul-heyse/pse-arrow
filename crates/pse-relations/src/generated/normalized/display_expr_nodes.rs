...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    93u8, 135u8, 168u8, 78u8, 231u8, 108u8, 110u8, 143u8, 244u8, 91u8, 161u8, 240u8,
    52u8, 136u8, 213u8, 133u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "display_expr_nodes";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    75u8, 55u8, 63u8, 138u8, 89u8, 190u8, 132u8, 201u8, 57u8, 42u8, 121u8, 6u8, 11u8,
    39u8, 194u8, 232u8, 193u8, 78u8, 161u8, 242u8, 33u8, 180u8, 114u8, 171u8, 154u8,
    52u8, 114u8, 60u8, 73u8, 174u8, 214u8, 94u8,
]);
...
pub struct NormalizedDisplayExprNodesRow {
    ///node_id
    pub r#node_id: u64,
    ///opcode
...
impl crate::typed::CellCodec for NormalizedDisplayExprNodesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedDisplayExprNodesRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedDisplayExprNodesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedDisplayExprNodesRow {
    fn append(
        &self,
...
pub type Row = NormalizedDisplayExprNodesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedDisplayExprNodesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedDisplayExprNodesBuilder;
impl NormalizedDisplayExprNodesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.display_expr_nodes".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedDisplayExprNodesRow {
    type Builder = NormalizedDisplayExprNodesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDisplayExprNodesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDisplayExprNodesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        126_312_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedDisplayExprNodesView<'a> {
...
impl<'a> NormalizedDisplayExprNodesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDisplayExprNodesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDisplayExprNodesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedDisplayExprNodesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedDisplayExprNodesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedDisplayExprNodesBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedDisplayExprNodesRow,
    ) -> Result<(), crate::RelationError> {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDisplayExprNodesView<'_>,
    ) -> Result<(), crate::RelationError> {
