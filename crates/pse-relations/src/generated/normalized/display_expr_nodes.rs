...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    65u8, 241u8, 254u8, 142u8, 13u8, 187u8, 100u8, 41u8, 98u8, 218u8, 69u8, 127u8, 25u8,
    181u8, 95u8, 170u8, 173u8, 226u8, 105u8, 181u8, 65u8, 162u8, 18u8, 86u8, 224u8, 95u8,
    38u8, 70u8, 159u8, 26u8, 40u8, 5u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprNodesRow {
    ...
    fn builder_allocation_size() -> usize {
        126_776_usize + size_of::<Self::Builder>()
    }
