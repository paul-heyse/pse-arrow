...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    47u8, 142u8, 85u8, 99u8, 93u8, 231u8, 212u8, 116u8, 165u8, 247u8, 163u8, 49u8, 161u8,
    186u8, 255u8, 199u8, 16u8, 7u8, 45u8, 151u8, 187u8, 121u8, 171u8, 254u8, 18u8, 39u8,
    140u8, 90u8, 16u8, 113u8, 118u8, 235u8,
]);
...
impl crate::columnar::RelationRow for NormalizedInstanceDomainBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        38_064_usize + size_of::<Self::Builder>()
    }
