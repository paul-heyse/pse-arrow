...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    11u8, 195u8, 72u8, 182u8, 255u8, 52u8, 163u8, 195u8, 115u8, 124u8, 106u8, 199u8,
    64u8, 82u8, 91u8, 237u8, 145u8, 42u8, 123u8, 242u8, 252u8, 128u8, 41u8, 182u8, 159u8,
    153u8, 170u8, 181u8, 27u8, 50u8, 243u8, 223u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedInstanceDomainBindingsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedInstanceDomainBindingsRow {
    type Builder = NormalizedInstanceDomainBindingsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceDomainBindingsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceDomainBindingsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        39_824_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedInstanceDomainBindingsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceDomainBindingsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceDomainBindingsRow {
...
impl NormalizedInstanceDomainBindingsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceDomainBindingsView<'_>,
    ) -> Result<(), crate::RelationError> {
