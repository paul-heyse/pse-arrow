...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    255u8, 88u8, 214u8, 79u8, 92u8, 157u8, 81u8, 8u8, 104u8, 208u8, 190u8, 179u8, 113u8,
    233u8, 186u8, 1u8, 78u8, 241u8, 136u8, 192u8, 37u8, 136u8, 6u8, 254u8, 245u8, 202u8,
    235u8, 221u8, 92u8, 56u8, 187u8, 149u8,
]);
...
impl crate::columnar::RelationRow for NormalizedInstanceDomainBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        37_312_usize + size_of::<Self::Builder>()
    }
