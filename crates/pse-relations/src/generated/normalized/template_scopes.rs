...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    218u8, 32u8, 40u8, 122u8, 63u8, 172u8, 118u8, 106u8, 225u8, 192u8, 36u8, 56u8, 72u8,
    92u8, 230u8, 178u8, 214u8, 181u8, 234u8, 9u8, 67u8, 61u8, 194u8, 66u8, 27u8, 130u8,
    52u8, 221u8, 162u8, 109u8, 2u8, 54u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateScopesRow {
    ...
    fn builder_allocation_size() -> usize {
        36_904_usize + size_of::<Self::Builder>()
    }
