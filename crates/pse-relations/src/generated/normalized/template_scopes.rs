...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    155u8, 29u8, 205u8, 186u8, 182u8, 182u8, 191u8, 8u8, 40u8, 189u8, 128u8, 79u8, 46u8,
    83u8, 26u8, 242u8, 207u8, 239u8, 217u8, 4u8, 154u8, 38u8, 109u8, 20u8, 120u8, 226u8,
    24u8, 151u8, 197u8, 17u8, 222u8, 243u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateScopesRow {
    ...
    fn builder_allocation_size() -> usize {
        39_128_usize + size_of::<Self::Builder>()
    }
