...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    104u8, 107u8, 248u8, 202u8, 173u8, 139u8, 109u8, 124u8, 239u8, 97u8, 253u8, 227u8,
    253u8, 142u8, 165u8, 222u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_scopes";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    231u8, 115u8, 223u8, 29u8, 7u8, 237u8, 182u8, 31u8, 249u8, 58u8, 163u8, 66u8, 249u8,
    147u8, 235u8, 38u8, 117u8, 78u8, 169u8, 199u8, 86u8, 229u8, 109u8, 210u8, 4u8, 115u8,
    108u8, 176u8, 43u8, 206u8, 190u8, 130u8,
]);
...
pub struct NormalizedTemplateScopesRow {
    ///template_id
...
impl crate::typed::CellCodec for NormalizedTemplateScopesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(NormalizedTemplateScopesRow)));
        };
            ...
            r#template_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateScopesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedTemplateScopesRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateScopesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateScopesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateScopesBuilder;
impl NormalizedTemplateScopesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_scopes".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateScopesRow {
    type Builder = NormalizedTemplateScopesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateScopesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateScopesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        37_368_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateScopesView<'a> {
...
impl<'a> NormalizedTemplateScopesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateScopesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateScopesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateScopesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateScopesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateScopesBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateScopesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateScopesView<'_>,
    ) -> Result<(), crate::RelationError> {
