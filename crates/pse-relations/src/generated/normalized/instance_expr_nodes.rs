...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    227u8, 105u8, 125u8, 80u8, 151u8, 59u8, 98u8, 239u8, 33u8, 131u8, 55u8, 28u8, 114u8,
    137u8, 20u8, 211u8, 240u8, 14u8, 158u8, 147u8, 215u8, 248u8, 102u8, 125u8, 81u8,
    41u8, 104u8, 236u8, 23u8, 15u8, 24u8, 33u8,
]);
