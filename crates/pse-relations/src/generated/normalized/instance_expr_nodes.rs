...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    118u8, 70u8, 110u8, 1u8, 85u8, 194u8, 123u8, 210u8, 32u8, 37u8, 243u8, 23u8, 98u8,
    171u8, 47u8, 77u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_expr_nodes";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    46u8, 185u8, 154u8, 203u8, 82u8, 19u8, 117u8, 124u8, 168u8, 27u8, 125u8, 169u8,
    247u8, 69u8, 154u8, 167u8, 154u8, 34u8, 70u8, 113u8, 16u8, 115u8, 193u8, 61u8, 195u8,
    212u8, 255u8, 9u8, 107u8, 242u8, 86u8, 179u8,
]);
...
pub struct NormalizedInstanceExprNodesRow {
    ///node_id
    pub r#node_id: u64,
    ///opcode
...
impl crate::typed::CellCodec for NormalizedInstanceExprNodesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedInstanceExprNodesRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedInstanceExprNodesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprNodesRow {
    fn append(
        &self,
...
pub type Row = NormalizedInstanceExprNodesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstanceExprNodesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstanceExprNodesBuilder;
impl NormalizedInstanceExprNodesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instance_expr_nodes".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstanceExprNodesRow {
    type Builder = NormalizedInstanceExprNodesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprNodesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprNodesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        126_320_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedInstanceExprNodesView<'a> {
...
impl<'a> NormalizedInstanceExprNodesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprNodesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprNodesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedInstanceExprNodesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstanceExprNodesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstanceExprNodesBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedInstanceExprNodesRow,
    ) -> Result<(), crate::RelationError> {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprNodesView<'_>,
    ) -> Result<(), crate::RelationError> {
