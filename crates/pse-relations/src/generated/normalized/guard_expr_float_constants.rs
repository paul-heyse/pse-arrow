...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    206u8, 83u8, 91u8, 244u8, 50u8, 160u8, 240u8, 172u8, 73u8, 132u8, 218u8, 97u8, 68u8,
    233u8, 232u8, 162u8, 247u8, 15u8, 47u8, 10u8, 137u8, 152u8, 122u8, 188u8, 69u8,
    118u8, 144u8, 42u8, 86u8, 76u8, 183u8, 43u8,
]);
...
impl<'a> NormalizedGuardExprFloatConstantsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedGuardExprFloatConstantsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedGuardExprFloatConstantsBuilder {
    rows: Vec<NormalizedGuardExprFloatConstantsRow>,
}
impl NormalizedGuardExprFloatConstantsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedGuardExprFloatConstantsRow::into_cells)
            .collect::<Vec<_>>();
