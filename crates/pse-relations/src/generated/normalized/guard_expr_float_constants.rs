...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    235u8, 88u8, 130u8, 171u8, 242u8, 92u8, 239u8, 68u8, 141u8, 130u8, 227u8, 194u8,
    165u8, 69u8, 40u8, 205u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "guard_expr_float_constants";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    118u8, 36u8, 246u8, 56u8, 138u8, 55u8, 241u8, 91u8, 68u8, 104u8, 151u8, 176u8, 134u8,
    183u8, 157u8, 90u8, 146u8, 253u8, 127u8, 159u8, 132u8, 126u8, 184u8, 142u8, 54u8,
    68u8, 130u8, 181u8, 170u8, 119u8, 2u8, 136u8,
]);
...
pub struct NormalizedGuardExprFloatConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: f64,
...
impl crate::typed::CellCodec for NormalizedGuardExprFloatConstantsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedGuardExprFloatConstantsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedGuardExprFloatConstantsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedGuardExprFloatConstantsRow {
    fn append(
        &self,
...
pub type Row = NormalizedGuardExprFloatConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedGuardExprFloatConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedGuardExprFloatConstantsBuilder;
impl NormalizedGuardExprFloatConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.guard_expr_float_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedGuardExprFloatConstantsRow {
    type Builder = NormalizedGuardExprFloatConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprFloatConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprFloatConstantsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_048_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedGuardExprFloatConstantsView<'a> {
...
impl<'a> NormalizedGuardExprFloatConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprFloatConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprFloatConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedGuardExprFloatConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedGuardExprFloatConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedGuardExprFloatConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedGuardExprFloatConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprFloatConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
