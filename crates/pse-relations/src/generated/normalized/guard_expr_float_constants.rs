...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    215u8, 248u8, 182u8, 82u8, 57u8, 133u8, 96u8, 164u8, 12u8, 53u8, 113u8, 185u8, 210u8,
    68u8, 241u8, 225u8, 184u8, 57u8, 207u8, 58u8, 118u8, 167u8, 137u8, 209u8, 155u8,
    111u8, 25u8, 7u8, 76u8, 230u8, 193u8, 131u8,
]);
...
impl crate::columnar::RelationRow for NormalizedGuardExprFloatConstantsRow {
    ...
    fn builder_allocation_size() -> usize {
        26_584_usize + size_of::<Self::Builder>()
    }
