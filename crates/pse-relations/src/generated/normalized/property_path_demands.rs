...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    32u8, 73u8, 21u8, 222u8, 16u8, 203u8, 208u8, 16u8, 66u8, 90u8, 172u8, 224u8, 89u8,
    29u8, 194u8, 83u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "property_path_demands";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    234u8, 88u8, 202u8, 204u8, 245u8, 223u8, 30u8, 16u8, 222u8, 178u8, 91u8, 237u8,
    162u8, 206u8, 84u8, 63u8, 77u8, 38u8, 64u8, 246u8, 200u8, 43u8, 64u8, 209u8, 254u8,
    185u8, 106u8, 108u8, 250u8, 201u8, 217u8, 140u8,
]);
...
pub struct NormalizedPropertyPathDemandsRow {
    ///demand_id
    pub r#demand_id: pse_ids::SemanticId,
    ///source_id
...
impl crate::typed::CellCodec for NormalizedPropertyPathDemandsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                crate::typed::CellCodec::into_cell(self.r#demand_id),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedPropertyPathDemandsRow)),
            );
        };
        ...
        Ok(Self {
            r#demand_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedPropertyPathDemandsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedPropertyPathDemandsRow {
    fn append(
        &self,
    ...
    fn read(
        ...
        Ok(Self {
            r#demand_id: <pse_ids::SemanticId as crate::columnar::ArrowValue>::read(
...
pub type Row = NormalizedPropertyPathDemandsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedPropertyPathDemandsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedPropertyPathDemandsBuilder;
impl NormalizedPropertyPathDemandsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.property_path_demands".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedPropertyPathDemandsRow {
    type Builder = NormalizedPropertyPathDemandsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedPropertyPathDemandsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedPropertyPathDemandsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        55_624_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedPropertyPathDemandsView<'a> {
    batch: &'a crate::RecordBatch,
    demand_id_column: &'a arrow_array::FixedSizeBinaryArray,
...
impl<'a> NormalizedPropertyPathDemandsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            batch,
            demand_id_column: crate::columnar::array::<
    ...
    pub const fn demand_id_column(&self) -> &'a arrow_array::FixedSizeBinaryArray {
        self.demand_id_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "demand_id", "`.")]
    pub fn demand_id_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedPropertyPathDemandsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedPropertyPathDemandsRow {
            r#demand_id: crate::columnar::ArrowValue::read(
                self.demand_id_column,
                index,
            )?,
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedPropertyPathDemandsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedPropertyPathDemandsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedPropertyPathDemandsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedPropertyPathDemandsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedPropertyPathDemandsView<'_>,
    ) -> Result<(), crate::RelationError> {
