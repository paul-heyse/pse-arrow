...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    241u8, 20u8, 162u8, 60u8, 210u8, 25u8, 146u8, 72u8, 11u8, 62u8, 252u8, 2u8, 42u8,
    2u8, 239u8, 155u8, 25u8, 93u8, 144u8, 162u8, 15u8, 161u8, 52u8, 86u8, 250u8, 54u8,
    61u8, 156u8, 175u8, 46u8, 145u8, 252u8,
]);
...
impl crate::columnar::RelationRow for NormalizedPropertyPathDemandsRow {
    ...
    fn builder_allocation_size() -> usize {
        55_160_usize + size_of::<Self::Builder>()
    }
