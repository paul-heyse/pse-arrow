...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    171u8, 124u8, 119u8, 200u8, 54u8, 147u8, 216u8, 107u8, 21u8, 63u8, 40u8, 98u8, 129u8,
    51u8, 185u8, 98u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "contribution_expr_reductions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    210u8, 123u8, 163u8, 57u8, 255u8, 1u8, 160u8, 107u8, 94u8, 126u8, 149u8, 140u8,
    112u8, 74u8, 27u8, 144u8, 113u8, 153u8, 92u8, 222u8, 144u8, 188u8, 2u8, 168u8, 91u8,
    58u8, 17u8, 194u8, 185u8, 32u8, 94u8, 179u8,
]);
...
pub struct NormalizedContributionExprReductionsRow {
    ///node_id
    pub r#node_id: u64,
    ///kind
...
impl crate::typed::CellCodec for NormalizedContributionExprReductionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedContributionExprReductionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedContributionExprReductionsRow {
    fn append(
        &self,
...
pub type Row = NormalizedContributionExprReductionsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedContributionExprReductionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedContributionExprReductionsBuilder;
impl NormalizedContributionExprReductionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.contribution_expr_reductions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedContributionExprReductionsRow {
    type Builder = NormalizedContributionExprReductionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedContributionExprReductionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedContributionExprReductionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        88_808_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedContributionExprReductionsView<'a> {
...
impl<'a> NormalizedContributionExprReductionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedContributionExprReductionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedContributionExprReductionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedContributionExprReductionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedContributionExprReductionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedContributionExprReductionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedContributionExprReductionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedContributionExprReductionsView<'_>,
    ) -> Result<(), crate::RelationError> {
