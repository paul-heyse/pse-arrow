...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    145u8, 99u8, 16u8, 184u8, 105u8, 134u8, 75u8, 247u8, 63u8, 142u8, 220u8, 175u8,
    134u8, 121u8, 186u8, 202u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_expr_integrals";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    110u8, 131u8, 198u8, 79u8, 15u8, 250u8, 21u8, 239u8, 174u8, 196u8, 105u8, 50u8,
    129u8, 254u8, 4u8, 194u8, 164u8, 129u8, 125u8, 170u8, 110u8, 161u8, 132u8, 64u8,
    89u8, 25u8, 96u8, 144u8, 23u8, 186u8, 125u8, 158u8,
]);
...
pub struct NormalizedTemplateExprIntegralsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for NormalizedTemplateExprIntegralsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateExprIntegralsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateExprIntegralsRow),
                    ))?,
            )?,
            r#domain_id: <Option<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprIntegralsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateExprIntegralsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateExprIntegralsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateExprIntegralsBuilder;
impl NormalizedTemplateExprIntegralsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_expr_integrals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateExprIntegralsRow {
    type Builder = NormalizedTemplateExprIntegralsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprIntegralsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprIntegralsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        85_936_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateExprIntegralsView<'a> {
...
impl<'a> NormalizedTemplateExprIntegralsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprIntegralsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprIntegralsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateExprIntegralsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateExprIntegralsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateExprIntegralsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateExprIntegralsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprIntegralsView<'_>,
    ) -> Result<(), crate::RelationError> {
