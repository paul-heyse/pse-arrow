...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    193u8, 112u8, 95u8, 134u8, 226u8, 32u8, 215u8, 3u8, 117u8, 67u8, 55u8, 205u8, 233u8,
    241u8, 157u8, 4u8, 86u8, 14u8, 148u8, 9u8, 126u8, 19u8, 104u8, 171u8, 6u8, 74u8,
    186u8, 176u8, 193u8, 250u8, 117u8, 133u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateExprIntegralsRow {
    ...
    fn builder_allocation_size() -> usize {
        85_472_usize + size_of::<Self::Builder>()
    }
