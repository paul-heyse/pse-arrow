...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    143u8, 150u8, 218u8, 66u8, 169u8, 21u8, 63u8, 185u8, 174u8, 208u8, 163u8, 160u8,
    158u8, 86u8, 230u8, 104u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_binding_lengths";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    203u8, 241u8, 99u8, 52u8, 62u8, 119u8, 219u8, 32u8, 140u8, 49u8, 202u8, 87u8, 234u8,
    222u8, 20u8, 88u8, 254u8, 197u8, 116u8, 138u8, 163u8, 65u8, 147u8, 149u8, 156u8,
    228u8, 37u8, 136u8, 242u8, 136u8, 40u8, 220u8,
]);
...
pub struct NormalizedPortBindingLengthsRow {
    ///template_id
...
impl crate::typed::CellCodec for NormalizedPortBindingLengthsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#length),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedPortBindingLengthsRow)),
            );
        };
        ...
        Ok(Self {
            r#template_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedPortBindingLengthsRow),
                    ))?,
            )?,
            ...
            r#length: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedPortBindingLengthsRow),
...
impl crate::columnar::ArrowValue for NormalizedPortBindingLengthsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#length, children[2usize].as_mut())?;
        crate::columnar::ArrowValue::append(
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#length: <u64 as crate::columnar::ArrowValue>::read(
...
pub type Row = NormalizedPortBindingLengthsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedPortBindingLengthsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedPortBindingLengthsBuilder;
impl NormalizedPortBindingLengthsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.port_binding_lengths".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedPortBindingLengthsRow {
    type Builder = NormalizedPortBindingLengthsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedPortBindingLengthsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedPortBindingLengthsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        38_872_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedPortBindingLengthsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            length_column: crate::columnar::array::<
    ...
    pub const fn length_column(&self) -> &'a arrow_array::UInt64Array {
        self.length_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "length", "`.")]
    pub fn length_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedPortBindingLengthsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedPortBindingLengthsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedPortBindingLengthsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedPortBindingLengthsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedPortBindingLengthsView<'_>,
    ) -> Result<(), crate::RelationError> {
