...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    228u8, 68u8, 212u8, 83u8, 130u8, 119u8, 170u8, 79u8, 168u8, 220u8, 34u8, 246u8,
    102u8, 222u8, 111u8, 120u8, 48u8, 72u8, 149u8, 208u8, 110u8, 123u8, 156u8, 118u8,
    21u8, 114u8, 205u8, 207u8, 202u8, 206u8, 165u8, 50u8,
]);
...
impl crate::typed::CellCodec for NormalizedPortBindingLengthsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        ...
        Ok(Self {
            ...
            r#length: <i64 as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedPortBindingLengthsRow),
...
impl crate::columnar::ArrowValue for NormalizedPortBindingLengthsRow {
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#length: <i64 as crate::columnar::ArrowValue>::read(
...
impl crate::columnar::RelationRow for NormalizedPortBindingLengthsRow {
    ...
    fn builder_allocation_size() -> usize {
        41_992_usize + size_of::<Self::Builder>()
    }
...
pub struct NormalizedPortBindingLengthsView<'a> {
    ...
    length_column: &'a arrow_array::Int64Array,
...
impl<'a> NormalizedPortBindingLengthsView<'a> {
    ...
    pub const fn length_column(&self) -> &'a arrow_array::Int64Array {
        self.length_column
    }
...
impl NormalizedPortBindingLengthsBuilder {
    ...
    pub fn push(
        ...
        if !((0_i64..=9_223_372_036_854_775_807_i64)
            .contains(&(row.r#length).to_owned()))
        {
            return Err(
