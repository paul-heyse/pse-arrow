...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    183u8, 118u8, 158u8, 192u8, 141u8, 166u8, 44u8, 161u8, 97u8, 166u8, 38u8, 185u8,
    72u8, 183u8, 87u8, 60u8, 217u8, 12u8, 106u8, 64u8, 8u8, 68u8, 10u8, 180u8, 81u8,
    84u8, 156u8, 222u8, 71u8, 146u8, 50u8, 243u8,
]);
...
impl crate::columnar::RelationRow for NormalizedPortBindingLengthsRow {
    ...
    fn builder_allocation_size() -> usize {
        38_408_usize + size_of::<Self::Builder>()
    }
