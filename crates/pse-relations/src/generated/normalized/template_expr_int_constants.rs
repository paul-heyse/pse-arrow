...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    150u8, 65u8, 3u8, 187u8, 89u8, 24u8, 205u8, 17u8, 100u8, 183u8, 44u8, 15u8, 129u8,
    229u8, 28u8, 103u8, 232u8, 102u8, 127u8, 182u8, 40u8, 239u8, 102u8, 66u8, 60u8,
    226u8, 44u8, 233u8, 236u8, 9u8, 250u8, 253u8,
]);
...
impl<'a> NormalizedTemplateExprIntConstantsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedTemplateExprIntConstantsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedTemplateExprIntConstantsBuilder {
    rows: Vec<NormalizedTemplateExprIntConstantsRow>,
}
impl NormalizedTemplateExprIntConstantsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedTemplateExprIntConstantsRow::into_cells)
            .collect::<Vec<_>>();
