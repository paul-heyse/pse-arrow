...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    76u8, 141u8, 202u8, 246u8, 30u8, 139u8, 41u8, 8u8, 133u8, 79u8, 85u8, 234u8, 179u8,
    253u8, 240u8, 86u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_expr_int_constants";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    41u8, 154u8, 54u8, 143u8, 136u8, 9u8, 167u8, 248u8, 143u8, 150u8, 226u8, 248u8, 70u8,
    121u8, 251u8, 124u8, 23u8, 19u8, 1u8, 74u8, 208u8, 173u8, 29u8, 201u8, 39u8, 54u8,
    154u8, 97u8, 3u8, 34u8, 232u8, 77u8,
]);
...
pub struct NormalizedTemplateExprIntConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: i64,
}
impl crate::typed::CellCodec for NormalizedTemplateExprIntConstantsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateExprIntConstantsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateExprIntConstantsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprIntConstantsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateExprIntConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateExprIntConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateExprIntConstantsBuilder;
impl NormalizedTemplateExprIntConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_expr_int_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateExprIntConstantsRow {
    type Builder = NormalizedTemplateExprIntConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprIntConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprIntConstantsView::from_checked(batch)?.rows()
    }
...
impl<'a> NormalizedTemplateExprIntConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprIntConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprIntConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateExprIntConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateExprIntConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateExprIntConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateExprIntConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprIntConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
