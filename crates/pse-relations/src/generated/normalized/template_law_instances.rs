...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    12u8, 141u8, 140u8, 246u8, 15u8, 109u8, 198u8, 85u8, 151u8, 217u8, 31u8, 236u8, 88u8,
    107u8, 251u8, 247u8, 176u8, 234u8, 75u8, 33u8, 98u8, 230u8, 228u8, 193u8, 32u8, 3u8,
    186u8, 240u8, 54u8, 34u8, 28u8, 175u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateLawInstancesRow {
    ...
    fn builder_allocation_size() -> usize {
        98_648_usize + size_of::<Self::Builder>()
    }
