...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    35u8, 87u8, 174u8, 76u8, 67u8, 212u8, 9u8, 80u8, 6u8, 167u8, 43u8, 42u8, 236u8,
    127u8, 56u8, 171u8, 117u8, 123u8, 96u8, 205u8, 153u8, 221u8, 217u8, 135u8, 165u8,
    31u8, 40u8, 241u8, 11u8, 94u8, 200u8, 143u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateLawInstancesRow {
    ...
    fn builder_allocation_size() -> usize {
        100_408_usize + size_of::<Self::Builder>()
    }
