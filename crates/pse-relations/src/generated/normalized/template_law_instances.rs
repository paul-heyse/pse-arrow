...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    192u8, 239u8, 199u8, 73u8, 153u8, 201u8, 85u8, 175u8, 33u8, 137u8, 92u8, 217u8,
    128u8, 127u8, 11u8, 141u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    203u8, 213u8, 3u8, 105u8, 106u8, 3u8, 164u8, 41u8, 154u8, 148u8, 249u8, 71u8, 89u8,
    4u8, 125u8, 4u8, 203u8, 220u8, 117u8, 137u8, 30u8, 131u8, 170u8, 19u8, 160u8, 155u8,
    82u8, 146u8, 130u8, 250u8, 97u8, 191u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedTemplateLawInstancesFieldOptionsItem {
    fn append(
        &self,
...
impl crate::columnar::ArrowValue for NormalizedTemplateLawInstancesRow {
    fn append(
        &self,
        output: &mut dyn arrow_array::builder::ArrayBuilder,
    ) -> Result<(), crate::RelationError> {
...
impl crate::columnar::RelationRow for NormalizedTemplateLawInstancesRow {
    type Builder = NormalizedTemplateLawInstancesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateLawInstancesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateLawInstancesView::from_checked(batch)?.rows()
    }
...
impl<'a> NormalizedTemplateLawInstancesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateLawInstancesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateLawInstancesRow {
...
impl NormalizedTemplateLawInstancesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateLawInstancesView<'_>,
    ) -> Result<(), crate::RelationError> {
