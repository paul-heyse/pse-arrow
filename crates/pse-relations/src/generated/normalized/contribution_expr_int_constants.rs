...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    117u8, 227u8, 151u8, 23u8, 117u8, 163u8, 77u8, 101u8, 240u8, 22u8, 19u8, 23u8, 71u8,
    9u8, 15u8, 98u8, 190u8, 136u8, 152u8, 205u8, 17u8, 225u8, 142u8, 240u8, 182u8, 247u8,
    244u8, 111u8, 219u8, 98u8, 46u8, 135u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedContributionExprIntConstantsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedContributionExprIntConstantsRow {
    type Builder = NormalizedContributionExprIntConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedContributionExprIntConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedContributionExprIntConstantsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        16_368_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedContributionExprIntConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedContributionExprIntConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedContributionExprIntConstantsRow {
...
impl NormalizedContributionExprIntConstantsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedContributionExprIntConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
