...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    146u8, 231u8, 48u8, 253u8, 213u8, 164u8, 162u8, 5u8, 168u8, 152u8, 74u8, 71u8, 153u8,
    57u8, 31u8, 103u8, 100u8, 210u8, 182u8, 108u8, 189u8, 30u8, 175u8, 59u8, 223u8,
    132u8, 250u8, 179u8, 223u8, 77u8, 16u8, 4u8,
]);
