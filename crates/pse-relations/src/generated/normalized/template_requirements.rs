...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    128u8, 20u8, 124u8, 97u8, 41u8, 123u8, 79u8, 5u8, 182u8, 206u8, 61u8, 73u8, 161u8,
    31u8, 143u8, 43u8, 141u8, 212u8, 137u8, 94u8, 151u8, 103u8, 196u8, 232u8, 6u8, 31u8,
    51u8, 83u8, 62u8, 158u8, 25u8, 86u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateRequirementsRow {
    ...
    fn builder_allocation_size() -> usize {
        41_808_usize + size_of::<Self::Builder>()
    }
