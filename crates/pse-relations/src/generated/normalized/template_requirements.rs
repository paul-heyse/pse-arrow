...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    3u8, 41u8, 152u8, 192u8, 76u8, 31u8, 122u8, 134u8, 245u8, 199u8, 151u8, 129u8, 224u8,
    61u8, 43u8, 60u8, 197u8, 103u8, 145u8, 130u8, 191u8, 85u8, 253u8, 102u8, 98u8, 127u8,
    233u8, 112u8, 149u8, 244u8, 253u8, 214u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedTemplateRequirementsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedTemplateRequirementsRow {
    type Builder = NormalizedTemplateRequirementsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateRequirementsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateRequirementsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        42_272_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedTemplateRequirementsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateRequirementsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateRequirementsRow {
...
impl NormalizedTemplateRequirementsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateRequirementsView<'_>,
    ) -> Result<(), crate::RelationError> {
