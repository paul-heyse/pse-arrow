...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    126u8, 184u8, 180u8, 9u8, 143u8, 187u8, 143u8, 50u8, 192u8, 154u8, 198u8, 223u8,
    51u8, 182u8, 74u8, 228u8, 242u8, 23u8, 67u8, 207u8, 158u8, 148u8, 245u8, 234u8, 68u8,
    235u8, 36u8, 160u8, 164u8, 253u8, 230u8, 67u8,
]);
...
impl<'a> NormalizedContributionExprImplicitRefsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedContributionExprImplicitRefsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedContributionExprImplicitRefsBuilder {
    rows: Vec<NormalizedContributionExprImplicitRefsRow>,
}
impl NormalizedContributionExprImplicitRefsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedContributionExprImplicitRefsRow::into_cells)
            .collect::<Vec<_>>();
