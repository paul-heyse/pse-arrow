...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    12u8, 114u8, 82u8, 205u8, 93u8, 170u8, 63u8, 155u8, 108u8, 155u8, 171u8, 67u8, 150u8,
    130u8, 81u8, 249u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "contribution_expr_implicit_refs";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    133u8, 133u8, 206u8, 204u8, 184u8, 249u8, 31u8, 109u8, 203u8, 170u8, 236u8, 185u8,
    76u8, 219u8, 102u8, 110u8, 194u8, 17u8, 117u8, 191u8, 211u8, 76u8, 45u8, 107u8, 48u8,
    221u8, 198u8, 177u8, 215u8, 50u8, 199u8, 206u8,
]);
...
pub struct NormalizedContributionExprImplicitRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///implicit_system_id
...
impl crate::typed::CellCodec for NormalizedContributionExprImplicitRefsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedContributionExprImplicitRefsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedContributionExprImplicitRefsRow {
    fn append(
        &self,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#unknown_ordinal: <u16 as crate::columnar::ArrowValue>::read(
...
pub type Row = NormalizedContributionExprImplicitRefsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedContributionExprImplicitRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedContributionExprImplicitRefsBuilder;
impl NormalizedContributionExprImplicitRefsRow {
...
const COMPILED_DECLARATION: &str = "[\"struct\",[[\"text\",\"compiled_relation_v1\"],[\"id\",\"0c7252cd5daa3f9b6c9bab43968251f9\"],[\"struct\",[[\"text\",\"normalized\"],[\"text\",\"contribution_expr_implicit_refs\"],[\"u64\",1]]],[\"text\",\"derived\"],[\"text\",\"derived\"],[\"text\",\"row\"],[\"text\",\"evolving\"],[\"list\",[[\"text\",\"node_id\"]]],[\"list\",[[\"struct\",[[\"struct\",[[\"text\",\"node_id\"],[\"text\",\"\\\"UInt64\\\"\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.domain.doc\"],[\"text\",\"node_id\"]]],[\"struct\",[[\"text\",\"pse.domain.role\"],[\"text\",\"key\"]]]]]]],[\"struct\",[[\"text\",\"node_id\"],[\"text\",\"\\\"UInt64\\\"\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"u64\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"key\"]]]]]]],[\"struct\",[[\"null\",null],[\"list\",[]]]],[\"null\",null]]],[\"struct\",[[\"struct\",[[\"text\",\"implicit_system_id\"],[\"text\",\"{\\\"FixedSizeBinary\\\":16}\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.domain.doc\"],[\"text\",\"implicit_system_id\"]]],[\"struct\",[[\"text\",\"pse.domain.extension\"],[\"text\",\"pse.semantic_id\"]]],[\"struct\",[[\"text\",\"pse.domain.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"text\",\"implicit_system_id\"],[\"text\",\"{\\\"FixedSizeBinary\\\":16}\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"ARROW:extension:metadata\"],[\"text\",\"{\\\"v\\\":1}\"]]],[\"struct\",[[\"text\",\"ARROW:extension:name\"],[\"text\",\"pse.semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"struct\",[[\"text\",\"extension\"],[\"text\",\"semantic_id\"],[\"text\",\"pse.semantic_id\"],[\"text\",\"{\\\"FixedSizeBinary\\\":16}\"],[\"text\",\"version_only\"],[\"u64\",1],[\"text\",\"{\\\"v\\\":1}\"],[\"null\",null],[\"text\",\"128-bit semantic identity (blueprint §5.1).\"]]],[\"list\",[]]]],[\"null\",null]]],[\"struct\",[[\"struct\",[[\"text\",\"unknown_ordinal\"],[\"text\",\"\\\"UInt16\\\"\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.domain.doc\"],[\"text\",\"unknown_ordinal\"]]],[\"struct\",[[\"text\",\"pse.domain.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"text\",\"unknown_ordinal\"],[\"text\",\"\\\"UInt16\\\"\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"u16\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"null\",null],[\"list\",[]]]],[\"null\",null]]]]],[\"text\",\"blueprint §6.9 math: math_implicit_refs.\"],[\"list\",[[\"struct\",[[\"text\",\"pse.contract.id\"],[\"text\",\"0c7252cd5daa3f9b6c9bab43968251f9\"]]],[\"struct\",[[\"text\",\"pse.contract.version\"],[\"text\",\"1\"]]],[\"struct\",[[\"text\",\"pse.namespace\"],[\"text\",\"normalized\"]]]]]]]";
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.contribution_expr_implicit_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedContributionExprImplicitRefsRow {
    type Builder = NormalizedContributionExprImplicitRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedContributionExprImplicitRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedContributionExprImplicitRefsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_096_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedContributionExprImplicitRefsView<'a> {
    ...
    unknown_ordinal_column: &'a arrow_array::UInt16Array,
}
impl<'a> NormalizedContributionExprImplicitRefsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            unknown_ordinal_column: crate::columnar::array::<
    ...
    pub const fn unknown_ordinal_column(&self) -> &'a arrow_array::UInt16Array {
        self.unknown_ordinal_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "unknown_ordinal", "`.")]
    pub fn unknown_ordinal_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedContributionExprImplicitRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedContributionExprImplicitRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedContributionExprImplicitRefsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedContributionExprImplicitRefsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedContributionExprImplicitRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
