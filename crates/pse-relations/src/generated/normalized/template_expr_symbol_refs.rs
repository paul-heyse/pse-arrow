...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    31u8, 201u8, 71u8, 44u8, 69u8, 101u8, 46u8, 251u8, 127u8, 205u8, 24u8, 251u8, 240u8,
    147u8, 224u8, 94u8, 252u8, 1u8, 132u8, 229u8, 172u8, 127u8, 122u8, 240u8, 192u8,
    100u8, 81u8, 215u8, 227u8, 50u8, 42u8, 130u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateExprSymbolRefsRow {
    ...
    fn builder_allocation_size() -> usize {
        106_856_usize + size_of::<Self::Builder>()
    }
