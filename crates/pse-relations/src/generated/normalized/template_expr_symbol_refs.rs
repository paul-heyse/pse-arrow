...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    117u8, 42u8, 65u8, 187u8, 10u8, 220u8, 170u8, 130u8, 97u8, 221u8, 227u8, 131u8, 36u8,
    54u8, 55u8, 208u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_expr_symbol_refs";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    112u8, 83u8, 2u8, 225u8, 154u8, 221u8, 96u8, 116u8, 89u8, 62u8, 228u8, 245u8, 49u8,
    226u8, 164u8, 23u8, 67u8, 231u8, 68u8, 145u8, 49u8, 242u8, 91u8, 250u8, 112u8, 162u8,
    58u8, 225u8, 224u8, 177u8, 197u8, 58u8,
]);
...
pub struct NormalizedTemplateExprSymbolRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///symbol_id
...
impl crate::typed::CellCodec for NormalizedTemplateExprSymbolRefsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedTemplateExprSymbolRefsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedTemplateExprSymbolRefsRow),
                    ))?,
            )?,
            r#symbol_id: <Option<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprSymbolRefsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateExprSymbolRefsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateExprSymbolRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateExprSymbolRefsBuilder;
impl NormalizedTemplateExprSymbolRefsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_expr_symbol_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateExprSymbolRefsRow {
    type Builder = NormalizedTemplateExprSymbolRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprSymbolRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprSymbolRefsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        111_296_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateExprSymbolRefsView<'a> {
...
impl<'a> NormalizedTemplateExprSymbolRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprSymbolRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprSymbolRefsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateExprSymbolRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateExprSymbolRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateExprSymbolRefsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateExprSymbolRefsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprSymbolRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
