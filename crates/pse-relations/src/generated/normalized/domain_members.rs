...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    59u8, 18u8, 19u8, 106u8, 50u8, 234u8, 127u8, 254u8, 151u8, 9u8, 100u8, 38u8, 223u8,
    160u8, 109u8, 205u8, 244u8, 226u8, 38u8, 244u8, 99u8, 110u8, 151u8, 167u8, 175u8,
    143u8, 47u8, 97u8, 171u8, 244u8, 108u8, 229u8,
]);
...
impl crate::columnar::ArrowValue for NormalizedDomainMembersRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedDomainMembersRow {
    type Builder = NormalizedDomainMembersBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedDomainMembersBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedDomainMembersView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        59_560_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedDomainMembersView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedDomainMembersRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedDomainMembersRow {
...
impl NormalizedDomainMembersBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedDomainMembersView<'_>,
    ) -> Result<(), crate::RelationError> {
