...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    48u8, 123u8, 212u8, 224u8, 255u8, 134u8, 214u8, 70u8, 0u8, 174u8, 58u8, 68u8, 207u8,
    115u8, 200u8, 70u8, 170u8, 200u8, 135u8, 242u8, 40u8, 153u8, 235u8, 251u8, 38u8,
    179u8, 42u8, 181u8, 45u8, 189u8, 86u8, 164u8,
]);
...
impl crate::columnar::RelationRow for NormalizedScopesRow {
    ...
    fn builder_allocation_size() -> usize {
        26_064_usize + size_of::<Self::Builder>()
    }
