...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    84u8, 32u8, 184u8, 177u8, 225u8, 22u8, 204u8, 82u8, 14u8, 142u8, 221u8, 83u8, 14u8,
    39u8, 234u8, 78u8, 72u8, 158u8, 117u8, 148u8, 135u8, 235u8, 95u8, 76u8, 166u8, 216u8,
    199u8, 144u8, 60u8, 130u8, 117u8, 84u8,
]);
