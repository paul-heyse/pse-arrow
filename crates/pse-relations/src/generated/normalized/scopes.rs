...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    173u8, 223u8, 18u8, 78u8, 74u8, 224u8, 72u8, 35u8, 2u8, 6u8, 241u8, 82u8, 79u8, 76u8,
    220u8, 216u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    75u8, 160u8, 100u8, 142u8, 140u8, 57u8, 7u8, 121u8, 250u8, 176u8, 96u8, 213u8, 53u8,
    41u8, 240u8, 135u8, 141u8, 115u8, 34u8, 202u8, 232u8, 254u8, 226u8, 102u8, 244u8,
    40u8, 177u8, 231u8, 105u8, 133u8, 145u8, 186u8,
]);
            ...
            r#scope_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedScopesRow),
                    ))?,
            )?,
            r#root_term_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedScopesRow),
...
impl crate::columnar::ArrowValue for NormalizedScopesRow {
    fn append(
        &self,
...
pub type Row = NormalizedScopesRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedScopesView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedScopesBuilder;
impl NormalizedScopesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.scopes".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedScopesRow {
    type Builder = NormalizedScopesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedScopesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedScopesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_824_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedScopesView<'a> {
...
impl<'a> NormalizedScopesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedScopesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedScopesRow {
    ...
    pub fn rows(&self) -> Result<Vec<NormalizedScopesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedScopesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedScopesBuilder {
