...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    3u8, 203u8, 83u8, 201u8, 167u8, 15u8, 194u8, 210u8, 112u8, 16u8, 14u8, 130u8, 42u8,
    179u8, 72u8, 27u8, 223u8, 20u8, 53u8, 109u8, 47u8, 166u8, 189u8, 76u8, 35u8, 185u8,
    32u8, 110u8, 78u8, 43u8, 198u8, 96u8,
]);
