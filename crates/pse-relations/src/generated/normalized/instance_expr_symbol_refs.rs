...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    203u8, 51u8, 211u8, 244u8, 61u8, 133u8, 207u8, 228u8, 73u8, 16u8, 68u8, 5u8, 138u8,
    183u8, 227u8, 37u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_expr_symbol_refs";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    236u8, 251u8, 207u8, 46u8, 255u8, 200u8, 148u8, 121u8, 44u8, 98u8, 49u8, 19u8, 200u8,
    33u8, 36u8, 235u8, 70u8, 157u8, 112u8, 255u8, 50u8, 72u8, 144u8, 129u8, 221u8, 104u8,
    66u8, 42u8, 28u8, 253u8, 21u8, 175u8,
]);
...
pub struct NormalizedInstanceExprSymbolRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///symbol_id
...
impl crate::typed::CellCodec for NormalizedInstanceExprSymbolRefsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedInstanceExprSymbolRefsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedInstanceExprSymbolRefsRow),
                    ))?,
            )?,
            r#symbol_id: <Option<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedInstanceExprSymbolRefsRow {
    fn append(
        &self,
...
pub type Row = NormalizedInstanceExprSymbolRefsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedInstanceExprSymbolRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedInstanceExprSymbolRefsBuilder;
impl NormalizedInstanceExprSymbolRefsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.instance_expr_symbol_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedInstanceExprSymbolRefsRow {
    type Builder = NormalizedInstanceExprSymbolRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedInstanceExprSymbolRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedInstanceExprSymbolRefsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct NormalizedInstanceExprSymbolRefsView<'a> {
...
impl<'a> NormalizedInstanceExprSymbolRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedInstanceExprSymbolRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedInstanceExprSymbolRefsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedInstanceExprSymbolRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedInstanceExprSymbolRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedInstanceExprSymbolRefsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedInstanceExprSymbolRefsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedInstanceExprSymbolRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
