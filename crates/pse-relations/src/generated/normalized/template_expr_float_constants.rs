...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    242u8, 173u8, 9u8, 154u8, 147u8, 74u8, 155u8, 25u8, 204u8, 68u8, 0u8, 137u8, 199u8,
    133u8, 69u8, 176u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "template_expr_float_constants";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    45u8, 186u8, 60u8, 86u8, 24u8, 34u8, 188u8, 35u8, 99u8, 230u8, 232u8, 223u8, 252u8,
    180u8, 243u8, 177u8, 215u8, 190u8, 29u8, 106u8, 60u8, 16u8, 189u8, 234u8, 127u8,
    152u8, 155u8, 85u8, 199u8, 68u8, 9u8, 35u8,
]);
...
pub struct NormalizedTemplateExprFloatConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: f64,
...
impl crate::typed::CellCodec for NormalizedTemplateExprFloatConstantsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(NormalizedTemplateExprFloatConstantsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for NormalizedTemplateExprFloatConstantsRow {
    fn append(
        &self,
...
pub type Row = NormalizedTemplateExprFloatConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedTemplateExprFloatConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedTemplateExprFloatConstantsBuilder;
impl NormalizedTemplateExprFloatConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.template_expr_float_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedTemplateExprFloatConstantsRow {
    type Builder = NormalizedTemplateExprFloatConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedTemplateExprFloatConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedTemplateExprFloatConstantsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_072_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedTemplateExprFloatConstantsView<'a> {
...
impl<'a> NormalizedTemplateExprFloatConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedTemplateExprFloatConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedTemplateExprFloatConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedTemplateExprFloatConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedTemplateExprFloatConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedTemplateExprFloatConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedTemplateExprFloatConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedTemplateExprFloatConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
