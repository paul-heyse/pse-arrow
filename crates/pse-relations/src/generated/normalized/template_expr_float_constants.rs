...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    191u8, 244u8, 131u8, 147u8, 52u8, 241u8, 128u8, 168u8, 184u8, 57u8, 116u8, 20u8,
    77u8, 30u8, 171u8, 48u8, 201u8, 83u8, 16u8, 87u8, 228u8, 186u8, 137u8, 9u8, 112u8,
    143u8, 28u8, 228u8, 3u8, 84u8, 227u8, 177u8,
]);
...
impl crate::columnar::RelationRow for NormalizedTemplateExprFloatConstantsRow {
    ...
    fn builder_allocation_size() -> usize {
        26_608_usize + size_of::<Self::Builder>()
    }
