...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    179u8, 2u8, 146u8, 235u8, 133u8, 6u8, 138u8, 47u8, 217u8, 62u8, 155u8, 84u8, 51u8,
    199u8, 61u8, 203u8, 85u8, 157u8, 133u8, 49u8, 231u8, 190u8, 38u8, 198u8, 238u8,
    190u8, 116u8, 22u8, 183u8, 156u8, 177u8, 222u8,
]);
...
impl<'a> NormalizedTemplateExprFloatConstantsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(NormalizedTemplateExprFloatConstantsRow::from_cells)
            .collect()
    }
}
...
pub struct NormalizedTemplateExprFloatConstantsBuilder {
    rows: Vec<NormalizedTemplateExprFloatConstantsRow>,
}
impl NormalizedTemplateExprFloatConstantsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(NormalizedTemplateExprFloatConstantsRow::into_cells)
            .collect::<Vec<_>>();
