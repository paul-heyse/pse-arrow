...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    174u8, 43u8, 216u8, 5u8, 189u8, 40u8, 133u8, 112u8, 104u8, 228u8, 249u8, 51u8, 19u8,
    239u8, 9u8, 124u8, 99u8, 90u8, 22u8, 151u8, 96u8, 209u8, 197u8, 163u8, 195u8, 230u8,
    166u8, 120u8, 232u8, 188u8, 16u8, 179u8,
]);
    ...
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#species_ids),
                crate::typed::CellCodec::into_cell(self.r#phase_ids),
...
impl crate::columnar::ArrowValue for NormalizedMaterialSystemsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for NormalizedMaterialSystemsRow {
    type Builder = NormalizedMaterialSystemsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedMaterialSystemsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedMaterialSystemsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        89_952_usize + size_of::<Self::Builder>()
    }
...
impl<'a> NormalizedMaterialSystemsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedMaterialSystemsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedMaterialSystemsRow {
...
impl NormalizedMaterialSystemsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedMaterialSystemsView<'_>,
    ) -> Result<(), crate::RelationError> {
