...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    19u8, 42u8, 86u8, 40u8, 152u8, 145u8, 73u8, 132u8, 4u8, 102u8, 207u8, 5u8, 18u8,
    82u8, 115u8, 254u8, 24u8, 105u8, 4u8, 196u8, 79u8, 102u8, 107u8, 208u8, 133u8, 152u8,
    141u8, 94u8, 105u8, 236u8, 142u8, 151u8,
]);
...
impl crate::columnar::RelationRow for NormalizedMaterialSystemsRow {
    ...
    fn builder_allocation_size() -> usize {
        79_776_usize + size_of::<Self::Builder>()
    }
