...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    223u8, 117u8, 167u8, 16u8, 252u8, 55u8, 191u8, 65u8, 83u8, 183u8, 225u8, 209u8, 76u8,
    114u8, 72u8, 114u8, 226u8, 131u8, 144u8, 80u8, 107u8, 233u8, 166u8, 102u8, 209u8,
    33u8, 127u8, 39u8, 242u8, 24u8, 4u8, 139u8,
]);
...
impl crate::columnar::RelationRow for NormalizedMaterialDomainMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        91_536_usize + size_of::<Self::Builder>()
    }
