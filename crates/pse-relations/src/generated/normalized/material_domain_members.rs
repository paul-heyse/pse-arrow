...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    100u8, 33u8, 32u8, 36u8, 74u8, 181u8, 172u8, 170u8, 46u8, 120u8, 31u8, 117u8, 129u8,
    4u8, 232u8, 235u8, 109u8, 119u8, 238u8, 137u8, 80u8, 244u8, 39u8, 72u8, 157u8, 117u8,
    110u8, 9u8, 229u8, 183u8, 170u8, 120u8,
]);
...
impl crate::columnar::RelationRow for NormalizedMaterialDomainMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        93_296_usize + size_of::<Self::Builder>()
    }
