...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    103u8, 40u8, 116u8, 244u8, 114u8, 116u8, 86u8, 73u8, 187u8, 69u8, 221u8, 56u8, 51u8,
    105u8, 39u8, 34u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "guard_expr_symbol_refs";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    114u8, 230u8, 112u8, 200u8, 125u8, 161u8, 127u8, 181u8, 129u8, 194u8, 218u8, 103u8,
    109u8, 43u8, 65u8, 187u8, 212u8, 179u8, 208u8, 93u8, 194u8, 128u8, 21u8, 39u8, 52u8,
    187u8, 107u8, 227u8, 132u8, 62u8, 171u8, 205u8,
]);
...
pub struct NormalizedGuardExprSymbolRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///symbol_id
...
impl crate::typed::CellCodec for NormalizedGuardExprSymbolRefsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(NormalizedGuardExprSymbolRefsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(NormalizedGuardExprSymbolRefsRow),
                    ))?,
            )?,
            r#symbol_id: <Option<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for NormalizedGuardExprSymbolRefsRow {
    fn append(
        &self,
...
pub type Row = NormalizedGuardExprSymbolRefsRow;
/// The concrete generated relation view.
pub type View<'a> = NormalizedGuardExprSymbolRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = NormalizedGuardExprSymbolRefsBuilder;
impl NormalizedGuardExprSymbolRefsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "normalized.guard_expr_symbol_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for NormalizedGuardExprSymbolRefsRow {
    type Builder = NormalizedGuardExprSymbolRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        NormalizedGuardExprSymbolRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        NormalizedGuardExprSymbolRefsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        111_272_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct NormalizedGuardExprSymbolRefsView<'a> {
...
impl<'a> NormalizedGuardExprSymbolRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<NormalizedGuardExprSymbolRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(NormalizedGuardExprSymbolRefsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<NormalizedGuardExprSymbolRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct NormalizedGuardExprSymbolRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl NormalizedGuardExprSymbolRefsBuilder {
    ...
    pub fn push(
        &mut self,
        row: NormalizedGuardExprSymbolRefsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &NormalizedGuardExprSymbolRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
