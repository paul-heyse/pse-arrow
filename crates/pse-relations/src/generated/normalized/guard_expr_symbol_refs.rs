...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    133u8, 171u8, 230u8, 42u8, 96u8, 109u8, 37u8, 29u8, 31u8, 100u8, 6u8, 44u8, 198u8,
    92u8, 114u8, 207u8, 3u8, 118u8, 143u8, 111u8, 17u8, 221u8, 229u8, 165u8, 167u8,
    200u8, 93u8, 99u8, 130u8, 210u8, 71u8, 9u8,
]);
...
impl crate::columnar::RelationRow for NormalizedGuardExprSymbolRefsRow {
    ...
    fn builder_allocation_size() -> usize {
        106_832_usize + size_of::<Self::Builder>()
    }
