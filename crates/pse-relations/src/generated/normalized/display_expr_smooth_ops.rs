...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    167u8, 131u8, 3u8, 109u8, 72u8, 36u8, 9u8, 163u8, 153u8, 203u8, 119u8, 154u8, 109u8,
    177u8, 196u8, 67u8, 159u8, 147u8, 31u8, 9u8, 127u8, 70u8, 7u8, 28u8, 51u8, 226u8,
    108u8, 54u8, 49u8, 233u8, 9u8, 51u8,
]);
...
impl crate::columnar::RelationRow for NormalizedDisplayExprSmoothOpsRow {
    ...
    fn builder_allocation_size() -> usize {
        41_016_usize + size_of::<Self::Builder>()
    }
