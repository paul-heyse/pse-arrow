...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    159u8, 104u8, 220u8, 168u8, 40u8, 76u8, 181u8, 248u8, 100u8, 203u8, 130u8, 129u8,
    202u8, 47u8, 84u8, 72u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    230u8, 199u8, 162u8, 120u8, 124u8, 43u8, 47u8, 99u8, 89u8, 126u8, 86u8, 133u8, 235u8,
    102u8, 115u8, 130u8, 106u8, 78u8, 27u8, 226u8, 80u8, 192u8, 61u8, 108u8, 129u8, 97u8,
    75u8, 241u8, 180u8, 13u8, 146u8, 4u8,
]);
...
pub struct ProvenancePortAssertionsRow {
...
impl crate::typed::CellCodec for ProvenancePortAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(ProvenancePortAssertionsRow)));
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenancePortAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenancePortAssertionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#name, children[5usize].as_mut())?;
...
pub type Row = ProvenancePortAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenancePortAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenancePortAssertionsBuilder;
impl ProvenancePortAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.port_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenancePortAssertionsRow {
    type Builder = ProvenancePortAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenancePortAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenancePortAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        109_840_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenancePortAssertionsView<'a> {
...
impl<'a> ProvenancePortAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenancePortAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenancePortAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenancePortAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenancePortAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenancePortAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenancePortAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenancePortAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
