...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    254u8, 160u8, 12u8, 250u8, 115u8, 167u8, 73u8, 22u8, 16u8, 95u8, 181u8, 207u8, 227u8,
    91u8, 165u8, 223u8, 218u8, 216u8, 113u8, 79u8, 62u8, 63u8, 93u8, 211u8, 55u8, 255u8,
    190u8, 127u8, 9u8, 74u8, 182u8, 211u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePotentialMethodResolutionAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        101_640_usize + size_of::<Self::Builder>()
    }
