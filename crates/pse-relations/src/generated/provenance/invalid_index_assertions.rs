...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    71u8, 177u8, 12u8, 119u8, 113u8, 178u8, 51u8, 106u8, 31u8, 238u8, 16u8, 67u8, 59u8,
    152u8, 57u8, 234u8, 245u8, 186u8, 40u8, 18u8, 125u8, 37u8, 178u8, 185u8, 12u8, 89u8,
    236u8, 225u8, 99u8, 202u8, 159u8, 158u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceInvalidIndexAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        68_344_usize + size_of::<Self::Builder>()
    }
