...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    35u8, 73u8, 99u8, 118u8, 242u8, 122u8, 163u8, 189u8, 99u8, 24u8, 202u8, 104u8, 221u8,
    50u8, 103u8, 210u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "invalid_index_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    33u8, 160u8, 87u8, 106u8, 162u8, 23u8, 109u8, 77u8, 126u8, 229u8, 120u8, 123u8,
    250u8, 119u8, 130u8, 112u8, 219u8, 84u8, 145u8, 118u8, 182u8, 75u8, 65u8, 134u8,
    203u8, 154u8, 205u8, 226u8, 93u8, 197u8, 183u8, 135u8,
]);
...
pub struct ProvenanceInvalidIndexAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceInvalidIndexAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceInvalidIndexAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceInvalidIndexAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceInvalidIndexAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceInvalidIndexAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceInvalidIndexAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceInvalidIndexAssertionsBuilder;
impl ProvenanceInvalidIndexAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.invalid_index_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceInvalidIndexAssertionsRow {
    type Builder = ProvenanceInvalidIndexAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceInvalidIndexAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceInvalidIndexAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        67_880_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceInvalidIndexAssertionsView<'a> {
...
impl<'a> ProvenanceInvalidIndexAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceInvalidIndexAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceInvalidIndexAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceInvalidIndexAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceInvalidIndexAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceInvalidIndexAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceInvalidIndexAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceInvalidIndexAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
