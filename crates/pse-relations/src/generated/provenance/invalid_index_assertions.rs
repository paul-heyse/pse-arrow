...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    85u8, 33u8, 23u8, 255u8, 18u8, 22u8, 112u8, 223u8, 183u8, 192u8, 187u8, 101u8, 211u8,
    205u8, 248u8, 194u8, 115u8, 181u8, 111u8, 244u8, 150u8, 56u8, 134u8, 58u8, 186u8,
    211u8, 247u8, 241u8, 20u8, 91u8, 42u8, 65u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceInvalidIndexAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        70_104_usize + size_of::<Self::Builder>()
    }
