...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    116u8, 238u8, 61u8, 152u8, 168u8, 53u8, 10u8, 217u8, 228u8, 187u8, 37u8, 63u8, 215u8,
    44u8, 233u8, 149u8, 7u8, 55u8, 160u8, 135u8, 229u8, 44u8, 65u8, 34u8, 189u8, 28u8,
    69u8, 244u8, 123u8, 46u8, 31u8, 40u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceStateMethodSelectionKeyAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_816_usize + size_of::<Self::Builder>()
    }
