...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    40u8, 152u8, 194u8, 84u8, 65u8, 103u8, 164u8, 39u8, 129u8, 215u8, 41u8, 31u8, 208u8,
    86u8, 12u8, 252u8, 46u8, 52u8, 246u8, 211u8, 99u8, 128u8, 131u8, 24u8, 192u8, 67u8,
    9u8, 55u8, 38u8, 97u8, 22u8, 127u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceStateMethodSelectionKeyAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_352_usize + size_of::<Self::Builder>()
    }
