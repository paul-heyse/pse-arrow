...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    2u8, 144u8, 240u8, 206u8, 216u8, 188u8, 111u8, 217u8, 37u8, 144u8, 124u8, 27u8,
    239u8, 35u8, 46u8, 171u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "state_method_selection_key_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    103u8, 168u8, 84u8, 200u8, 193u8, 21u8, 114u8, 102u8, 4u8, 40u8, 51u8, 33u8, 180u8,
    3u8, 110u8, 253u8, 200u8, 131u8, 15u8, 128u8, 96u8, 129u8, 7u8, 97u8, 10u8, 41u8,
    216u8, 122u8, 199u8, 162u8, 150u8, 135u8,
]);
...
pub struct ProvenanceStateMethodSelectionKeyAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceStateMethodSelectionKeyAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceStateMethodSelectionKeyAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceStateMethodSelectionKeyAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceStateMethodSelectionKeyAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceStateMethodSelectionKeyAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceStateMethodSelectionKeyAssertionsBuilder;
impl ProvenanceStateMethodSelectionKeyAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.state_method_selection_key_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceStateMethodSelectionKeyAssertionsRow {
    type Builder = ProvenanceStateMethodSelectionKeyAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceStateMethodSelectionKeyAssertionsBuilder::with_registry(
            registry,
            capacity,
        )
    }
    ...
    fn rows(
        ...
        ProvenanceStateMethodSelectionKeyAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        65_576_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceStateMethodSelectionKeyAssertionsView<'a> {
...
impl<'a> ProvenanceStateMethodSelectionKeyAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceStateMethodSelectionKeyAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceStateMethodSelectionKeyAssertionsRow {
    ...
    pub fn rows(
        ...
        Vec<ProvenanceStateMethodSelectionKeyAssertionsRow>,
        crate::RelationError,
    > {
...
#[derive(Debug)]
pub struct ProvenanceStateMethodSelectionKeyAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceStateMethodSelectionKeyAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceStateMethodSelectionKeyAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceStateMethodSelectionKeyAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
