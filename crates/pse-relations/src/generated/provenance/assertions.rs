...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    219u8, 28u8, 94u8, 208u8, 34u8, 0u8, 200u8, 135u8, 229u8, 237u8, 230u8, 200u8, 123u8,
    126u8, 230u8, 187u8, 131u8, 67u8, 117u8, 137u8, 143u8, 31u8, 66u8, 102u8, 90u8,
    182u8, 94u8, 94u8, 91u8, 13u8, 40u8, 111u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        54_296_usize + size_of::<Self::Builder>()
    }
...
impl ProvenanceAssertionsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
