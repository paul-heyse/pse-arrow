...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    239u8, 124u8, 210u8, 242u8, 199u8, 194u8, 18u8, 127u8, 35u8, 148u8, 21u8, 211u8,
    253u8, 7u8, 167u8, 3u8, 55u8, 242u8, 54u8, 124u8, 103u8, 11u8, 161u8, 128u8, 6u8,
    164u8, 14u8, 201u8, 223u8, 209u8, 8u8, 130u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceLawInternalTransferAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        65_424_usize + size_of::<Self::Builder>()
    }
