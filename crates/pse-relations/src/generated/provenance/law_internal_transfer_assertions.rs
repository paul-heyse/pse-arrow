...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    24u8, 2u8, 158u8, 157u8, 46u8, 131u8, 228u8, 10u8, 229u8, 252u8, 27u8, 8u8, 247u8,
    237u8, 178u8, 1u8, 27u8, 103u8, 205u8, 61u8, 50u8, 160u8, 223u8, 135u8, 14u8, 215u8,
    163u8, 55u8, 60u8, 91u8, 43u8, 102u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceLawInternalTransferAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_200_usize + size_of::<Self::Builder>()
    }
