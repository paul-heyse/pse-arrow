...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    183u8, 98u8, 204u8, 203u8, 99u8, 180u8, 63u8, 74u8, 249u8, 80u8, 234u8, 3u8, 124u8,
    156u8, 114u8, 89u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "law_internal_transfer_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    187u8, 53u8, 246u8, 180u8, 221u8, 83u8, 220u8, 56u8, 95u8, 199u8, 251u8, 233u8,
    237u8, 249u8, 220u8, 58u8, 2u8, 171u8, 213u8, 186u8, 56u8, 120u8, 100u8, 205u8,
    159u8, 37u8, 39u8, 24u8, 235u8, 80u8, 61u8, 62u8,
]);
...
pub struct ProvenanceLawInternalTransferAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceLawInternalTransferAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceLawInternalTransferAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceLawInternalTransferAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceLawInternalTransferAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceLawInternalTransferAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceLawInternalTransferAssertionsBuilder;
impl ProvenanceLawInternalTransferAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.law_internal_transfer_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceLawInternalTransferAssertionsRow {
    type Builder = ProvenanceLawInternalTransferAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceLawInternalTransferAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceLawInternalTransferAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        63_664_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceLawInternalTransferAssertionsView<'a> {
...
impl<'a> ProvenanceLawInternalTransferAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceLawInternalTransferAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceLawInternalTransferAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceLawInternalTransferAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceLawInternalTransferAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceLawInternalTransferAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceLawInternalTransferAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceLawInternalTransferAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
