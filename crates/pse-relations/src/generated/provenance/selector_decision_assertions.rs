...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    184u8, 202u8, 200u8, 140u8, 152u8, 161u8, 175u8, 103u8, 213u8, 201u8, 104u8, 221u8,
    123u8, 253u8, 121u8, 159u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "selector_decision_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    233u8, 76u8, 218u8, 96u8, 48u8, 109u8, 169u8, 250u8, 124u8, 222u8, 97u8, 178u8,
    221u8, 186u8, 216u8, 129u8, 110u8, 52u8, 231u8, 240u8, 110u8, 134u8, 114u8, 243u8,
    179u8, 215u8, 234u8, 178u8, 45u8, 111u8, 77u8, 101u8,
]);
...
pub struct ProvenanceSelectorDecisionAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceSelectorDecisionAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceSelectorDecisionAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceSelectorDecisionAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceSelectorDecisionAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceSelectorDecisionAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceSelectorDecisionAssertionsBuilder;
impl ProvenanceSelectorDecisionAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.selector_decision_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceSelectorDecisionAssertionsRow {
    type Builder = ProvenanceSelectorDecisionAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceSelectorDecisionAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceSelectorDecisionAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        79_480_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceSelectorDecisionAssertionsView<'a> {
...
impl<'a> ProvenanceSelectorDecisionAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceSelectorDecisionAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceSelectorDecisionAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceSelectorDecisionAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceSelectorDecisionAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceSelectorDecisionAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceSelectorDecisionAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceSelectorDecisionAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
