...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    228u8, 42u8, 32u8, 133u8, 179u8, 131u8, 183u8, 116u8, 240u8, 219u8, 112u8, 117u8,
    152u8, 253u8, 234u8, 244u8, 2u8, 67u8, 85u8, 0u8, 109u8, 116u8, 128u8, 249u8, 81u8,
    40u8, 37u8, 76u8, 189u8, 202u8, 247u8, 169u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceMaterialCountAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        81_792_usize + size_of::<Self::Builder>()
    }
