...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    243u8, 6u8, 23u8, 129u8, 84u8, 229u8, 117u8, 236u8, 42u8, 212u8, 226u8, 245u8, 28u8,
    34u8, 58u8, 154u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "material_count_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    216u8, 207u8, 213u8, 119u8, 82u8, 62u8, 105u8, 207u8, 206u8, 51u8, 240u8, 163u8,
    163u8, 51u8, 115u8, 166u8, 211u8, 127u8, 240u8, 193u8, 36u8, 127u8, 135u8, 177u8,
    137u8, 209u8, 213u8, 76u8, 99u8, 60u8, 185u8, 209u8,
]);
...
pub struct ProvenanceMaterialCountAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceMaterialCountAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceMaterialCountAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceMaterialCountAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceMaterialCountAssertionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#count, children[5usize].as_mut())?;
        output.append(true);
        Ok(())
    }
    fn append_null(
...
pub type Row = ProvenanceMaterialCountAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceMaterialCountAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceMaterialCountAssertionsBuilder;
impl ProvenanceMaterialCountAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.material_count_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceMaterialCountAssertionsRow {
    type Builder = ProvenanceMaterialCountAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceMaterialCountAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceMaterialCountAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        78_208_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceMaterialCountAssertionsView<'a> {
...
impl<'a> ProvenanceMaterialCountAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceMaterialCountAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceMaterialCountAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceMaterialCountAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceMaterialCountAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceMaterialCountAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceMaterialCountAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceMaterialCountAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
