...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    255u8, 39u8, 149u8, 34u8, 65u8, 63u8, 249u8, 145u8, 68u8, 166u8, 163u8, 13u8, 124u8,
    200u8, 146u8, 106u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_state_domain_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    2u8, 85u8, 23u8, 215u8, 132u8, 128u8, 185u8, 60u8, 63u8, 251u8, 123u8, 65u8, 44u8,
    199u8, 225u8, 18u8, 183u8, 255u8, 247u8, 20u8, 2u8, 153u8, 86u8, 225u8, 235u8, 234u8,
    4u8, 88u8, 11u8, 206u8, 173u8, 114u8,
]);
...
pub struct ProvenancePortStateDomainAssertionsRow {
...
impl crate::typed::CellCodec for ProvenancePortStateDomainAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenancePortStateDomainAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenancePortStateDomainAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenancePortStateDomainAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenancePortStateDomainAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenancePortStateDomainAssertionsBuilder;
impl ProvenancePortStateDomainAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.port_state_domain_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenancePortStateDomainAssertionsRow {
    type Builder = ProvenancePortStateDomainAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenancePortStateDomainAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenancePortStateDomainAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        89_032_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenancePortStateDomainAssertionsView<'a> {
...
impl<'a> ProvenancePortStateDomainAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenancePortStateDomainAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenancePortStateDomainAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenancePortStateDomainAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenancePortStateDomainAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenancePortStateDomainAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenancePortStateDomainAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenancePortStateDomainAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
