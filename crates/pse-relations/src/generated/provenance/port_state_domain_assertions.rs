...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    160u8, 152u8, 118u8, 50u8, 183u8, 194u8, 89u8, 152u8, 8u8, 39u8, 182u8, 134u8, 70u8,
    129u8, 233u8, 46u8, 36u8, 125u8, 203u8, 22u8, 241u8, 87u8, 28u8, 0u8, 44u8, 246u8,
    23u8, 196u8, 178u8, 71u8, 178u8, 65u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePortStateDomainAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        87_272_usize + size_of::<Self::Builder>()
    }
