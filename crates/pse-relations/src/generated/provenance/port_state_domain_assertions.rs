...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    71u8, 162u8, 162u8, 162u8, 188u8, 86u8, 72u8, 220u8, 63u8, 168u8, 234u8, 169u8,
    222u8, 52u8, 181u8, 20u8, 92u8, 107u8, 74u8, 150u8, 136u8, 247u8, 165u8, 208u8,
    155u8, 57u8, 233u8, 80u8, 227u8, 21u8, 19u8, 73u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePortStateDomainAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        82_832_usize + size_of::<Self::Builder>()
    }
