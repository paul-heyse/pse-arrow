...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    187u8, 91u8, 249u8, 228u8, 198u8, 17u8, 59u8, 209u8, 127u8, 186u8, 189u8, 128u8,
    126u8, 201u8, 19u8, 244u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "feature_check_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    241u8, 95u8, 39u8, 71u8, 100u8, 74u8, 103u8, 223u8, 37u8, 19u8, 155u8, 178u8, 234u8,
    123u8, 163u8, 232u8, 39u8, 3u8, 27u8, 185u8, 11u8, 139u8, 178u8, 32u8, 253u8, 173u8,
    100u8, 30u8, 162u8, 124u8, 240u8, 175u8,
]);
...
pub struct ProvenanceFeatureCheckAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceFeatureCheckAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceFeatureCheckAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceFeatureCheckAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceFeatureCheckAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceFeatureCheckAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceFeatureCheckAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceFeatureCheckAssertionsBuilder;
impl ProvenanceFeatureCheckAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.feature_check_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceFeatureCheckAssertionsRow {
    type Builder = ProvenanceFeatureCheckAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceFeatureCheckAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceFeatureCheckAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        77_928_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceFeatureCheckAssertionsView<'a> {
...
impl<'a> ProvenanceFeatureCheckAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceFeatureCheckAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceFeatureCheckAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceFeatureCheckAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceFeatureCheckAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceFeatureCheckAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceFeatureCheckAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceFeatureCheckAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
