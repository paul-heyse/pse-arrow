...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    248u8, 63u8, 240u8, 2u8, 64u8, 130u8, 105u8, 140u8, 101u8, 30u8, 78u8, 151u8, 68u8,
    245u8, 21u8, 162u8, 103u8, 65u8, 49u8, 172u8, 194u8, 22u8, 94u8, 142u8, 39u8, 150u8,
    123u8, 87u8, 227u8, 23u8, 131u8, 238u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceFeatureCheckAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        78_392_usize + size_of::<Self::Builder>()
    }
