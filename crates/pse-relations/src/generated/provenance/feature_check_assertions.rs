...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    3u8, 54u8, 20u8, 206u8, 22u8, 44u8, 41u8, 173u8, 7u8, 40u8, 147u8, 243u8, 129u8, 8u8,
    94u8, 11u8, 247u8, 219u8, 199u8, 223u8, 191u8, 124u8, 73u8, 132u8, 33u8, 24u8, 226u8,
    7u8, 237u8, 130u8, 89u8, 88u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceFeatureCheckAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        80_152_usize + size_of::<Self::Builder>()
    }
