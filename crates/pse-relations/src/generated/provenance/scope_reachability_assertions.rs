...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    72u8, 16u8, 2u8, 132u8, 196u8, 160u8, 192u8, 54u8, 57u8, 183u8, 183u8, 234u8, 57u8,
    63u8, 234u8, 117u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_reachability_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    91u8, 96u8, 26u8, 1u8, 232u8, 55u8, 160u8, 164u8, 82u8, 171u8, 34u8, 41u8, 70u8,
    12u8, 83u8, 167u8, 250u8, 85u8, 242u8, 182u8, 164u8, 136u8, 65u8, 105u8, 101u8,
    116u8, 229u8, 200u8, 96u8, 247u8, 235u8, 58u8,
]);
...
pub struct ProvenanceScopeReachabilityAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceScopeReachabilityAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceScopeReachabilityAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceScopeReachabilityAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceScopeReachabilityAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceScopeReachabilityAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceScopeReachabilityAssertionsBuilder;
impl ProvenanceScopeReachabilityAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.scope_reachability_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceScopeReachabilityAssertionsRow {
    type Builder = ProvenanceScopeReachabilityAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceScopeReachabilityAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceScopeReachabilityAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        65_264_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceScopeReachabilityAssertionsView<'a> {
...
impl<'a> ProvenanceScopeReachabilityAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceScopeReachabilityAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceScopeReachabilityAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceScopeReachabilityAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceScopeReachabilityAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceScopeReachabilityAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceScopeReachabilityAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceScopeReachabilityAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
