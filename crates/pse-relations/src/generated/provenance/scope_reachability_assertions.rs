...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    231u8, 181u8, 8u8, 88u8, 8u8, 195u8, 16u8, 255u8, 85u8, 237u8, 31u8, 236u8, 35u8,
    232u8, 49u8, 223u8, 207u8, 159u8, 14u8, 101u8, 44u8, 46u8, 230u8, 121u8, 32u8, 26u8,
    239u8, 118u8, 115u8, 133u8, 98u8, 139u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopeReachabilityAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_504_usize + size_of::<Self::Builder>()
    }
