...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    150u8, 20u8, 100u8, 145u8, 224u8, 50u8, 143u8, 179u8, 39u8, 80u8, 12u8, 209u8, 10u8,
    233u8, 36u8, 2u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "demand_request_key_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    196u8, 195u8, 233u8, 116u8, 180u8, 96u8, 104u8, 229u8, 86u8, 181u8, 112u8, 3u8, 62u8,
    114u8, 194u8, 196u8, 247u8, 182u8, 102u8, 156u8, 6u8, 64u8, 220u8, 124u8, 61u8,
    102u8, 3u8, 192u8, 199u8, 3u8, 212u8, 146u8,
]);
...
pub struct ProvenanceDemandRequestKeyAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceDemandRequestKeyAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceDemandRequestKeyAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceDemandRequestKeyAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceDemandRequestKeyAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceDemandRequestKeyAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceDemandRequestKeyAssertionsBuilder;
impl ProvenanceDemandRequestKeyAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.demand_request_key_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceDemandRequestKeyAssertionsRow {
    type Builder = ProvenanceDemandRequestKeyAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceDemandRequestKeyAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceDemandRequestKeyAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        74_472_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceDemandRequestKeyAssertionsView<'a> {
...
impl<'a> ProvenanceDemandRequestKeyAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceDemandRequestKeyAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceDemandRequestKeyAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceDemandRequestKeyAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceDemandRequestKeyAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceDemandRequestKeyAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceDemandRequestKeyAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceDemandRequestKeyAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
