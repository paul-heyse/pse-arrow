...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    10u8, 131u8, 174u8, 28u8, 96u8, 80u8, 77u8, 236u8, 98u8, 132u8, 60u8, 243u8, 18u8,
    237u8, 255u8, 59u8, 36u8, 33u8, 229u8, 221u8, 228u8, 163u8, 156u8, 192u8, 196u8,
    89u8, 57u8, 226u8, 20u8, 147u8, 34u8, 251u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceDemandRequestKeyAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        74_008_usize + size_of::<Self::Builder>()
    }
