...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    180u8, 47u8, 22u8, 101u8, 72u8, 185u8, 45u8, 74u8, 89u8, 126u8, 11u8, 164u8, 36u8,
    212u8, 201u8, 145u8, 87u8, 75u8, 189u8, 151u8, 52u8, 145u8, 234u8, 245u8, 80u8,
    150u8, 208u8, 202u8, 29u8, 120u8, 102u8, 53u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceDemandRequestKeyAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        76_232_usize + size_of::<Self::Builder>()
    }
