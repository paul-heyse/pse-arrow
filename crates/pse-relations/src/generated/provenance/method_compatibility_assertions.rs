...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    46u8, 127u8, 190u8, 169u8, 206u8, 185u8, 61u8, 162u8, 95u8, 209u8, 222u8, 4u8, 56u8,
    226u8, 211u8, 197u8, 143u8, 30u8, 34u8, 215u8, 93u8, 135u8, 193u8, 163u8, 92u8,
    180u8, 85u8, 223u8, 69u8, 84u8, 114u8, 26u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceMethodCompatibilityAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        88_784_usize + size_of::<Self::Builder>()
    }
