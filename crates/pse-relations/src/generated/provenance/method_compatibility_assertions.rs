...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    94u8, 24u8, 146u8, 29u8, 47u8, 185u8, 171u8, 71u8, 12u8, 88u8, 232u8, 171u8, 238u8,
    32u8, 221u8, 197u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "method_compatibility_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    65u8, 201u8, 248u8, 27u8, 198u8, 55u8, 198u8, 56u8, 70u8, 48u8, 68u8, 45u8, 72u8,
    227u8, 123u8, 251u8, 181u8, 125u8, 163u8, 49u8, 100u8, 178u8, 121u8, 136u8, 133u8,
    110u8, 50u8, 19u8, 19u8, 179u8, 225u8, 192u8,
]);
...
pub struct ProvenanceMethodCompatibilityAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceMethodCompatibilityAssertionsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#compatible),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceMethodCompatibilityAssertionsRow),
                ),
            );
        };
        ...
        Ok(Self {
            ...
            r#compatible: <bool as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceMethodCompatibilityAssertionsRow),
...
impl crate::columnar::ArrowValue for ProvenanceMethodCompatibilityAssertionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#reason, children[6usize].as_mut())?;
        output.append(true);
        Ok(())
    }
    fn append_null(
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#compatible: <bool as crate::columnar::ArrowValue>::read(
...
pub type Row = ProvenanceMethodCompatibilityAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceMethodCompatibilityAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceMethodCompatibilityAssertionsBuilder;
impl ProvenanceMethodCompatibilityAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.method_compatibility_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceMethodCompatibilityAssertionsRow {
    type Builder = ProvenanceMethodCompatibilityAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceMethodCompatibilityAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceMethodCompatibilityAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        87_024_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceMethodCompatibilityAssertionsView<'a> {
    ...
    compatible_column: &'a arrow_array::BooleanArray,
    reason_column: &'a arrow_array::StringArray,
}
impl<'a> ProvenanceMethodCompatibilityAssertionsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            compatible_column: crate::columnar::array::<
    ...
    pub const fn compatible_column(&self) -> &'a arrow_array::BooleanArray {
        self.compatible_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "compatible", "`.")]
    pub fn compatible_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceMethodCompatibilityAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceMethodCompatibilityAssertionsRow {
            ...
            r#compatible: crate::columnar::ArrowValue::read(
                self.compatible_column,
                index,
            )?,
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceMethodCompatibilityAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceMethodCompatibilityAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceMethodCompatibilityAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceMethodCompatibilityAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceMethodCompatibilityAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
