...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    233u8, 242u8, 2u8, 173u8, 253u8, 8u8, 104u8, 45u8, 201u8, 199u8, 252u8, 162u8, 85u8,
    42u8, 7u8, 49u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "potential_method_winner_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    80u8, 95u8, 152u8, 142u8, 222u8, 242u8, 151u8, 85u8, 136u8, 204u8, 30u8, 183u8, 57u8,
    26u8, 252u8, 8u8, 163u8, 48u8, 177u8, 250u8, 3u8, 160u8, 71u8, 128u8, 105u8, 150u8,
    144u8, 79u8, 78u8, 216u8, 160u8, 59u8,
]);
...
pub struct ProvenancePotentialMethodWinnerAssertionsRow {
...
impl crate::typed::CellCodec for ProvenancePotentialMethodWinnerAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenancePotentialMethodWinnerAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenancePotentialMethodWinnerAssertionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#rank, children[6usize].as_mut())?;
        output.append(true);
        Ok(())
    }
    fn append_null(
        ...
        <u16 as crate::columnar::ArrowValue>::append_null(children[6usize].as_mut())?;
        output.append(false);
        Ok(())
    }
    fn read(
...
pub type Row = ProvenancePotentialMethodWinnerAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenancePotentialMethodWinnerAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenancePotentialMethodWinnerAssertionsBuilder;
impl ProvenancePotentialMethodWinnerAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.potential_method_winner_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenancePotentialMethodWinnerAssertionsRow {
    type Builder = ProvenancePotentialMethodWinnerAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenancePotentialMethodWinnerAssertionsBuilder::with_registry(
            registry,
            capacity,
        )
    }
    ...
    fn rows(
        ...
        ProvenancePotentialMethodWinnerAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        80_120_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenancePotentialMethodWinnerAssertionsView<'a> {
...
impl<'a> ProvenancePotentialMethodWinnerAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenancePotentialMethodWinnerAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenancePotentialMethodWinnerAssertionsRow {
    ...
    pub fn rows(
        ...
        Vec<ProvenancePotentialMethodWinnerAssertionsRow>,
        crate::RelationError,
    > {
...
#[derive(Debug)]
pub struct ProvenancePotentialMethodWinnerAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenancePotentialMethodWinnerAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenancePotentialMethodWinnerAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenancePotentialMethodWinnerAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
