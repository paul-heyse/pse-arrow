...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    9u8, 213u8, 12u8, 221u8, 146u8, 28u8, 123u8, 41u8, 208u8, 21u8, 85u8, 206u8, 222u8,
    31u8, 80u8, 21u8, 171u8, 40u8, 10u8, 73u8, 93u8, 179u8, 153u8, 35u8, 121u8, 96u8,
    205u8, 147u8, 39u8, 59u8, 168u8, 125u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePotentialMethodWinnerAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        79_656_usize + size_of::<Self::Builder>()
    }
