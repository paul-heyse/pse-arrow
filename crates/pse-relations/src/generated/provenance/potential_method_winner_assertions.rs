...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    116u8, 204u8, 160u8, 206u8, 98u8, 117u8, 74u8, 226u8, 25u8, 69u8, 174u8, 213u8,
    162u8, 206u8, 145u8, 11u8, 135u8, 17u8, 204u8, 87u8, 37u8, 252u8, 42u8, 155u8, 42u8,
    40u8, 79u8, 247u8, 7u8, 103u8, 161u8, 83u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePotentialMethodWinnerAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        83_016_usize + size_of::<Self::Builder>()
    }
