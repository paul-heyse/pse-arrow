...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    85u8, 227u8, 22u8, 240u8, 189u8, 60u8, 80u8, 179u8, 98u8, 141u8, 165u8, 141u8, 118u8,
    230u8, 197u8, 151u8, 216u8, 114u8, 87u8, 44u8, 145u8, 254u8, 193u8, 49u8, 29u8,
    177u8, 200u8, 173u8, 248u8, 139u8, 95u8, 154u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceAlgorithmSourceOccurrencesRow {
    ...
    fn builder_allocation_size() -> usize {
        54_368_usize + size_of::<Self::Builder>()
    }
