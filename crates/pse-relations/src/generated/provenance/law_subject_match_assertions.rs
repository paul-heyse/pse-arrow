...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    21u8, 213u8, 52u8, 110u8, 0u8, 14u8, 90u8, 165u8, 218u8, 108u8, 96u8, 2u8, 68u8,
    138u8, 129u8, 116u8, 238u8, 77u8, 190u8, 45u8, 223u8, 9u8, 251u8, 243u8, 105u8,
    231u8, 87u8, 215u8, 112u8, 201u8, 203u8, 19u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceLawSubjectMatchAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_632_usize + size_of::<Self::Builder>()
    }
