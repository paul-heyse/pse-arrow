...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    236u8, 206u8, 87u8, 205u8, 115u8, 64u8, 199u8, 77u8, 220u8, 199u8, 41u8, 150u8, 92u8,
    73u8, 120u8, 174u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "law_subject_match_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    183u8, 76u8, 181u8, 43u8, 212u8, 82u8, 162u8, 205u8, 220u8, 249u8, 189u8, 113u8,
    127u8, 208u8, 98u8, 235u8, 78u8, 220u8, 55u8, 164u8, 183u8, 113u8, 152u8, 199u8,
    251u8, 236u8, 220u8, 167u8, 73u8, 225u8, 22u8, 80u8,
]);
...
pub struct ProvenanceLawSubjectMatchAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceLawSubjectMatchAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceLawSubjectMatchAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceLawSubjectMatchAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceLawSubjectMatchAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceLawSubjectMatchAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceLawSubjectMatchAssertionsBuilder;
impl ProvenanceLawSubjectMatchAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.law_subject_match_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceLawSubjectMatchAssertionsRow {
    type Builder = ProvenanceLawSubjectMatchAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceLawSubjectMatchAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceLawSubjectMatchAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        63_168_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceLawSubjectMatchAssertionsView<'a> {
...
impl<'a> ProvenanceLawSubjectMatchAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceLawSubjectMatchAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceLawSubjectMatchAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceLawSubjectMatchAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceLawSubjectMatchAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceLawSubjectMatchAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceLawSubjectMatchAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceLawSubjectMatchAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
