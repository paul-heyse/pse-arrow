...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    174u8, 68u8, 67u8, 203u8, 147u8, 141u8, 62u8, 48u8, 180u8, 4u8, 64u8, 43u8, 51u8,
    139u8, 94u8, 49u8, 215u8, 217u8, 128u8, 218u8, 77u8, 157u8, 121u8, 171u8, 17u8, 0u8,
    243u8, 207u8, 23u8, 114u8, 175u8, 182u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceLawEmptyApplicationAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        52_336_usize + size_of::<Self::Builder>()
    }
