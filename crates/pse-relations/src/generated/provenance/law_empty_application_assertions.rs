...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    117u8, 235u8, 238u8, 142u8, 57u8, 115u8, 11u8, 56u8, 87u8, 47u8, 170u8, 150u8, 131u8,
    244u8, 90u8, 60u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "law_empty_application_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    164u8, 65u8, 121u8, 76u8, 204u8, 219u8, 215u8, 78u8, 107u8, 218u8, 212u8, 71u8, 37u8,
    58u8, 150u8, 251u8, 43u8, 90u8, 33u8, 214u8, 11u8, 131u8, 5u8, 211u8, 132u8, 42u8,
    255u8, 121u8, 41u8, 253u8, 158u8, 116u8,
]);
...
pub struct ProvenanceLawEmptyApplicationAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceLawEmptyApplicationAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceLawEmptyApplicationAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceLawEmptyApplicationAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceLawEmptyApplicationAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceLawEmptyApplicationAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceLawEmptyApplicationAssertionsBuilder;
impl ProvenanceLawEmptyApplicationAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.law_empty_application_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceLawEmptyApplicationAssertionsRow {
    type Builder = ProvenanceLawEmptyApplicationAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceLawEmptyApplicationAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceLawEmptyApplicationAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        52_800_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceLawEmptyApplicationAssertionsView<'a> {
...
impl<'a> ProvenanceLawEmptyApplicationAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceLawEmptyApplicationAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceLawEmptyApplicationAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceLawEmptyApplicationAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceLawEmptyApplicationAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceLawEmptyApplicationAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceLawEmptyApplicationAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceLawEmptyApplicationAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
