...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    217u8, 33u8, 70u8, 126u8, 247u8, 78u8, 143u8, 57u8, 22u8, 254u8, 117u8, 231u8, 68u8,
    38u8, 3u8, 222u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_guard_violation_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    181u8, 106u8, 99u8, 106u8, 141u8, 193u8, 177u8, 85u8, 242u8, 114u8, 1u8, 13u8, 110u8,
    241u8, 196u8, 207u8, 215u8, 115u8, 71u8, 152u8, 167u8, 207u8, 219u8, 198u8, 184u8,
    39u8, 59u8, 181u8, 41u8, 8u8, 21u8, 148u8,
]);
...
pub struct ProvenanceInstanceGuardViolationAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceInstanceGuardViolationAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceInstanceGuardViolationAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceInstanceGuardViolationAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceInstanceGuardViolationAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceInstanceGuardViolationAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceInstanceGuardViolationAssertionsBuilder;
impl ProvenanceInstanceGuardViolationAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.instance_guard_violation_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceInstanceGuardViolationAssertionsRow {
    type Builder = ProvenanceInstanceGuardViolationAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceInstanceGuardViolationAssertionsBuilder::with_registry(
            registry,
            capacity,
        )
    }
    ...
    fn rows(
        ...
        ProvenanceInstanceGuardViolationAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        58_120_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceInstanceGuardViolationAssertionsView<'a> {
...
impl<'a> ProvenanceInstanceGuardViolationAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceInstanceGuardViolationAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceInstanceGuardViolationAssertionsRow {
    ...
    pub fn rows(
        ...
        Vec<ProvenanceInstanceGuardViolationAssertionsRow>,
        crate::RelationError,
    > {
...
#[derive(Debug)]
pub struct ProvenanceInstanceGuardViolationAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceInstanceGuardViolationAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceInstanceGuardViolationAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceInstanceGuardViolationAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
