...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    155u8, 196u8, 75u8, 206u8, 99u8, 15u8, 142u8, 89u8, 221u8, 154u8, 4u8, 37u8, 150u8,
    182u8, 233u8, 225u8, 183u8, 255u8, 107u8, 57u8, 112u8, 215u8, 182u8, 139u8, 38u8,
    38u8, 59u8, 97u8, 70u8, 242u8, 1u8, 151u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceInstanceGuardViolationAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        60_344_usize + size_of::<Self::Builder>()
    }
