...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    163u8, 101u8, 25u8, 213u8, 90u8, 144u8, 253u8, 171u8, 148u8, 92u8, 55u8, 137u8,
    103u8, 185u8, 99u8, 20u8, 176u8, 24u8, 82u8, 169u8, 28u8, 0u8, 55u8, 202u8, 69u8,
    115u8, 120u8, 109u8, 153u8, 70u8, 46u8, 239u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePhaseSpeciesAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        80_128_usize + size_of::<Self::Builder>()
    }
