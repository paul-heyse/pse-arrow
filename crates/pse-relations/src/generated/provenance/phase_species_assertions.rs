...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    246u8, 93u8, 40u8, 192u8, 196u8, 194u8, 246u8, 129u8, 142u8, 100u8, 95u8, 118u8,
    168u8, 27u8, 215u8, 69u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "phase_species_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    20u8, 243u8, 198u8, 93u8, 178u8, 113u8, 214u8, 20u8, 35u8, 206u8, 2u8, 51u8, 67u8,
    159u8, 110u8, 225u8, 30u8, 81u8, 221u8, 120u8, 171u8, 209u8, 181u8, 143u8, 64u8,
    148u8, 108u8, 245u8, 25u8, 211u8, 253u8, 51u8,
]);
...
pub struct ProvenancePhaseSpeciesAssertionsRow {
...
impl crate::typed::CellCodec for ProvenancePhaseSpeciesAssertionsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#henry),
            ],
        )
    }
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenancePhaseSpeciesAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenancePhaseSpeciesAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenancePhaseSpeciesAssertionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#henry, children[6usize].as_mut())?;
        output.append(true);
        Ok(())
    }
    fn append_null(
...
pub type Row = ProvenancePhaseSpeciesAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenancePhaseSpeciesAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenancePhaseSpeciesAssertionsBuilder;
impl ProvenancePhaseSpeciesAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.phase_species_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenancePhaseSpeciesAssertionsRow {
    type Builder = ProvenancePhaseSpeciesAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenancePhaseSpeciesAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenancePhaseSpeciesAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        79_664_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenancePhaseSpeciesAssertionsView<'a> {
...
impl<'a> ProvenancePhaseSpeciesAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenancePhaseSpeciesAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenancePhaseSpeciesAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenancePhaseSpeciesAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenancePhaseSpeciesAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenancePhaseSpeciesAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenancePhaseSpeciesAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenancePhaseSpeciesAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
