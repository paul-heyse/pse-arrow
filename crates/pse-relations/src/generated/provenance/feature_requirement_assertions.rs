...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    75u8, 97u8, 215u8, 23u8, 251u8, 51u8, 37u8, 244u8, 31u8, 139u8, 1u8, 9u8, 23u8,
    238u8, 67u8, 236u8, 202u8, 187u8, 186u8, 176u8, 97u8, 75u8, 104u8, 20u8, 29u8, 44u8,
    56u8, 87u8, 31u8, 66u8, 27u8, 6u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceFeatureRequirementAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        60_256_usize + size_of::<Self::Builder>()
    }
