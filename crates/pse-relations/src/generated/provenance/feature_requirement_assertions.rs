...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    97u8, 62u8, 152u8, 60u8, 248u8, 100u8, 70u8, 97u8, 64u8, 218u8, 36u8, 215u8, 138u8,
    21u8, 9u8, 116u8, 37u8, 73u8, 201u8, 98u8, 93u8, 188u8, 252u8, 193u8, 196u8, 50u8,
    87u8, 85u8, 246u8, 138u8, 37u8, 148u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceFeatureRequirementAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        58_032_usize + size_of::<Self::Builder>()
    }
