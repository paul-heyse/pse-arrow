...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    23u8, 240u8, 224u8, 160u8, 81u8, 22u8, 172u8, 176u8, 43u8, 164u8, 6u8, 70u8, 14u8,
    202u8, 59u8, 245u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "feature_requirement_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    248u8, 113u8, 29u8, 44u8, 22u8, 24u8, 221u8, 180u8, 111u8, 193u8, 107u8, 73u8, 53u8,
    178u8, 77u8, 240u8, 104u8, 108u8, 220u8, 178u8, 72u8, 85u8, 114u8, 191u8, 27u8,
    195u8, 141u8, 67u8, 139u8, 185u8, 79u8, 88u8,
]);
...
pub struct ProvenanceFeatureRequirementAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceFeatureRequirementAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceFeatureRequirementAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceFeatureRequirementAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceFeatureRequirementAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceFeatureRequirementAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceFeatureRequirementAssertionsBuilder;
impl ProvenanceFeatureRequirementAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.feature_requirement_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceFeatureRequirementAssertionsRow {
    type Builder = ProvenanceFeatureRequirementAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceFeatureRequirementAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceFeatureRequirementAssertionsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct ProvenanceFeatureRequirementAssertionsView<'a> {
...
impl<'a> ProvenanceFeatureRequirementAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceFeatureRequirementAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceFeatureRequirementAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceFeatureRequirementAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceFeatureRequirementAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceFeatureRequirementAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceFeatureRequirementAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceFeatureRequirementAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
