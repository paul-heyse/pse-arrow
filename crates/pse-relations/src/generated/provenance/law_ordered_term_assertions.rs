...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    12u8, 155u8, 30u8, 169u8, 252u8, 19u8, 81u8, 115u8, 3u8, 108u8, 18u8, 28u8, 131u8,
    162u8, 170u8, 12u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "law_ordered_term_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    190u8, 103u8, 207u8, 67u8, 130u8, 90u8, 18u8, 138u8, 209u8, 88u8, 51u8, 123u8, 109u8,
    235u8, 230u8, 233u8, 51u8, 169u8, 254u8, 99u8, 123u8, 27u8, 142u8, 86u8, 134u8,
    244u8, 31u8, 3u8, 35u8, 159u8, 174u8, 120u8,
]);
...
pub struct ProvenanceLawOrderedTermAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceLawOrderedTermAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceLawOrderedTermAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceLawOrderedTermAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceLawOrderedTermAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceLawOrderedTermAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceLawOrderedTermAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceLawOrderedTermAssertionsBuilder;
impl ProvenanceLawOrderedTermAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.law_ordered_term_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceLawOrderedTermAssertionsRow {
    type Builder = ProvenanceLawOrderedTermAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceLawOrderedTermAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceLawOrderedTermAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        78_512_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceLawOrderedTermAssertionsView<'a> {
...
impl<'a> ProvenanceLawOrderedTermAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceLawOrderedTermAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceLawOrderedTermAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceLawOrderedTermAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceLawOrderedTermAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceLawOrderedTermAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceLawOrderedTermAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceLawOrderedTermAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
