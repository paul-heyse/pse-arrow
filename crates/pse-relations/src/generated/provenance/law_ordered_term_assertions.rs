...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    144u8, 215u8, 54u8, 118u8, 78u8, 113u8, 246u8, 186u8, 98u8, 6u8, 185u8, 232u8, 15u8,
    239u8, 67u8, 240u8, 215u8, 209u8, 60u8, 137u8, 9u8, 131u8, 72u8, 247u8, 36u8, 90u8,
    210u8, 41u8, 34u8, 183u8, 25u8, 250u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceLawOrderedTermAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        76_752_usize + size_of::<Self::Builder>()
    }
