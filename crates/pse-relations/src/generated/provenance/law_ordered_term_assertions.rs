...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    117u8, 150u8, 26u8, 99u8, 99u8, 132u8, 253u8, 1u8, 192u8, 99u8, 58u8, 85u8, 43u8,
    71u8, 192u8, 157u8, 254u8, 255u8, 100u8, 232u8, 72u8, 171u8, 133u8, 74u8, 13u8, 76u8,
    92u8, 170u8, 242u8, 237u8, 100u8, 156u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceLawOrderedTermAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        72_312_usize + size_of::<Self::Builder>()
    }
