...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    100u8, 5u8, 128u8, 87u8, 191u8, 108u8, 97u8, 175u8, 67u8, 15u8, 99u8, 62u8, 166u8,
    92u8, 118u8, 93u8, 124u8, 151u8, 52u8, 33u8, 44u8, 137u8, 171u8, 141u8, 248u8, 225u8,
    62u8, 196u8, 131u8, 9u8, 61u8, 186u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceUnboundPortAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        79_320_usize + size_of::<Self::Builder>()
    }
