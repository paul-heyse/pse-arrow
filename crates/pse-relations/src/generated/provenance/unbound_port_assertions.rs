...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    97u8, 11u8, 120u8, 244u8, 0u8, 103u8, 73u8, 2u8, 30u8, 191u8, 109u8, 220u8, 70u8,
    167u8, 96u8, 237u8, 16u8, 189u8, 218u8, 250u8, 120u8, 70u8, 157u8, 101u8, 83u8,
    137u8, 255u8, 39u8, 22u8, 41u8, 71u8, 93u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceUnboundPortAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        78_856_usize + size_of::<Self::Builder>()
    }
