...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    79u8, 79u8, 220u8, 175u8, 77u8, 228u8, 38u8, 100u8, 101u8, 235u8, 241u8, 124u8, 91u8,
    120u8, 204u8, 143u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "unbound_port_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    236u8, 124u8, 100u8, 248u8, 8u8, 128u8, 241u8, 172u8, 177u8, 106u8, 205u8, 224u8,
    68u8, 19u8, 249u8, 87u8, 194u8, 12u8, 55u8, 218u8, 223u8, 114u8, 233u8, 177u8, 141u8,
    70u8, 160u8, 205u8, 147u8, 84u8, 130u8, 128u8,
]);
...
pub struct ProvenanceUnboundPortAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceUnboundPortAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceUnboundPortAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceUnboundPortAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceUnboundPortAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceUnboundPortAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceUnboundPortAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceUnboundPortAssertionsBuilder;
impl ProvenanceUnboundPortAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.unbound_port_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceUnboundPortAssertionsRow {
    type Builder = ProvenanceUnboundPortAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceUnboundPortAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceUnboundPortAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        81_080_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceUnboundPortAssertionsView<'a> {
...
impl<'a> ProvenanceUnboundPortAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceUnboundPortAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceUnboundPortAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceUnboundPortAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceUnboundPortAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceUnboundPortAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceUnboundPortAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceUnboundPortAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
