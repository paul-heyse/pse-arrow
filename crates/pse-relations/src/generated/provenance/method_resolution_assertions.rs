...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    203u8, 2u8, 242u8, 170u8, 65u8, 27u8, 239u8, 123u8, 217u8, 112u8, 10u8, 229u8, 222u8,
    231u8, 91u8, 215u8, 196u8, 105u8, 75u8, 8u8, 194u8, 55u8, 250u8, 92u8, 29u8, 40u8,
    28u8, 160u8, 113u8, 75u8, 152u8, 139u8,
]);
