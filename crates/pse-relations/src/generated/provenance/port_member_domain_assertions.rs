...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    47u8, 133u8, 53u8, 86u8, 100u8, 159u8, 184u8, 18u8, 61u8, 178u8, 239u8, 245u8, 104u8,
    146u8, 229u8, 166u8, 249u8, 232u8, 207u8, 248u8, 150u8, 223u8, 129u8, 186u8, 58u8,
    243u8, 83u8, 98u8, 32u8, 168u8, 94u8, 61u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePortMemberDomainAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        95_976_usize + size_of::<Self::Builder>()
    }
