...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    2u8, 83u8, 229u8, 112u8, 50u8, 9u8, 244u8, 149u8, 85u8, 222u8, 135u8, 202u8, 35u8,
    37u8, 151u8, 3u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_member_domain_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    33u8, 88u8, 114u8, 86u8, 25u8, 99u8, 118u8, 222u8, 143u8, 45u8, 15u8, 61u8, 128u8,
    242u8, 131u8, 205u8, 213u8, 20u8, 158u8, 117u8, 34u8, 49u8, 15u8, 80u8, 236u8, 33u8,
    208u8, 187u8, 200u8, 166u8, 200u8, 173u8,
]);
...
pub struct ProvenancePortMemberDomainAssertionsRow {
...
impl crate::typed::CellCodec for ProvenancePortMemberDomainAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenancePortMemberDomainAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenancePortMemberDomainAssertionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#ordinal, children[4usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#domain_ids,
    ...
    fn append_null(
        ...
        <u16 as crate::columnar::ArrowValue>::append_null(children[4usize].as_mut())?;
        <Vec<
            pse_ids::SemanticId,
...
pub type Row = ProvenancePortMemberDomainAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenancePortMemberDomainAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenancePortMemberDomainAssertionsBuilder;
impl ProvenancePortMemberDomainAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.port_member_domain_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenancePortMemberDomainAssertionsRow {
    type Builder = ProvenancePortMemberDomainAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenancePortMemberDomainAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenancePortMemberDomainAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        93_080_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenancePortMemberDomainAssertionsView<'a> {
...
impl<'a> ProvenancePortMemberDomainAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenancePortMemberDomainAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenancePortMemberDomainAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenancePortMemberDomainAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenancePortMemberDomainAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenancePortMemberDomainAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenancePortMemberDomainAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenancePortMemberDomainAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
