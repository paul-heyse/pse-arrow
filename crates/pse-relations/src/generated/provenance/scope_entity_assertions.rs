...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    11u8, 37u8, 122u8, 54u8, 55u8, 209u8, 113u8, 46u8, 214u8, 25u8, 243u8, 179u8, 127u8,
    152u8, 106u8, 43u8, 37u8, 135u8, 23u8, 40u8, 160u8, 74u8, 249u8, 240u8, 24u8, 161u8,
    191u8, 211u8, 209u8, 234u8, 250u8, 229u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopeEntityAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        90_464_usize + size_of::<Self::Builder>()
    }
