...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    62u8, 155u8, 138u8, 67u8, 75u8, 215u8, 240u8, 202u8, 164u8, 45u8, 104u8, 49u8, 177u8,
    32u8, 241u8, 14u8, 75u8, 138u8, 227u8, 248u8, 77u8, 233u8, 169u8, 154u8, 175u8, 30u8,
    37u8, 166u8, 186u8, 170u8, 211u8, 249u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopeEntityAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        88_704_usize + size_of::<Self::Builder>()
    }
