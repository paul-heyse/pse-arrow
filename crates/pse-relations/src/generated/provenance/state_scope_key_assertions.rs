...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    65u8, 122u8, 239u8, 224u8, 13u8, 95u8, 236u8, 246u8, 153u8, 115u8, 192u8, 217u8,
    187u8, 0u8, 59u8, 26u8, 23u8, 211u8, 134u8, 223u8, 199u8, 232u8, 2u8, 203u8, 112u8,
    230u8, 161u8, 106u8, 1u8, 10u8, 238u8, 43u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceStateScopeKeyAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_264_usize + size_of::<Self::Builder>()
    }
