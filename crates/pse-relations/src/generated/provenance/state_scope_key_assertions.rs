...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    215u8, 161u8, 233u8, 49u8, 102u8, 224u8, 123u8, 92u8, 29u8, 14u8, 132u8, 12u8, 64u8,
    5u8, 237u8, 94u8, 46u8, 132u8, 96u8, 154u8, 188u8, 5u8, 195u8, 232u8, 65u8, 44u8,
    173u8, 149u8, 94u8, 226u8, 70u8, 180u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceStateScopeKeyAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        65_488_usize + size_of::<Self::Builder>()
    }
