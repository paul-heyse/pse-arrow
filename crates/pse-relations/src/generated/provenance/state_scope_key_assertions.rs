...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    207u8, 201u8, 9u8, 208u8, 86u8, 101u8, 107u8, 48u8, 37u8, 67u8, 125u8, 244u8, 136u8,
    145u8, 37u8, 122u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "state_scope_key_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    130u8, 177u8, 18u8, 173u8, 80u8, 195u8, 162u8, 119u8, 167u8, 156u8, 211u8, 86u8,
    242u8, 107u8, 72u8, 255u8, 101u8, 61u8, 201u8, 65u8, 230u8, 7u8, 106u8, 254u8, 159u8,
    118u8, 80u8, 173u8, 90u8, 20u8, 215u8, 138u8,
]);
...
pub struct ProvenanceStateScopeKeyAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceStateScopeKeyAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceStateScopeKeyAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceStateScopeKeyAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceStateScopeKeyAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceStateScopeKeyAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceStateScopeKeyAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceStateScopeKeyAssertionsBuilder;
impl ProvenanceStateScopeKeyAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.state_scope_key_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceStateScopeKeyAssertionsRow {
    type Builder = ProvenanceStateScopeKeyAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceStateScopeKeyAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceStateScopeKeyAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        63_728_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceStateScopeKeyAssertionsView<'a> {
...
impl<'a> ProvenanceStateScopeKeyAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceStateScopeKeyAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceStateScopeKeyAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceStateScopeKeyAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceStateScopeKeyAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceStateScopeKeyAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceStateScopeKeyAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceStateScopeKeyAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
