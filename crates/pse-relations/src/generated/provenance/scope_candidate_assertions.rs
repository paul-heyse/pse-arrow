...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    126u8, 186u8, 90u8, 196u8, 1u8, 120u8, 128u8, 82u8, 244u8, 194u8, 16u8, 140u8, 99u8,
    178u8, 154u8, 3u8, 40u8, 168u8, 165u8, 252u8, 129u8, 3u8, 70u8, 66u8, 112u8, 60u8,
    89u8, 4u8, 106u8, 188u8, 55u8, 110u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopeCandidateAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        74_400_usize + size_of::<Self::Builder>()
    }
