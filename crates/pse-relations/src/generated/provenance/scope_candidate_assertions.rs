...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    126u8, 96u8, 233u8, 175u8, 151u8, 103u8, 119u8, 163u8, 138u8, 157u8, 71u8, 234u8,
    233u8, 153u8, 3u8, 60u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_candidate_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    80u8, 18u8, 113u8, 196u8, 50u8, 203u8, 174u8, 189u8, 131u8, 73u8, 126u8, 31u8, 107u8,
    125u8, 133u8, 73u8, 194u8, 248u8, 42u8, 152u8, 249u8, 214u8, 12u8, 20u8, 216u8,
    220u8, 166u8, 26u8, 244u8, 132u8, 181u8, 113u8,
]);
...
pub struct ProvenanceScopeCandidateAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceScopeCandidateAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceScopeCandidateAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceScopeCandidateAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceScopeCandidateAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceScopeCandidateAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceScopeCandidateAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceScopeCandidateAssertionsBuilder;
impl ProvenanceScopeCandidateAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.scope_candidate_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceScopeCandidateAssertionsRow {
    type Builder = ProvenanceScopeCandidateAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceScopeCandidateAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceScopeCandidateAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        76_160_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceScopeCandidateAssertionsView<'a> {
...
impl<'a> ProvenanceScopeCandidateAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceScopeCandidateAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceScopeCandidateAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceScopeCandidateAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceScopeCandidateAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceScopeCandidateAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceScopeCandidateAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceScopeCandidateAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
