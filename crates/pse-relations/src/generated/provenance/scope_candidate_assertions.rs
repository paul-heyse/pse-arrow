...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    138u8, 106u8, 125u8, 133u8, 218u8, 251u8, 4u8, 221u8, 242u8, 29u8, 108u8, 78u8,
    203u8, 184u8, 97u8, 36u8, 53u8, 110u8, 249u8, 45u8, 33u8, 179u8, 182u8, 48u8, 226u8,
    212u8, 76u8, 131u8, 128u8, 253u8, 45u8, 141u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopeCandidateAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        73_936_usize + size_of::<Self::Builder>()
    }
