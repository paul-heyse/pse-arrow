...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    236u8, 84u8, 166u8, 51u8, 35u8, 153u8, 197u8, 8u8, 1u8, 5u8, 53u8, 95u8, 60u8, 1u8,
    24u8, 119u8, 198u8, 67u8, 207u8, 190u8, 25u8, 111u8, 218u8, 72u8, 2u8, 157u8, 160u8,
    167u8, 182u8, 26u8, 143u8, 185u8,
]);
