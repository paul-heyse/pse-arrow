...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    236u8, 125u8, 140u8, 164u8, 146u8, 136u8, 180u8, 108u8, 152u8, 59u8, 247u8, 251u8,
    94u8, 230u8, 146u8, 10u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "state_scope_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    45u8, 175u8, 47u8, 154u8, 66u8, 54u8, 43u8, 222u8, 217u8, 213u8, 105u8, 123u8, 82u8,
    86u8, 221u8, 172u8, 204u8, 54u8, 47u8, 68u8, 209u8, 138u8, 48u8, 227u8, 169u8, 235u8,
    59u8, 69u8, 158u8, 109u8, 90u8, 212u8,
]);
...
pub struct ProvenanceStateScopeAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceStateScopeAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceStateScopeAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceStateScopeAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceStateScopeAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceStateScopeAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceStateScopeAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceStateScopeAssertionsBuilder;
impl ProvenanceStateScopeAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.state_scope_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceStateScopeAssertionsRow {
    type Builder = ProvenanceStateScopeAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceStateScopeAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceStateScopeAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        76_416_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceStateScopeAssertionsView<'a> {
...
impl<'a> ProvenanceStateScopeAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceStateScopeAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceStateScopeAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceStateScopeAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceStateScopeAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceStateScopeAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceStateScopeAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceStateScopeAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
