...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    20u8, 54u8, 142u8, 241u8, 57u8, 177u8, 149u8, 183u8, 77u8, 85u8, 149u8, 199u8, 148u8,
    97u8, 121u8, 64u8, 68u8, 6u8, 138u8, 211u8, 162u8, 69u8, 137u8, 59u8, 90u8, 206u8,
    12u8, 209u8, 255u8, 60u8, 135u8, 143u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceStateScopeAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        74_192_usize + size_of::<Self::Builder>()
    }
