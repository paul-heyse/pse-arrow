...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    55u8, 56u8, 80u8, 1u8, 54u8, 75u8, 211u8, 55u8, 44u8, 16u8, 107u8, 48u8, 219u8, 14u8,
    186u8, 57u8, 92u8, 21u8, 60u8, 115u8, 199u8, 2u8, 16u8, 167u8, 90u8, 29u8, 15u8,
    251u8, 231u8, 247u8, 58u8, 183u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceMethodCandidateAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        103_528_usize + size_of::<Self::Builder>()
    }
