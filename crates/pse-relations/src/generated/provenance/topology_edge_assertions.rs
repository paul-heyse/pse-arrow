...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    157u8, 136u8, 253u8, 180u8, 75u8, 205u8, 171u8, 16u8, 111u8, 206u8, 9u8, 6u8, 193u8,
    228u8, 114u8, 148u8, 149u8, 115u8, 125u8, 91u8, 78u8, 85u8, 216u8, 75u8, 112u8,
    126u8, 7u8, 109u8, 2u8, 63u8, 53u8, 224u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceTopologyEdgeAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        76_280_usize + size_of::<Self::Builder>()
    }
