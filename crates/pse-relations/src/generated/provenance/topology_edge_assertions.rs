...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    204u8, 226u8, 210u8, 190u8, 208u8, 9u8, 239u8, 50u8, 42u8, 129u8, 250u8, 220u8, 15u8,
    50u8, 196u8, 38u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "topology_edge_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    55u8, 226u8, 214u8, 216u8, 107u8, 120u8, 1u8, 248u8, 117u8, 215u8, 140u8, 171u8,
    36u8, 255u8, 0u8, 133u8, 91u8, 155u8, 165u8, 82u8, 235u8, 98u8, 138u8, 137u8, 32u8,
    177u8, 222u8, 83u8, 73u8, 172u8, 27u8, 73u8,
]);
...
pub struct ProvenanceTopologyEdgeAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceTopologyEdgeAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceTopologyEdgeAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceTopologyEdgeAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceTopologyEdgeAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceTopologyEdgeAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceTopologyEdgeAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceTopologyEdgeAssertionsBuilder;
impl ProvenanceTopologyEdgeAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.topology_edge_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceTopologyEdgeAssertionsRow {
    type Builder = ProvenanceTopologyEdgeAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceTopologyEdgeAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceTopologyEdgeAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        74_056_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceTopologyEdgeAssertionsView<'a> {
...
impl<'a> ProvenanceTopologyEdgeAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceTopologyEdgeAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceTopologyEdgeAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceTopologyEdgeAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceTopologyEdgeAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceTopologyEdgeAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceTopologyEdgeAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceTopologyEdgeAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
