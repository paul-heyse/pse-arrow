...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    120u8, 53u8, 92u8, 205u8, 152u8, 56u8, 28u8, 57u8, 210u8, 248u8, 236u8, 56u8, 76u8,
    99u8, 46u8, 90u8, 123u8, 99u8, 64u8, 218u8, 70u8, 79u8, 124u8, 2u8, 27u8, 73u8,
    211u8, 50u8, 139u8, 254u8, 17u8, 157u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceConnectionViolationAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        60_360_usize + size_of::<Self::Builder>()
    }
