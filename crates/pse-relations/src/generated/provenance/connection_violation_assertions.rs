...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    26u8, 190u8, 195u8, 220u8, 154u8, 30u8, 234u8, 233u8, 101u8, 133u8, 215u8, 124u8,
    78u8, 40u8, 54u8, 161u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "connection_violation_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    233u8, 76u8, 21u8, 196u8, 49u8, 83u8, 237u8, 121u8, 204u8, 75u8, 250u8, 107u8, 37u8,
    200u8, 169u8, 253u8, 69u8, 174u8, 200u8, 39u8, 160u8, 134u8, 133u8, 39u8, 207u8,
    210u8, 66u8, 244u8, 34u8, 135u8, 58u8, 230u8,
]);
...
pub struct ProvenanceConnectionViolationAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceConnectionViolationAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceConnectionViolationAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceConnectionViolationAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceConnectionViolationAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceConnectionViolationAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceConnectionViolationAssertionsBuilder;
impl ProvenanceConnectionViolationAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.connection_violation_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceConnectionViolationAssertionsRow {
    type Builder = ProvenanceConnectionViolationAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceConnectionViolationAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceConnectionViolationAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        58_136_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceConnectionViolationAssertionsView<'a> {
...
impl<'a> ProvenanceConnectionViolationAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceConnectionViolationAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceConnectionViolationAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceConnectionViolationAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceConnectionViolationAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceConnectionViolationAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceConnectionViolationAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceConnectionViolationAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
