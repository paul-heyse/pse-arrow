...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    51u8, 74u8, 126u8, 196u8, 78u8, 168u8, 102u8, 226u8, 245u8, 22u8, 18u8, 47u8, 171u8,
    153u8, 165u8, 100u8, 55u8, 78u8, 170u8, 59u8, 30u8, 203u8, 154u8, 109u8, 181u8, 52u8,
    108u8, 184u8, 214u8, 96u8, 171u8, 103u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceConnectionViolationAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        58_600_usize + size_of::<Self::Builder>()
    }
