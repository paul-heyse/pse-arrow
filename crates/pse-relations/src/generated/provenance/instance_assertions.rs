...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    137u8, 19u8, 156u8, 22u8, 57u8, 225u8, 65u8, 248u8, 92u8, 18u8, 234u8, 104u8, 210u8,
    48u8, 83u8, 47u8, 27u8, 93u8, 93u8, 169u8, 228u8, 55u8, 78u8, 226u8, 170u8, 60u8,
    171u8, 158u8, 164u8, 141u8, 255u8, 202u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceInstanceAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        95_720_usize + size_of::<Self::Builder>()
    }
