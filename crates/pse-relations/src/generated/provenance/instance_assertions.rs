...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    105u8, 183u8, 129u8, 56u8, 76u8, 149u8, 1u8, 168u8, 113u8, 29u8, 95u8, 119u8, 94u8,
    24u8, 227u8, 166u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    142u8, 149u8, 21u8, 88u8, 119u8, 180u8, 168u8, 212u8, 164u8, 232u8, 233u8, 158u8,
    103u8, 249u8, 73u8, 165u8, 47u8, 12u8, 166u8, 220u8, 57u8, 248u8, 199u8, 156u8,
    157u8, 65u8, 98u8, 59u8, 226u8, 223u8, 76u8, 10u8,
]);
...
pub struct ProvenanceInstanceAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceInstanceAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceInstanceAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceInstanceAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceInstanceAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceInstanceAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceInstanceAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceInstanceAssertionsBuilder;
impl ProvenanceInstanceAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.instance_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceInstanceAssertionsRow {
    type Builder = ProvenanceInstanceAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceInstanceAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceInstanceAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        97_480_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceInstanceAssertionsView<'a> {
...
impl<'a> ProvenanceInstanceAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceInstanceAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceInstanceAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceInstanceAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceInstanceAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceInstanceAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceInstanceAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceInstanceAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
