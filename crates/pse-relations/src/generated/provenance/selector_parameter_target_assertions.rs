...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    149u8, 252u8, 87u8, 26u8, 117u8, 252u8, 140u8, 2u8, 116u8, 231u8, 91u8, 53u8, 118u8,
    10u8, 170u8, 246u8, 7u8, 186u8, 151u8, 126u8, 115u8, 212u8, 50u8, 135u8, 20u8, 195u8,
    206u8, 153u8, 140u8, 137u8, 51u8, 219u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceSelectorParameterTargetAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        74_328_usize + size_of::<Self::Builder>()
    }
