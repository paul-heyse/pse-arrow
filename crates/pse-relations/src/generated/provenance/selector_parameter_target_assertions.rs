...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    186u8, 53u8, 205u8, 120u8, 182u8, 34u8, 241u8, 16u8, 138u8, 120u8, 94u8, 111u8,
    160u8, 164u8, 253u8, 134u8, 243u8, 152u8, 229u8, 188u8, 125u8, 92u8, 221u8, 236u8,
    226u8, 55u8, 45u8, 111u8, 65u8, 5u8, 246u8, 76u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceSelectorParameterTargetAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        73_864_usize + size_of::<Self::Builder>()
    }
