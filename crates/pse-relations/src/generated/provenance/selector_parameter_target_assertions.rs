...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    159u8, 179u8, 73u8, 114u8, 181u8, 10u8, 203u8, 229u8, 98u8, 35u8, 41u8, 189u8, 208u8,
    121u8, 48u8, 185u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "selector_parameter_target_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    254u8, 74u8, 154u8, 99u8, 173u8, 172u8, 180u8, 69u8, 151u8, 228u8, 210u8, 202u8,
    161u8, 109u8, 115u8, 124u8, 119u8, 162u8, 68u8, 233u8, 152u8, 248u8, 218u8, 10u8,
    164u8, 116u8, 151u8, 11u8, 134u8, 119u8, 66u8, 50u8,
]);
...
pub struct ProvenanceSelectorParameterTargetAssertionsRow {
    ...
    ///target_entity_id
    pub r#target_entity_id: pse_ids::SemanticId,
}
impl crate::typed::CellCodec for ProvenanceSelectorParameterTargetAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceSelectorParameterTargetAssertionsRow),
                ),
            );
        };
        ...
        Ok(Self {
            ...
            r#target_entity_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceSelectorParameterTargetAssertionsRow),
...
impl crate::columnar::ArrowValue for ProvenanceSelectorParameterTargetAssertionsRow {
    fn append(
        &self,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#target_entity_id: <pse_ids::SemanticId as crate::columnar::ArrowValue>::read(
...
pub type Row = ProvenanceSelectorParameterTargetAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceSelectorParameterTargetAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceSelectorParameterTargetAssertionsBuilder;
impl ProvenanceSelectorParameterTargetAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.selector_parameter_target_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceSelectorParameterTargetAssertionsRow {
    type Builder = ProvenanceSelectorParameterTargetAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceSelectorParameterTargetAssertionsBuilder::with_registry(
            registry,
            capacity,
        )
    }
    ...
    fn rows(
        ...
        ProvenanceSelectorParameterTargetAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        76_088_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceSelectorParameterTargetAssertionsView<'a> {
...
impl<'a> ProvenanceSelectorParameterTargetAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceSelectorParameterTargetAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceSelectorParameterTargetAssertionsRow {
    ...
    pub fn rows(
        ...
        Vec<ProvenanceSelectorParameterTargetAssertionsRow>,
        crate::RelationError,
    > {
...
#[derive(Debug)]
pub struct ProvenanceSelectorParameterTargetAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceSelectorParameterTargetAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceSelectorParameterTargetAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceSelectorParameterTargetAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
