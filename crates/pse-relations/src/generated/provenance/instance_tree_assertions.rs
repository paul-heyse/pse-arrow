...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    181u8, 135u8, 126u8, 12u8, 25u8, 91u8, 162u8, 236u8, 149u8, 173u8, 121u8, 236u8,
    198u8, 99u8, 140u8, 252u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_tree_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    86u8, 114u8, 11u8, 203u8, 147u8, 106u8, 36u8, 173u8, 157u8, 238u8, 213u8, 67u8,
    228u8, 209u8, 54u8, 123u8, 177u8, 164u8, 198u8, 111u8, 220u8, 50u8, 163u8, 25u8,
    148u8, 194u8, 83u8, 170u8, 177u8, 198u8, 129u8, 2u8,
]);
...
pub struct ProvenanceInstanceTreeAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceInstanceTreeAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceInstanceTreeAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceInstanceTreeAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceInstanceTreeAssertionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#depth, children[5usize].as_mut())?;
        output.append(true);
        Ok(())
    }
    fn append_null(
...
pub type Row = ProvenanceInstanceTreeAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceInstanceTreeAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceInstanceTreeAssertionsBuilder;
impl ProvenanceInstanceTreeAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.instance_tree_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceInstanceTreeAssertionsRow {
    type Builder = ProvenanceInstanceTreeAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceInstanceTreeAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceInstanceTreeAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        69_312_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceInstanceTreeAssertionsView<'a> {
...
impl<'a> ProvenanceInstanceTreeAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceInstanceTreeAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceInstanceTreeAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceInstanceTreeAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceInstanceTreeAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceInstanceTreeAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceInstanceTreeAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceInstanceTreeAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
