...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    159u8, 167u8, 62u8, 119u8, 183u8, 241u8, 147u8, 26u8, 71u8, 86u8, 59u8, 148u8, 49u8,
    161u8, 248u8, 134u8, 204u8, 0u8, 53u8, 180u8, 80u8, 31u8, 229u8, 173u8, 68u8, 74u8,
    109u8, 57u8, 64u8, 164u8, 175u8, 179u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopeBindingAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        76_472_usize + size_of::<Self::Builder>()
    }
