...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    6u8, 226u8, 78u8, 52u8, 174u8, 52u8, 204u8, 57u8, 124u8, 183u8, 0u8, 165u8, 12u8,
    24u8, 195u8, 111u8, 10u8, 165u8, 28u8, 194u8, 51u8, 31u8, 210u8, 240u8, 177u8, 80u8,
    210u8, 158u8, 202u8, 76u8, 101u8, 90u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopeBindingAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        78_696_usize + size_of::<Self::Builder>()
    }
