...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    76u8, 223u8, 148u8, 188u8, 124u8, 151u8, 120u8, 129u8, 138u8, 131u8, 147u8, 192u8,
    122u8, 191u8, 83u8, 199u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_binding_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    171u8, 78u8, 52u8, 138u8, 73u8, 49u8, 136u8, 121u8, 188u8, 188u8, 19u8, 124u8, 180u8,
    183u8, 144u8, 1u8, 190u8, 240u8, 121u8, 226u8, 74u8, 84u8, 178u8, 46u8, 139u8, 76u8,
    70u8, 44u8, 184u8, 25u8, 64u8, 179u8,
]);
...
pub struct ProvenanceScopeBindingAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceScopeBindingAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceScopeBindingAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceScopeBindingAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceScopeBindingAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceScopeBindingAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceScopeBindingAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceScopeBindingAssertionsBuilder;
impl ProvenanceScopeBindingAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.scope_binding_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceScopeBindingAssertionsRow {
    type Builder = ProvenanceScopeBindingAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceScopeBindingAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceScopeBindingAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        76_936_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceScopeBindingAssertionsView<'a> {
...
impl<'a> ProvenanceScopeBindingAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceScopeBindingAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceScopeBindingAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceScopeBindingAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceScopeBindingAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceScopeBindingAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceScopeBindingAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceScopeBindingAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
