...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    0u8, 75u8, 241u8, 151u8, 156u8, 59u8, 110u8, 230u8, 86u8, 213u8, 228u8, 82u8, 77u8,
    44u8, 230u8, 232u8, 61u8, 31u8, 113u8, 52u8, 110u8, 203u8, 108u8, 32u8, 88u8, 104u8,
    185u8, 62u8, 237u8, 233u8, 193u8, 132u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePortMemberAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        86_056_usize + size_of::<Self::Builder>()
    }
