...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    62u8, 89u8, 190u8, 10u8, 192u8, 74u8, 114u8, 88u8, 251u8, 35u8, 236u8, 110u8, 229u8,
    34u8, 19u8, 187u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_member_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    13u8, 65u8, 77u8, 46u8, 169u8, 109u8, 212u8, 44u8, 146u8, 142u8, 225u8, 202u8, 226u8,
    164u8, 59u8, 156u8, 126u8, 40u8, 80u8, 240u8, 151u8, 29u8, 60u8, 75u8, 203u8, 214u8,
    246u8, 153u8, 118u8, 14u8, 196u8, 87u8,
]);
...
pub struct ProvenancePortMemberAssertionsRow {
...
impl crate::typed::CellCodec for ProvenancePortMemberAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenancePortMemberAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenancePortMemberAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenancePortMemberAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenancePortMemberAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenancePortMemberAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenancePortMemberAssertionsBuilder;
impl ProvenancePortMemberAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.port_member_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenancePortMemberAssertionsRow {
    type Builder = ProvenancePortMemberAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenancePortMemberAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenancePortMemberAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        85_592_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenancePortMemberAssertionsView<'a> {
...
impl<'a> ProvenancePortMemberAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenancePortMemberAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenancePortMemberAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenancePortMemberAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenancePortMemberAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenancePortMemberAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenancePortMemberAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenancePortMemberAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
