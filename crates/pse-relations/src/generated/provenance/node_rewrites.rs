...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    194u8, 89u8, 62u8, 71u8, 177u8, 52u8, 50u8, 46u8, 184u8, 82u8, 234u8, 19u8, 20u8,
    121u8, 85u8, 117u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "node_rewrites";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    84u8, 98u8, 121u8, 233u8, 217u8, 223u8, 61u8, 141u8, 78u8, 102u8, 186u8, 45u8, 4u8,
    222u8, 113u8, 58u8, 101u8, 71u8, 238u8, 64u8, 247u8, 171u8, 29u8, 67u8, 31u8, 71u8,
    81u8, 51u8, 190u8, 30u8, 231u8, 154u8,
]);
...
impl crate::typed::CellCodec for ProvenanceNodeRewritesRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                crate::typed::CellCodec::into_cell(self.r#input_node_id),
                crate::typed::CellCodec::into_cell(self.r#output_node_id),
            ],
        )
    }
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(ProvenanceNodeRewritesRow)));
        };
...
impl crate::columnar::ArrowValue for ProvenanceNodeRewritesRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(
            &self.r#input_node_id,
            children[0usize].as_mut(),
        )?;
        crate::columnar::ArrowValue::append(
            &self.r#output_node_id,
...
pub type Row = ProvenanceNodeRewritesRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceNodeRewritesView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceNodeRewritesBuilder;
impl ProvenanceNodeRewritesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.node_rewrites".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceNodeRewritesRow {
    type Builder = ProvenanceNodeRewritesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceNodeRewritesBuilder::with_registry(registry, capacity)
    }
    ...
    fn builder_allocation_size() -> usize {
        17_632_usize + size_of::<Self::Builder>()
    }
...
impl<'a> ProvenanceNodeRewritesView<'a> {
    ...
    pub fn input_node_id_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn output_node_id_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceNodeRewritesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceNodeRewritesRow {
            r#input_node_id: crate::columnar::ArrowValue::read(
                self.input_node_id_column,
                index,
            )?,
            r#output_node_id: crate::columnar::ArrowValue::read(
                self.output_node_id_column,
                index,
            )?,
        })
    ...
    pub fn rows(&self) -> Result<Vec<ProvenanceNodeRewritesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceNodeRewritesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceNodeRewritesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceNodeRewritesView<'_>,
    ) -> Result<(), crate::RelationError> {
