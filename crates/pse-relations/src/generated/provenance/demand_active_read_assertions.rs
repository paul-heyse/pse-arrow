...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    96u8, 196u8, 175u8, 207u8, 82u8, 233u8, 220u8, 189u8, 254u8, 243u8, 253u8, 47u8,
    39u8, 121u8, 71u8, 54u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "demand_active_read_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    235u8, 238u8, 87u8, 50u8, 176u8, 221u8, 126u8, 53u8, 41u8, 237u8, 154u8, 165u8,
    197u8, 9u8, 224u8, 104u8, 227u8, 245u8, 205u8, 213u8, 137u8, 210u8, 226u8, 222u8,
    164u8, 121u8, 218u8, 235u8, 164u8, 105u8, 151u8, 154u8,
]);
...
pub struct ProvenanceDemandActiveReadAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceDemandActiveReadAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceDemandActiveReadAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceDemandActiveReadAssertionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#read_id, children[3usize].as_mut())?;
        crate::columnar::ArrowValue::append(&self.r#seed_id, children[4usize].as_mut())?;
        crate::columnar::ArrowValue::append(
...
pub type Row = ProvenanceDemandActiveReadAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceDemandActiveReadAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceDemandActiveReadAssertionsBuilder;
impl ProvenanceDemandActiveReadAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.demand_active_read_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceDemandActiveReadAssertionsRow {
    type Builder = ProvenanceDemandActiveReadAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceDemandActiveReadAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceDemandActiveReadAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        165_800_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceDemandActiveReadAssertionsView<'a> {
...
impl<'a> ProvenanceDemandActiveReadAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceDemandActiveReadAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceDemandActiveReadAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceDemandActiveReadAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceDemandActiveReadAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceDemandActiveReadAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceDemandActiveReadAssertionsRow,
    ) -> Result<(), crate::RelationError> {
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceDemandActiveReadAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
