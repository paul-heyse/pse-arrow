...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    252u8, 58u8, 255u8, 10u8, 147u8, 171u8, 2u8, 111u8, 57u8, 88u8, 73u8, 109u8, 217u8,
    241u8, 57u8, 239u8, 111u8, 7u8, 136u8, 14u8, 75u8, 20u8, 93u8, 168u8, 15u8, 179u8,
    157u8, 54u8, 58u8, 148u8, 207u8, 127u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopeMemberAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        65_144_usize + size_of::<Self::Builder>()
    }
