...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    254u8, 223u8, 206u8, 45u8, 111u8, 90u8, 67u8, 248u8, 7u8, 58u8, 179u8, 148u8, 44u8,
    180u8, 80u8, 184u8, 206u8, 90u8, 64u8, 135u8, 190u8, 13u8, 6u8, 204u8, 175u8, 85u8,
    200u8, 213u8, 26u8, 61u8, 24u8, 159u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceInstanceReachabilityAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_624_usize + size_of::<Self::Builder>()
    }
