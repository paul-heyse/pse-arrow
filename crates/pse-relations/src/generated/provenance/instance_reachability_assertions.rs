...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    2u8, 13u8, 225u8, 31u8, 6u8, 73u8, 96u8, 165u8, 23u8, 24u8, 55u8, 40u8, 137u8, 186u8,
    223u8, 53u8, 121u8, 36u8, 246u8, 9u8, 32u8, 204u8, 156u8, 219u8, 160u8, 91u8, 102u8,
    32u8, 172u8, 71u8, 230u8, 0u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceInstanceReachabilityAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_160_usize + size_of::<Self::Builder>()
    }
