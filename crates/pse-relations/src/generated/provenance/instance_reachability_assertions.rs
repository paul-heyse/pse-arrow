...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    49u8, 135u8, 125u8, 25u8, 17u8, 169u8, 102u8, 168u8, 24u8, 227u8, 154u8, 233u8,
    250u8, 50u8, 153u8, 215u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_reachability_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    33u8, 150u8, 34u8, 112u8, 69u8, 57u8, 163u8, 75u8, 233u8, 201u8, 90u8, 138u8, 232u8,
    211u8, 188u8, 253u8, 32u8, 49u8, 237u8, 199u8, 243u8, 231u8, 168u8, 97u8, 44u8,
    115u8, 161u8, 198u8, 56u8, 129u8, 218u8, 195u8,
]);
...
pub struct ProvenanceInstanceReachabilityAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceInstanceReachabilityAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceInstanceReachabilityAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceInstanceReachabilityAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceInstanceReachabilityAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceInstanceReachabilityAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceInstanceReachabilityAssertionsBuilder;
impl ProvenanceInstanceReachabilityAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.instance_reachability_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceInstanceReachabilityAssertionsRow {
    type Builder = ProvenanceInstanceReachabilityAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceInstanceReachabilityAssertionsBuilder::with_registry(
            registry,
            capacity,
        )
    }
    ...
    fn rows(
        ...
        ProvenanceInstanceReachabilityAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        65_384_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceInstanceReachabilityAssertionsView<'a> {
...
impl<'a> ProvenanceInstanceReachabilityAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceInstanceReachabilityAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceInstanceReachabilityAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceInstanceReachabilityAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceInstanceReachabilityAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceInstanceReachabilityAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceInstanceReachabilityAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceInstanceReachabilityAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
