...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    56u8, 10u8, 234u8, 143u8, 143u8, 74u8, 35u8, 246u8, 61u8, 148u8, 88u8, 53u8, 138u8,
    137u8, 156u8, 164u8, 165u8, 145u8, 112u8, 214u8, 39u8, 113u8, 230u8, 198u8, 207u8,
    38u8, 147u8, 88u8, 117u8, 102u8, 253u8, 126u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceValidIndexAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        71_160_usize + size_of::<Self::Builder>()
    }
