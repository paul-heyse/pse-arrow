...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    94u8, 220u8, 185u8, 59u8, 13u8, 105u8, 65u8, 20u8, 84u8, 56u8, 109u8, 211u8, 220u8,
    164u8, 99u8, 136u8, 108u8, 201u8, 183u8, 21u8, 67u8, 184u8, 73u8, 0u8, 136u8, 208u8,
    97u8, 20u8, 75u8, 146u8, 232u8, 231u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceMaterialCheckAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        75_064_usize + size_of::<Self::Builder>()
    }
