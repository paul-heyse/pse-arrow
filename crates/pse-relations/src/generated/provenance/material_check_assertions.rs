...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    185u8, 77u8, 107u8, 31u8, 173u8, 43u8, 113u8, 5u8, 56u8, 136u8, 99u8, 233u8, 64u8,
    16u8, 173u8, 15u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "material_check_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    26u8, 241u8, 144u8, 240u8, 164u8, 253u8, 37u8, 16u8, 117u8, 128u8, 53u8, 89u8, 68u8,
    240u8, 184u8, 178u8, 45u8, 44u8, 175u8, 109u8, 59u8, 85u8, 163u8, 140u8, 140u8, 32u8,
    20u8, 35u8, 224u8, 130u8, 221u8, 10u8,
]);
...
pub struct ProvenanceMaterialCheckAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceMaterialCheckAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceMaterialCheckAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceMaterialCheckAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceMaterialCheckAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceMaterialCheckAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceMaterialCheckAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceMaterialCheckAssertionsBuilder;
impl ProvenanceMaterialCheckAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.material_check_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceMaterialCheckAssertionsRow {
    type Builder = ProvenanceMaterialCheckAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceMaterialCheckAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceMaterialCheckAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        75_528_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceMaterialCheckAssertionsView<'a> {
...
impl<'a> ProvenanceMaterialCheckAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceMaterialCheckAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceMaterialCheckAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceMaterialCheckAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceMaterialCheckAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceMaterialCheckAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceMaterialCheckAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceMaterialCheckAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
