...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    103u8, 253u8, 2u8, 127u8, 171u8, 142u8, 87u8, 94u8, 105u8, 169u8, 10u8, 21u8, 8u8,
    241u8, 99u8, 252u8, 210u8, 25u8, 89u8, 192u8, 124u8, 206u8, 124u8, 223u8, 122u8,
    91u8, 33u8, 54u8, 232u8, 253u8, 57u8, 232u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceDerivationsRow {
    ...
    fn builder_allocation_size() -> usize {
        126_992_usize + size_of::<Self::Builder>()
    }
