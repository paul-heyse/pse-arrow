...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    72u8, 125u8, 19u8, 187u8, 239u8, 211u8, 46u8, 168u8, 40u8, 114u8, 24u8, 30u8, 83u8,
    24u8, 228u8, 185u8, 171u8, 151u8, 214u8, 41u8, 79u8, 81u8, 254u8, 172u8, 230u8,
    223u8, 85u8, 243u8, 69u8, 17u8, 70u8, 148u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceDomainMemberAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        65_176_usize + size_of::<Self::Builder>()
    }
