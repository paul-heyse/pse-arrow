...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    45u8, 135u8, 168u8, 152u8, 77u8, 188u8, 1u8, 213u8, 142u8, 135u8, 14u8, 114u8, 26u8,
    49u8, 139u8, 46u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "domain_member_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    179u8, 140u8, 56u8, 154u8, 16u8, 40u8, 72u8, 136u8, 219u8, 106u8, 212u8, 18u8, 215u8,
    201u8, 46u8, 172u8, 11u8, 185u8, 97u8, 156u8, 189u8, 117u8, 119u8, 186u8, 57u8, 80u8,
    115u8, 56u8, 232u8, 156u8, 100u8, 184u8,
]);
...
pub struct ProvenanceDomainMemberAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceDomainMemberAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceDomainMemberAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceDomainMemberAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceDomainMemberAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceDomainMemberAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceDomainMemberAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceDomainMemberAssertionsBuilder;
impl ProvenanceDomainMemberAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.domain_member_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceDomainMemberAssertionsRow {
    type Builder = ProvenanceDomainMemberAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceDomainMemberAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceDomainMemberAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        63_416_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceDomainMemberAssertionsView<'a> {
...
impl<'a> ProvenanceDomainMemberAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceDomainMemberAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceDomainMemberAssertionsRow {
            ...
            r#member_id: crate::columnar::ArrowValue::read(self.member_id_column, index)?,
        })
    }
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceDomainMemberAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceDomainMemberAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceDomainMemberAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceDomainMemberAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceDomainMemberAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
