...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    117u8, 90u8, 248u8, 129u8, 115u8, 122u8, 101u8, 195u8, 101u8, 129u8, 44u8, 232u8,
    150u8, 184u8, 149u8, 66u8, 154u8, 116u8, 7u8, 155u8, 126u8, 187u8, 33u8, 232u8,
    134u8, 175u8, 15u8, 182u8, 216u8, 81u8, 158u8, 165u8,
]);
...
impl crate::columnar::ArrowValue for ProvenanceLawParticipationAssertionsRow {
    fn append(
        ...
        crate::columnar::ArrowValue::append(&self.r#sign, children[7usize].as_mut())?;
        output.append(true);
        Ok(())
    }
    fn append_null(
        ...
        <i32 as crate::columnar::ArrowValue>::append_null(children[7usize].as_mut())?;
        output.append(false);
        Ok(())
    }
    fn read(
...
impl crate::columnar::RelationRow for ProvenanceLawParticipationAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        97_648_usize + size_of::<Self::Builder>()
    }
