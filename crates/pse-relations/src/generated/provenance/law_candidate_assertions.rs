...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    185u8, 38u8, 51u8, 165u8, 24u8, 146u8, 33u8, 110u8, 140u8, 104u8, 244u8, 165u8, 0u8,
    130u8, 168u8, 115u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "law_candidate_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    222u8, 154u8, 213u8, 164u8, 174u8, 182u8, 144u8, 12u8, 240u8, 189u8, 235u8, 123u8,
    39u8, 169u8, 66u8, 48u8, 27u8, 157u8, 176u8, 113u8, 47u8, 160u8, 233u8, 63u8, 47u8,
    45u8, 222u8, 113u8, 70u8, 192u8, 102u8, 208u8,
]);
...
pub struct ProvenanceLawCandidateAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceLawCandidateAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceLawCandidateAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceLawCandidateAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceLawCandidateAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceLawCandidateAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceLawCandidateAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceLawCandidateAssertionsBuilder;
impl ProvenanceLawCandidateAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.law_candidate_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceLawCandidateAssertionsRow {
    type Builder = ProvenanceLawCandidateAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceLawCandidateAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceLawCandidateAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        63_136_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceLawCandidateAssertionsView<'a> {
...
impl<'a> ProvenanceLawCandidateAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceLawCandidateAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceLawCandidateAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceLawCandidateAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceLawCandidateAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceLawCandidateAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceLawCandidateAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceLawCandidateAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
