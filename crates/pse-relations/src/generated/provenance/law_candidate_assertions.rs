...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    199u8, 209u8, 155u8, 195u8, 71u8, 183u8, 190u8, 30u8, 146u8, 171u8, 222u8, 93u8,
    129u8, 43u8, 20u8, 75u8, 204u8, 128u8, 49u8, 150u8, 133u8, 244u8, 47u8, 59u8, 48u8,
    192u8, 5u8, 237u8, 150u8, 248u8, 194u8, 240u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceLawCandidateAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        65_360_usize + size_of::<Self::Builder>()
    }
