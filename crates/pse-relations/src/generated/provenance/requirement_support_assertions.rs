...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    131u8, 81u8, 163u8, 158u8, 150u8, 219u8, 28u8, 196u8, 185u8, 109u8, 226u8, 87u8,
    214u8, 25u8, 78u8, 14u8, 11u8, 41u8, 23u8, 7u8, 150u8, 0u8, 74u8, 11u8, 65u8, 180u8,
    238u8, 27u8, 102u8, 108u8, 33u8, 140u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceRequirementSupportAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        76_704_usize + size_of::<Self::Builder>()
    }
