...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    38u8, 96u8, 179u8, 172u8, 240u8, 254u8, 113u8, 214u8, 122u8, 101u8, 142u8, 204u8,
    118u8, 86u8, 183u8, 249u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "requirement_support_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    159u8, 206u8, 156u8, 195u8, 159u8, 110u8, 143u8, 164u8, 110u8, 156u8, 13u8, 62u8,
    122u8, 197u8, 184u8, 83u8, 153u8, 120u8, 160u8, 176u8, 62u8, 190u8, 95u8, 161u8,
    96u8, 230u8, 32u8, 48u8, 253u8, 169u8, 32u8, 207u8,
]);
...
pub struct ProvenanceRequirementSupportAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceRequirementSupportAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceRequirementSupportAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceRequirementSupportAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceRequirementSupportAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceRequirementSupportAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceRequirementSupportAssertionsBuilder;
impl ProvenanceRequirementSupportAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.requirement_support_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceRequirementSupportAssertionsRow {
    type Builder = ProvenanceRequirementSupportAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceRequirementSupportAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceRequirementSupportAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        78_928_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceRequirementSupportAssertionsView<'a> {
...
impl<'a> ProvenanceRequirementSupportAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceRequirementSupportAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceRequirementSupportAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceRequirementSupportAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceRequirementSupportAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceRequirementSupportAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceRequirementSupportAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceRequirementSupportAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
