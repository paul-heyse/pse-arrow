...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    7u8, 49u8, 217u8, 143u8, 255u8, 255u8, 175u8, 61u8, 35u8, 54u8, 61u8, 230u8, 104u8,
    117u8, 43u8, 206u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    72u8, 115u8, 209u8, 241u8, 20u8, 101u8, 45u8, 86u8, 174u8, 71u8, 10u8, 203u8, 44u8,
    105u8, 159u8, 15u8, 230u8, 182u8, 48u8, 254u8, 158u8, 176u8, 242u8, 110u8, 148u8,
    199u8, 120u8, 122u8, 219u8, 47u8, 108u8, 209u8,
]);
...
pub struct ProvenanceScopeAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceScopeAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(ProvenanceScopeAssertionsRow)));
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceScopeAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceScopeAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceScopeAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceScopeAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceScopeAssertionsBuilder;
impl ProvenanceScopeAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.scope_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceScopeAssertionsRow {
    type Builder = ProvenanceScopeAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceScopeAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceScopeAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        73_856_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceScopeAssertionsView<'a> {
...
impl<'a> ProvenanceScopeAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceScopeAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceScopeAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceScopeAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceScopeAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceScopeAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceScopeAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceScopeAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
