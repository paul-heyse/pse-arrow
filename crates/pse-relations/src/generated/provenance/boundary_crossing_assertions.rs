...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    55u8, 102u8, 171u8, 234u8, 182u8, 15u8, 20u8, 14u8, 16u8, 118u8, 106u8, 76u8, 213u8,
    138u8, 155u8, 113u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "boundary_crossing_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    154u8, 134u8, 172u8, 11u8, 244u8, 202u8, 162u8, 248u8, 106u8, 194u8, 245u8, 97u8,
    83u8, 194u8, 44u8, 159u8, 97u8, 58u8, 223u8, 77u8, 200u8, 34u8, 13u8, 149u8, 78u8,
    104u8, 226u8, 231u8, 106u8, 240u8, 197u8, 113u8,
]);
...
pub struct ProvenanceBoundaryCrossingAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceBoundaryCrossingAssertionsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#classification),
            ],
        )
    }
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceBoundaryCrossingAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceBoundaryCrossingAssertionsRow {
    fn append(
        &self,
    ...
    fn append_null(
        ...
        <crate::generated::enums::Crossing as crate::columnar::ArrowValue>::append_null(
            children[5usize].as_mut(),
        )?;
        output.append(false);
        Ok(())
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#classification: <crate::generated::enums::Crossing as crate::columnar::ArrowValue>::read(
...
pub type Row = ProvenanceBoundaryCrossingAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceBoundaryCrossingAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceBoundaryCrossingAssertionsBuilder;
impl ProvenanceBoundaryCrossingAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.boundary_crossing_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceBoundaryCrossingAssertionsRow {
    type Builder = ProvenanceBoundaryCrossingAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceBoundaryCrossingAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceBoundaryCrossingAssertionsView::from_checked(batch)?.rows()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            crate::columnar::allocation_add(8, (self.r#classification).as_str().len())?,
        )?;
        Ok(bytes)
    }
}
...
#[derive(Debug)]
pub struct ProvenanceBoundaryCrossingAssertionsView<'a> {
    ...
    classification_column: &'a arrow_array::StringArray,
}
impl<'a> ProvenanceBoundaryCrossingAssertionsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            classification_column: crate::columnar::array::<
                arrow_array::StringArray,
    ...
    pub const fn classification_column(&self) -> &'a arrow_array::StringArray {
        self.classification_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "classification", "`.")]
    pub fn classification_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceBoundaryCrossingAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceBoundaryCrossingAssertionsRow {
            ...
            r#classification: crate::columnar::ArrowValue::read(
                self.classification_column,
                index,
            )?,
        })
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceBoundaryCrossingAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceBoundaryCrossingAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceBoundaryCrossingAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceBoundaryCrossingAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceBoundaryCrossingAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
