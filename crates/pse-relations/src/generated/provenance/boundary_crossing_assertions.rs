...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    25u8, 195u8, 167u8, 245u8, 229u8, 219u8, 65u8, 84u8, 225u8, 170u8, 128u8, 164u8,
    83u8, 239u8, 150u8, 6u8, 135u8, 73u8, 141u8, 211u8, 99u8, 197u8, 76u8, 197u8, 20u8,
    3u8, 184u8, 20u8, 177u8, 28u8, 170u8, 165u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceBoundaryCrossingAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        77_680_usize + size_of::<Self::Builder>()
    }
