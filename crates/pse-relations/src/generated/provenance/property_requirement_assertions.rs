...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    138u8, 4u8, 165u8, 253u8, 177u8, 0u8, 253u8, 40u8, 63u8, 127u8, 255u8, 244u8, 30u8,
    226u8, 100u8, 2u8, 30u8, 233u8, 37u8, 2u8, 89u8, 89u8, 9u8, 32u8, 29u8, 226u8, 180u8,
    65u8, 144u8, 105u8, 40u8, 116u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePropertyRequirementAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        91_968_usize + size_of::<Self::Builder>()
    }
