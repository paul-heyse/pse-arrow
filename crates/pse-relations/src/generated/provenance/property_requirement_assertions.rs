...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    199u8, 168u8, 97u8, 221u8, 27u8, 203u8, 85u8, 214u8, 203u8, 110u8, 161u8, 181u8,
    20u8, 186u8, 211u8, 131u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "property_requirement_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    14u8, 13u8, 233u8, 130u8, 253u8, 83u8, 246u8, 69u8, 207u8, 145u8, 107u8, 168u8,
    232u8, 120u8, 130u8, 133u8, 198u8, 91u8, 188u8, 144u8, 158u8, 48u8, 145u8, 123u8,
    149u8, 183u8, 26u8, 125u8, 108u8, 244u8, 126u8, 158u8,
]);
...
pub struct ProvenancePropertyRequirementAssertionsRow {
...
impl crate::typed::CellCodec for ProvenancePropertyRequirementAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenancePropertyRequirementAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenancePropertyRequirementAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenancePropertyRequirementAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenancePropertyRequirementAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenancePropertyRequirementAssertionsBuilder;
impl ProvenancePropertyRequirementAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.property_requirement_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenancePropertyRequirementAssertionsRow {
    type Builder = ProvenancePropertyRequirementAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenancePropertyRequirementAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenancePropertyRequirementAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        90_208_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenancePropertyRequirementAssertionsView<'a> {
...
impl<'a> ProvenancePropertyRequirementAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenancePropertyRequirementAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenancePropertyRequirementAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenancePropertyRequirementAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenancePropertyRequirementAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenancePropertyRequirementAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenancePropertyRequirementAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenancePropertyRequirementAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
