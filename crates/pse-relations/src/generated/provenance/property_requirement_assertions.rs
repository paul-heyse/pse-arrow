...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    233u8, 216u8, 53u8, 48u8, 119u8, 41u8, 79u8, 3u8, 11u8, 245u8, 226u8, 171u8, 70u8,
    202u8, 13u8, 91u8, 34u8, 42u8, 163u8, 60u8, 81u8, 167u8, 181u8, 225u8, 110u8, 52u8,
    39u8, 61u8, 148u8, 245u8, 121u8, 230u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePropertyRequirementAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        89_744_usize + size_of::<Self::Builder>()
    }
