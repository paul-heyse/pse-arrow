...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    2u8, 78u8, 20u8, 148u8, 50u8, 79u8, 136u8, 195u8, 45u8, 99u8, 25u8, 43u8, 1u8, 58u8,
    47u8, 119u8, 245u8, 188u8, 3u8, 211u8, 108u8, 135u8, 227u8, 112u8, 71u8, 210u8,
    198u8, 187u8, 114u8, 255u8, 95u8, 75u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopePortStateAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        80_896_usize + size_of::<Self::Builder>()
    }
