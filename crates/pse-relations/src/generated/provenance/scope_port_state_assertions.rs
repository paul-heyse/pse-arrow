...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    25u8, 80u8, 251u8, 27u8, 123u8, 250u8, 42u8, 16u8, 166u8, 230u8, 208u8, 97u8, 48u8,
    101u8, 163u8, 236u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_port_state_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    81u8, 125u8, 120u8, 110u8, 172u8, 101u8, 141u8, 13u8, 190u8, 186u8, 138u8, 244u8,
    229u8, 211u8, 176u8, 215u8, 82u8, 71u8, 211u8, 235u8, 216u8, 133u8, 184u8, 74u8,
    15u8, 224u8, 79u8, 110u8, 196u8, 231u8, 178u8, 144u8,
]);
...
pub struct ProvenanceScopePortStateAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceScopePortStateAssertionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(ProvenanceScopePortStateAssertionsRow)),
            );
        };
            ...
            r#assertion_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(ProvenanceScopePortStateAssertionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for ProvenanceScopePortStateAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceScopePortStateAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceScopePortStateAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceScopePortStateAssertionsBuilder;
impl ProvenanceScopePortStateAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.scope_port_state_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceScopePortStateAssertionsRow {
    type Builder = ProvenanceScopePortStateAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceScopePortStateAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceScopePortStateAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        78_672_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceScopePortStateAssertionsView<'a> {
...
impl<'a> ProvenanceScopePortStateAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceScopePortStateAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceScopePortStateAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceScopePortStateAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceScopePortStateAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceScopePortStateAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceScopePortStateAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceScopePortStateAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
