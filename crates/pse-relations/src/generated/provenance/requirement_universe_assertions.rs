...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    199u8, 244u8, 245u8, 10u8, 180u8, 10u8, 226u8, 85u8, 220u8, 87u8, 220u8, 136u8, 59u8,
    47u8, 125u8, 123u8, 90u8, 3u8, 136u8, 159u8, 166u8, 7u8, 105u8, 155u8, 32u8, 239u8,
    3u8, 90u8, 29u8, 19u8, 3u8, 138u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceRequirementUniverseAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        112_080_usize + size_of::<Self::Builder>()
    }
