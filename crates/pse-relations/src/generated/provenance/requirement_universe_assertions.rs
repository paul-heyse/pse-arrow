...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    247u8, 41u8, 81u8, 193u8, 164u8, 79u8, 255u8, 186u8, 161u8, 135u8, 198u8, 118u8,
    199u8, 40u8, 92u8, 194u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "requirement_universe_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    27u8, 153u8, 86u8, 119u8, 8u8, 130u8, 51u8, 224u8, 24u8, 216u8, 43u8, 71u8, 239u8,
    154u8, 203u8, 119u8, 118u8, 215u8, 175u8, 204u8, 120u8, 215u8, 197u8, 212u8, 103u8,
    12u8, 236u8, 163u8, 24u8, 223u8, 72u8, 6u8,
]);
...
pub struct ProvenanceRequirementUniverseAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceRequirementUniverseAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceRequirementUniverseAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceRequirementUniverseAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenanceRequirementUniverseAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceRequirementUniverseAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceRequirementUniverseAssertionsBuilder;
impl ProvenanceRequirementUniverseAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.requirement_universe_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceRequirementUniverseAssertionsRow {
    type Builder = ProvenanceRequirementUniverseAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceRequirementUniverseAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceRequirementUniverseAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        113_840_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceRequirementUniverseAssertionsView<'a> {
...
impl<'a> ProvenanceRequirementUniverseAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceRequirementUniverseAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceRequirementUniverseAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceRequirementUniverseAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceRequirementUniverseAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceRequirementUniverseAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceRequirementUniverseAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceRequirementUniverseAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
