...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    45u8, 0u8, 63u8, 107u8, 154u8, 147u8, 176u8, 50u8, 102u8, 245u8, 226u8, 188u8, 249u8,
    57u8, 116u8, 172u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_port_decision_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    44u8, 182u8, 238u8, 182u8, 33u8, 203u8, 99u8, 158u8, 136u8, 139u8, 130u8, 213u8,
    114u8, 125u8, 33u8, 211u8, 182u8, 101u8, 104u8, 228u8, 109u8, 211u8, 4u8, 74u8, 78u8,
    122u8, 183u8, 61u8, 220u8, 178u8, 1u8, 228u8,
]);
...
pub struct ProvenanceScopePortDecisionAssertionsRow {
...
impl crate::typed::CellCodec for ProvenanceScopePortDecisionAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenanceScopePortDecisionAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenanceScopePortDecisionAssertionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#port_id, children[4usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#state_index,
...
pub type Row = ProvenanceScopePortDecisionAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenanceScopePortDecisionAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenanceScopePortDecisionAssertionsBuilder;
impl ProvenanceScopePortDecisionAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.scope_port_decision_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenanceScopePortDecisionAssertionsRow {
    type Builder = ProvenanceScopePortDecisionAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenanceScopePortDecisionAssertionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        ProvenanceScopePortDecisionAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        85_008_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenanceScopePortDecisionAssertionsView<'a> {
...
impl<'a> ProvenanceScopePortDecisionAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenanceScopePortDecisionAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenanceScopePortDecisionAssertionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<ProvenanceScopePortDecisionAssertionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct ProvenanceScopePortDecisionAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenanceScopePortDecisionAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenanceScopePortDecisionAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenanceScopePortDecisionAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
