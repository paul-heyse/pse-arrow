...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    238u8, 67u8, 37u8, 39u8, 195u8, 46u8, 212u8, 219u8, 29u8, 5u8, 192u8, 126u8, 118u8,
    41u8, 85u8, 75u8, 124u8, 168u8, 251u8, 163u8, 107u8, 214u8, 14u8, 9u8, 95u8, 54u8,
    44u8, 252u8, 217u8, 169u8, 36u8, 62u8,
]);
...
impl crate::columnar::RelationRow for ProvenanceScopePortDecisionAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        84_544_usize + size_of::<Self::Builder>()
    }
