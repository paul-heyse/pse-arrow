...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    47u8, 245u8, 90u8, 167u8, 85u8, 181u8, 206u8, 92u8, 93u8, 216u8, 85u8, 233u8, 7u8,
    97u8, 198u8, 158u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "potential_method_candidate_assertions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    229u8, 103u8, 159u8, 134u8, 125u8, 48u8, 188u8, 210u8, 82u8, 111u8, 151u8, 16u8,
    199u8, 115u8, 202u8, 70u8, 113u8, 16u8, 83u8, 82u8, 63u8, 211u8, 15u8, 39u8, 105u8,
    254u8, 5u8, 114u8, 254u8, 153u8, 251u8, 19u8,
]);
...
pub struct ProvenancePotentialMethodCandidateAssertionsRow {
...
impl crate::typed::CellCodec for ProvenancePotentialMethodCandidateAssertionsRow {
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(ProvenancePotentialMethodCandidateAssertionsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for ProvenancePotentialMethodCandidateAssertionsRow {
    fn append(
        &self,
...
pub type Row = ProvenancePotentialMethodCandidateAssertionsRow;
/// The concrete generated relation view.
pub type View<'a> = ProvenancePotentialMethodCandidateAssertionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = ProvenancePotentialMethodCandidateAssertionsBuilder;
impl ProvenancePotentialMethodCandidateAssertionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "provenance.potential_method_candidate_assertions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for ProvenancePotentialMethodCandidateAssertionsRow {
    type Builder = ProvenancePotentialMethodCandidateAssertionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        ProvenancePotentialMethodCandidateAssertionsBuilder::with_registry(
            registry,
            capacity,
        )
    }
    ...
    fn rows(
        ...
        ProvenancePotentialMethodCandidateAssertionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        103_144_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct ProvenancePotentialMethodCandidateAssertionsView<'a> {
...
impl<'a> ProvenancePotentialMethodCandidateAssertionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<ProvenancePotentialMethodCandidateAssertionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(ProvenancePotentialMethodCandidateAssertionsRow {
    ...
    pub fn rows(
        ...
        Vec<ProvenancePotentialMethodCandidateAssertionsRow>,
        crate::RelationError,
    > {
...
#[derive(Debug)]
pub struct ProvenancePotentialMethodCandidateAssertionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl ProvenancePotentialMethodCandidateAssertionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: ProvenancePotentialMethodCandidateAssertionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &ProvenancePotentialMethodCandidateAssertionsView<'_>,
    ) -> Result<(), crate::RelationError> {
