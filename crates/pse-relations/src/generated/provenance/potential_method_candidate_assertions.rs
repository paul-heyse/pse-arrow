...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    14u8, 124u8, 226u8, 63u8, 189u8, 81u8, 235u8, 241u8, 63u8, 117u8, 26u8, 5u8, 20u8,
    95u8, 222u8, 164u8, 108u8, 186u8, 37u8, 122u8, 59u8, 84u8, 95u8, 208u8, 212u8, 246u8,
    221u8, 56u8, 118u8, 10u8, 86u8, 215u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePotentialMethodCandidateAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        103_608_usize + size_of::<Self::Builder>()
    }
