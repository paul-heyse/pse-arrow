...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    179u8, 251u8, 224u8, 177u8, 234u8, 95u8, 210u8, 241u8, 40u8, 196u8, 118u8, 52u8,
    134u8, 204u8, 172u8, 16u8, 197u8, 146u8, 88u8, 216u8, 184u8, 235u8, 0u8, 33u8, 253u8,
    85u8, 126u8, 32u8, 60u8, 90u8, 158u8, 225u8,
]);
...
impl crate::columnar::RelationRow for ProvenancePotentialMethodCandidateAssertionsRow {
    ...
    fn builder_allocation_size() -> usize {
        106_504_usize + size_of::<Self::Builder>()
    }
...
impl ProvenancePotentialMethodCandidateAssertionsBuilder {
    ...
    pub fn push(
        ...
        if let Some(value) = (row.r#rank).as_ref()
