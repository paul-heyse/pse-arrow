...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    230u8, 111u8, 59u8, 158u8, 47u8, 71u8, 247u8, 244u8, 197u8, 216u8, 23u8, 132u8,
    186u8, 185u8, 85u8, 231u8, 19u8, 176u8, 57u8, 144u8, 27u8, 27u8, 205u8, 28u8, 148u8,
    205u8, 232u8, 3u8, 21u8, 70u8, 17u8, 208u8,
]);
...
impl crate::columnar::RelationRow for AuthoredCasePoliciesRow {
    ...
    fn builder_allocation_size() -> usize {
        70_136_usize + size_of::<Self::Builder>()
    }
