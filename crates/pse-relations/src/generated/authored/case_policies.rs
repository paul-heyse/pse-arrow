...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    212u8, 230u8, 137u8, 249u8, 95u8, 162u8, 26u8, 242u8, 5u8, 24u8, 79u8, 40u8, 149u8,
    12u8, 123u8, 32u8, 7u8, 118u8, 140u8, 44u8, 4u8, 58u8, 164u8, 121u8, 60u8, 17u8,
    130u8, 54u8, 70u8, 183u8, 66u8, 146u8,
]);
...
impl crate::columnar::RelationRow for AuthoredCasePoliciesRow {
    ...
    fn builder_allocation_size() -> usize {
        71_896_usize + size_of::<Self::Builder>()
    }
