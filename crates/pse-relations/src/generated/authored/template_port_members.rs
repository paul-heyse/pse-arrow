...
pub use pse_model::generated::r#authored::r#template_port_members::{
    AuthoredTemplatePortMembersRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    189u8, 236u8, 179u8, 152u8, 208u8, 131u8, 11u8, 55u8, 94u8, 201u8, 95u8, 225u8, 75u8,
    162u8, 216u8, 143u8, 166u8, 10u8, 85u8, 127u8, 152u8, 213u8, 84u8, 188u8, 55u8, 35u8,
    156u8, 209u8, 251u8, 169u8, 38u8, 14u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplatePortMembersRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredTemplatePortMembersView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///symbol_decl_id
    pub const SYMBOL_DECL_ID: crate::columnar::ColumnReference = super::COLUMNS[2usize];
    ///symbol_group
    pub const SYMBOL_GROUP: crate::columnar::ColumnReference = super::COLUMNS[3usize];
}
...
pub type AuthoredTemplatePortMembersBuilder = crate::columnar::RowBuilder<
    AuthoredTemplatePortMembersRow,
>;
impl crate::columnar::RelationView for AuthoredTemplatePortMembersView<'_> {
    type Row = AuthoredTemplatePortMembersRow;
