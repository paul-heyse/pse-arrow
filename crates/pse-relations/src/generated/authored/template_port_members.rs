...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    5u8, 234u8, 8u8, 219u8, 5u8, 252u8, 126u8, 31u8, 41u8, 148u8, 34u8, 69u8, 161u8,
    100u8, 103u8, 63u8, 162u8, 213u8, 12u8, 84u8, 236u8, 225u8, 155u8, 171u8, 6u8, 93u8,
    115u8, 165u8, 110u8, 137u8, 185u8, 62u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplatePortMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        43_896_usize + size_of::<Self::Builder>()
    }
