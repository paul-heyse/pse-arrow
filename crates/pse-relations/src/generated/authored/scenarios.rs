...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    20u8, 153u8, 5u8, 106u8, 182u8, 29u8, 1u8, 66u8, 116u8, 194u8, 218u8, 197u8, 245u8,
    235u8, 189u8, 216u8, 248u8, 158u8, 37u8, 60u8, 233u8, 61u8, 114u8, 84u8, 115u8,
    135u8, 37u8, 103u8, 212u8, 58u8, 203u8, 75u8,
]);
...
impl crate::columnar::RelationRow for AuthoredScenariosRow {
    ...
    fn builder_allocation_size() -> usize {
        39_240_usize + size_of::<Self::Builder>()
    }
