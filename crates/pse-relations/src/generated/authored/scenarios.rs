...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    136u8, 15u8, 185u8, 60u8, 233u8, 78u8, 233u8, 174u8, 59u8, 84u8, 100u8, 123u8, 224u8,
    134u8, 221u8, 161u8, 55u8, 52u8, 126u8, 188u8, 115u8, 10u8, 171u8, 81u8, 112u8,
    214u8, 178u8, 218u8, 40u8, 139u8, 142u8, 71u8,
]);
...
impl crate::columnar::RelationRow for AuthoredScenariosRow {
    ...
    fn builder_allocation_size() -> usize {
        37_480_usize + size_of::<Self::Builder>()
    }
