...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    154u8, 103u8, 163u8, 85u8, 140u8, 8u8, 19u8, 16u8, 67u8, 40u8, 28u8, 173u8, 74u8,
    200u8, 246u8, 8u8, 94u8, 59u8, 200u8, 178u8, 78u8, 224u8, 66u8, 58u8, 253u8, 61u8,
    90u8, 70u8, 110u8, 3u8, 12u8, 77u8,
]);
...
impl crate::columnar::RelationRow for AuthoredCaseSpecsRow {
    ...
    fn builder_allocation_size() -> usize {
        180_440_usize + size_of::<Self::Builder>()
    }
