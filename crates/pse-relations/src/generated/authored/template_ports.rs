...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    129u8, 105u8, 11u8, 242u8, 157u8, 27u8, 118u8, 235u8, 64u8, 228u8, 242u8, 213u8,
    252u8, 100u8, 170u8, 164u8, 204u8, 26u8, 105u8, 51u8, 36u8, 162u8, 153u8, 123u8,
    157u8, 35u8, 178u8, 202u8, 170u8, 157u8, 55u8, 34u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplatePortsRow {
    ...
    fn builder_allocation_size() -> usize {
        73_704_usize + size_of::<Self::Builder>()
    }
...
impl AuthoredTemplatePortsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredTemplatePortsView<'_>,
    ) -> Result<(), crate::RelationError> {
