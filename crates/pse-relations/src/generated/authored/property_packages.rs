...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    245u8, 73u8, 200u8, 66u8, 155u8, 77u8, 39u8, 12u8, 155u8, 92u8, 153u8, 60u8, 218u8,
    19u8, 38u8, 204u8, 182u8, 139u8, 239u8, 241u8, 179u8, 228u8, 114u8, 225u8, 221u8,
    65u8, 128u8, 242u8, 90u8, 7u8, 209u8, 201u8,
]);
...
impl crate::columnar::RelationRow for AuthoredPropertyPackagesRow {
    ...
    fn builder_allocation_size() -> usize {
        104_352_usize + size_of::<Self::Builder>()
    }
