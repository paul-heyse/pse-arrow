...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    143u8, 138u8, 211u8, 41u8, 2u8, 79u8, 124u8, 84u8, 122u8, 59u8, 196u8, 131u8, 56u8,
    240u8, 225u8, 203u8, 26u8, 45u8, 201u8, 202u8, 227u8, 162u8, 21u8, 211u8, 102u8,
    115u8, 93u8, 226u8, 8u8, 29u8, 241u8, 84u8,
]);
...
impl crate::columnar::RelationRow for AuthoredDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        86_920_usize + size_of::<Self::Builder>()
    }
