...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    6u8, 2u8, 76u8, 51u8, 47u8, 148u8, 102u8, 87u8, 254u8, 11u8, 231u8, 197u8, 7u8,
    214u8, 19u8, 37u8, 202u8, 170u8, 0u8, 45u8, 100u8, 61u8, 192u8, 232u8, 5u8, 62u8,
    221u8, 152u8, 49u8, 151u8, 117u8, 87u8,
]);
...
impl<'a> AuthoredDomainsView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<AuthoredDomainsRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(AuthoredDomainsRow::from_cells)
            .collect()
    }
}
...
impl AuthoredDomainsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(AuthoredDomainsRow::into_cells)
            .collect::<Vec<_>>();
