...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    31u8, 170u8, 20u8, 204u8, 216u8, 128u8, 18u8, 57u8, 104u8, 179u8, 208u8, 4u8, 58u8,
    173u8, 83u8, 185u8, 52u8, 95u8, 125u8, 203u8, 75u8, 203u8, 144u8, 10u8, 154u8, 224u8,
    205u8, 241u8, 180u8, 190u8, 115u8, 174u8,
]);
...
impl crate::typed::CellCodec for AuthoredDomainsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(AuthoredDomainsRow)));
        };
...
impl crate::columnar::RelationRow for AuthoredDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        86_456_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredDomainsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredDomainsBuilder {
    ...
    pub fn push(&mut self, row: AuthoredDomainsRow) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
                crate::columnar::ArrowValue::append(
