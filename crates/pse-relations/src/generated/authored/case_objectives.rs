...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    215u8, 60u8, 230u8, 117u8, 51u8, 45u8, 185u8, 141u8, 239u8, 55u8, 244u8, 25u8, 211u8,
    96u8, 50u8, 163u8, 233u8, 51u8, 136u8, 176u8, 99u8, 66u8, 104u8, 219u8, 75u8, 121u8,
    35u8, 254u8, 149u8, 138u8, 181u8, 85u8,
]);
...
impl crate::columnar::RelationRow for AuthoredCaseObjectivesRow {
    ...
    fn builder_allocation_size() -> usize {
        39_576_usize + size_of::<Self::Builder>()
    }
