...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    201u8, 52u8, 103u8, 86u8, 63u8, 202u8, 249u8, 31u8, 128u8, 163u8, 69u8, 110u8, 221u8,
    91u8, 227u8, 169u8, 24u8, 234u8, 185u8, 218u8, 69u8, 157u8, 62u8, 94u8, 84u8, 215u8,
    188u8, 116u8, 195u8, 115u8, 12u8, 112u8,
]);
...
impl crate::columnar::RelationRow for AuthoredDiscretizationPoliciesRow {
    ...
    fn builder_allocation_size() -> usize {
        78_472_usize + size_of::<Self::Builder>()
    }
