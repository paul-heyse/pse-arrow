...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    190u8, 109u8, 68u8, 226u8, 206u8, 174u8, 33u8, 96u8, 137u8, 136u8, 49u8, 61u8, 62u8,
    155u8, 29u8, 150u8, 49u8, 4u8, 8u8, 17u8, 41u8, 43u8, 156u8, 150u8, 16u8, 46u8,
    133u8, 43u8, 119u8, 254u8, 58u8, 177u8,
]);
...
impl crate::columnar::RelationRow for AuthoredDiscretizationPoliciesRow {
    ...
    fn builder_allocation_size() -> usize {
        73_904_usize + size_of::<Self::Builder>()
    }
