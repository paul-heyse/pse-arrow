...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    223u8, 53u8, 78u8, 167u8, 212u8, 113u8, 248u8, 233u8, 238u8, 198u8, 1u8, 137u8,
    134u8, 147u8, 37u8, 216u8, 162u8, 68u8, 123u8, 16u8, 73u8, 96u8, 143u8, 139u8, 252u8,
    95u8, 162u8, 53u8, 157u8, 127u8, 248u8, 151u8,
]);
    ...
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#finite_elements),
                crate::typed::CellCodec::into_cell(self.r#collocation_points),
            ],
        )
    }
...
impl crate::columnar::ArrowValue for AuthoredDiscretizationPoliciesRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#method, children[3usize].as_mut())?;
        crate::columnar::ArrowValue::append(&self.r#scheme, children[4usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#finite_elements,
            children[5usize].as_mut(),
        )?;
        crate::columnar::ArrowValue::append(
            &self.r#collocation_points,
    ...
    fn append_null(
        ...
        <crate::generated::enums::DiscretizationMethod as crate::columnar::ArrowValue>::append_null(
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#method: <crate::generated::enums::DiscretizationMethod as crate::columnar::ArrowValue>::read(
...
impl crate::columnar::RelationRow for AuthoredDiscretizationPoliciesRow {
    type Builder = AuthoredDiscretizationPoliciesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        AuthoredDiscretizationPoliciesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredDiscretizationPoliciesView::from_checked(batch)?.rows()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            if (self.r#collocation_points).is_some() {
...
impl<'a> AuthoredDiscretizationPoliciesView<'a> {
    ...
    pub fn finite_elements_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn collocation_points_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredDiscretizationPoliciesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredDiscretizationPoliciesRow {
            ...
            r#finite_elements: crate::columnar::ArrowValue::read(
                self.finite_elements_column,
                index,
            )?,
            r#collocation_points: crate::columnar::ArrowValue::read(
                self.collocation_points_column,
                index,
            )?,
        })
...
impl AuthoredDiscretizationPoliciesBuilder {
    ...
    pub fn push(
        ...
        self.columns
            .append(move |columns| {
                ...
                crate::columnar::ArrowValue::append(
                    &row.r#finite_elements,
                    columns[5usize].as_mut(),
                )?;
                crate::columnar::ArrowValue::append(
                    &row.r#collocation_points,
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredDiscretizationPoliciesView<'_>,
    ) -> Result<(), crate::RelationError> {
