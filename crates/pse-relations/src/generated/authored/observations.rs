...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    25u8, 245u8, 112u8, 224u8, 157u8, 137u8, 5u8, 45u8, 157u8, 51u8, 174u8, 27u8, 110u8,
    44u8, 95u8, 90u8, 233u8, 150u8, 136u8, 177u8, 202u8, 68u8, 126u8, 36u8, 192u8, 192u8,
    219u8, 37u8, 61u8, 245u8, 164u8, 125u8,
]);
...
impl crate::columnar::RelationRow for AuthoredObservationsRow {
    ...
    fn builder_allocation_size() -> usize {
        103_112_usize + size_of::<Self::Builder>()
    }
