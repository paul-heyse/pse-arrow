...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    30u8, 163u8, 5u8, 179u8, 78u8, 166u8, 237u8, 169u8, 247u8, 142u8, 149u8, 66u8, 141u8,
    103u8, 214u8, 9u8, 197u8, 200u8, 94u8, 103u8, 143u8, 90u8, 239u8, 4u8, 250u8, 110u8,
    90u8, 223u8, 4u8, 9u8, 44u8, 12u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplatesRow {
    ...
    fn builder_allocation_size() -> usize {
        93_048_usize + size_of::<Self::Builder>()
    }
