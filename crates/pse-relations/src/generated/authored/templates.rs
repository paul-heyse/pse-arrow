...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    180u8, 93u8, 142u8, 128u8, 161u8, 30u8, 3u8, 128u8, 11u8, 145u8, 76u8, 219u8, 98u8,
    99u8, 94u8, 248u8, 69u8, 138u8, 114u8, 4u8, 67u8, 214u8, 100u8, 112u8, 45u8, 134u8,
    71u8, 20u8, 98u8, 75u8, 26u8, 14u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplatesRow {
    ...
    fn builder_allocation_size() -> usize {
        95_272_usize + size_of::<Self::Builder>()
    }
