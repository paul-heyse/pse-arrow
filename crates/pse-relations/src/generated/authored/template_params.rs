...
pub use pse_model::generated::r#authored::r#template_params::{
    AuthoredTemplateParamsRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    4u8, 174u8, 226u8, 254u8, 200u8, 12u8, 47u8, 199u8, 202u8, 15u8, 105u8, 251u8, 247u8,
    156u8, 92u8, 13u8, 13u8, 236u8, 74u8, 244u8, 115u8, 120u8, 247u8, 89u8, 56u8, 209u8,
    255u8, 99u8, 253u8, 174u8, 32u8, 183u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateParamsRow {
    ...
    fn append_columns(
        ...
        crate::columnar::ArrowValue::append(&self.r#required, columns[5usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#domain_spec,
    ...
    fn rows_at(
        ...
        let view = AuthoredTemplateParamsView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///logical_type_id
    pub const LOGICAL_TYPE_ID: crate::columnar::ColumnReference = super::COLUMNS[2usize];
    ///enum_id
    ...
    ///required
    pub const REQUIRED: crate::columnar::ColumnReference = super::COLUMNS[5usize];
    ///domain_spec
    pub const DOMAIN_SPEC: crate::columnar::ColumnReference = super::COLUMNS[6usize];
    ///doc
...
pub type AuthoredTemplateParamsBuilder = crate::columnar::RowBuilder<
    AuthoredTemplateParamsRow,
>;
impl crate::columnar::RelationView for AuthoredTemplateParamsView<'_> {
    type Row = AuthoredTemplateParamsRow;
