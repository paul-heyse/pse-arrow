...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    134u8, 113u8, 120u8, 155u8, 174u8, 138u8, 14u8, 81u8, 223u8, 200u8, 135u8, 138u8,
    82u8, 180u8, 46u8, 200u8, 109u8, 20u8, 226u8, 88u8, 91u8, 199u8, 132u8, 150u8, 228u8,
    48u8, 77u8, 42u8, 236u8, 253u8, 215u8, 178u8,
]);
...
impl crate::columnar::ArrowValue for AuthoredTemplateParamsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for AuthoredTemplateParamsRow {
    type Builder = AuthoredTemplateParamsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        AuthoredTemplateParamsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredTemplateParamsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        70_312_usize + size_of::<Self::Builder>()
    }
...
impl<'a> AuthoredTemplateParamsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredTemplateParamsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredTemplateParamsRow {
...
impl AuthoredTemplateParamsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredTemplateParamsView<'_>,
    ) -> Result<(), crate::RelationError> {
