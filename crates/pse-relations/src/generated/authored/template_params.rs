...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    137u8, 66u8, 74u8, 235u8, 113u8, 16u8, 4u8, 213u8, 112u8, 20u8, 151u8, 229u8, 79u8,
    233u8, 47u8, 161u8, 238u8, 6u8, 52u8, 208u8, 148u8, 128u8, 72u8, 63u8, 3u8, 177u8,
    110u8, 209u8, 182u8, 63u8, 26u8, 194u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateParamsRow {
    ...
    fn builder_allocation_size() -> usize {
        68_088_usize + size_of::<Self::Builder>()
    }
