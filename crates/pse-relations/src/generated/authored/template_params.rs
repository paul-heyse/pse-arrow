...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    195u8, 174u8, 253u8, 67u8, 93u8, 27u8, 20u8, 113u8, 244u8, 133u8, 27u8, 183u8, 5u8,
    172u8, 61u8, 186u8, 224u8, 8u8, 128u8, 150u8, 29u8, 59u8, 109u8, 183u8, 92u8, 19u8,
    173u8, 36u8, 89u8, 199u8, 143u8, 13u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateParamsRow {
    ...
    fn builder_allocation_size() -> usize {
        68_552_usize + size_of::<Self::Builder>()
    }
