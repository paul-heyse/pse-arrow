...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    87u8, 192u8, 30u8, 237u8, 62u8, 23u8, 92u8, 231u8, 22u8, 95u8, 40u8, 155u8, 7u8,
    175u8, 31u8, 172u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "case_revisions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    230u8, 206u8, 204u8, 126u8, 135u8, 10u8, 6u8, 132u8, 250u8, 165u8, 189u8, 76u8, 18u8,
    215u8, 224u8, 5u8, 27u8, 87u8, 100u8, 2u8, 174u8, 238u8, 11u8, 147u8, 223u8, 192u8,
    152u8, 116u8, 66u8, 228u8, 174u8, 73u8,
]);
...
pub struct AuthoredCaseRevisionsRow {
    ///case_revision_id
    pub r#case_revision_id: pse_ids::SemanticId,
    ///model_revision_id
...
impl crate::typed::CellCodec for AuthoredCaseRevisionsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                crate::typed::CellCodec::into_cell(self.r#case_revision_id),
                crate::typed::CellCodec::into_cell(self.r#model_revision_id),
                crate::typed::CellCodec::into_cell(self.r#parent_case_id),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(AuthoredCaseRevisionsRow)));
        };
        ...
        Ok(Self {
            r#case_revision_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(AuthoredCaseRevisionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for AuthoredCaseRevisionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#author, children[5usize].as_mut())?;
    ...
    fn read(
        ...
        Ok(Self {
            r#case_revision_id: <pse_ids::SemanticId as crate::columnar::ArrowValue>::read(
...
pub type Row = AuthoredCaseRevisionsRow;
/// The concrete generated relation view.
pub type View<'a> = AuthoredCaseRevisionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = AuthoredCaseRevisionsBuilder;
impl AuthoredCaseRevisionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "authored.case_revisions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for AuthoredCaseRevisionsRow {
    type Builder = AuthoredCaseRevisionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        AuthoredCaseRevisionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredCaseRevisionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        67_808_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredCaseRevisionsView<'a> {
    batch: &'a crate::RecordBatch,
    case_revision_id_column: &'a arrow_array::FixedSizeBinaryArray,
...
impl<'a> AuthoredCaseRevisionsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            batch,
            case_revision_id_column: crate::columnar::array::<
    ...
    pub const fn case_revision_id_column(
        &self,
    ) -> &'a arrow_array::FixedSizeBinaryArray {
        self.case_revision_id_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "case_revision_id", "`.")]
    pub fn case_revision_id_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredCaseRevisionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredCaseRevisionsRow {
            r#case_revision_id: crate::columnar::ArrowValue::read(
                self.case_revision_id_column,
                index,
            )?,
    ...
    pub fn rows(&self) -> Result<Vec<AuthoredCaseRevisionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct AuthoredCaseRevisionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredCaseRevisionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: AuthoredCaseRevisionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
                crate::columnar::ArrowValue::append(
                    &row.r#case_revision_id,
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredCaseRevisionsView<'_>,
    ) -> Result<(), crate::RelationError> {
