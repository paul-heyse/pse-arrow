...
pub use pse_model::generated::r#authored::r#template_material_constraints::{
    AuthoredTemplateMaterialConstraintsRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    165u8, 88u8, 131u8, 38u8, 117u8, 178u8, 223u8, 94u8, 118u8, 238u8, 200u8, 145u8,
    25u8, 215u8, 2u8, 30u8, 218u8, 110u8, 154u8, 202u8, 143u8, 121u8, 244u8, 57u8, 9u8,
    209u8, 58u8, 126u8, 109u8, 242u8, 171u8, 63u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateMaterialConstraintsRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredTemplateMaterialConstraintsView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///min_phases
    pub const MIN_PHASES: crate::columnar::ColumnReference = super::COLUMNS[1usize];
    ///max_phases
    pub const MAX_PHASES: crate::columnar::ColumnReference = super::COLUMNS[2usize];
    ///min_species
    pub const MIN_SPECIES: crate::columnar::ColumnReference = super::COLUMNS[3usize];
    ///max_species
    pub const MAX_SPECIES: crate::columnar::ColumnReference = super::COLUMNS[4usize];
}
...
pub type AuthoredTemplateMaterialConstraintsBuilder = crate::columnar::RowBuilder<
    AuthoredTemplateMaterialConstraintsRow,
>;
impl crate::columnar::RelationView for AuthoredTemplateMaterialConstraintsView<'_> {
    type Row = AuthoredTemplateMaterialConstraintsRow;
