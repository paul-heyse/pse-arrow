...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    125u8, 18u8, 170u8, 29u8, 210u8, 189u8, 19u8, 179u8, 98u8, 232u8, 8u8, 182u8, 184u8,
    245u8, 194u8, 20u8, 176u8, 51u8, 211u8, 125u8, 164u8, 39u8, 187u8, 13u8, 134u8, 24u8,
    31u8, 57u8, 97u8, 151u8, 174u8, 32u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateMaterialConstraintsRow {
    ...
    fn builder_allocation_size() -> usize {
        42_728_usize + size_of::<Self::Builder>()
    }
