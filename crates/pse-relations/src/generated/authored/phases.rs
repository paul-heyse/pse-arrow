...
pub use pse_model::generated::r#authored::r#phases::{AuthoredPhasesRow, Row};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    113u8, 53u8, 43u8, 198u8, 87u8, 229u8, 84u8, 184u8, 252u8, 215u8, 227u8, 110u8,
    145u8, 196u8, 115u8, 7u8, 249u8, 83u8, 72u8, 135u8, 187u8, 68u8, 67u8, 239u8, 125u8,
    238u8, 178u8, 51u8, 122u8, 219u8, 175u8, 255u8,
]);
...
impl crate::columnar::RelationRow for AuthoredPhasesRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredPhasesView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///phase_type
    pub const PHASE_TYPE: crate::columnar::ColumnReference = super::COLUMNS[3usize];
    ///is_solvent_phase
    pub const IS_SOLVENT_PHASE: crate::columnar::ColumnReference = super::COLUMNS[4usize];
    ///doc
...
pub type AuthoredPhasesBuilder = crate::columnar::RowBuilder<AuthoredPhasesRow>;
impl crate::columnar::RelationView for AuthoredPhasesView<'_> {
    type Row = AuthoredPhasesRow;
