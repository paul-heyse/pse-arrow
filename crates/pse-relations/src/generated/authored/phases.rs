...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    4u8, 82u8, 1u8, 15u8, 187u8, 11u8, 117u8, 223u8, 242u8, 92u8, 229u8, 108u8, 48u8,
    38u8, 61u8, 206u8, 143u8, 192u8, 82u8, 85u8, 35u8, 242u8, 180u8, 6u8, 235u8, 186u8,
    78u8, 14u8, 98u8, 181u8, 192u8, 186u8,
]);
...
impl crate::columnar::RelationRow for AuthoredPhasesRow {
    ...
    fn builder_allocation_size() -> usize {
        61_928_usize + size_of::<Self::Builder>()
    }
