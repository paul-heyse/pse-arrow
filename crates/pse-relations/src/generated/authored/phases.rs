...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    245u8, 38u8, 44u8, 37u8, 141u8, 238u8, 248u8, 92u8, 231u8, 158u8, 103u8, 213u8, 18u8,
    123u8, 227u8, 25u8, 123u8, 252u8, 48u8, 5u8, 96u8, 218u8, 96u8, 148u8, 15u8, 111u8,
    6u8, 207u8, 137u8, 186u8, 168u8, 46u8,
]);
...
impl crate::columnar::RelationRow for AuthoredPhasesRow {
    ...
    fn builder_allocation_size() -> usize {
        63_688_usize + size_of::<Self::Builder>()
    }
