...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    249u8, 16u8, 26u8, 115u8, 135u8, 254u8, 58u8, 247u8, 32u8, 200u8, 40u8, 117u8, 118u8,
    57u8, 133u8, 111u8, 96u8, 21u8, 55u8, 94u8, 56u8, 144u8, 87u8, 17u8, 177u8, 78u8,
    18u8, 214u8, 195u8, 55u8, 152u8, 103u8,
]);
...
impl<'a> AuthoredScopesView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<AuthoredScopesRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(AuthoredScopesRow::from_cells)
            .collect()
    }
}
...
impl AuthoredScopesBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(AuthoredScopesRow::into_cells)
            .collect::<Vec<_>>();
