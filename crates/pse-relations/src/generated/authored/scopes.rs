...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    225u8, 36u8, 248u8, 194u8, 219u8, 88u8, 32u8, 204u8, 82u8, 137u8, 207u8, 173u8,
    231u8, 36u8, 10u8, 130u8, 101u8, 136u8, 84u8, 56u8, 82u8, 21u8, 183u8, 17u8, 130u8,
    74u8, 111u8, 7u8, 99u8, 69u8, 205u8, 111u8,
]);
...
impl crate::columnar::RelationRow for AuthoredScopesRow {
    ...
    fn builder_allocation_size() -> usize {
        26_016_usize + size_of::<Self::Builder>()
    }
