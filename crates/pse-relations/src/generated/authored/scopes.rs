...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    196u8, 144u8, 148u8, 157u8, 241u8, 82u8, 51u8, 163u8, 2u8, 116u8, 84u8, 244u8, 232u8,
    155u8, 163u8, 42u8, 47u8, 5u8, 72u8, 138u8, 66u8, 25u8, 46u8, 167u8, 163u8, 189u8,
    94u8, 113u8, 61u8, 138u8, 71u8, 126u8,
]);
...
impl crate::typed::CellCodec for AuthoredScopesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(AuthoredScopesRow)));
        };
...
impl crate::columnar::RelationRow for AuthoredScopesRow {
    ...
    fn builder_allocation_size() -> usize {
        27_776_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredScopesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredScopesBuilder {
    ...
    pub fn push(&mut self, row: AuthoredScopesRow) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
                crate::columnar::ArrowValue::append(
