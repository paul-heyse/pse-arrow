...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    149u8, 164u8, 81u8, 65u8, 200u8, 8u8, 131u8, 113u8, 64u8, 251u8, 169u8, 151u8, 240u8,
    107u8, 210u8, 92u8, 18u8, 81u8, 58u8, 182u8, 16u8, 77u8, 12u8, 44u8, 208u8, 95u8,
    84u8, 60u8, 75u8, 113u8, 164u8, 21u8,
]);
...
impl crate::columnar::RelationRow for AuthoredScopesRow {
    ...
    fn builder_allocation_size() -> usize {
        25_552_usize + size_of::<Self::Builder>()
    }
