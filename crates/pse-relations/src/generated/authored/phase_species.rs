...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    31u8, 61u8, 127u8, 73u8, 50u8, 48u8, 140u8, 131u8, 123u8, 186u8, 181u8, 109u8, 72u8,
    177u8, 139u8, 137u8, 156u8, 10u8, 16u8, 8u8, 177u8, 107u8, 129u8, 13u8, 189u8, 34u8,
    23u8, 146u8, 210u8, 102u8, 56u8, 245u8,
]);
...
impl crate::columnar::RelationRow for AuthoredPhaseSpeciesRow {
    ...
    fn builder_allocation_size() -> usize {
        33_080_usize + size_of::<Self::Builder>()
    }
