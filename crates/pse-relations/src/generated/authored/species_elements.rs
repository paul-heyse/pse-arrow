...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    67u8, 67u8, 240u8, 36u8, 160u8, 55u8, 238u8, 5u8, 104u8, 142u8, 212u8, 111u8, 215u8,
    15u8, 184u8, 229u8, 134u8, 82u8, 37u8, 213u8, 108u8, 107u8, 10u8, 81u8, 165u8, 20u8,
    208u8, 18u8, 149u8, 69u8, 127u8, 183u8,
]);
...
impl crate::columnar::RelationRow for AuthoredSpeciesElementsRow {
    ...
    fn builder_allocation_size() -> usize {
        39_064_usize + size_of::<Self::Builder>()
    }
