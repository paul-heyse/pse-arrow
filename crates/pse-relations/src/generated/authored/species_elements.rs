...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    132u8, 36u8, 61u8, 46u8, 120u8, 40u8, 162u8, 226u8, 159u8, 193u8, 152u8, 195u8,
    253u8, 178u8, 165u8, 139u8, 36u8, 66u8, 240u8, 45u8, 14u8, 167u8, 224u8, 48u8, 171u8,
    228u8, 178u8, 33u8, 94u8, 229u8, 237u8, 24u8,
]);
...
impl crate::columnar::ArrowValue for AuthoredSpeciesElementsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for AuthoredSpeciesElementsRow {
    type Builder = AuthoredSpeciesElementsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        AuthoredSpeciesElementsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredSpeciesElementsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        36_840_usize + size_of::<Self::Builder>()
    }
...
impl<'a> AuthoredSpeciesElementsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredSpeciesElementsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredSpeciesElementsRow {
...
impl AuthoredSpeciesElementsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredSpeciesElementsView<'_>,
    ) -> Result<(), crate::RelationError> {
