...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    138u8, 73u8, 162u8, 34u8, 46u8, 216u8, 62u8, 10u8, 26u8, 208u8, 189u8, 87u8, 177u8,
    180u8, 152u8, 130u8, 208u8, 173u8, 8u8, 52u8, 79u8, 156u8, 64u8, 163u8, 247u8, 89u8,
    188u8, 23u8, 158u8, 51u8, 209u8, 230u8,
]);
...
impl crate::columnar::RelationRow for AuthoredSpeciesElementsRow {
    ...
    fn builder_allocation_size() -> usize {
        37_304_usize + size_of::<Self::Builder>()
    }
