...
pub use pse_model::generated::r#authored::r#species_elements::{
    AuthoredSpeciesElementsRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    166u8, 123u8, 150u8, 248u8, 96u8, 140u8, 129u8, 255u8, 36u8, 58u8, 126u8, 149u8,
    36u8, 185u8, 114u8, 25u8, 43u8, 154u8, 39u8, 217u8, 81u8, 175u8, 208u8, 4u8, 148u8,
    83u8, 179u8, 92u8, 112u8, 108u8, 154u8, 192u8,
]);
...
impl crate::columnar::RelationRow for AuthoredSpeciesElementsRow {
    ...
    fn append_columns(
        ...
        crate::columnar::ArrowValue::append(&self.r#count, columns[2usize].as_mut())?;
        Ok(())
    }
    fn relation(
    ...
    fn rows_at(
        ...
        let view = AuthoredSpeciesElementsView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///element_id
    pub const ELEMENT_ID: crate::columnar::ColumnReference = super::COLUMNS[1usize];
    ///count
    pub const COUNT: crate::columnar::ColumnReference = super::COLUMNS[2usize];
}
...
pub type AuthoredSpeciesElementsBuilder = crate::columnar::RowBuilder<
    AuthoredSpeciesElementsRow,
>;
impl crate::columnar::RelationView for AuthoredSpeciesElementsView<'_> {
    type Row = AuthoredSpeciesElementsRow;
