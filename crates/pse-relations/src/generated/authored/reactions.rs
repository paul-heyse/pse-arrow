...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    39u8, 84u8, 33u8, 83u8, 81u8, 149u8, 1u8, 190u8, 244u8, 62u8, 147u8, 79u8, 0u8,
    213u8, 15u8, 87u8, 173u8, 121u8, 189u8, 166u8, 28u8, 176u8, 149u8, 251u8, 208u8,
    99u8, 95u8, 22u8, 209u8, 124u8, 246u8, 59u8,
]);
...
impl crate::columnar::RelationRow for AuthoredReactionsRow {
    ...
    fn builder_allocation_size() -> usize {
        99_800_usize + size_of::<Self::Builder>()
    }
