...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    148u8, 46u8, 1u8, 164u8, 132u8, 128u8, 204u8, 167u8, 38u8, 89u8, 148u8, 35u8, 128u8,
    203u8, 130u8, 30u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    250u8, 201u8, 164u8, 141u8, 110u8, 98u8, 135u8, 121u8, 48u8, 227u8, 67u8, 160u8,
    147u8, 17u8, 222u8, 54u8, 24u8, 140u8, 110u8, 16u8, 47u8, 131u8, 12u8, 108u8, 94u8,
    235u8, 189u8, 130u8, 230u8, 123u8, 217u8, 1u8,
]);
...
impl crate::typed::CellCodec for AuthoredTemplateGuardsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(AuthoredTemplateGuardsRow)));
        };
            ...
            r#guard_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(AuthoredTemplateGuardsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for AuthoredTemplateGuardsRow {
    fn append(
        &self,
...
pub type View<'a> = AuthoredTemplateGuardsView<'a>;
/// The concrete generated relation builder.
pub type Builder = AuthoredTemplateGuardsBuilder;
impl AuthoredTemplateGuardsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "authored.template_guards".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for AuthoredTemplateGuardsRow {
    type Builder = AuthoredTemplateGuardsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        AuthoredTemplateGuardsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredTemplateGuardsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        43_904_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredTemplateGuardsView<'a> {
...
impl<'a> AuthoredTemplateGuardsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredTemplateGuardsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredTemplateGuardsRow {
    ...
    pub fn rows(&self) -> Result<Vec<AuthoredTemplateGuardsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct AuthoredTemplateGuardsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredTemplateGuardsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredTemplateGuardsView<'_>,
    ) -> Result<(), crate::RelationError> {
