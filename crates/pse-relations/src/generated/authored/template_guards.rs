...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    241u8, 38u8, 197u8, 71u8, 169u8, 103u8, 144u8, 123u8, 180u8, 83u8, 3u8, 175u8, 217u8,
    26u8, 61u8, 240u8, 23u8, 4u8, 80u8, 123u8, 113u8, 224u8, 5u8, 238u8, 142u8, 234u8,
    103u8, 177u8, 138u8, 85u8, 211u8, 144u8,
]);
...
impl<'a> AuthoredTemplateGuardsView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<AuthoredTemplateGuardsRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(AuthoredTemplateGuardsRow::from_cells)
            .collect()
    }
}
...
pub struct AuthoredTemplateGuardsBuilder {
    rows: Vec<AuthoredTemplateGuardsRow>,
}
impl AuthoredTemplateGuardsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(AuthoredTemplateGuardsRow::into_cells)
            .collect::<Vec<_>>();
