...
pub use pse_model::generated::r#authored::r#template_guards::{
    AuthoredTemplateGuardsRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    145u8, 53u8, 101u8, 122u8, 165u8, 107u8, 150u8, 212u8, 68u8, 74u8, 69u8, 118u8, 25u8,
    112u8, 128u8, 104u8, 179u8, 172u8, 251u8, 146u8, 82u8, 37u8, 224u8, 177u8, 135u8,
    95u8, 90u8, 97u8, 127u8, 96u8, 24u8, 231u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateGuardsRow {
    ...
    fn append_columns(
        ...
        crate::columnar::ArrowValue::append(&self.r#guard_id, columns[0usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#template_id,
    ...
    fn rows_at(
        ...
        let view = AuthoredTemplateGuardsView::from_checked(batch)?;
...
pub mod columns {
    ///guard_id
    pub const GUARD_ID: crate::columnar::ColumnReference = super::COLUMNS[0usize];
    ///template_id
    pub const TEMPLATE_ID: crate::columnar::ColumnReference = super::COLUMNS[1usize];
    ///predicate
    pub const PREDICATE: crate::columnar::ColumnReference = super::COLUMNS[2usize];
    ///doc
...
pub type AuthoredTemplateGuardsBuilder = crate::columnar::RowBuilder<
    AuthoredTemplateGuardsRow,
>;
impl crate::columnar::RelationView for AuthoredTemplateGuardsView<'_> {
    type Row = AuthoredTemplateGuardsRow;
