...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    179u8, 140u8, 234u8, 233u8, 225u8, 143u8, 189u8, 162u8, 187u8, 131u8, 13u8, 248u8,
    194u8, 150u8, 74u8, 86u8, 51u8, 119u8, 142u8, 148u8, 16u8, 87u8, 89u8, 247u8, 232u8,
    105u8, 125u8, 55u8, 46u8, 69u8, 113u8, 243u8,
]);
...
impl<'a> AuthoredPackageUnitSetsView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<AuthoredPackageUnitSetsRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(AuthoredPackageUnitSetsRow::from_cells)
            .collect()
    }
}
...
pub struct AuthoredPackageUnitSetsBuilder {
    rows: Vec<AuthoredPackageUnitSetsRow>,
}
impl AuthoredPackageUnitSetsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(AuthoredPackageUnitSetsRow::into_cells)
            .collect::<Vec<_>>();
