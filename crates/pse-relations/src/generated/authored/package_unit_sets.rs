...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    253u8, 74u8, 2u8, 245u8, 214u8, 189u8, 111u8, 146u8, 41u8, 233u8, 153u8, 13u8, 161u8,
    204u8, 227u8, 86u8, 52u8, 4u8, 71u8, 4u8, 12u8, 165u8, 206u8, 226u8, 177u8, 139u8,
    43u8, 163u8, 61u8, 183u8, 134u8, 61u8,
]);
...
impl crate::columnar::RelationRow for AuthoredPackageUnitSetsRow {
    ...
    fn builder_allocation_size() -> usize {
        33_520_usize + size_of::<Self::Builder>()
    }
