...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    48u8, 198u8, 121u8, 176u8, 10u8, 91u8, 217u8, 226u8, 235u8, 128u8, 252u8, 126u8,
    157u8, 202u8, 237u8, 215u8, 122u8, 188u8, 217u8, 147u8, 199u8, 196u8, 249u8, 95u8,
    134u8, 103u8, 198u8, 141u8, 3u8, 17u8, 103u8, 19u8,
]);
...
impl crate::typed::CellCodec for AuthoredPackageUnitSetsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(AuthoredPackageUnitSetsRow)));
        };
            ...
            r#package_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(AuthoredPackageUnitSetsRow),
                    ))?,
            )?,
...
impl AuthoredPackageUnitSetsRow {
...
impl crate::columnar::RelationRow for AuthoredPackageUnitSetsRow {
    ...
    fn builder_allocation_size() -> usize {
        31_296_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredPackageUnitSetsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredPackageUnitSetsBuilder {
    ...
    pub fn push(
        &mut self,
        row: AuthoredPackageUnitSetsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredPackageUnitSetsView<'_>,
    ) -> Result<(), crate::RelationError> {
