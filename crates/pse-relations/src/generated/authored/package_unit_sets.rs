...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    73u8, 87u8, 77u8, 109u8, 234u8, 7u8, 246u8, 67u8, 79u8, 83u8, 166u8, 221u8, 156u8,
    15u8, 178u8, 126u8, 87u8, 53u8, 92u8, 251u8, 4u8, 156u8, 101u8, 220u8, 82u8, 147u8,
    161u8, 210u8, 155u8, 239u8, 234u8, 165u8,
]);
...
impl crate::columnar::RelationRow for AuthoredPackageUnitSetsRow {
    ...
    fn builder_allocation_size() -> usize {
        31_760_usize + size_of::<Self::Builder>()
    }
