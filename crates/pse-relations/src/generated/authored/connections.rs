...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    13u8, 3u8, 195u8, 141u8, 10u8, 192u8, 45u8, 159u8, 237u8, 129u8, 224u8, 131u8, 80u8,
    56u8, 23u8, 157u8, 91u8, 197u8, 244u8, 203u8, 53u8, 12u8, 64u8, 220u8, 228u8, 213u8,
    169u8, 44u8, 130u8, 254u8, 2u8, 173u8,
]);
...
impl crate::columnar::RelationRow for AuthoredConnectionsRow {
    ...
    fn builder_allocation_size() -> usize {
        58_952_usize + size_of::<Self::Builder>()
    }
