...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    175u8, 229u8, 120u8, 202u8, 19u8, 144u8, 9u8, 115u8, 207u8, 239u8, 73u8, 15u8, 32u8,
    204u8, 172u8, 96u8, 85u8, 23u8, 100u8, 233u8, 133u8, 110u8, 254u8, 68u8, 64u8, 123u8,
    20u8, 44u8, 230u8, 241u8, 183u8, 54u8,
]);
...
impl AuthoredConnectionsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredConnectionsView<'_>,
    ) -> Result<(), crate::RelationError> {
