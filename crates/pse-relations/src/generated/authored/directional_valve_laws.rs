...
pub use pse_model::generated::r#authored::r#directional_valve_laws::{
    AuthoredDirectionalValveLawsRow, Row,
};
/// The declared relation identity.
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    44u8, 170u8, 115u8, 220u8, 75u8, 44u8, 194u8, 13u8, 238u8, 93u8, 163u8, 159u8, 29u8,
    182u8, 241u8, 213u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "directional_valve_laws";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    43u8, 131u8, 151u8, 212u8, 163u8, 170u8, 111u8, 131u8, 44u8, 233u8, 136u8, 42u8,
    11u8, 141u8, 210u8, 158u8, 154u8, 34u8, 77u8, 190u8, 140u8, 242u8, 159u8, 168u8,
    82u8, 78u8, 110u8, 238u8, 86u8, 143u8, 140u8, 48u8,
]);
impl crate::columnar::ArrowValue for AuthoredDirectionalValveLawsRow {
    fn append(
        &self,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#transition_width_id: <pse_ids::SemanticId as crate::columnar::ArrowValue>::read(
...
pub type View<'a> = AuthoredDirectionalValveLawsView<'a>;
/// The concrete generated relation builder.
pub type Builder = AuthoredDirectionalValveLawsBuilder;
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "authored.directional_valve_laws".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for AuthoredDirectionalValveLawsRow {
    type Builder = AuthoredDirectionalValveLawsBuilder;
    fn append_columns(
        &self,
    ...
    fn builder(
        ...
        AuthoredDirectionalValveLawsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredDirectionalValveLawsView::from_checked(batch)?.rows()
    }
    fn rows_at(
        batch: &crate::columnar::FieldCheckedBatch,
        positions: &[usize],
    ) -> Result<Vec<Self>, crate::RelationError> {
        let view = AuthoredDirectionalValveLawsView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///transition_width_id
    pub const TRANSITION_WIDTH_ID: crate::columnar::ColumnReference = super::COLUMNS[2usize];
}
/// Borrowed Arrow columns with checked layout and local values.
/// Keys, references and domain completeness require relational admission.
#[derive(Debug)]
pub struct AuthoredDirectionalValveLawsView<'a> {
    batch: &'a crate::RecordBatch,
    model_id_column: &'a arrow_array::FixedSizeBinaryArray,
    name_column: &'a arrow_array::StringArray,
    transition_width_id_column: &'a arrow_array::FixedSizeBinaryArray,
}
impl<'a> AuthoredDirectionalValveLawsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            transition_width_id_column: crate::columnar::array::<
                arrow_array::FixedSizeBinaryArray,
    ...
    pub const fn transition_width_id_column(
        &self,
    ) -> &'a arrow_array::FixedSizeBinaryArray {
        self.transition_width_id_column
    }
    #[doc = concat!(
    ...
    pub fn transition_width_id_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredDirectionalValveLawsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredDirectionalValveLawsRow {
            ...
            r#transition_width_id: crate::columnar::ArrowValue::read(
                self.transition_width_id_column,
                index,
            )?,
        })
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<AuthoredDirectionalValveLawsRow>, crate::RelationError> {
        (0..self.len()).map(|index| self.row(index)).collect()
    }
}
/// Shared native column builder for this declaration.
pub type AuthoredDirectionalValveLawsBuilder = crate::columnar::RowBuilder<
    AuthoredDirectionalValveLawsRow,
>;
impl crate::columnar::RelationView for AuthoredDirectionalValveLawsView<'_> {
    type Row = AuthoredDirectionalValveLawsRow;
