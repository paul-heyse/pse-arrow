...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    16u8, 54u8, 255u8, 194u8, 180u8, 35u8, 33u8, 86u8, 222u8, 76u8, 106u8, 233u8, 45u8,
    231u8, 23u8, 152u8, 105u8, 220u8, 138u8, 58u8, 220u8, 130u8, 155u8, 161u8, 67u8,
    138u8, 29u8, 1u8, 59u8, 15u8, 110u8, 75u8,
]);
...
impl crate::columnar::RelationRow for AuthoredCaseActivationTargetsRow {
    ...
    fn builder_allocation_size() -> usize {
        112_544_usize + size_of::<Self::Builder>()
    }
