...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    227u8, 99u8, 13u8, 42u8, 61u8, 88u8, 255u8, 152u8, 37u8, 109u8, 238u8, 112u8, 224u8,
    197u8, 8u8, 62u8, 103u8, 120u8, 89u8, 234u8, 200u8, 37u8, 178u8, 12u8, 145u8, 236u8,
    55u8, 21u8, 25u8, 165u8, 159u8, 163u8,
]);
...
impl crate::typed::CellCodec for AuthoredTemplateDerivativesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(AuthoredTemplateDerivativesRow)),
            );
        };
            ...
            r#symbol_decl_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(AuthoredTemplateDerivativesRow),
                    ))?,
            )?,
...
impl AuthoredTemplateDerivativesRow {
...
impl crate::columnar::RelationRow for AuthoredTemplateDerivativesRow {
    ...
    fn builder_allocation_size() -> usize {
        27_904_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredTemplateDerivativesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredTemplateDerivativesBuilder {
    ...
    pub fn push(
        &mut self,
        row: AuthoredTemplateDerivativesRow,
    ) -> Result<(), crate::RelationError> {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredTemplateDerivativesView<'_>,
    ) -> Result<(), crate::RelationError> {
