...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    161u8, 73u8, 47u8, 90u8, 117u8, 171u8, 194u8, 250u8, 84u8, 10u8, 179u8, 61u8, 139u8,
    86u8, 115u8, 141u8, 8u8, 28u8, 39u8, 242u8, 73u8, 196u8, 180u8, 84u8, 66u8, 243u8,
    254u8, 188u8, 1u8, 250u8, 115u8, 158u8,
]);
...
impl crate::columnar::RelationRow for AuthoredInstanceDomainBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        39_488_usize + size_of::<Self::Builder>()
    }
