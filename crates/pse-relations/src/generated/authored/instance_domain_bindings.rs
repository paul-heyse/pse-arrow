...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    238u8, 55u8, 199u8, 251u8, 40u8, 62u8, 212u8, 29u8, 231u8, 99u8, 88u8, 66u8, 75u8,
    52u8, 93u8, 71u8, 190u8, 229u8, 167u8, 173u8, 176u8, 74u8, 204u8, 77u8, 38u8, 129u8,
    80u8, 189u8, 147u8, 197u8, 81u8, 155u8,
]);
...
impl crate::columnar::RelationRow for AuthoredInstanceDomainBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        37_728_usize + size_of::<Self::Builder>()
    }
