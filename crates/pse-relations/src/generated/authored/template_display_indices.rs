...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    64u8, 30u8, 44u8, 125u8, 138u8, 50u8, 43u8, 199u8, 84u8, 80u8, 149u8, 164u8, 180u8,
    246u8, 134u8, 62u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    160u8, 179u8, 229u8, 247u8, 194u8, 172u8, 37u8, 229u8, 103u8, 8u8, 221u8, 172u8,
    252u8, 58u8, 82u8, 118u8, 188u8, 103u8, 123u8, 154u8, 254u8, 38u8, 208u8, 199u8,
    187u8, 42u8, 223u8, 13u8, 2u8, 235u8, 147u8, 238u8,
]);
...
impl crate::typed::CellCodec for AuthoredTemplateDisplayIndicesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(AuthoredTemplateDisplayIndicesRow)),
            );
        };
            ...
            r#template_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(AuthoredTemplateDisplayIndicesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for AuthoredTemplateDisplayIndicesRow {
    fn append(
        &self,
...
pub type View<'a> = AuthoredTemplateDisplayIndicesView<'a>;
/// The concrete generated relation builder.
pub type Builder = AuthoredTemplateDisplayIndicesBuilder;
impl AuthoredTemplateDisplayIndicesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "authored.template_display_indices".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for AuthoredTemplateDisplayIndicesRow {
    type Builder = AuthoredTemplateDisplayIndicesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        AuthoredTemplateDisplayIndicesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredTemplateDisplayIndicesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        58_528_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredTemplateDisplayIndicesView<'a> {
...
impl<'a> AuthoredTemplateDisplayIndicesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredTemplateDisplayIndicesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredTemplateDisplayIndicesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<AuthoredTemplateDisplayIndicesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct AuthoredTemplateDisplayIndicesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredTemplateDisplayIndicesBuilder {
    ...
    pub fn push(
        &mut self,
        row: AuthoredTemplateDisplayIndicesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredTemplateDisplayIndicesView<'_>,
    ) -> Result<(), crate::RelationError> {
