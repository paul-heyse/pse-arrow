...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    139u8, 119u8, 106u8, 250u8, 30u8, 30u8, 255u8, 211u8, 72u8, 36u8, 238u8, 24u8, 63u8,
    151u8, 239u8, 124u8, 183u8, 54u8, 152u8, 231u8, 195u8, 182u8, 10u8, 74u8, 239u8,
    35u8, 236u8, 204u8, 56u8, 14u8, 35u8, 60u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateDisplayIndicesRow {
    ...
    fn builder_allocation_size() -> usize {
        56_768_usize + size_of::<Self::Builder>()
    }
