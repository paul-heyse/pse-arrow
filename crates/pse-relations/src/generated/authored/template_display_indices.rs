...
pub use pse_model::generated::r#authored::r#template_display_indices::{
    AuthoredTemplateDisplayIndicesRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    193u8, 217u8, 169u8, 220u8, 253u8, 148u8, 24u8, 185u8, 100u8, 156u8, 74u8, 8u8, 75u8,
    199u8, 39u8, 110u8, 177u8, 8u8, 205u8, 219u8, 3u8, 19u8, 120u8, 192u8, 21u8, 217u8,
    205u8, 223u8, 113u8, 96u8, 174u8, 207u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateDisplayIndicesRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredTemplateDisplayIndicesView::from_checked(batch)?;
...
pub type AuthoredTemplateDisplayIndicesBuilder = crate::columnar::RowBuilder<
    AuthoredTemplateDisplayIndicesRow,
>;
impl crate::columnar::RelationView for AuthoredTemplateDisplayIndicesView<'_> {
    type Row = AuthoredTemplateDisplayIndicesRow;
