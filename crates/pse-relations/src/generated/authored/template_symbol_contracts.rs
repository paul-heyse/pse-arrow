...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    181u8, 52u8, 60u8, 122u8, 235u8, 119u8, 59u8, 23u8, 31u8, 209u8, 66u8, 149u8, 224u8,
    219u8, 32u8, 205u8, 4u8, 236u8, 205u8, 35u8, 68u8, 217u8, 156u8, 123u8, 101u8, 176u8,
    15u8, 142u8, 154u8, 243u8, 123u8, 235u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateSymbolContractsRow {
    ...
    fn builder_allocation_size() -> usize {
        50_160_usize + size_of::<Self::Builder>()
    }
