...
pub use pse_model::generated::r#authored::r#instances::{
    AuthoredInstancesFieldParamValuesItem, AuthoredInstancesFieldFeatureValuesItem,
    AuthoredInstancesRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    88u8, 155u8, 181u8, 103u8, 0u8, 57u8, 109u8, 220u8, 182u8, 112u8, 1u8, 162u8, 162u8,
    124u8, 106u8, 29u8, 21u8, 227u8, 224u8, 154u8, 36u8, 174u8, 27u8, 57u8, 107u8, 186u8,
    193u8, 159u8, 54u8, 141u8, 153u8, 116u8,
]);
...
impl crate::columnar::RelationRow for AuthoredInstancesRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredInstancesView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///param_values
    pub const PARAM_VALUES: crate::columnar::ColumnReference = super::COLUMNS[4usize];
    ///feature_values
    pub const FEATURE_VALUES: crate::columnar::ColumnReference = super::COLUMNS[5usize];
    ///property_package_id
    pub const PROPERTY_PACKAGE_ID: crate::columnar::ColumnReference = super::COLUMNS[6usize];
    ///reaction_package_id
    pub const REACTION_PACKAGE_ID: crate::columnar::ColumnReference = super::COLUMNS[7usize];
    ///doc
...
pub type AuthoredInstancesBuilder = crate::columnar::RowBuilder<AuthoredInstancesRow>;
impl crate::columnar::RelationView for AuthoredInstancesView<'_> {
    type Row = AuthoredInstancesRow;
