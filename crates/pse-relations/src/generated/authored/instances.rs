...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    14u8, 189u8, 58u8, 245u8, 59u8, 234u8, 205u8, 223u8, 32u8, 78u8, 238u8, 49u8, 206u8,
    161u8, 156u8, 181u8, 91u8, 158u8, 95u8, 37u8, 211u8, 101u8, 236u8, 114u8, 136u8,
    76u8, 47u8, 67u8, 99u8, 201u8, 127u8, 133u8,
]);
...
impl crate::columnar::RelationRow for AuthoredInstancesRow {
    ...
    fn builder_allocation_size() -> usize {
        151_736_usize + size_of::<Self::Builder>()
    }
