...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    189u8, 29u8, 20u8, 26u8, 251u8, 94u8, 159u8, 41u8, 91u8, 102u8, 231u8, 214u8, 149u8,
    68u8, 30u8, 31u8, 139u8, 220u8, 115u8, 48u8, 121u8, 182u8, 110u8, 0u8, 30u8, 139u8,
    70u8, 95u8, 72u8, 5u8, 58u8, 41u8,
]);
...
impl crate::columnar::RelationRow for AuthoredDocumentsRow {
    ...
    fn builder_allocation_size() -> usize {
        41_432_usize + size_of::<Self::Builder>()
    }
