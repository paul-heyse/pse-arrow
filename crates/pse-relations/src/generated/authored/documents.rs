...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    87u8, 34u8, 251u8, 77u8, 146u8, 218u8, 235u8, 254u8, 141u8, 204u8, 71u8, 0u8, 250u8,
    81u8, 113u8, 67u8, 125u8, 216u8, 162u8, 180u8, 212u8, 150u8, 76u8, 195u8, 226u8,
    217u8, 148u8, 220u8, 101u8, 221u8, 231u8, 57u8,
]);
...
impl<'a> AuthoredDocumentsView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<AuthoredDocumentsRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(AuthoredDocumentsRow::from_cells)
            .collect()
    }
}
...
impl AuthoredDocumentsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(AuthoredDocumentsRow::into_cells)
            .collect::<Vec<_>>();
