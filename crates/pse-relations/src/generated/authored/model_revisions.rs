...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    69u8, 30u8, 254u8, 11u8, 36u8, 140u8, 204u8, 129u8, 238u8, 160u8, 137u8, 79u8, 207u8,
    252u8, 217u8, 156u8, 83u8, 229u8, 109u8, 14u8, 54u8, 104u8, 37u8, 154u8, 233u8,
    254u8, 32u8, 74u8, 59u8, 108u8, 36u8, 180u8,
]);
...
impl crate::columnar::RelationRow for AuthoredModelRevisionsRow {
    ...
    fn builder_allocation_size() -> usize {
        57_040_usize + size_of::<Self::Builder>()
    }
