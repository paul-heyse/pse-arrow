...
pub use pse_model::generated::r#authored::r#template_law_instances::{
    AuthoredTemplateLawInstancesFieldOptionsItem, AuthoredTemplateLawInstancesRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    36u8, 190u8, 55u8, 175u8, 105u8, 77u8, 146u8, 240u8, 210u8, 253u8, 234u8, 217u8,
    144u8, 113u8, 175u8, 23u8, 110u8, 28u8, 180u8, 127u8, 251u8, 33u8, 142u8, 0u8, 43u8,
    139u8, 83u8, 194u8, 212u8, 155u8, 213u8, 77u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateLawInstancesRow {
    ...
    fn append_columns(
        ...
        crate::columnar::ArrowValue::append(&self.r#scope, columns[3usize].as_mut())?;
        crate::columnar::ArrowValue::append(&self.r#options, columns[4usize].as_mut())?;
    ...
    fn rows_at(
        ...
        let view = AuthoredTemplateLawInstancesView::from_checked(batch)?;
...
pub mod columns {
    ...
    pub const LAW_INSTANCE_DECL_ID: crate::columnar::ColumnReference = super::COLUMNS[1usize];
    ///law_template_id
    pub const LAW_TEMPLATE_ID: crate::columnar::ColumnReference = super::COLUMNS[2usize];
    ///scope
    pub const SCOPE: crate::columnar::ColumnReference = super::COLUMNS[3usize];
    ///options
    pub const OPTIONS: crate::columnar::ColumnReference = super::COLUMNS[4usize];
    ///guard_id
...
pub type AuthoredTemplateLawInstancesBuilder = crate::columnar::RowBuilder<
    AuthoredTemplateLawInstancesRow,
>;
impl crate::columnar::RelationView for AuthoredTemplateLawInstancesView<'_> {
    type Row = AuthoredTemplateLawInstancesRow;
