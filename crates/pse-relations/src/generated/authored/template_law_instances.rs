...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    197u8, 133u8, 52u8, 110u8, 95u8, 150u8, 200u8, 121u8, 125u8, 121u8, 68u8, 84u8,
    170u8, 96u8, 187u8, 152u8, 78u8, 150u8, 58u8, 37u8, 41u8, 183u8, 182u8, 83u8, 77u8,
    88u8, 231u8, 138u8, 176u8, 252u8, 60u8, 224u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateLawInstancesRow {
    ...
    fn builder_allocation_size() -> usize {
        98_600_usize + size_of::<Self::Builder>()
    }
