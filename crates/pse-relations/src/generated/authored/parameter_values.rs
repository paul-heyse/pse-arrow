...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    118u8, 87u8, 65u8, 26u8, 92u8, 215u8, 3u8, 173u8, 131u8, 92u8, 241u8, 42u8, 41u8,
    78u8, 174u8, 140u8, 142u8, 42u8, 204u8, 7u8, 197u8, 87u8, 214u8, 204u8, 59u8, 47u8,
    33u8, 19u8, 221u8, 39u8, 217u8, 174u8,
]);
...
impl crate::columnar::RelationRow for AuthoredParameterValuesRow {
    ...
    fn builder_allocation_size() -> usize {
        75_600_usize + size_of::<Self::Builder>()
    }
