...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    0u8, 239u8, 65u8, 45u8, 48u8, 161u8, 166u8, 24u8, 182u8, 241u8, 61u8, 254u8, 238u8,
    238u8, 32u8, 179u8, 215u8, 169u8, 164u8, 50u8, 169u8, 247u8, 3u8, 75u8, 184u8, 55u8,
    153u8, 214u8, 214u8, 169u8, 247u8, 84u8,
]);
...
impl crate::columnar::RelationRow for AuthoredParameterValuesRow {
    ...
    fn builder_allocation_size() -> usize {
        73_840_usize + size_of::<Self::Builder>()
    }
