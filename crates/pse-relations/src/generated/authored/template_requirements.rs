...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    217u8, 42u8, 171u8, 182u8, 166u8, 106u8, 178u8, 198u8, 115u8, 112u8, 30u8, 141u8,
    170u8, 84u8, 255u8, 179u8, 243u8, 247u8, 0u8, 134u8, 5u8, 201u8, 190u8, 30u8, 182u8,
    52u8, 132u8, 143u8, 97u8, 55u8, 241u8, 87u8,
]);
...
impl crate::typed::CellCodec for AuthoredTemplateRequirementsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(AuthoredTemplateRequirementsRow)),
            );
        };
            ...
            r#template_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(AuthoredTemplateRequirementsRow),
                    ))?,
            )?,
...
impl AuthoredTemplateRequirementsRow {
...
impl crate::columnar::RelationRow for AuthoredTemplateRequirementsRow {
    ...
    fn builder_allocation_size() -> usize {
        42_224_usize + size_of::<Self::Builder>()
    }
