...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    138u8, 208u8, 88u8, 220u8, 2u8, 74u8, 245u8, 95u8, 135u8, 52u8, 2u8, 201u8, 23u8,
    203u8, 119u8, 66u8, 90u8, 248u8, 37u8, 132u8, 231u8, 129u8, 67u8, 174u8, 253u8,
    116u8, 209u8, 181u8, 250u8, 75u8, 113u8, 104u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateRequirementsRow {
    ...
    fn builder_allocation_size() -> usize {
        43_984_usize + size_of::<Self::Builder>()
    }
