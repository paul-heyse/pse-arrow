...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    133u8, 52u8, 38u8, 175u8, 2u8, 142u8, 76u8, 69u8, 213u8, 171u8, 246u8, 55u8, 111u8,
    115u8, 5u8, 36u8, 101u8, 250u8, 190u8, 38u8, 252u8, 77u8, 39u8, 10u8, 246u8, 238u8,
    44u8, 231u8, 227u8, 134u8, 80u8, 62u8,
]);
...
impl crate::columnar::RelationRow for AuthoredCaseSpecTargetsRow {
    ...
    fn builder_allocation_size() -> usize {
        112_256_usize + size_of::<Self::Builder>()
    }
