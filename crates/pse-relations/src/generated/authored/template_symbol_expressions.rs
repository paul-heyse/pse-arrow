...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    215u8, 165u8, 162u8, 79u8, 123u8, 52u8, 68u8, 26u8, 94u8, 164u8, 42u8, 235u8, 45u8,
    144u8, 162u8, 155u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    199u8, 75u8, 221u8, 56u8, 21u8, 166u8, 88u8, 179u8, 130u8, 80u8, 35u8, 107u8, 193u8,
    126u8, 103u8, 108u8, 136u8, 42u8, 242u8, 150u8, 168u8, 226u8, 243u8, 203u8, 138u8,
    56u8, 231u8, 141u8, 2u8, 246u8, 153u8, 141u8,
]);
...
impl crate::typed::CellCodec for AuthoredTemplateSymbolExpressionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(AuthoredTemplateSymbolExpressionsRow)),
            );
        };
            ...
            r#symbol_decl_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(AuthoredTemplateSymbolExpressionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for AuthoredTemplateSymbolExpressionsRow {
    fn append(
        &self,
...
pub type View<'a> = AuthoredTemplateSymbolExpressionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = AuthoredTemplateSymbolExpressionsBuilder;
impl AuthoredTemplateSymbolExpressionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "authored.template_symbol_expressions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for AuthoredTemplateSymbolExpressionsRow {
    type Builder = AuthoredTemplateSymbolExpressionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        AuthoredTemplateSymbolExpressionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredTemplateSymbolExpressionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        41_768_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredTemplateSymbolExpressionsView<'a> {
...
impl<'a> AuthoredTemplateSymbolExpressionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredTemplateSymbolExpressionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredTemplateSymbolExpressionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<AuthoredTemplateSymbolExpressionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct AuthoredTemplateSymbolExpressionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredTemplateSymbolExpressionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: AuthoredTemplateSymbolExpressionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredTemplateSymbolExpressionsView<'_>,
    ) -> Result<(), crate::RelationError> {
