...
pub use pse_model::generated::r#authored::r#template_symbol_expressions::{
    AuthoredTemplateSymbolExpressionsRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    98u8, 185u8, 168u8, 1u8, 48u8, 186u8, 170u8, 174u8, 246u8, 172u8, 35u8, 0u8, 56u8,
    50u8, 156u8, 209u8, 55u8, 234u8, 84u8, 143u8, 25u8, 155u8, 77u8, 212u8, 115u8, 242u8,
    87u8, 169u8, 142u8, 159u8, 140u8, 109u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateSymbolExpressionsRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredTemplateSymbolExpressionsView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///expression
    pub const EXPRESSION: crate::columnar::ColumnReference = super::COLUMNS[2usize];
}
...
pub type AuthoredTemplateSymbolExpressionsBuilder = crate::columnar::RowBuilder<
    AuthoredTemplateSymbolExpressionsRow,
>;
impl crate::columnar::RelationView for AuthoredTemplateSymbolExpressionsView<'_> {
    type Row = AuthoredTemplateSymbolExpressionsRow;
