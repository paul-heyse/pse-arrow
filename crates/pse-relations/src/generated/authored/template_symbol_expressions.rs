...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    118u8, 128u8, 38u8, 238u8, 20u8, 35u8, 189u8, 234u8, 187u8, 53u8, 250u8, 171u8, 62u8,
    61u8, 240u8, 57u8, 185u8, 112u8, 242u8, 174u8, 92u8, 169u8, 183u8, 189u8, 208u8,
    219u8, 166u8, 236u8, 19u8, 70u8, 195u8, 84u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateSymbolExpressionsRow {
    ...
    fn builder_allocation_size() -> usize {
        41_304_usize + size_of::<Self::Builder>()
    }
