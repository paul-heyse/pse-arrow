...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    211u8, 239u8, 213u8, 199u8, 27u8, 78u8, 222u8, 75u8, 54u8, 187u8, 32u8, 179u8, 20u8,
    65u8, 53u8, 83u8, 249u8, 102u8, 134u8, 147u8, 102u8, 234u8, 117u8, 251u8, 108u8,
    84u8, 47u8, 176u8, 92u8, 30u8, 95u8, 204u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateSymbolExpressionsRow {
    ...
    fn builder_allocation_size() -> usize {
        43_528_usize + size_of::<Self::Builder>()
    }
