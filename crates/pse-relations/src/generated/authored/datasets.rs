...
pub use pse_model::generated::r#authored::r#datasets::{AuthoredDatasetsRow, Row};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    47u8, 16u8, 162u8, 249u8, 185u8, 7u8, 138u8, 127u8, 33u8, 215u8, 237u8, 186u8, 108u8,
    40u8, 230u8, 91u8, 206u8, 81u8, 31u8, 236u8, 40u8, 17u8, 3u8, 219u8, 58u8, 150u8,
    171u8, 73u8, 91u8, 16u8, 90u8, 202u8,
]);
...
impl crate::columnar::RelationRow for AuthoredDatasetsRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredDatasetsView::from_checked(batch)?;
...
pub mod columns {
    ///dataset_id
    pub const DATASET_ID: crate::columnar::ColumnReference = super::COLUMNS[0usize];
    ///name
    ...
    ///content_hash
    pub const CONTENT_HASH: crate::columnar::ColumnReference = super::COLUMNS[3usize];
}
...
pub type AuthoredDatasetsBuilder = crate::columnar::RowBuilder<AuthoredDatasetsRow>;
impl crate::columnar::RelationView for AuthoredDatasetsView<'_> {
    type Row = AuthoredDatasetsRow;
