...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    133u8, 141u8, 105u8, 39u8, 138u8, 61u8, 225u8, 217u8, 134u8, 219u8, 125u8, 172u8,
    72u8, 141u8, 102u8, 81u8, 150u8, 78u8, 36u8, 170u8, 52u8, 70u8, 214u8, 137u8, 216u8,
    30u8, 92u8, 246u8, 202u8, 99u8, 17u8, 27u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateScopesRow {
    ...
    fn builder_allocation_size() -> usize {
        37_320_usize + size_of::<Self::Builder>()
    }
