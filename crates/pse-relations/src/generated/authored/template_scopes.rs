...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    25u8, 184u8, 248u8, 1u8, 59u8, 101u8, 216u8, 215u8, 8u8, 164u8, 33u8, 89u8, 198u8,
    214u8, 157u8, 228u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    114u8, 186u8, 227u8, 236u8, 83u8, 28u8, 232u8, 210u8, 238u8, 68u8, 16u8, 248u8,
    249u8, 82u8, 138u8, 101u8, 233u8, 178u8, 89u8, 148u8, 137u8, 127u8, 70u8, 11u8,
    108u8, 179u8, 179u8, 121u8, 121u8, 207u8, 103u8, 175u8,
]);
...
impl crate::typed::CellCodec for AuthoredTemplateScopesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(AuthoredTemplateScopesRow)));
        };
            ...
            r#template_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(AuthoredTemplateScopesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for AuthoredTemplateScopesRow {
    fn append(
        &self,
...
pub type View<'a> = AuthoredTemplateScopesView<'a>;
/// The concrete generated relation builder.
pub type Builder = AuthoredTemplateScopesBuilder;
impl AuthoredTemplateScopesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "authored.template_scopes".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for AuthoredTemplateScopesRow {
    type Builder = AuthoredTemplateScopesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        AuthoredTemplateScopesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredTemplateScopesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        39_080_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredTemplateScopesView<'a> {
...
impl<'a> AuthoredTemplateScopesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredTemplateScopesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredTemplateScopesRow {
    ...
    pub fn rows(&self) -> Result<Vec<AuthoredTemplateScopesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct AuthoredTemplateScopesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredTemplateScopesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredTemplateScopesView<'_>,
    ) -> Result<(), crate::RelationError> {
