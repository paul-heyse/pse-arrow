...
pub use pse_model::generated::r#authored::r#template_scopes::{
    AuthoredTemplateScopesRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    162u8, 119u8, 218u8, 124u8, 163u8, 162u8, 91u8, 156u8, 188u8, 89u8, 219u8, 233u8,
    186u8, 182u8, 28u8, 185u8, 37u8, 6u8, 71u8, 56u8, 123u8, 105u8, 61u8, 166u8, 175u8,
    239u8, 62u8, 154u8, 175u8, 107u8, 117u8, 26u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateScopesRow {
    ...
    fn append_columns(
        ...
        crate::columnar::ArrowValue::append(&self.r#scope_id, columns[2usize].as_mut())?;
        Ok(())
    }
    fn relation(
    ...
    fn rows_at(
        ...
        let view = AuthoredTemplateScopesView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///scope_id
    pub const SCOPE_ID: crate::columnar::ColumnReference = super::COLUMNS[2usize];
}
...
pub type AuthoredTemplateScopesBuilder = crate::columnar::RowBuilder<
    AuthoredTemplateScopesRow,
>;
impl crate::columnar::RelationView for AuthoredTemplateScopesView<'_> {
    type Row = AuthoredTemplateScopesRow;
