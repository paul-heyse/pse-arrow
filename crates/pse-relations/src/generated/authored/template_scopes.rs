...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    63u8, 19u8, 90u8, 227u8, 236u8, 12u8, 231u8, 149u8, 119u8, 224u8, 132u8, 223u8,
    249u8, 75u8, 253u8, 127u8, 226u8, 147u8, 99u8, 230u8, 167u8, 70u8, 247u8, 62u8, 98u8,
    199u8, 227u8, 104u8, 224u8, 53u8, 59u8, 243u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateScopesRow {
    ...
    fn builder_allocation_size() -> usize {
        36_856_usize + size_of::<Self::Builder>()
    }
