...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    26u8, 226u8, 215u8, 93u8, 229u8, 242u8, 210u8, 122u8, 155u8, 31u8, 173u8, 161u8,
    71u8, 185u8, 25u8, 219u8, 3u8, 155u8, 52u8, 157u8, 12u8, 185u8, 67u8, 133u8, 196u8,
    110u8, 105u8, 40u8, 25u8, 82u8, 10u8, 27u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        87_920_usize + size_of::<Self::Builder>()
    }
