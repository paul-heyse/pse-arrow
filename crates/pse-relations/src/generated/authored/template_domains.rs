...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    46u8, 202u8, 11u8, 46u8, 198u8, 69u8, 11u8, 47u8, 39u8, 34u8, 182u8, 242u8, 89u8,
    225u8, 246u8, 73u8, 86u8, 66u8, 131u8, 157u8, 28u8, 216u8, 86u8, 57u8, 75u8, 150u8,
    73u8, 60u8, 4u8, 41u8, 85u8, 33u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        89_680_usize + size_of::<Self::Builder>()
    }
