...
pub use pse_model::generated::r#authored::r#case_set_samples::{
    AuthoredCaseSetSamplesRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    14u8, 230u8, 84u8, 9u8, 200u8, 157u8, 66u8, 106u8, 58u8, 235u8, 246u8, 87u8, 214u8,
    57u8, 185u8, 201u8, 120u8, 106u8, 213u8, 145u8, 191u8, 10u8, 251u8, 112u8, 33u8,
    204u8, 21u8, 196u8, 211u8, 91u8, 139u8, 238u8,
]);
...
impl crate::columnar::RelationRow for AuthoredCaseSetSamplesRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredCaseSetSamplesView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///sample_ordinal
    pub const SAMPLE_ORDINAL: crate::columnar::ColumnReference = super::COLUMNS[1usize];
    ///case_id
...
pub type AuthoredCaseSetSamplesBuilder = crate::columnar::RowBuilder<
    AuthoredCaseSetSamplesRow,
>;
impl crate::columnar::RelationView for AuthoredCaseSetSamplesView<'_> {
    type Row = AuthoredCaseSetSamplesRow;
