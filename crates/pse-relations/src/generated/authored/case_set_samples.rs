...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    201u8, 74u8, 245u8, 243u8, 184u8, 251u8, 88u8, 203u8, 142u8, 24u8, 95u8, 134u8, 50u8,
    14u8, 61u8, 169u8, 226u8, 188u8, 153u8, 132u8, 34u8, 89u8, 125u8, 241u8, 246u8,
    210u8, 238u8, 129u8, 247u8, 49u8, 191u8, 104u8,
]);
    ...
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                ::typed::CellCodec::into_cell(self.r#sample_ordinal), crate
                ::typed::CellCodec::into_cell(self.r#case_id)
            ],
        )
    }
...
impl<'a> AuthoredCaseSetSamplesView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<AuthoredCaseSetSamplesRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(AuthoredCaseSetSamplesRow::from_cells)
            .collect()
    }
}
...
pub struct AuthoredCaseSetSamplesBuilder {
    rows: Vec<AuthoredCaseSetSamplesRow>,
}
impl AuthoredCaseSetSamplesBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(AuthoredCaseSetSamplesRow::into_cells)
            .collect::<Vec<_>>();
