...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    255u8, 237u8, 177u8, 116u8, 2u8, 113u8, 228u8, 6u8, 222u8, 205u8, 230u8, 90u8, 143u8,
    170u8, 8u8, 225u8, 176u8, 213u8, 123u8, 81u8, 199u8, 91u8, 241u8, 119u8, 77u8, 148u8,
    105u8, 177u8, 228u8, 133u8, 187u8, 44u8,
]);
...
impl crate::typed::CellCodec for AuthoredCasesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(AuthoredCasesRow)));
        };
        ...
        Ok(Self {
            r#case_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(stringify!(AuthoredCasesRow)))?,
            )?,
            ...
            r#kind: <crate::generated::enums::CaseKind as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(stringify!(AuthoredCasesRow)))?,
            )?,
...
impl crate::columnar::RelationRow for AuthoredCasesRow {
    ...
    fn builder_allocation_size() -> usize {
        65_992_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredCasesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredCasesBuilder {
    ...
    pub fn push(&mut self, row: AuthoredCasesRow) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
                crate::columnar::ArrowValue::append(
