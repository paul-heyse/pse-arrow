...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    113u8, 87u8, 208u8, 179u8, 13u8, 96u8, 0u8, 14u8, 89u8, 53u8, 59u8, 176u8, 155u8,
    22u8, 151u8, 187u8, 108u8, 188u8, 227u8, 174u8, 116u8, 162u8, 112u8, 115u8, 103u8,
    28u8, 36u8, 228u8, 90u8, 89u8, 80u8, 75u8,
]);
...
impl crate::columnar::RelationRow for AuthoredObservationTargetsRow {
    ...
    fn builder_allocation_size() -> usize {
        112_512_usize + size_of::<Self::Builder>()
    }
