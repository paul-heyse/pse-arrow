...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    99u8, 81u8, 178u8, 220u8, 112u8, 43u8, 12u8, 11u8, 24u8, 28u8, 102u8, 30u8, 114u8,
    249u8, 92u8, 59u8, 41u8, 155u8, 88u8, 164u8, 39u8, 116u8, 53u8, 133u8, 67u8, 46u8,
    120u8, 79u8, 237u8, 233u8, 23u8, 75u8,
]);
...
impl crate::columnar::RelationRow for AuthoredCaseActivationsRow {
    ...
    fn builder_allocation_size() -> usize {
        74_680_usize + size_of::<Self::Builder>()
    }
