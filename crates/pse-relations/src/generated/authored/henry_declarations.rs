...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    207u8, 48u8, 248u8, 0u8, 141u8, 228u8, 116u8, 125u8, 90u8, 240u8, 171u8, 255u8, 47u8,
    229u8, 157u8, 37u8, 50u8, 105u8, 227u8, 25u8, 112u8, 156u8, 181u8, 245u8, 115u8,
    174u8, 210u8, 153u8, 106u8, 82u8, 78u8, 105u8,
]);
...
impl crate::columnar::RelationRow for AuthoredHenryDeclarationsRow {
    ...
    fn builder_allocation_size() -> usize {
        58_632_usize + size_of::<Self::Builder>()
    }
...
impl AuthoredHenryDeclarationsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredHenryDeclarationsView<'_>,
    ) -> Result<(), crate::RelationError> {
