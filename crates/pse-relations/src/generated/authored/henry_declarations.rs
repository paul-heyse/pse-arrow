...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    165u8, 146u8, 108u8, 71u8, 199u8, 248u8, 132u8, 217u8, 203u8, 126u8, 171u8, 231u8,
    151u8, 140u8, 237u8, 242u8, 57u8, 223u8, 111u8, 5u8, 41u8, 11u8, 50u8, 162u8, 219u8,
    66u8, 165u8, 96u8, 123u8, 188u8, 96u8, 78u8,
]);
...
impl crate::columnar::RelationRow for AuthoredHenryDeclarationsRow {
    ...
    fn builder_allocation_size() -> usize {
        56_408_usize + size_of::<Self::Builder>()
    }
