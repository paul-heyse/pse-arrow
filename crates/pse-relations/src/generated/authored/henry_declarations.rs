...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    31u8, 69u8, 219u8, 77u8, 48u8, 199u8, 116u8, 108u8, 253u8, 112u8, 63u8, 152u8, 12u8,
    186u8, 59u8, 91u8, 207u8, 92u8, 15u8, 99u8, 97u8, 161u8, 24u8, 125u8, 99u8, 148u8,
    186u8, 220u8, 5u8, 106u8, 164u8, 161u8,
]);
...
impl crate::columnar::RelationRow for AuthoredHenryDeclarationsRow {
    ...
    fn builder_allocation_size() -> usize {
        56_872_usize + size_of::<Self::Builder>()
    }
