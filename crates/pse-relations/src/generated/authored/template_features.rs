...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    55u8, 91u8, 116u8, 38u8, 238u8, 100u8, 115u8, 10u8, 169u8, 115u8, 193u8, 216u8,
    189u8, 244u8, 176u8, 49u8, 129u8, 39u8, 85u8, 246u8, 12u8, 29u8, 246u8, 60u8, 207u8,
    30u8, 28u8, 10u8, 56u8, 196u8, 219u8, 46u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateFeaturesRow {
    ...
    fn builder_allocation_size() -> usize {
        67_336_usize + size_of::<Self::Builder>()
    }
