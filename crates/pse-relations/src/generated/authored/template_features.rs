...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    96u8, 114u8, 3u8, 179u8, 156u8, 179u8, 37u8, 201u8, 223u8, 183u8, 85u8, 14u8, 124u8,
    182u8, 205u8, 212u8, 17u8, 250u8, 253u8, 212u8, 25u8, 76u8, 254u8, 65u8, 215u8,
    236u8, 52u8, 143u8, 214u8, 106u8, 70u8, 52u8,
]);
...
impl AuthoredTemplateFeaturesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredTemplateFeaturesView<'_>,
    ) -> Result<(), crate::RelationError> {
