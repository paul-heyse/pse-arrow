...
pub use pse_model::generated::r#authored::r#template_symbol_properties::{
    AuthoredTemplateSymbolPropertiesRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    249u8, 117u8, 195u8, 246u8, 188u8, 115u8, 66u8, 170u8, 29u8, 53u8, 191u8, 156u8,
    89u8, 118u8, 213u8, 153u8, 169u8, 5u8, 65u8, 24u8, 110u8, 204u8, 160u8, 237u8, 79u8,
    121u8, 184u8, 16u8, 182u8, 238u8, 110u8, 222u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateSymbolPropertiesRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredTemplateSymbolPropertiesView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///scope_selector_id
    pub const SCOPE_SELECTOR_ID: crate::columnar::ColumnReference = super::COLUMNS[2usize];
}
...
pub type AuthoredTemplateSymbolPropertiesBuilder = crate::columnar::RowBuilder<
    AuthoredTemplateSymbolPropertiesRow,
>;
impl crate::columnar::RelationView for AuthoredTemplateSymbolPropertiesView<'_> {
    type Row = AuthoredTemplateSymbolPropertiesRow;
