...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    85u8, 211u8, 222u8, 237u8, 172u8, 250u8, 132u8, 65u8, 72u8, 161u8, 40u8, 250u8,
    247u8, 24u8, 148u8, 68u8, 222u8, 184u8, 252u8, 158u8, 70u8, 25u8, 56u8, 198u8, 128u8,
    44u8, 128u8, 189u8, 114u8, 22u8, 140u8, 27u8,
]);
