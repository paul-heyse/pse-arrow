...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    50u8, 191u8, 135u8, 253u8, 101u8, 145u8, 166u8, 203u8, 8u8, 93u8, 99u8, 233u8, 223u8,
    26u8, 146u8, 86u8, 31u8, 145u8, 234u8, 38u8, 252u8, 191u8, 88u8, 52u8, 211u8, 113u8,
    221u8, 72u8, 209u8, 147u8, 231u8, 83u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateSymbolPropertiesRow {
    ...
    fn builder_allocation_size() -> usize {
        47_872_usize + size_of::<Self::Builder>()
    }
