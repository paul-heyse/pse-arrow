...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    99u8, 2u8, 120u8, 45u8, 175u8, 124u8, 106u8, 226u8, 34u8, 154u8, 19u8, 211u8, 71u8,
    133u8, 199u8, 48u8, 124u8, 136u8, 158u8, 83u8, 221u8, 165u8, 244u8, 156u8, 159u8,
    202u8, 24u8, 191u8, 162u8, 68u8, 57u8, 219u8,
]);
...
impl crate::columnar::RelationRow for AuthoredContinuousDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        66_640_usize + size_of::<Self::Builder>()
    }
