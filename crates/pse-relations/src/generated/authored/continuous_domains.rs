...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    206u8, 102u8, 223u8, 222u8, 151u8, 14u8, 78u8, 217u8, 230u8, 135u8, 7u8, 130u8, 2u8,
    99u8, 245u8, 115u8, 106u8, 22u8, 147u8, 91u8, 123u8, 191u8, 47u8, 185u8, 110u8,
    214u8, 91u8, 96u8, 220u8, 72u8, 208u8, 205u8,
]);
