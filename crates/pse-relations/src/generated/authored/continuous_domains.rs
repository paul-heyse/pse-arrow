...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    218u8, 166u8, 80u8, 10u8, 62u8, 234u8, 99u8, 46u8, 43u8, 237u8, 84u8, 186u8, 110u8,
    139u8, 4u8, 10u8, 166u8, 20u8, 149u8, 193u8, 144u8, 118u8, 16u8, 47u8, 37u8, 120u8,
    139u8, 154u8, 82u8, 174u8, 57u8, 64u8,
]);
...
impl crate::columnar::RelationRow for AuthoredContinuousDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        73_256_usize + size_of::<Self::Builder>()
    }
...
impl AuthoredContinuousDomainsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredContinuousDomainsView<'_>,
    ) -> Result<(), crate::RelationError> {
