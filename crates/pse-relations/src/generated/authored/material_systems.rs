...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    29u8, 133u8, 175u8, 103u8, 248u8, 64u8, 14u8, 244u8, 177u8, 172u8, 252u8, 44u8,
    150u8, 2u8, 197u8, 39u8, 122u8, 98u8, 178u8, 60u8, 56u8, 227u8, 55u8, 9u8, 172u8,
    96u8, 236u8, 168u8, 154u8, 65u8, 103u8, 52u8,
]);
...
impl crate::columnar::RelationRow for AuthoredMaterialSystemsRow {
    ...
    fn builder_allocation_size() -> usize {
        89_904_usize + size_of::<Self::Builder>()
    }
