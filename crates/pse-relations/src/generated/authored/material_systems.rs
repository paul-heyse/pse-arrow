...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    40u8, 24u8, 102u8, 214u8, 39u8, 108u8, 105u8, 104u8, 9u8, 85u8, 59u8, 39u8, 163u8,
    26u8, 193u8, 55u8, 22u8, 255u8, 165u8, 91u8, 155u8, 111u8, 53u8, 77u8, 163u8, 234u8,
    15u8, 232u8, 103u8, 137u8, 102u8, 165u8,
]);
...
impl crate::typed::CellCodec for AuthoredMaterialSystemsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(AuthoredMaterialSystemsRow)));
        };
            ...
            r#material_system_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(AuthoredMaterialSystemsRow),
                    ))?,
            )?,
...
impl AuthoredMaterialSystemsRow {
...
impl crate::columnar::RelationRow for AuthoredMaterialSystemsRow {
    ...
    fn builder_allocation_size() -> usize {
        88_144_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct AuthoredMaterialSystemsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl AuthoredMaterialSystemsBuilder {
    ...
    pub fn push(
        &mut self,
        row: AuthoredMaterialSystemsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredMaterialSystemsView<'_>,
    ) -> Result<(), crate::RelationError> {
