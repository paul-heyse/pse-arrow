...
pub use pse_model::generated::r#authored::r#model_compositions::{
    AuthoredModelCompositionsRow, Row,
};
/// The declared relation identity.
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    154u8, 5u8, 143u8, 200u8, 110u8, 98u8, 78u8, 159u8, 57u8, 164u8, 252u8, 205u8, 171u8,
    181u8, 216u8, 149u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "model_compositions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    222u8, 182u8, 56u8, 186u8, 223u8, 177u8, 108u8, 185u8, 188u8, 59u8, 166u8, 27u8,
    224u8, 160u8, 27u8, 14u8, 145u8, 152u8, 92u8, 13u8, 108u8, 237u8, 226u8, 53u8, 229u8,
    46u8, 185u8, 171u8, 14u8, 88u8, 117u8, 232u8,
]);
impl crate::columnar::ArrowValue for AuthoredModelCompositionsRow {
    fn append(
        &self,
...
pub type View<'a> = AuthoredModelCompositionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = AuthoredModelCompositionsBuilder;
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "authored.model_compositions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for AuthoredModelCompositionsRow {
    type Builder = AuthoredModelCompositionsBuilder;
    fn append_columns(
        &self,
    ...
    fn builder(
        ...
        AuthoredModelCompositionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        AuthoredModelCompositionsView::from_checked(batch)?.rows()
    }
    fn rows_at(
        batch: &crate::columnar::FieldCheckedBatch,
        positions: &[usize],
    ) -> Result<Vec<Self>, crate::RelationError> {
        let view = AuthoredModelCompositionsView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///root_instance_id
    pub const ROOT_INSTANCE_ID: crate::columnar::ColumnReference = super::COLUMNS[1usize];
}
/// Borrowed Arrow columns with checked layout and local values.
/// Keys, references and domain completeness require relational admission.
#[derive(Debug)]
pub struct AuthoredModelCompositionsView<'a> {
...
impl<'a> AuthoredModelCompositionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<AuthoredModelCompositionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(AuthoredModelCompositionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<AuthoredModelCompositionsRow>, crate::RelationError> {
        (0..self.len()).map(|index| self.row(index)).collect()
    }
}
/// Shared native column builder for this declaration.
pub type AuthoredModelCompositionsBuilder = crate::columnar::RowBuilder<
    AuthoredModelCompositionsRow,
>;
impl crate::columnar::RelationView for AuthoredModelCompositionsView<'_> {
    type Row = AuthoredModelCompositionsRow;
