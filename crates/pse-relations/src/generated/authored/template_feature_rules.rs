...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    177u8, 156u8, 143u8, 99u8, 211u8, 254u8, 173u8, 5u8, 109u8, 202u8, 51u8, 89u8, 170u8,
    14u8, 12u8, 42u8, 68u8, 139u8, 245u8, 13u8, 87u8, 154u8, 123u8, 251u8, 76u8, 31u8,
    44u8, 21u8, 16u8, 156u8, 252u8, 48u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateFeatureRulesRow {
    ...
    fn builder_allocation_size() -> usize {
        45_928_usize + size_of::<Self::Builder>()
    }
