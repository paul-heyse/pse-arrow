...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    179u8, 119u8, 48u8, 94u8, 236u8, 215u8, 175u8, 28u8, 98u8, 185u8, 79u8, 183u8, 230u8,
    44u8, 242u8, 51u8, 160u8, 60u8, 16u8, 132u8, 202u8, 190u8, 190u8, 101u8, 109u8,
    118u8, 126u8, 114u8, 248u8, 241u8, 63u8, 0u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateFeatureRulesRow {
    ...
    fn builder_allocation_size() -> usize {
        44_168_usize + size_of::<Self::Builder>()
    }
...
impl AuthoredTemplateFeatureRulesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &AuthoredTemplateFeatureRulesView<'_>,
    ) -> Result<(), crate::RelationError> {
