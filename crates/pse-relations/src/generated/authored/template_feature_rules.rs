...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    90u8, 215u8, 109u8, 219u8, 244u8, 63u8, 89u8, 25u8, 28u8, 97u8, 50u8, 98u8, 118u8,
    53u8, 160u8, 25u8, 23u8, 194u8, 15u8, 160u8, 220u8, 146u8, 4u8, 39u8, 57u8, 0u8,
    210u8, 126u8, 124u8, 64u8, 24u8, 215u8,
]);
...
impl crate::columnar::RelationRow for AuthoredTemplateFeatureRulesRow {
    ...
    fn builder_allocation_size() -> usize {
        43_704_usize + size_of::<Self::Builder>()
    }
