...
pub use pse_model::generated::r#authored::r#instance_equations::{
    AuthoredInstanceEquationsRow, Row,
};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    199u8, 247u8, 236u8, 193u8, 95u8, 113u8, 83u8, 132u8, 206u8, 128u8, 246u8, 183u8,
    15u8, 60u8, 125u8, 6u8, 47u8, 224u8, 179u8, 109u8, 159u8, 113u8, 193u8, 196u8, 145u8,
    178u8, 57u8, 76u8, 116u8, 2u8, 241u8, 32u8,
]);
...
impl crate::columnar::RelationRow for AuthoredInstanceEquationsRow {
    ...
    fn rows_at(
        ...
        let view = AuthoredInstanceEquationsView::from_checked(batch)?;
...
pub type AuthoredInstanceEquationsBuilder = crate::columnar::RowBuilder<
    AuthoredInstanceEquationsRow,
>;
impl crate::columnar::RelationView for AuthoredInstanceEquationsView<'_> {
    type Row = AuthoredInstanceEquationsRow;
