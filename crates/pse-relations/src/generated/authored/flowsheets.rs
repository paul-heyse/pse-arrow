...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    252u8, 119u8, 243u8, 10u8, 30u8, 87u8, 236u8, 2u8, 229u8, 133u8, 5u8, 204u8, 81u8,
    228u8, 69u8, 7u8, 24u8, 58u8, 66u8, 184u8, 143u8, 2u8, 69u8, 98u8, 81u8, 17u8, 11u8,
    139u8, 64u8, 12u8, 235u8, 210u8,
]);
...
impl crate::columnar::RelationRow for AuthoredFlowsheetsRow {
    ...
    fn builder_allocation_size() -> usize {
        55_464_usize + size_of::<Self::Builder>()
    }
