...
pub use pse_model::generated::r#authored::r#flowsheets::{AuthoredFlowsheetsRow, Row};
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    103u8, 48u8, 139u8, 11u8, 210u8, 43u8, 122u8, 191u8, 147u8, 55u8, 170u8, 183u8,
    198u8, 252u8, 36u8, 176u8, 50u8, 159u8, 60u8, 129u8, 49u8, 179u8, 111u8, 26u8, 254u8,
    32u8, 219u8, 39u8, 2u8, 225u8, 198u8, 157u8,
]);
...
impl crate::columnar::RelationRow for AuthoredFlowsheetsRow {
    ...
    fn append_columns(
        ...
        crate::columnar::ArrowValue::append(&self.r#dynamic, columns[2usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#default_property_package_id,
    ...
    fn rows_at(
        ...
        let view = AuthoredFlowsheetsView::from_checked(batch)?;
...
pub mod columns {
    ...
    ///time_domain_id
    pub const TIME_DOMAIN_ID: crate::columnar::ColumnReference = super::COLUMNS[1usize];
    ///dynamic
    pub const DYNAMIC: crate::columnar::ColumnReference = super::COLUMNS[2usize];
    ///default_property_package_id
    pub const DEFAULT_PROPERTY_PACKAGE_ID: crate::columnar::ColumnReference = super::COLUMNS[3usize];
}
...
pub type AuthoredFlowsheetsBuilder = crate::columnar::RowBuilder<AuthoredFlowsheetsRow>;
impl crate::columnar::RelationView for AuthoredFlowsheetsView<'_> {
    type Row = AuthoredFlowsheetsRow;
