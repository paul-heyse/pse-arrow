...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    123u8, 243u8, 239u8, 225u8, 167u8, 161u8, 168u8, 34u8, 34u8, 71u8, 115u8, 148u8,
    37u8, 133u8, 171u8, 188u8, 84u8, 240u8, 140u8, 243u8, 72u8, 245u8, 174u8, 42u8, 41u8,
    236u8, 9u8, 243u8, 119u8, 47u8, 33u8, 174u8,
]);
...
impl crate::columnar::RelationRow for AuthoredStoichiometryRow {
    ...
    fn builder_allocation_size() -> usize {
        50_312_usize + size_of::<Self::Builder>()
    }
