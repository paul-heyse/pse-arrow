...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    163u8, 155u8, 104u8, 144u8, 103u8, 81u8, 229u8, 32u8, 224u8, 100u8, 108u8, 76u8, 1u8,
    124u8, 38u8, 185u8, 210u8, 15u8, 72u8, 37u8, 194u8, 154u8, 191u8, 12u8, 17u8, 137u8,
    210u8, 84u8, 5u8, 123u8, 137u8, 127u8,
]);
...
impl crate::columnar::RelationRow for AuthoredChangeSetsRow {
    ...
    fn builder_allocation_size() -> usize {
        45_392_usize + size_of::<Self::Builder>()
    }
