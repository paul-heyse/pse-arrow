...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    230u8, 161u8, 231u8, 121u8, 169u8, 153u8, 134u8, 210u8, 77u8, 143u8, 39u8, 28u8,
    20u8, 104u8, 164u8, 102u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "expression_roots";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    195u8, 27u8, 229u8, 213u8, 139u8, 254u8, 255u8, 208u8, 124u8, 193u8, 73u8, 25u8,
    15u8, 31u8, 198u8, 15u8, 60u8, 208u8, 81u8, 27u8, 50u8, 153u8, 38u8, 124u8, 47u8,
    174u8, 221u8, 225u8, 169u8, 78u8, 155u8, 2u8,
]);
...
pub struct CompiledExpressionRootsRow {
    ///owner_id
...
impl crate::typed::CellCodec for CompiledExpressionRootsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledExpressionRootsRow)));
        };
...
impl crate::columnar::ArrowValue for CompiledExpressionRootsRow {
    fn append(
        &self,
...
pub type Row = CompiledExpressionRootsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledExpressionRootsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledExpressionRootsBuilder;
impl CompiledExpressionRootsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.expression_roots".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledExpressionRootsRow {
    type Builder = CompiledExpressionRootsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledExpressionRootsBuilder::with_registry(registry, capacity)
    }
    ...
    fn builder_allocation_size() -> usize {
        53_472_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledExpressionRootsView<'a> {
...
impl<'a> CompiledExpressionRootsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledExpressionRootsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledExpressionRootsRow {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledExpressionRootsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledExpressionRootsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledExpressionRootsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledExpressionRootsView<'_>,
    ) -> Result<(), crate::RelationError> {
