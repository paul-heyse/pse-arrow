...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    11u8, 148u8, 234u8, 250u8, 230u8, 221u8, 91u8, 196u8, 80u8, 2u8, 3u8, 187u8, 159u8,
    8u8, 198u8, 237u8, 76u8, 30u8, 179u8, 0u8, 16u8, 54u8, 254u8, 146u8, 205u8, 99u8,
    225u8, 244u8, 222u8, 204u8, 96u8, 63u8,
]);
...
impl crate::columnar::RelationRow for CompiledSymbolReferencesRow {
    ...
    fn builder_allocation_size() -> usize {
        39_264_usize + size_of::<Self::Builder>()
    }
