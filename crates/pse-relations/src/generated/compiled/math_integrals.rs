...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    27u8, 45u8, 114u8, 82u8, 73u8, 93u8, 219u8, 18u8, 167u8, 230u8, 189u8, 30u8, 200u8,
    79u8, 28u8, 86u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "math_integrals";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    192u8, 3u8, 50u8, 90u8, 75u8, 189u8, 154u8, 138u8, 149u8, 14u8, 144u8, 71u8, 237u8,
    124u8, 15u8, 211u8, 0u8, 178u8, 52u8, 52u8, 150u8, 232u8, 65u8, 84u8, 11u8, 225u8,
    41u8, 150u8, 17u8, 118u8, 205u8, 39u8,
]);
...
pub struct CompiledMathIntegralsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for CompiledMathIntegralsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledMathIntegralsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledMathIntegralsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledMathIntegralsRow {
    fn append(
        &self,
...
pub type Row = CompiledMathIntegralsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledMathIntegralsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledMathIntegralsBuilder;
impl CompiledMathIntegralsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.math_integrals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledMathIntegralsRow {
    type Builder = CompiledMathIntegralsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathIntegralsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathIntegralsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        48_912_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledMathIntegralsView<'a> {
...
impl<'a> CompiledMathIntegralsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathIntegralsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathIntegralsRow {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledMathIntegralsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledMathIntegralsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledMathIntegralsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathIntegralsView<'_>,
    ) -> Result<(), crate::RelationError> {
