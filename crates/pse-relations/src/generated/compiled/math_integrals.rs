...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    3u8, 237u8, 184u8, 27u8, 13u8, 182u8, 199u8, 236u8, 213u8, 73u8, 97u8, 227u8, 67u8,
    114u8, 140u8, 147u8, 61u8, 72u8, 36u8, 2u8, 91u8, 45u8, 18u8, 185u8, 227u8, 58u8,
    149u8, 58u8, 27u8, 217u8, 32u8, 64u8,
]);
