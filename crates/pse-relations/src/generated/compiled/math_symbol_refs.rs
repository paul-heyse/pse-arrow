...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    52u8, 32u8, 120u8, 118u8, 38u8, 223u8, 66u8, 254u8, 64u8, 148u8, 218u8, 59u8, 21u8,
    120u8, 10u8, 81u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "math_symbol_refs";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    10u8, 246u8, 8u8, 25u8, 240u8, 210u8, 133u8, 117u8, 112u8, 102u8, 161u8, 241u8,
    138u8, 80u8, 55u8, 125u8, 240u8, 15u8, 172u8, 196u8, 204u8, 133u8, 41u8, 169u8, 5u8,
    178u8, 200u8, 137u8, 237u8, 38u8, 27u8, 152u8,
]);
...
pub struct CompiledMathSymbolRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///symbol_id
    pub r#symbol_id: pse_ids::SemanticId,
}
impl crate::typed::CellCodec for CompiledMathSymbolRefsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledMathSymbolRefsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledMathSymbolRefsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledMathSymbolRefsRow {
    fn append(
        &self,
...
pub type Row = CompiledMathSymbolRefsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledMathSymbolRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledMathSymbolRefsBuilder;
impl CompiledMathSymbolRefsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.math_symbol_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledMathSymbolRefsRow {
    type Builder = CompiledMathSymbolRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathSymbolRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathSymbolRefsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        20_720_usize + size_of::<Self::Builder>()
    }
...
impl<'a> CompiledMathSymbolRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathSymbolRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathSymbolRefsRow {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledMathSymbolRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledMathSymbolRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledMathSymbolRefsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathSymbolRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
