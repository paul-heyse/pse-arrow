...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    52u8, 101u8, 207u8, 66u8, 118u8, 50u8, 33u8, 138u8, 102u8, 99u8, 8u8, 58u8, 47u8,
    239u8, 143u8, 62u8, 108u8, 132u8, 29u8, 45u8, 221u8, 150u8, 124u8, 224u8, 31u8,
    114u8, 23u8, 214u8, 8u8, 173u8, 3u8, 130u8,
]);
...
impl crate::columnar::RelationRow for CompiledMathSymbolRefsRow {
    ...
    fn builder_allocation_size() -> usize {
        21_184_usize + size_of::<Self::Builder>()
    }
