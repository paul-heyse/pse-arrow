...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    68u8, 196u8, 61u8, 159u8, 112u8, 89u8, 170u8, 39u8, 181u8, 85u8, 143u8, 189u8, 118u8,
    92u8, 36u8, 19u8, 14u8, 134u8, 5u8, 23u8, 211u8, 68u8, 28u8, 120u8, 210u8, 168u8,
    157u8, 20u8, 43u8, 57u8, 62u8, 176u8,
]);
...
impl<'a> CompiledMathSymbolRefsView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledMathSymbolRefsRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(CompiledMathSymbolRefsRow::from_cells)
            .collect()
    }
}
...
pub struct CompiledMathSymbolRefsBuilder {
    rows: Vec<CompiledMathSymbolRefsRow>,
}
impl CompiledMathSymbolRefsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(CompiledMathSymbolRefsRow::into_cells)
            .collect::<Vec<_>>();
