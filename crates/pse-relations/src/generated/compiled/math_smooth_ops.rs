...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    47u8, 20u8, 17u8, 146u8, 174u8, 209u8, 222u8, 176u8, 76u8, 7u8, 108u8, 158u8, 173u8,
    54u8, 7u8, 68u8, 90u8, 195u8, 188u8, 44u8, 234u8, 56u8, 217u8, 203u8, 222u8, 124u8,
    61u8, 150u8, 184u8, 167u8, 11u8, 217u8,
]);
...
impl crate::columnar::ArrowValue for CompiledMathSmoothOpsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for CompiledMathSmoothOpsRow {
    type Builder = CompiledMathSmoothOpsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathSmoothOpsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathSmoothOpsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        15_704_usize + size_of::<Self::Builder>()
    }
...
impl<'a> CompiledMathSmoothOpsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathSmoothOpsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathSmoothOpsRow {
...
impl CompiledMathSmoothOpsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathSmoothOpsView<'_>,
    ) -> Result<(), crate::RelationError> {
