...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    147u8, 34u8, 244u8, 66u8, 241u8, 0u8, 187u8, 70u8, 15u8, 195u8, 136u8, 52u8, 226u8,
    194u8, 212u8, 165u8, 43u8, 119u8, 90u8, 0u8, 249u8, 114u8, 23u8, 19u8, 10u8, 141u8,
    23u8, 205u8, 165u8, 228u8, 172u8, 102u8,
]);
...
impl crate::columnar::RelationRow for CompiledBlockMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        40_880_usize + size_of::<Self::Builder>()
    }
