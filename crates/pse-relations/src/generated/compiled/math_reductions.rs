...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    146u8, 65u8, 26u8, 37u8, 73u8, 104u8, 220u8, 143u8, 11u8, 77u8, 203u8, 209u8, 44u8,
    40u8, 244u8, 223u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    86u8, 12u8, 229u8, 140u8, 249u8, 234u8, 27u8, 53u8, 106u8, 136u8, 154u8, 147u8, 98u8,
    232u8, 71u8, 224u8, 217u8, 218u8, 89u8, 52u8, 252u8, 244u8, 74u8, 1u8, 27u8, 197u8,
    176u8, 74u8, 148u8, 120u8, 79u8, 38u8,
]);
...
pub struct CompiledMathReductionsRow {
    ///node_id
    pub r#node_id: u64,
    ///kind
...
impl crate::typed::CellCodec for CompiledMathReductionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledMathReductionsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledMathReductionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledMathReductionsRow {
    fn append(
        &self,
...
pub type Row = CompiledMathReductionsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledMathReductionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledMathReductionsBuilder;
impl CompiledMathReductionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.math_reductions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledMathReductionsRow {
    type Builder = CompiledMathReductionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathReductionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathReductionsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct CompiledMathReductionsView<'a> {
...
impl<'a> CompiledMathReductionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathReductionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathReductionsRow {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledMathReductionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledMathReductionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledMathReductionsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathReductionsView<'_>,
    ) -> Result<(), crate::RelationError> {
