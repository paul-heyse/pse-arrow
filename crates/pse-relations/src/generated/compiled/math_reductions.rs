...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    13u8, 41u8, 235u8, 161u8, 229u8, 77u8, 198u8, 77u8, 115u8, 56u8, 66u8, 122u8, 67u8,
    54u8, 53u8, 192u8, 213u8, 78u8, 163u8, 87u8, 216u8, 159u8, 51u8, 60u8, 0u8, 139u8,
    166u8, 17u8, 84u8, 171u8, 202u8, 116u8,
]);
...
impl crate::columnar::RelationRow for CompiledMathReductionsRow {
    ...
    fn builder_allocation_size() -> usize {
        52_216_usize + size_of::<Self::Builder>()
    }
