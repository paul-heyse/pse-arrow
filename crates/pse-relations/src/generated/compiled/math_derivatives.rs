...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    37u8, 117u8, 126u8, 73u8, 15u8, 161u8, 8u8, 52u8, 144u8, 17u8, 189u8, 36u8, 88u8,
    40u8, 154u8, 20u8, 239u8, 44u8, 200u8, 41u8, 203u8, 200u8, 58u8, 78u8, 129u8, 118u8,
    118u8, 181u8, 27u8, 131u8, 169u8, 237u8,
]);
...
impl crate::columnar::RelationRow for CompiledMathDerivativesRow {
    ...
    fn builder_allocation_size() -> usize {
        26_544_usize + size_of::<Self::Builder>()
    }
