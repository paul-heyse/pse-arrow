...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    208u8, 89u8, 236u8, 252u8, 223u8, 202u8, 26u8, 187u8, 50u8, 204u8, 124u8, 122u8,
    102u8, 201u8, 195u8, 13u8, 225u8, 122u8, 154u8, 211u8, 16u8, 57u8, 159u8, 48u8,
    146u8, 241u8, 109u8, 34u8, 180u8, 176u8, 66u8, 46u8,
]);
...
impl crate::columnar::ArrowValue for CompiledMathDerivativesRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for CompiledMathDerivativesRow {
    type Builder = CompiledMathDerivativesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathDerivativesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathDerivativesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        27_008_usize + size_of::<Self::Builder>()
    }
...
impl<'a> CompiledMathDerivativesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathDerivativesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathDerivativesRow {
...
impl CompiledMathDerivativesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathDerivativesView<'_>,
    ) -> Result<(), crate::RelationError> {
