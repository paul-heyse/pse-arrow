...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    11u8, 136u8, 54u8, 131u8, 174u8, 52u8, 113u8, 254u8, 43u8, 32u8, 36u8, 128u8, 45u8,
    94u8, 128u8, 121u8, 99u8, 172u8, 169u8, 66u8, 209u8, 188u8, 86u8, 13u8, 4u8, 252u8,
    151u8, 217u8, 209u8, 56u8, 105u8, 220u8,
]);
...
impl crate::columnar::RelationRow for CompiledInitializationPlansRow {
    ...
    fn builder_allocation_size() -> usize {
        42_176_usize + size_of::<Self::Builder>()
    }
