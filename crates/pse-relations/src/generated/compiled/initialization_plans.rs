...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    214u8, 73u8, 21u8, 245u8, 64u8, 243u8, 253u8, 38u8, 106u8, 28u8, 177u8, 231u8, 164u8,
    236u8, 246u8, 107u8, 31u8, 237u8, 70u8, 233u8, 108u8, 160u8, 189u8, 43u8, 85u8,
    120u8, 116u8, 199u8, 47u8, 195u8, 108u8, 226u8,
]);
...
impl crate::columnar::ArrowValue for CompiledInitializationPlansRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for CompiledInitializationPlansRow {
    type Builder = CompiledInitializationPlansBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledInitializationPlansBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledInitializationPlansView::from_checked(batch)?.rows()
    }
...
impl<'a> CompiledInitializationPlansView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledInitializationPlansRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledInitializationPlansRow {
...
impl CompiledInitializationPlansBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledInitializationPlansView<'_>,
    ) -> Result<(), crate::RelationError> {
