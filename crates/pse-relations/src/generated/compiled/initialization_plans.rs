...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    173u8, 219u8, 154u8, 58u8, 88u8, 47u8, 217u8, 171u8, 94u8, 77u8, 195u8, 19u8, 11u8,
    189u8, 177u8, 8u8, 145u8, 221u8, 80u8, 161u8, 43u8, 181u8, 157u8, 66u8, 233u8, 110u8,
    18u8, 6u8, 118u8, 14u8, 59u8, 62u8,
]);
...
impl crate::columnar::RelationRow for CompiledInitializationPlansRow {
    ...
    fn builder_allocation_size() -> usize {
        44_400_usize + size_of::<Self::Builder>()
    }
