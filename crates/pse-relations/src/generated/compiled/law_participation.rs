...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    190u8, 123u8, 45u8, 131u8, 162u8, 230u8, 58u8, 238u8, 98u8, 178u8, 81u8, 165u8,
    202u8, 215u8, 114u8, 242u8, 180u8, 90u8, 82u8, 240u8, 95u8, 165u8, 33u8, 23u8, 173u8,
    169u8, 63u8, 12u8, 96u8, 186u8, 123u8, 47u8,
]);
...
impl crate::columnar::RelationRow for CompiledLawParticipationRow {
    ...
    fn builder_allocation_size() -> usize {
        82_752_usize + size_of::<Self::Builder>()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            if (self.r#conversion_id).is_some() {
