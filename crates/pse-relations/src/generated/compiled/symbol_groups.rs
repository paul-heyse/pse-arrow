...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    92u8, 67u8, 183u8, 114u8, 2u8, 43u8, 197u8, 71u8, 246u8, 205u8, 36u8, 91u8, 89u8,
    242u8, 122u8, 246u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "symbol_groups";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    178u8, 222u8, 21u8, 200u8, 242u8, 216u8, 216u8, 162u8, 187u8, 115u8, 154u8, 205u8,
    131u8, 98u8, 196u8, 238u8, 217u8, 208u8, 64u8, 53u8, 63u8, 57u8, 29u8, 16u8, 46u8,
    46u8, 221u8, 164u8, 26u8, 34u8, 232u8, 140u8,
]);
...
pub struct CompiledSymbolGroupsRow {
    ///group_id
...
impl crate::typed::CellCodec for CompiledSymbolGroupsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledSymbolGroupsRow)));
        };
            ...
            r#group_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledSymbolGroupsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledSymbolGroupsRow {
    fn append(
        &self,
...
pub type Row = CompiledSymbolGroupsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledSymbolGroupsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledSymbolGroupsBuilder;
impl CompiledSymbolGroupsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.symbol_groups".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledSymbolGroupsRow {
    type Builder = CompiledSymbolGroupsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledSymbolGroupsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledSymbolGroupsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        42_696_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledSymbolGroupsView<'a> {
...
impl<'a> CompiledSymbolGroupsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledSymbolGroupsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledSymbolGroupsRow {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledSymbolGroupsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledSymbolGroupsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledSymbolGroupsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledSymbolGroupsView<'_>,
    ) -> Result<(), crate::RelationError> {
