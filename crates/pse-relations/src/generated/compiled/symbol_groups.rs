...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    159u8, 51u8, 85u8, 187u8, 156u8, 254u8, 173u8, 9u8, 170u8, 192u8, 124u8, 168u8,
    199u8, 130u8, 212u8, 234u8, 1u8, 8u8, 37u8, 12u8, 58u8, 153u8, 144u8, 55u8, 123u8,
    74u8, 158u8, 151u8, 127u8, 133u8, 94u8, 12u8,
]);
...
impl crate::columnar::RelationRow for CompiledSymbolGroupsRow {
    ...
    fn builder_allocation_size() -> usize {
        42_232_usize + size_of::<Self::Builder>()
    }
