...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    222u8, 22u8, 12u8, 99u8, 151u8, 42u8, 83u8, 104u8, 71u8, 155u8, 131u8, 14u8, 144u8,
    219u8, 251u8, 78u8, 120u8, 186u8, 76u8, 6u8, 85u8, 208u8, 89u8, 44u8, 29u8, 64u8,
    154u8, 65u8, 131u8, 19u8, 3u8, 236u8,
]);
