...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    183u8, 39u8, 243u8, 165u8, 26u8, 163u8, 240u8, 173u8, 17u8, 245u8, 1u8, 64u8, 103u8,
    206u8, 71u8, 107u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "predicate_mask_members";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    15u8, 45u8, 19u8, 169u8, 222u8, 49u8, 208u8, 132u8, 141u8, 137u8, 244u8, 82u8, 48u8,
    30u8, 32u8, 3u8, 18u8, 243u8, 3u8, 145u8, 163u8, 194u8, 198u8, 182u8, 160u8, 150u8,
    128u8, 60u8, 254u8, 213u8, 178u8, 60u8,
]);
...
pub struct CompiledPredicateMaskMembersRow {
    ///group_id
...
impl crate::typed::CellCodec for CompiledPredicateMaskMembersRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(CompiledPredicateMaskMembersRow)),
            );
        };
            ...
            r#group_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledPredicateMaskMembersRow),
                    ))?,
            )?,
            r#index: <Vec<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for CompiledPredicateMaskMembersRow {
    fn append(
        &self,
...
pub type Row = CompiledPredicateMaskMembersRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledPredicateMaskMembersView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledPredicateMaskMembersBuilder;
impl CompiledPredicateMaskMembersRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.predicate_mask_members".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledPredicateMaskMembersRow {
    type Builder = CompiledPredicateMaskMembersBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledPredicateMaskMembersBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledPredicateMaskMembersView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        67_528_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledPredicateMaskMembersView<'a> {
    ...
    value_column: &'a arrow_array::BooleanArray,
    derivation_id_column: &'a arrow_array::FixedSizeBinaryArray,
}
impl<'a> CompiledPredicateMaskMembersView<'a> {
    ...
    pub const fn value_column(&self) -> &'a arrow_array::BooleanArray {
        self.value_column
    }
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledPredicateMaskMembersRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledPredicateMaskMembersRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<CompiledPredicateMaskMembersRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledPredicateMaskMembersBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledPredicateMaskMembersBuilder {
    ...
    pub fn push(
        &mut self,
        row: CompiledPredicateMaskMembersRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledPredicateMaskMembersView<'_>,
    ) -> Result<(), crate::RelationError> {
