...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    6u8, 177u8, 2u8, 191u8, 242u8, 99u8, 117u8, 61u8, 99u8, 156u8, 233u8, 129u8, 19u8,
    142u8, 244u8, 4u8, 154u8, 106u8, 92u8, 69u8, 103u8, 102u8, 139u8, 157u8, 20u8, 191u8,
    187u8, 25u8, 218u8, 63u8, 254u8, 168u8,
]);
...
impl crate::columnar::RelationRow for CompiledEquationOrderRow {
    ...
    fn builder_allocation_size() -> usize {
        58_896_usize + size_of::<Self::Builder>()
    }
