...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    193u8, 96u8, 123u8, 155u8, 180u8, 48u8, 120u8, 21u8, 168u8, 187u8, 229u8, 0u8, 5u8,
    250u8, 158u8, 191u8, 232u8, 88u8, 252u8, 47u8, 41u8, 213u8, 36u8, 98u8, 147u8, 147u8,
    152u8, 211u8, 184u8, 99u8, 121u8, 219u8,
]);
...
impl crate::columnar::RelationRow for CompiledMathKernelCallsRow {
    ...
    fn builder_allocation_size() -> usize {
        27_360_usize + size_of::<Self::Builder>()
    }
