...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    9u8, 94u8, 203u8, 48u8, 206u8, 232u8, 133u8, 105u8, 138u8, 134u8, 75u8, 63u8, 176u8,
    154u8, 86u8, 230u8, 188u8, 253u8, 59u8, 249u8, 124u8, 157u8, 235u8, 104u8, 60u8,
    12u8, 250u8, 81u8, 55u8, 30u8, 65u8, 106u8,
]);
...
impl<'a> CompiledMathKernelCallsView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledMathKernelCallsRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(CompiledMathKernelCallsRow::from_cells)
            .collect()
    }
}
...
pub struct CompiledMathKernelCallsBuilder {
    rows: Vec<CompiledMathKernelCallsRow>,
}
impl CompiledMathKernelCallsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(CompiledMathKernelCallsRow::into_cells)
            .collect::<Vec<_>>();
