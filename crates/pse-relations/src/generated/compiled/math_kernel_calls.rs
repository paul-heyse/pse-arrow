...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    97u8, 98u8, 34u8, 234u8, 177u8, 232u8, 43u8, 34u8, 33u8, 226u8, 39u8, 218u8, 183u8,
    81u8, 255u8, 106u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "math_kernel_calls";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    145u8, 139u8, 211u8, 60u8, 75u8, 243u8, 115u8, 114u8, 24u8, 80u8, 110u8, 34u8, 250u8,
    119u8, 25u8, 102u8, 67u8, 70u8, 189u8, 220u8, 27u8, 237u8, 253u8, 157u8, 22u8, 52u8,
    211u8, 160u8, 13u8, 47u8, 152u8, 127u8,
]);
...
pub struct CompiledMathKernelCallsRow {
    ///node_id
    pub r#node_id: u64,
    ///kernel_binding_id
...
impl crate::typed::CellCodec for CompiledMathKernelCallsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledMathKernelCallsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledMathKernelCallsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledMathKernelCallsRow {
    fn append(
        &self,
...
pub type Row = CompiledMathKernelCallsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledMathKernelCallsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledMathKernelCallsBuilder;
impl CompiledMathKernelCallsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.math_kernel_calls".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledMathKernelCallsRow {
    type Builder = CompiledMathKernelCallsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathKernelCallsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathKernelCallsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        26_896_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledMathKernelCallsView<'a> {
...
impl<'a> CompiledMathKernelCallsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathKernelCallsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathKernelCallsRow {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledMathKernelCallsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledMathKernelCallsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledMathKernelCallsBuilder {
    ...
    pub fn push(
        &mut self,
        row: CompiledMathKernelCallsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathKernelCallsView<'_>,
    ) -> Result<(), crate::RelationError> {
