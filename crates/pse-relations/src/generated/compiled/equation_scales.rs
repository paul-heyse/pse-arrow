...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    36u8, 192u8, 48u8, 3u8, 16u8, 162u8, 1u8, 208u8, 121u8, 39u8, 100u8, 228u8, 32u8,
    213u8, 187u8, 52u8, 74u8, 54u8, 112u8, 72u8, 137u8, 101u8, 157u8, 123u8, 65u8, 64u8,
    234u8, 107u8, 238u8, 169u8, 255u8, 227u8,
]);
...
impl crate::columnar::RelationRow for CompiledEquationScalesRow {
    ...
    fn builder_allocation_size() -> usize {
        50_496_usize + size_of::<Self::Builder>()
    }
