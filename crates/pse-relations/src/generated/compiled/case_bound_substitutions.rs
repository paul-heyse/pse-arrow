...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    84u8, 122u8, 20u8, 18u8, 141u8, 238u8, 172u8, 207u8, 163u8, 233u8, 13u8, 110u8,
    245u8, 111u8, 224u8, 41u8, 134u8, 121u8, 220u8, 69u8, 138u8, 110u8, 107u8, 33u8,
    191u8, 129u8, 112u8, 75u8, 153u8, 214u8, 190u8, 164u8,
]);
...
impl crate::columnar::RelationRow for CompiledCaseBoundSubstitutionsRow {
    ...
    fn builder_allocation_size() -> usize {
        71_856_usize + size_of::<Self::Builder>()
    }
