...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    4u8, 92u8, 143u8, 50u8, 121u8, 36u8, 131u8, 68u8, 107u8, 82u8, 26u8, 158u8, 79u8,
    96u8, 187u8, 17u8, 234u8, 254u8, 104u8, 235u8, 14u8, 225u8, 203u8, 66u8, 85u8, 58u8,
    131u8, 162u8, 130u8, 81u8, 201u8, 117u8,
]);
...
impl crate::columnar::RelationRow for CompiledCaseBoundSubstitutionsRow {
    ...
    fn builder_allocation_size() -> usize {
        69_632_usize + size_of::<Self::Builder>()
    }
