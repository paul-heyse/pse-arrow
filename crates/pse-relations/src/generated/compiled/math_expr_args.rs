...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    65u8, 178u8, 216u8, 110u8, 214u8, 175u8, 82u8, 13u8, 226u8, 110u8, 117u8, 186u8,
    87u8, 244u8, 225u8, 211u8, 2u8, 134u8, 149u8, 94u8, 174u8, 80u8, 66u8, 211u8, 240u8,
    247u8, 91u8, 208u8, 183u8, 42u8, 31u8, 95u8,
]);
...
impl crate::columnar::RelationRow for CompiledMathExprArgsRow {
    ...
    fn builder_allocation_size() -> usize {
        22_776_usize + size_of::<Self::Builder>()
    }
