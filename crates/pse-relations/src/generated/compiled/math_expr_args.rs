...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    89u8, 90u8, 251u8, 100u8, 219u8, 253u8, 219u8, 81u8, 12u8, 139u8, 254u8, 98u8, 224u8,
    219u8, 14u8, 85u8, 245u8, 75u8, 33u8, 154u8, 186u8, 62u8, 43u8, 53u8, 182u8, 62u8,
    244u8, 72u8, 184u8, 170u8, 229u8, 235u8,
]);
...
impl<'a> CompiledMathExprArgsView<'a> {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledMathExprArgsRow>, crate::RelationError> {
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(CompiledMathExprArgsRow::from_cells)
            .collect()
    }
}
...
pub struct CompiledMathExprArgsBuilder {
    rows: Vec<CompiledMathExprArgsRow>,
}
impl CompiledMathExprArgsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(CompiledMathExprArgsRow::into_cells)
            .collect::<Vec<_>>();
