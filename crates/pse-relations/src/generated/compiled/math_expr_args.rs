...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    22u8, 189u8, 141u8, 133u8, 57u8, 87u8, 192u8, 83u8, 161u8, 51u8, 126u8, 56u8, 215u8,
    136u8, 194u8, 101u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "math_expr_args";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    122u8, 180u8, 20u8, 224u8, 50u8, 11u8, 191u8, 139u8, 162u8, 133u8, 38u8, 175u8,
    188u8, 238u8, 25u8, 143u8, 239u8, 27u8, 82u8, 69u8, 237u8, 7u8, 81u8, 175u8, 213u8,
    201u8, 129u8, 173u8, 196u8, 199u8, 165u8, 47u8,
]);
...
pub struct CompiledMathExprArgsRow {
    ///parent_node_id
...
impl crate::typed::CellCodec for CompiledMathExprArgsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledMathExprArgsRow)));
        };
            ...
            r#parent_node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledMathExprArgsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledMathExprArgsRow {
    fn append(
        &self,
...
pub type Row = CompiledMathExprArgsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledMathExprArgsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledMathExprArgsBuilder;
impl CompiledMathExprArgsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.math_expr_args".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledMathExprArgsRow {
    type Builder = CompiledMathExprArgsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathExprArgsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathExprArgsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        22_312_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledMathExprArgsView<'a> {
...
impl<'a> CompiledMathExprArgsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathExprArgsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathExprArgsRow {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledMathExprArgsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledMathExprArgsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledMathExprArgsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathExprArgsView<'_>,
    ) -> Result<(), crate::RelationError> {
