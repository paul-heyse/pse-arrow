...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    36u8, 75u8, 109u8, 71u8, 189u8, 226u8, 216u8, 236u8, 236u8, 219u8, 177u8, 237u8,
    253u8, 122u8, 131u8, 13u8, 99u8, 18u8, 242u8, 80u8, 147u8, 177u8, 10u8, 61u8, 211u8,
    140u8, 124u8, 226u8, 213u8, 243u8, 168u8, 23u8,
]);
...
impl crate::columnar::RelationRow for CompiledMathUnitConvertsRow {
    ...
    fn builder_allocation_size() -> usize {
        43_128_usize + size_of::<Self::Builder>()
    }
