...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    5u8, 65u8, 176u8, 98u8, 20u8, 68u8, 73u8, 17u8, 150u8, 72u8, 160u8, 144u8, 200u8,
    155u8, 77u8, 161u8, 202u8, 132u8, 220u8, 210u8, 191u8, 2u8, 19u8, 52u8, 15u8, 181u8,
    217u8, 206u8, 174u8, 190u8, 197u8, 142u8,
]);
...
impl crate::columnar::RelationRow for CompiledSymbolGroupMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        43_624_usize + size_of::<Self::Builder>()
    }
