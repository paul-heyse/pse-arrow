...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    65u8, 207u8, 90u8, 149u8, 51u8, 241u8, 215u8, 67u8, 69u8, 103u8, 200u8, 34u8, 182u8,
    117u8, 153u8, 28u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    178u8, 128u8, 130u8, 149u8, 151u8, 209u8, 46u8, 120u8, 185u8, 174u8, 23u8, 234u8,
    175u8, 97u8, 152u8, 106u8, 41u8, 123u8, 69u8, 13u8, 76u8, 46u8, 33u8, 197u8, 224u8,
    33u8, 2u8, 23u8, 20u8, 129u8, 211u8, 205u8,
]);
...
pub struct CompiledMathObjectivesRow {
    ///objective_id
...
impl crate::typed::CellCodec for CompiledMathObjectivesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledMathObjectivesRow)));
        };
            ...
            r#objective_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledMathObjectivesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledMathObjectivesRow {
    fn append(
        &self,
...
pub type Row = CompiledMathObjectivesRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledMathObjectivesView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledMathObjectivesBuilder;
impl CompiledMathObjectivesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.math_objectives".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledMathObjectivesRow {
    type Builder = CompiledMathObjectivesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathObjectivesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathObjectivesView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct CompiledMathObjectivesView<'a> {
...
impl<'a> CompiledMathObjectivesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathObjectivesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathObjectivesRow {
    ...
    pub fn rows(&self) -> Result<Vec<CompiledMathObjectivesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledMathObjectivesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledMathObjectivesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathObjectivesView<'_>,
    ) -> Result<(), crate::RelationError> {
