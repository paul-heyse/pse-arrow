...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    119u8, 76u8, 85u8, 229u8, 87u8, 183u8, 0u8, 139u8, 188u8, 48u8, 7u8, 209u8, 76u8,
    153u8, 210u8, 214u8, 114u8, 240u8, 217u8, 237u8, 146u8, 232u8, 15u8, 213u8, 178u8,
    17u8, 19u8, 13u8, 18u8, 225u8, 53u8, 6u8,
]);
...
impl crate::columnar::RelationRow for CompiledVariableScalesRow {
    ...
    fn builder_allocation_size() -> usize {
        54_024_usize + size_of::<Self::Builder>()
    }
