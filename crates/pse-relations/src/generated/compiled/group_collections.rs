...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    191u8, 209u8, 190u8, 163u8, 163u8, 98u8, 240u8, 104u8, 50u8, 241u8, 154u8, 245u8,
    101u8, 5u8, 246u8, 85u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "group_collections";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    204u8, 102u8, 211u8, 163u8, 164u8, 167u8, 157u8, 199u8, 140u8, 205u8, 187u8, 229u8,
    168u8, 18u8, 170u8, 151u8, 246u8, 188u8, 192u8, 90u8, 236u8, 113u8, 225u8, 0u8, 76u8,
    217u8, 104u8, 142u8, 132u8, 194u8, 124u8, 100u8,
]);
...
pub struct CompiledGroupCollectionsRow {
    ///group_id
...
impl crate::typed::CellCodec for CompiledGroupCollectionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledGroupCollectionsRow)));
        };
            ...
            r#group_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledGroupCollectionsRow),
                    ))?,
            )?,
            r#root_instance_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledGroupCollectionsRow),
...
impl crate::columnar::ArrowValue for CompiledGroupCollectionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#path_id, children[3usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#product_id,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#root_instance_id: <pse_ids::SemanticId as crate::columnar::ArrowValue>::read(
...
pub type Row = CompiledGroupCollectionsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledGroupCollectionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledGroupCollectionsBuilder;
impl CompiledGroupCollectionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.group_collections".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledGroupCollectionsRow {
    type Builder = CompiledGroupCollectionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledGroupCollectionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledGroupCollectionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        87_632_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledGroupCollectionsView<'a> {
...
impl<'a> CompiledGroupCollectionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledGroupCollectionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledGroupCollectionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<CompiledGroupCollectionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledGroupCollectionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledGroupCollectionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: CompiledGroupCollectionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledGroupCollectionsView<'_>,
    ) -> Result<(), crate::RelationError> {
