...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    83u8, 124u8, 26u8, 7u8, 97u8, 41u8, 110u8, 226u8, 65u8, 247u8, 100u8, 239u8, 120u8,
    63u8, 144u8, 130u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "math_float_constants";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    43u8, 144u8, 247u8, 13u8, 9u8, 217u8, 250u8, 242u8, 107u8, 226u8, 96u8, 230u8, 253u8,
    128u8, 172u8, 22u8, 255u8, 54u8, 160u8, 169u8, 98u8, 55u8, 157u8, 79u8, 250u8, 26u8,
    185u8, 36u8, 209u8, 103u8, 196u8, 219u8,
]);
...
pub struct CompiledMathFloatConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: f64,
...
impl crate::typed::CellCodec for CompiledMathFloatConstantsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(CompiledMathFloatConstantsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledMathFloatConstantsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledMathFloatConstantsRow {
    fn append(
        &self,
...
pub type Row = CompiledMathFloatConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledMathFloatConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledMathFloatConstantsBuilder;
impl CompiledMathFloatConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.math_float_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledMathFloatConstantsRow {
    type Builder = CompiledMathFloatConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathFloatConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathFloatConstantsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        26_968_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledMathFloatConstantsView<'a> {
...
impl<'a> CompiledMathFloatConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathFloatConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathFloatConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<CompiledMathFloatConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledMathFloatConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledMathFloatConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: CompiledMathFloatConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathFloatConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
