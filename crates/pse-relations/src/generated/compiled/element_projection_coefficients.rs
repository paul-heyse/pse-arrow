...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    173u8, 93u8, 154u8, 38u8, 80u8, 220u8, 68u8, 68u8, 216u8, 46u8, 158u8, 251u8, 4u8,
    237u8, 173u8, 55u8, 225u8, 185u8, 42u8, 251u8, 160u8, 218u8, 73u8, 117u8, 82u8,
    244u8, 208u8, 25u8, 240u8, 239u8, 134u8, 236u8,
]);
...
impl crate::columnar::RelationRow for CompiledElementProjectionCoefficientsRow {
    ...
    fn builder_allocation_size() -> usize {
        100_960_usize + size_of::<Self::Builder>()
    }
