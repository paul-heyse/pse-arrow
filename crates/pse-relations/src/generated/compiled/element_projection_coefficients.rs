...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    168u8, 169u8, 107u8, 32u8, 209u8, 194u8, 204u8, 103u8, 118u8, 64u8, 202u8, 100u8,
    163u8, 160u8, 124u8, 204u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "element_projection_coefficients";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    34u8, 224u8, 58u8, 177u8, 205u8, 58u8, 204u8, 98u8, 57u8, 139u8, 210u8, 50u8, 228u8,
    138u8, 153u8, 184u8, 154u8, 171u8, 179u8, 192u8, 104u8, 8u8, 116u8, 64u8, 34u8,
    225u8, 124u8, 226u8, 117u8, 205u8, 233u8, 240u8,
]);
...
pub struct CompiledElementProjectionCoefficientsRow {
    ///group_id
    ...
    pub r#count: f64,
    ///molecular_weight
    pub r#molecular_weight: Option<f64>,
    ///value
    pub r#value: f64,
    ///Exact source derivation.
    pub r#derivation_id: pse_ids::SemanticId,
}
impl crate::typed::CellCodec for CompiledElementProjectionCoefficientsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#molecular_weight),
        ...
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(
                    stringify!(CompiledElementProjectionCoefficientsRow),
                ),
            );
        };
...
impl crate::columnar::ArrowValue for CompiledElementProjectionCoefficientsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#node_id, children[3usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#element_id,
        ...
        crate::columnar::ArrowValue::append(&self.r#count, children[6usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#molecular_weight,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#count: <f64 as crate::columnar::ArrowValue>::read(
...
pub type Row = CompiledElementProjectionCoefficientsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledElementProjectionCoefficientsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledElementProjectionCoefficientsBuilder;
impl CompiledElementProjectionCoefficientsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.element_projection_coefficients".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledElementProjectionCoefficientsRow {
    type Builder = CompiledElementProjectionCoefficientsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledElementProjectionCoefficientsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledElementProjectionCoefficientsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        101_424_usize + size_of::<Self::Builder>()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            if (self.r#molecular_weight).is_some() {
...
#[derive(Debug)]
pub struct CompiledElementProjectionCoefficientsView<'a> {
    ...
    count_column: &'a arrow_array::Float64Array,
    molecular_weight_column: &'a arrow_array::Float64Array,
    value_column: &'a arrow_array::Float64Array,
    derivation_id_column: &'a arrow_array::FixedSizeBinaryArray,
}
impl<'a> CompiledElementProjectionCoefficientsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            molecular_weight_column: crate::columnar::array::<
                arrow_array::Float64Array,
    ...
    pub const fn count_column(&self) -> &'a arrow_array::Float64Array {
        self.count_column
    }
    ...
    pub const fn molecular_weight_column(&self) -> &'a arrow_array::Float64Array {
        self.molecular_weight_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "molecular_weight", "`.")]
    pub fn molecular_weight_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledElementProjectionCoefficientsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledElementProjectionCoefficientsRow {
            ...
            r#molecular_weight: crate::columnar::ArrowValue::read(
                self.molecular_weight_column,
                index,
            )?,
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<CompiledElementProjectionCoefficientsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledElementProjectionCoefficientsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledElementProjectionCoefficientsBuilder {
    ...
    pub fn push(
        &mut self,
        row: CompiledElementProjectionCoefficientsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledElementProjectionCoefficientsView<'_>,
    ) -> Result<(), crate::RelationError> {
