...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    45u8, 202u8, 57u8, 112u8, 204u8, 175u8, 135u8, 5u8, 165u8, 35u8, 13u8, 103u8, 17u8,
    40u8, 216u8, 40u8, 129u8, 188u8, 137u8, 8u8, 174u8, 124u8, 249u8, 249u8, 181u8,
    196u8, 67u8, 149u8, 165u8, 8u8, 81u8, 64u8,
]);
...
impl crate::columnar::RelationRow for CompiledSymbolExpressionsRow {
    ...
    fn builder_allocation_size() -> usize {
        31_936_usize + size_of::<Self::Builder>()
    }
