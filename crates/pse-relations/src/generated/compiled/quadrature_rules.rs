...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    137u8, 131u8, 14u8, 131u8, 32u8, 3u8, 250u8, 128u8, 141u8, 145u8, 142u8, 82u8, 42u8,
    220u8, 205u8, 125u8, 5u8, 89u8, 100u8, 160u8, 60u8, 219u8, 70u8, 213u8, 103u8, 152u8,
    235u8, 117u8, 18u8, 131u8, 190u8, 239u8,
]);
...
impl crate::columnar::RelationRow for CompiledQuadratureRulesRow {
    ...
    fn builder_allocation_size() -> usize {
        44_544_usize + size_of::<Self::Builder>()
    }
