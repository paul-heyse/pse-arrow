...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    62u8, 181u8, 199u8, 212u8, 222u8, 226u8, 252u8, 91u8, 159u8, 142u8, 229u8, 128u8,
    222u8, 153u8, 105u8, 149u8, 141u8, 192u8, 194u8, 207u8, 49u8, 74u8, 31u8, 31u8,
    218u8, 186u8, 84u8, 44u8, 68u8, 106u8, 23u8, 248u8,
]);
...
impl crate::columnar::ArrowValue for CompiledQuadratureRulesRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#node_id, children[2usize].as_mut())?;
...
impl crate::columnar::RelationRow for CompiledQuadratureRulesRow {
    type Builder = CompiledQuadratureRulesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledQuadratureRulesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledQuadratureRulesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        45_008_usize + size_of::<Self::Builder>()
    }
...
impl<'a> CompiledQuadratureRulesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledQuadratureRulesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledQuadratureRulesRow {
...
impl CompiledQuadratureRulesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledQuadratureRulesView<'_>,
    ) -> Result<(), crate::RelationError> {
