...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    50u8, 191u8, 55u8, 169u8, 94u8, 155u8, 194u8, 197u8, 207u8, 163u8, 185u8, 29u8,
    239u8, 2u8, 254u8, 177u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_member_groups";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    155u8, 251u8, 82u8, 207u8, 106u8, 210u8, 229u8, 235u8, 117u8, 189u8, 184u8, 75u8,
    52u8, 229u8, 78u8, 243u8, 232u8, 237u8, 20u8, 134u8, 166u8, 222u8, 242u8, 227u8,
    88u8, 150u8, 157u8, 161u8, 116u8, 203u8, 1u8, 145u8,
]);
...
pub struct CompiledPortMemberGroupsRow {
    ///group_id
...
impl crate::typed::CellCodec for CompiledPortMemberGroupsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledPortMemberGroupsRow)));
        };
            ...
            r#group_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledPortMemberGroupsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledPortMemberGroupsRow {
    fn append(
        &self,
...
pub type Row = CompiledPortMemberGroupsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledPortMemberGroupsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledPortMemberGroupsBuilder;
impl CompiledPortMemberGroupsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.port_member_groups".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledPortMemberGroupsRow {
    type Builder = CompiledPortMemberGroupsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledPortMemberGroupsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledPortMemberGroupsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        64_672_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledPortMemberGroupsView<'a> {
...
impl<'a> CompiledPortMemberGroupsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledPortMemberGroupsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledPortMemberGroupsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<CompiledPortMemberGroupsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledPortMemberGroupsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledPortMemberGroupsBuilder {
    ...
    pub fn push(
        &mut self,
        row: CompiledPortMemberGroupsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledPortMemberGroupsView<'_>,
    ) -> Result<(), crate::RelationError> {
