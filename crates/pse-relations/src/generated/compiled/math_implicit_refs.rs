...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    186u8, 47u8, 157u8, 209u8, 146u8, 235u8, 59u8, 17u8, 192u8, 4u8, 192u8, 83u8, 95u8,
    228u8, 240u8, 7u8, 113u8, 230u8, 205u8, 183u8, 34u8, 109u8, 101u8, 56u8, 84u8, 55u8,
    199u8, 38u8, 0u8, 96u8, 184u8, 12u8,
]);
...
impl crate::columnar::RelationRow for CompiledMathImplicitRefsRow {
    ...
    fn builder_allocation_size() -> usize {
        27_424_usize + size_of::<Self::Builder>()
    }
