...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    171u8, 246u8, 137u8, 162u8, 206u8, 87u8, 134u8, 2u8, 121u8, 82u8, 170u8, 23u8, 141u8,
    172u8, 234u8, 255u8, 171u8, 213u8, 102u8, 61u8, 213u8, 8u8, 55u8, 32u8, 192u8, 172u8,
    191u8, 40u8, 130u8, 127u8, 197u8, 108u8,
]);
...
impl<'a> CompiledMathImplicitRefsView<'a> {
    ...
    pub fn rows(
        ...
        crate::cells::cells_from_batch(self.registry, spec(self.registry)?, self.batch)?
            .into_iter()
            .map(CompiledMathImplicitRefsRow::from_cells)
            .collect()
    }
}
...
pub struct CompiledMathImplicitRefsBuilder {
    rows: Vec<CompiledMathImplicitRefsRow>,
}
impl CompiledMathImplicitRefsBuilder {
    ...
    pub fn finish_with_registry(
        ...
        let cells = self
            .rows
            .into_iter()
            .map(CompiledMathImplicitRefsRow::into_cells)
            .collect::<Vec<_>>();
