...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    250u8, 67u8, 41u8, 28u8, 104u8, 103u8, 43u8, 18u8, 240u8, 254u8, 251u8, 107u8, 191u8,
    107u8, 238u8, 81u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "math_implicit_refs";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    123u8, 161u8, 149u8, 16u8, 87u8, 26u8, 205u8, 192u8, 48u8, 78u8, 124u8, 161u8, 169u8,
    7u8, 59u8, 228u8, 144u8, 16u8, 30u8, 53u8, 209u8, 79u8, 234u8, 38u8, 89u8, 244u8,
    137u8, 61u8, 208u8, 110u8, 157u8, 195u8,
]);
...
pub struct CompiledMathImplicitRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///implicit_system_id
...
impl crate::typed::CellCodec for CompiledMathImplicitRefsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(CompiledMathImplicitRefsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledMathImplicitRefsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledMathImplicitRefsRow {
    fn append(
        &self,
...
pub type Row = CompiledMathImplicitRefsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledMathImplicitRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledMathImplicitRefsBuilder;
impl CompiledMathImplicitRefsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.math_implicit_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledMathImplicitRefsRow {
    type Builder = CompiledMathImplicitRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathImplicitRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathImplicitRefsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        26_960_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledMathImplicitRefsView<'a> {
...
impl<'a> CompiledMathImplicitRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathImplicitRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathImplicitRefsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<CompiledMathImplicitRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledMathImplicitRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledMathImplicitRefsBuilder {
    ...
    pub fn push(
        &mut self,
        row: CompiledMathImplicitRefsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathImplicitRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
