...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    131u8, 7u8, 66u8, 197u8, 198u8, 241u8, 173u8, 235u8, 181u8, 214u8, 75u8, 219u8,
    127u8, 91u8, 233u8, 77u8, 193u8, 255u8, 85u8, 61u8, 184u8, 195u8, 188u8, 154u8, 45u8,
    64u8, 158u8, 21u8, 95u8, 127u8, 75u8, 242u8,
]);
...
impl crate::columnar::ArrowValue for CompiledMathBroadcastsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for CompiledMathBroadcastsRow {
    type Builder = CompiledMathBroadcastsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledMathBroadcastsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledMathBroadcastsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        31_544_usize + size_of::<Self::Builder>()
    }
...
impl<'a> CompiledMathBroadcastsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledMathBroadcastsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledMathBroadcastsRow {
...
impl CompiledMathBroadcastsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledMathBroadcastsView<'_>,
    ) -> Result<(), crate::RelationError> {
