...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    224u8, 155u8, 54u8, 100u8, 62u8, 16u8, 104u8, 15u8, 250u8, 240u8, 198u8, 182u8,
    203u8, 37u8, 17u8, 90u8, 178u8, 70u8, 234u8, 30u8, 146u8, 35u8, 40u8, 66u8, 122u8,
    101u8, 115u8, 213u8, 140u8, 50u8, 248u8, 249u8,
]);
...
impl crate::columnar::RelationRow for CompiledMathBroadcastsRow {
    ...
    fn builder_allocation_size() -> usize {
        32_008_usize + size_of::<Self::Builder>()
    }
