...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    197u8, 224u8, 63u8, 192u8, 143u8, 204u8, 91u8, 155u8, 90u8, 61u8, 42u8, 4u8, 201u8,
    89u8, 134u8, 185u8, 64u8, 32u8, 80u8, 115u8, 14u8, 113u8, 186u8, 208u8, 13u8, 138u8,
    41u8, 34u8, 226u8, 248u8, 252u8, 189u8,
]);
...
impl crate::columnar::RelationRow for CompiledMeshesRow {
    ...
    fn builder_allocation_size() -> usize {
        55_128_usize + size_of::<Self::Builder>()
    }
