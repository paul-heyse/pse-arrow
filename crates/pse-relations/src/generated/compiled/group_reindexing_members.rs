...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    246u8, 203u8, 124u8, 183u8, 119u8, 169u8, 198u8, 70u8, 185u8, 200u8, 143u8, 200u8,
    61u8, 95u8, 208u8, 231u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "group_reindexing_members";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    178u8, 22u8, 206u8, 227u8, 14u8, 4u8, 199u8, 182u8, 46u8, 39u8, 38u8, 16u8, 200u8,
    216u8, 38u8, 200u8, 65u8, 14u8, 189u8, 230u8, 52u8, 33u8, 146u8, 112u8, 184u8, 179u8,
    208u8, 96u8, 140u8, 248u8, 243u8, 253u8,
]);
...
pub struct CompiledGroupReindexingMembersRow {
    ///group_id
...
impl crate::typed::CellCodec for CompiledGroupReindexingMembersRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(CompiledGroupReindexingMembersRow)),
            );
        };
            ...
            r#group_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledGroupReindexingMembersRow),
                    ))?,
            )?,
            r#index: <Vec<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for CompiledGroupReindexingMembersRow {
    fn append(
        &self,
...
pub type Row = CompiledGroupReindexingMembersRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledGroupReindexingMembersView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledGroupReindexingMembersBuilder;
impl CompiledGroupReindexingMembersRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.group_reindexing_members".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledGroupReindexingMembersRow {
    type Builder = CompiledGroupReindexingMembersBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledGroupReindexingMembersBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledGroupReindexingMembersView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        74_376_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledGroupReindexingMembersView<'a> {
...
impl<'a> CompiledGroupReindexingMembersView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledGroupReindexingMembersRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledGroupReindexingMembersRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<CompiledGroupReindexingMembersRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledGroupReindexingMembersBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledGroupReindexingMembersBuilder {
    ...
    pub fn push(
        &mut self,
        row: CompiledGroupReindexingMembersRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledGroupReindexingMembersView<'_>,
    ) -> Result<(), crate::RelationError> {
