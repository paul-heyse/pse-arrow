...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    4u8, 131u8, 209u8, 153u8, 89u8, 82u8, 1u8, 67u8, 182u8, 55u8, 91u8, 109u8, 11u8,
    97u8, 190u8, 145u8, 228u8, 21u8, 60u8, 57u8, 231u8, 244u8, 67u8, 110u8, 108u8, 31u8,
    180u8, 22u8, 190u8, 76u8, 54u8, 228u8,
]);
...
impl crate::columnar::RelationRow for CompiledGroupReindexingMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        76_136_usize + size_of::<Self::Builder>()
    }
