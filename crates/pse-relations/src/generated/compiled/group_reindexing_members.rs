...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    54u8, 44u8, 182u8, 195u8, 154u8, 72u8, 34u8, 162u8, 140u8, 10u8, 184u8, 207u8, 243u8,
    211u8, 79u8, 220u8, 70u8, 98u8, 121u8, 73u8, 80u8, 37u8, 97u8, 186u8, 205u8, 62u8,
    5u8, 182u8, 69u8, 210u8, 239u8, 78u8,
]);
...
impl crate::columnar::RelationRow for CompiledGroupReindexingMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        73_912_usize + size_of::<Self::Builder>()
    }
