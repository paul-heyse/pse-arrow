...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    206u8, 182u8, 65u8, 204u8, 134u8, 70u8, 138u8, 163u8, 132u8, 77u8, 250u8, 212u8,
    103u8, 220u8, 155u8, 79u8, 165u8, 197u8, 135u8, 187u8, 132u8, 64u8, 171u8, 248u8,
    88u8, 195u8, 22u8, 255u8, 243u8, 31u8, 165u8, 17u8,
]);
...
impl crate::columnar::RelationRow for CompiledExpressionRootIndicesRow {
    ...
    fn builder_allocation_size() -> usize {
        82_640_usize + size_of::<Self::Builder>()
    }
