...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    34u8, 41u8, 34u8, 123u8, 208u8, 207u8, 7u8, 90u8, 128u8, 176u8, 48u8, 79u8, 151u8,
    71u8, 62u8, 44u8, 247u8, 177u8, 3u8, 51u8, 196u8, 210u8, 29u8, 221u8, 26u8, 249u8,
    164u8, 221u8, 38u8, 49u8, 41u8, 254u8,
]);
...
impl crate::columnar::RelationRow for CompiledPredicateMasksRow {
    ...
    fn builder_allocation_size() -> usize {
        75_472_usize + size_of::<Self::Builder>()
    }
