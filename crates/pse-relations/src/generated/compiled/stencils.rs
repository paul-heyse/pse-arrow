...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    24u8, 76u8, 75u8, 156u8, 197u8, 54u8, 3u8, 156u8, 132u8, 66u8, 79u8, 122u8, 150u8,
    17u8, 158u8, 180u8, 112u8, 206u8, 68u8, 80u8, 84u8, 193u8, 32u8, 100u8, 100u8, 155u8,
    1u8, 216u8, 177u8, 168u8, 21u8, 122u8,
]);
...
impl crate::columnar::RelationRow for CompiledStencilsRow {
    ...
    fn builder_allocation_size() -> usize {
        78_432_usize + size_of::<Self::Builder>()
    }
