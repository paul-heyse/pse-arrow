...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    234u8, 81u8, 126u8, 219u8, 156u8, 106u8, 88u8, 160u8, 74u8, 242u8, 250u8, 26u8,
    192u8, 149u8, 207u8, 157u8, 16u8, 44u8, 1u8, 200u8, 68u8, 179u8, 231u8, 241u8, 24u8,
    52u8, 243u8, 145u8, 14u8, 32u8, 84u8, 231u8,
]);
...
impl crate::typed::CellCodec for CompiledEquationBranchesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        ...
        Ok(Self {
            ...
            r#equation_node_id: <i64 as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledEquationBranchesRow),
...
impl crate::columnar::ArrowValue for CompiledEquationBranchesRow {
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#equation_node_id: <i64 as crate::columnar::ArrowValue>::read(
...
impl crate::columnar::RelationRow for CompiledEquationBranchesRow {
    ...
    fn builder_allocation_size() -> usize {
        150_560_usize + size_of::<Self::Builder>()
    }
...
pub struct CompiledEquationBranchesView<'a> {
    ...
    equation_node_id_column: &'a arrow_array::Int64Array,
...
impl<'a> CompiledEquationBranchesView<'a> {
    ...
    pub const fn equation_node_id_column(&self) -> &'a arrow_array::Int64Array {
...
impl CompiledEquationBranchesBuilder {
    ...
    pub fn push(
        ...
        if !((0_i64..=9_223_372_036_854_775_807_i64)
            .contains(&(row.r#equation_node_id).to_owned()))
        {
            return Err(
        ...
        (row.r#branch_guards)
            ...
            .try_for_each(|item| {
                if !((0_i64..=9_223_372_036_854_775_807_i64)
                    .contains(&((item).r#predicate_id).to_owned()))
                {
                    return Err(
                        crate::columnar::value_error(
                            "branch_guards.predicate_id",
                            row_index,
                            "value outside declared integer domain",
                        ),
                    );
