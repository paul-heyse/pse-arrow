...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    196u8, 186u8, 36u8, 139u8, 98u8, 142u8, 249u8, 233u8, 154u8, 22u8, 184u8, 138u8,
    169u8, 153u8, 184u8, 48u8, 127u8, 227u8, 3u8, 212u8, 231u8, 8u8, 100u8, 37u8, 118u8,
    172u8, 147u8, 54u8, 61u8, 205u8, 182u8, 176u8,
]);
...
pub struct CompiledEvaluationProgramsRow {
    ...
    ///instruction_count
    pub r#instruction_count: i64,
    ///workspace_size
    pub r#workspace_size: i64,
}
impl crate::typed::CellCodec for CompiledEvaluationProgramsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#instruction_count),
                crate::typed::CellCodec::into_cell(self.r#workspace_size),
            ],
        )
    }
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        ...
        Ok(Self {
            ...
            r#instruction_count: <i64 as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledEvaluationProgramsRow),
            ...
            r#workspace_size: <i64 as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledEvaluationProgramsRow),
...
impl crate::columnar::ArrowValue for CompiledEvaluationProgramsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(
            &self.r#instruction_count,
            children[3usize].as_mut(),
        )?;
        crate::columnar::ArrowValue::append(
            &self.r#workspace_size,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#artifact_hash: <pse_ids::ContentHash as crate::columnar::ArrowValue>::read(
                input.column(2usize).as_ref(),
                index,
            )?,
            r#instruction_count: <i64 as crate::columnar::ArrowValue>::read(
                input.column(3usize).as_ref(),
                index,
            )?,
            r#workspace_size: <i64 as crate::columnar::ArrowValue>::read(
...
impl crate::columnar::RelationRow for CompiledEvaluationProgramsRow {
    type Builder = CompiledEvaluationProgramsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledEvaluationProgramsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledEvaluationProgramsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        54_152_usize + size_of::<Self::Builder>()
    }
...
pub struct CompiledEvaluationProgramsView<'a> {
    ...
    instruction_count_column: &'a arrow_array::Int64Array,
    workspace_size_column: &'a arrow_array::Int64Array,
}
impl<'a> CompiledEvaluationProgramsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            instruction_count_column: crate::columnar::array::<
                arrow_array::Int64Array,
            >(batch.column(3usize).as_ref())?,
            workspace_size_column: crate::columnar::array::<
                arrow_array::Int64Array,
    ...
    pub const fn instruction_count_column(&self) -> &'a arrow_array::Int64Array {
        self.instruction_count_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "instruction_count", "`.")]
    pub fn instruction_count_field(&self) -> &'a crate::FieldRef {
    ...
    pub const fn workspace_size_column(&self) -> &'a arrow_array::Int64Array {
        self.workspace_size_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "workspace_size", "`.")]
    pub fn workspace_size_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledEvaluationProgramsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledEvaluationProgramsRow {
            ...
            r#instruction_count: crate::columnar::ArrowValue::read(
                self.instruction_count_column,
                index,
            )?,
            r#workspace_size: crate::columnar::ArrowValue::read(
                self.workspace_size_column,
                index,
            )?,
        })
...
impl CompiledEvaluationProgramsBuilder {
    ...
    pub fn push(
        ...
        if !((0_i64..=9_223_372_036_854_775_807_i64)
            .contains(&(row.r#instruction_count).to_owned()))
        {
            return Err(
        ...
        if !((0_i64..=9_223_372_036_854_775_807_i64)
            .contains(&(row.r#workspace_size).to_owned()))
        {
            return Err(
                crate::columnar::value_error(
                    "workspace_size",
        ...
        self.columns
            .append(move |columns| {
                ...
                crate::columnar::ArrowValue::append(
                    &row.r#instruction_count,
                    columns[3usize].as_mut(),
                )?;
                crate::columnar::ArrowValue::append(
                    &row.r#workspace_size,
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledEvaluationProgramsView<'_>,
    ) -> Result<(), crate::RelationError> {
