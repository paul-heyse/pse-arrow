...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    89u8, 149u8, 216u8, 40u8, 152u8, 153u8, 241u8, 200u8, 94u8, 34u8, 1u8, 147u8, 69u8,
    226u8, 170u8, 211u8, 179u8, 51u8, 244u8, 30u8, 84u8, 226u8, 156u8, 34u8, 117u8,
    128u8, 219u8, 186u8, 228u8, 23u8, 176u8, 155u8,
]);
...
impl crate::columnar::RelationRow for CompiledEvaluationProgramsRow {
    ...
    fn builder_allocation_size() -> usize {
        55_912_usize + size_of::<Self::Builder>()
    }
