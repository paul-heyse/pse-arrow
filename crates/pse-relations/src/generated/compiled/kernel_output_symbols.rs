...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    59u8, 163u8, 127u8, 153u8, 132u8, 194u8, 11u8, 53u8, 158u8, 200u8, 196u8, 23u8,
    189u8, 109u8, 76u8, 68u8, 116u8, 56u8, 37u8, 112u8, 21u8, 11u8, 246u8, 215u8, 68u8,
    204u8, 189u8, 33u8, 232u8, 228u8, 166u8, 9u8,
]);
...
impl crate::columnar::RelationRow for CompiledKernelOutputSymbolsRow {
    ...
    fn builder_allocation_size() -> usize {
        116_696_usize + size_of::<Self::Builder>()
    }
