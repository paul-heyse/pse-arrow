...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    32u8, 225u8, 247u8, 215u8, 53u8, 52u8, 94u8, 80u8, 8u8, 157u8, 101u8, 170u8, 141u8,
    73u8, 48u8, 3u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "kernel_output_symbols";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    62u8, 116u8, 97u8, 149u8, 223u8, 57u8, 165u8, 207u8, 37u8, 34u8, 201u8, 177u8, 71u8,
    150u8, 143u8, 49u8, 96u8, 22u8, 144u8, 78u8, 57u8, 203u8, 204u8, 108u8, 158u8, 189u8,
    165u8, 53u8, 184u8, 182u8, 47u8, 125u8,
]);
...
pub struct CompiledKernelOutputSymbolsRow {
    ///symbol_id
...
impl crate::typed::CellCodec for CompiledKernelOutputSymbolsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(CompiledKernelOutputSymbolsRow)),
            );
        };
            ...
            r#symbol_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(CompiledKernelOutputSymbolsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for CompiledKernelOutputSymbolsRow {
    fn append(
        &self,
    ...
    fn append_null(
        ...
        <u16 as crate::columnar::ArrowValue>::append_null(children[5usize].as_mut())?;
        <Vec<
            pse_ids::SemanticId,
...
pub type Row = CompiledKernelOutputSymbolsRow;
/// The concrete generated relation view.
pub type View<'a> = CompiledKernelOutputSymbolsView<'a>;
/// The concrete generated relation builder.
pub type Builder = CompiledKernelOutputSymbolsBuilder;
impl CompiledKernelOutputSymbolsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "compiled.kernel_output_symbols".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for CompiledKernelOutputSymbolsRow {
    type Builder = CompiledKernelOutputSymbolsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        CompiledKernelOutputSymbolsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        CompiledKernelOutputSymbolsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        116_232_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct CompiledKernelOutputSymbolsView<'a> {
...
impl<'a> CompiledKernelOutputSymbolsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<CompiledKernelOutputSymbolsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(CompiledKernelOutputSymbolsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<CompiledKernelOutputSymbolsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct CompiledKernelOutputSymbolsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl CompiledKernelOutputSymbolsBuilder {
    ...
    pub fn push(
        &mut self,
        row: CompiledKernelOutputSymbolsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &CompiledKernelOutputSymbolsView<'_>,
    ) -> Result<(), crate::RelationError> {
