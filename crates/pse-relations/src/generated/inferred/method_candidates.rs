...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    120u8, 142u8, 79u8, 125u8, 226u8, 52u8, 150u8, 173u8, 27u8, 250u8, 191u8, 130u8,
    141u8, 14u8, 241u8, 49u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "method_candidates";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    122u8, 119u8, 42u8, 158u8, 233u8, 114u8, 47u8, 131u8, 87u8, 113u8, 238u8, 225u8,
    36u8, 156u8, 200u8, 36u8, 146u8, 161u8, 217u8, 221u8, 241u8, 11u8, 78u8, 156u8, 67u8,
    133u8, 82u8, 125u8, 190u8, 201u8, 189u8, 234u8,
]);
...
pub struct InferredMethodCandidatesRow {
    ///requirement_id
...
impl crate::typed::CellCodec for InferredMethodCandidatesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMethodCandidatesRow)));
        };
            ...
            r#requirement_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMethodCandidatesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMethodCandidatesRow {
    fn append(
        &self,
...
pub type Row = InferredMethodCandidatesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMethodCandidatesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMethodCandidatesBuilder;
impl InferredMethodCandidatesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.method_candidates".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMethodCandidatesRow {
    type Builder = InferredMethodCandidatesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMethodCandidatesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMethodCandidatesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        77_800_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredMethodCandidatesView<'a> {
...
impl<'a> InferredMethodCandidatesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMethodCandidatesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMethodCandidatesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredMethodCandidatesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMethodCandidatesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMethodCandidatesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMethodCandidatesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMethodCandidatesView<'_>,
    ) -> Result<(), crate::RelationError> {
