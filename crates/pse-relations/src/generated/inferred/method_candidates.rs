...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    11u8, 230u8, 101u8, 70u8, 206u8, 200u8, 90u8, 59u8, 66u8, 73u8, 117u8, 43u8, 208u8,
    160u8, 16u8, 131u8, 231u8, 115u8, 157u8, 76u8, 232u8, 191u8, 6u8, 47u8, 152u8, 13u8,
    0u8, 53u8, 178u8, 101u8, 107u8, 248u8,
]);
...
impl crate::columnar::RelationRow for InferredMethodCandidatesRow {
    ...
    fn builder_allocation_size() -> usize {
        80_696_usize + size_of::<Self::Builder>()
    }
