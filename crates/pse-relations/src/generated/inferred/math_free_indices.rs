...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    194u8, 110u8, 36u8, 193u8, 86u8, 26u8, 129u8, 150u8, 246u8, 22u8, 72u8, 189u8, 119u8,
    142u8, 35u8, 24u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    58u8, 216u8, 128u8, 50u8, 149u8, 212u8, 148u8, 224u8, 195u8, 230u8, 109u8, 108u8,
    180u8, 49u8, 193u8, 177u8, 57u8, 70u8, 220u8, 192u8, 184u8, 201u8, 226u8, 11u8, 27u8,
    239u8, 156u8, 236u8, 217u8, 174u8, 165u8, 195u8,
]);
...
pub struct InferredMathFreeIndicesRow {
    ///indexed_equation_id
...
impl crate::typed::CellCodec for InferredMathFreeIndicesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathFreeIndicesRow)));
        };
            ...
            r#indexed_equation_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathFreeIndicesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathFreeIndicesRow {
    fn append(
        &self,
...
pub type Row = InferredMathFreeIndicesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathFreeIndicesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathFreeIndicesBuilder;
impl InferredMathFreeIndicesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_free_indices".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathFreeIndicesRow {
    type Builder = InferredMathFreeIndicesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathFreeIndicesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathFreeIndicesView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredMathFreeIndicesView<'a> {
...
impl<'a> InferredMathFreeIndicesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathFreeIndicesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathFreeIndicesRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredMathFreeIndicesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathFreeIndicesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathFreeIndicesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMathFreeIndicesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathFreeIndicesView<'_>,
    ) -> Result<(), crate::RelationError> {
