...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    240u8, 170u8, 7u8, 26u8, 255u8, 23u8, 129u8, 241u8, 27u8, 148u8, 147u8, 102u8, 15u8,
    224u8, 233u8, 147u8, 88u8, 5u8, 102u8, 169u8, 9u8, 122u8, 165u8, 34u8, 224u8, 201u8,
    137u8, 109u8, 223u8, 39u8, 29u8, 190u8,
]);
...
impl crate::columnar::RelationRow for InferredBoundaryCrossingsRow {
    ...
    fn builder_allocation_size() -> usize {
        51_960_usize + size_of::<Self::Builder>()
    }
