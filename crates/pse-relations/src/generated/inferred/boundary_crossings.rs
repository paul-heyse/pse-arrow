...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    58u8, 160u8, 67u8, 63u8, 108u8, 197u8, 187u8, 86u8, 33u8, 162u8, 242u8, 184u8, 137u8,
    9u8, 121u8, 37u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    102u8, 187u8, 87u8, 77u8, 205u8, 71u8, 35u8, 118u8, 168u8, 39u8, 210u8, 234u8, 125u8,
    45u8, 202u8, 209u8, 193u8, 111u8, 196u8, 158u8, 10u8, 45u8, 60u8, 203u8, 28u8, 50u8,
    237u8, 225u8, 240u8, 79u8, 211u8, 136u8,
]);
...
impl crate::columnar::ArrowValue for InferredBoundaryCrossingsRow {
    fn append(
        &self,
...
impl crate::columnar::RelationRow for InferredBoundaryCrossingsRow {
    type Builder = InferredBoundaryCrossingsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredBoundaryCrossingsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredBoundaryCrossingsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        51_496_usize + size_of::<Self::Builder>()
    }
...
impl<'a> InferredBoundaryCrossingsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredBoundaryCrossingsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredBoundaryCrossingsRow {
...
impl InferredBoundaryCrossingsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredBoundaryCrossingsView<'_>,
    ) -> Result<(), crate::RelationError> {
