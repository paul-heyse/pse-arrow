...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    92u8, 212u8, 211u8, 233u8, 222u8, 202u8, 216u8, 149u8, 134u8, 6u8, 42u8, 118u8,
    100u8, 27u8, 84u8, 163u8, 125u8, 181u8, 137u8, 240u8, 193u8, 91u8, 65u8, 161u8,
    164u8, 208u8, 139u8, 160u8, 124u8, 109u8, 204u8, 213u8,
]);
...
impl crate::columnar::RelationRow for InferredInstanceReachabilityRow {
    ...
    fn builder_allocation_size() -> usize {
        39_496_usize + size_of::<Self::Builder>()
    }
