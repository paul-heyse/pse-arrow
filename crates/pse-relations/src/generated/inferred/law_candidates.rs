...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    142u8, 131u8, 165u8, 21u8, 100u8, 100u8, 204u8, 175u8, 206u8, 84u8, 86u8, 251u8,
    77u8, 174u8, 7u8, 128u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "law_candidates";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    172u8, 247u8, 90u8, 135u8, 73u8, 90u8, 207u8, 81u8, 140u8, 207u8, 200u8, 230u8,
    176u8, 122u8, 83u8, 111u8, 43u8, 203u8, 19u8, 247u8, 9u8, 205u8, 213u8, 234u8, 44u8,
    29u8, 8u8, 173u8, 192u8, 82u8, 226u8, 196u8,
]);
...
pub struct InferredLawCandidatesRow {
    ///application_id
...
impl crate::typed::CellCodec for InferredLawCandidatesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredLawCandidatesRow)));
        };
            ...
            r#application_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredLawCandidatesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredLawCandidatesRow {
    fn append(
        &self,
...
pub type Row = InferredLawCandidatesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredLawCandidatesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredLawCandidatesBuilder;
impl InferredLawCandidatesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.law_candidates".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredLawCandidatesRow {
    type Builder = InferredLawCandidatesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredLawCandidatesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredLawCandidatesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        37_344_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredLawCandidatesView<'a> {
...
impl<'a> InferredLawCandidatesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredLawCandidatesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredLawCandidatesRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredLawCandidatesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredLawCandidatesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredLawCandidatesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredLawCandidatesView<'_>,
    ) -> Result<(), crate::RelationError> {
