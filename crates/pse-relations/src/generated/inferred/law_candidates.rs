...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    145u8, 212u8, 212u8, 1u8, 112u8, 60u8, 96u8, 199u8, 198u8, 34u8, 3u8, 158u8, 179u8,
    235u8, 48u8, 77u8, 162u8, 65u8, 117u8, 93u8, 240u8, 169u8, 29u8, 203u8, 148u8, 70u8,
    134u8, 4u8, 8u8, 54u8, 126u8, 193u8,
]);
...
impl crate::columnar::RelationRow for InferredLawCandidatesRow {
    ...
    fn builder_allocation_size() -> usize {
        37_808_usize + size_of::<Self::Builder>()
    }
