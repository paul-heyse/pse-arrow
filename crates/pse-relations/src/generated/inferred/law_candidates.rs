...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    10u8, 158u8, 75u8, 82u8, 16u8, 36u8, 88u8, 167u8, 0u8, 87u8, 104u8, 177u8, 4u8,
    243u8, 229u8, 83u8, 130u8, 240u8, 117u8, 153u8, 204u8, 110u8, 111u8, 9u8, 109u8, 0u8,
    36u8, 29u8, 229u8, 148u8, 29u8, 170u8,
]);
...
impl crate::columnar::RelationRow for InferredLawCandidatesRow {
    ...
    fn builder_allocation_size() -> usize {
        39_568_usize + size_of::<Self::Builder>()
    }
