...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    201u8, 140u8, 87u8, 74u8, 91u8, 82u8, 225u8, 202u8, 206u8, 150u8, 8u8, 226u8, 113u8,
    214u8, 137u8, 217u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    249u8, 83u8, 42u8, 86u8, 19u8, 208u8, 182u8, 148u8, 126u8, 104u8, 111u8, 164u8,
    184u8, 241u8, 154u8, 50u8, 100u8, 215u8, 56u8, 152u8, 237u8, 240u8, 167u8, 97u8,
    22u8, 206u8, 103u8, 57u8, 180u8, 34u8, 49u8, 218u8,
]);
...
pub struct InferredMathConditionalsRow {
    ///node_id
    pub r#node_id: u64,
    ///guard_node_id
    pub r#guard_node_id: u64,
}
impl crate::typed::CellCodec for InferredMathConditionalsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathConditionalsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathConditionalsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathConditionalsRow {
    fn append(
        &self,
...
pub type Row = InferredMathConditionalsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathConditionalsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathConditionalsBuilder;
impl InferredMathConditionalsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_conditionals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathConditionalsRow {
    type Builder = InferredMathConditionalsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathConditionalsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathConditionalsView::from_checked(batch)?.rows()
    }
...
impl<'a> InferredMathConditionalsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathConditionalsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathConditionalsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredMathConditionalsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathConditionalsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathConditionalsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMathConditionalsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathConditionalsView<'_>,
    ) -> Result<(), crate::RelationError> {
