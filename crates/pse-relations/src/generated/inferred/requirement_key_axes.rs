...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    185u8, 66u8, 233u8, 13u8, 161u8, 39u8, 84u8, 148u8, 114u8, 5u8, 29u8, 119u8, 125u8,
    66u8, 171u8, 109u8, 221u8, 1u8, 248u8, 161u8, 119u8, 75u8, 228u8, 249u8, 114u8, 11u8,
    168u8, 94u8, 225u8, 74u8, 68u8, 113u8,
]);
...
impl crate::columnar::RelationRow for InferredRequirementKeyAxesRow {
    ...
    fn builder_allocation_size() -> usize {
        85_152_usize + size_of::<Self::Builder>()
    }
