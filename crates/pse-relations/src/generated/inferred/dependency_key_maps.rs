...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    212u8, 65u8, 139u8, 29u8, 205u8, 170u8, 95u8, 73u8, 202u8, 175u8, 153u8, 142u8,
    206u8, 95u8, 148u8, 53u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "dependency_key_maps";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    219u8, 16u8, 44u8, 208u8, 27u8, 102u8, 150u8, 133u8, 130u8, 34u8, 186u8, 56u8, 252u8,
    100u8, 152u8, 9u8, 48u8, 187u8, 128u8, 64u8, 202u8, 182u8, 116u8, 100u8, 18u8, 243u8,
    127u8, 52u8, 204u8, 191u8, 182u8, 22u8,
]);
...
pub struct InferredDependencyKeyMapsRow {
    ///requirement_id
    ...
    pub r#target_requirement_id: pse_ids::SemanticId,
    ///Actual rule or structural source derivation.
    pub r#derivation_id: pse_ids::SemanticId,
}
impl crate::typed::CellCodec for InferredDependencyKeyMapsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#target_requirement_id),
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredDependencyKeyMapsRow)));
        };
        ...
        Ok(Self {
            r#requirement_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredDependencyKeyMapsRow),
                    ))?,
            )?,
            ...
            r#target_requirement_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredDependencyKeyMapsRow),
...
impl crate::columnar::ArrowValue for InferredDependencyKeyMapsRow {
    fn append(
        &self,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#target_requirement_id: <pse_ids::SemanticId as crate::columnar::ArrowValue>::read(
...
pub type Row = InferredDependencyKeyMapsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredDependencyKeyMapsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredDependencyKeyMapsBuilder;
impl InferredDependencyKeyMapsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.dependency_key_maps".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredDependencyKeyMapsRow {
    type Builder = InferredDependencyKeyMapsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredDependencyKeyMapsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredDependencyKeyMapsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        55_096_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredDependencyKeyMapsView<'a> {
    ...
    target_requirement_id_column: &'a arrow_array::FixedSizeBinaryArray,
    derivation_id_column: &'a arrow_array::FixedSizeBinaryArray,
}
impl<'a> InferredDependencyKeyMapsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            target_requirement_id_column: crate::columnar::array::<
                arrow_array::FixedSizeBinaryArray,
    ...
    pub const fn target_requirement_id_column(
        &self,
    ) -> &'a arrow_array::FixedSizeBinaryArray {
        self.target_requirement_id_column
    }
    #[doc = concat!(
        "Borrows the exact declared field for `",
        "target_requirement_id",
    ...
    pub fn target_requirement_id_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredDependencyKeyMapsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredDependencyKeyMapsRow {
            ...
            r#target_requirement_id: crate::columnar::ArrowValue::read(
                self.target_requirement_id_column,
                index,
            )?,
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredDependencyKeyMapsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredDependencyKeyMapsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredDependencyKeyMapsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredDependencyKeyMapsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredDependencyKeyMapsView<'_>,
    ) -> Result<(), crate::RelationError> {
