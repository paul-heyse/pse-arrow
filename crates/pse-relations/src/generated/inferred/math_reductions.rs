...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    161u8, 185u8, 113u8, 248u8, 72u8, 133u8, 249u8, 201u8, 123u8, 109u8, 252u8, 202u8,
    68u8, 43u8, 201u8, 190u8, 114u8, 222u8, 18u8, 0u8, 171u8, 157u8, 154u8, 215u8, 137u8,
    135u8, 185u8, 101u8, 209u8, 251u8, 193u8, 234u8,
]);
