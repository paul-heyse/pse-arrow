...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    172u8, 147u8, 177u8, 246u8, 36u8, 143u8, 114u8, 99u8, 79u8, 248u8, 23u8, 18u8, 212u8,
    203u8, 31u8, 202u8, 28u8, 15u8, 239u8, 137u8, 19u8, 60u8, 137u8, 255u8, 144u8, 70u8,
    35u8, 178u8, 233u8, 2u8, 250u8, 243u8,
]);
