...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    82u8, 149u8, 253u8, 64u8, 87u8, 193u8, 70u8, 32u8, 144u8, 157u8, 17u8, 26u8, 24u8,
    252u8, 243u8, 22u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_member_candidates";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    145u8, 140u8, 103u8, 56u8, 72u8, 191u8, 32u8, 108u8, 153u8, 180u8, 35u8, 188u8,
    219u8, 149u8, 144u8, 79u8, 138u8, 93u8, 111u8, 77u8, 117u8, 217u8, 36u8, 93u8, 134u8,
    116u8, 77u8, 130u8, 56u8, 144u8, 56u8, 168u8,
]);
...
pub struct InferredPortMemberCandidatesRow {
    ///port_id
...
impl crate::typed::CellCodec for InferredPortMemberCandidatesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredPortMemberCandidatesRow)),
            );
        };
            ...
            r#port_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredPortMemberCandidatesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredPortMemberCandidatesRow {
    fn append(
        &self,
...
pub type Row = InferredPortMemberCandidatesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredPortMemberCandidatesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredPortMemberCandidatesBuilder;
impl InferredPortMemberCandidatesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.port_member_candidates".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredPortMemberCandidatesRow {
    type Builder = InferredPortMemberCandidatesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredPortMemberCandidatesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredPortMemberCandidatesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        59_968_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredPortMemberCandidatesView<'a> {
...
impl<'a> InferredPortMemberCandidatesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredPortMemberCandidatesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredPortMemberCandidatesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredPortMemberCandidatesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredPortMemberCandidatesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredPortMemberCandidatesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredPortMemberCandidatesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredPortMemberCandidatesView<'_>,
    ) -> Result<(), crate::RelationError> {
