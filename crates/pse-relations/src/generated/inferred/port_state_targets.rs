...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    168u8, 98u8, 139u8, 64u8, 36u8, 89u8, 134u8, 37u8, 107u8, 216u8, 80u8, 6u8, 177u8,
    225u8, 14u8, 111u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_state_targets";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    51u8, 81u8, 57u8, 120u8, 251u8, 234u8, 113u8, 144u8, 84u8, 177u8, 230u8, 14u8, 26u8,
    179u8, 166u8, 186u8, 207u8, 131u8, 149u8, 132u8, 27u8, 70u8, 119u8, 89u8, 110u8,
    121u8, 47u8, 181u8, 121u8, 183u8, 184u8, 31u8,
]);
...
pub struct InferredPortStateTargetsRow {
    ///port_id
...
impl crate::typed::CellCodec for InferredPortStateTargetsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredPortStateTargetsRow)));
        };
            ...
            r#port_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredPortStateTargetsRow),
                    ))?,
            )?,
            r#state_index: <Vec<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for InferredPortStateTargetsRow {
    fn append(
        &self,
...
pub type Row = InferredPortStateTargetsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredPortStateTargetsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredPortStateTargetsBuilder;
impl InferredPortStateTargetsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.port_state_targets".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredPortStateTargetsRow {
    type Builder = InferredPortStateTargetsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredPortStateTargetsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredPortStateTargetsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        55_336_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredPortStateTargetsView<'a> {
...
impl<'a> InferredPortStateTargetsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredPortStateTargetsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredPortStateTargetsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredPortStateTargetsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredPortStateTargetsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredPortStateTargetsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredPortStateTargetsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredPortStateTargetsView<'_>,
    ) -> Result<(), crate::RelationError> {
