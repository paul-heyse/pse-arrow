...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    229u8, 139u8, 88u8, 138u8, 172u8, 39u8, 15u8, 81u8, 209u8, 214u8, 61u8, 51u8, 176u8,
    75u8, 218u8, 115u8, 69u8, 50u8, 3u8, 49u8, 105u8, 119u8, 234u8, 43u8, 189u8, 6u8,
    249u8, 18u8, 78u8, 191u8, 92u8, 59u8,
]);
...
impl crate::columnar::RelationRow for InferredPortStateTargetsRow {
    ...
    fn builder_allocation_size() -> usize {
        53_576_usize + size_of::<Self::Builder>()
    }
