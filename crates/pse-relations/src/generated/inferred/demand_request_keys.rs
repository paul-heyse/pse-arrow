...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    27u8, 217u8, 140u8, 27u8, 45u8, 98u8, 7u8, 232u8, 235u8, 123u8, 15u8, 117u8, 141u8,
    89u8, 11u8, 253u8, 238u8, 175u8, 69u8, 73u8, 100u8, 73u8, 61u8, 252u8, 136u8, 197u8,
    180u8, 189u8, 84u8, 204u8, 85u8, 66u8,
]);
...
impl crate::columnar::RelationRow for InferredDemandRequestKeysRow {
    ...
    fn builder_allocation_size() -> usize {
        49_000_usize + size_of::<Self::Builder>()
    }
