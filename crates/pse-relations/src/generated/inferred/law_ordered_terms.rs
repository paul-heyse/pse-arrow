...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    205u8, 154u8, 88u8, 112u8, 113u8, 168u8, 154u8, 109u8, 79u8, 235u8, 239u8, 177u8,
    36u8, 59u8, 26u8, 243u8, 1u8, 221u8, 91u8, 177u8, 8u8, 218u8, 97u8, 164u8, 45u8,
    127u8, 175u8, 112u8, 67u8, 33u8, 113u8, 76u8,
]);
...
impl crate::columnar::RelationRow for InferredLawOrderedTermsRow {
    ...
    fn builder_allocation_size() -> usize {
        52_504_usize + size_of::<Self::Builder>()
    }
