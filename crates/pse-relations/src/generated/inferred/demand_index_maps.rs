...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    46u8, 236u8, 84u8, 2u8, 191u8, 172u8, 139u8, 170u8, 124u8, 138u8, 66u8, 72u8, 213u8,
    212u8, 185u8, 183u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "demand_index_maps";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    227u8, 22u8, 192u8, 172u8, 25u8, 236u8, 139u8, 83u8, 216u8, 210u8, 162u8, 120u8,
    117u8, 242u8, 21u8, 95u8, 7u8, 141u8, 139u8, 157u8, 146u8, 59u8, 181u8, 77u8, 167u8,
    54u8, 3u8, 227u8, 155u8, 35u8, 40u8, 86u8,
]);
...
pub struct InferredDemandIndexMapsRow {
    ///read_id
...
impl crate::typed::CellCodec for InferredDemandIndexMapsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredDemandIndexMapsRow)));
        };
            ...
            r#read_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredDemandIndexMapsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredDemandIndexMapsRow {
    fn append(
        &self,
...
pub type Row = InferredDemandIndexMapsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredDemandIndexMapsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredDemandIndexMapsBuilder;
impl InferredDemandIndexMapsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.demand_index_maps".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredDemandIndexMapsRow {
    type Builder = InferredDemandIndexMapsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredDemandIndexMapsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredDemandIndexMapsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        38_192_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredDemandIndexMapsView<'a> {
...
impl<'a> InferredDemandIndexMapsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredDemandIndexMapsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredDemandIndexMapsRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredDemandIndexMapsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredDemandIndexMapsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredDemandIndexMapsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredDemandIndexMapsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredDemandIndexMapsView<'_>,
    ) -> Result<(), crate::RelationError> {
