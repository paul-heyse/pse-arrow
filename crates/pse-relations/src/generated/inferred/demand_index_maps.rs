...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    244u8, 66u8, 103u8, 45u8, 193u8, 15u8, 89u8, 182u8, 240u8, 162u8, 55u8, 89u8, 183u8,
    116u8, 39u8, 252u8, 231u8, 249u8, 249u8, 2u8, 27u8, 123u8, 53u8, 177u8, 4u8, 228u8,
    42u8, 91u8, 192u8, 26u8, 148u8, 225u8,
]);
...
impl crate::columnar::RelationRow for InferredDemandIndexMapsRow {
    ...
    fn builder_allocation_size() -> usize {
        39_952_usize + size_of::<Self::Builder>()
    }
