...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    102u8, 122u8, 63u8, 215u8, 96u8, 175u8, 28u8, 81u8, 238u8, 210u8, 129u8, 53u8, 68u8,
    251u8, 70u8, 16u8, 100u8, 23u8, 255u8, 197u8, 204u8, 138u8, 61u8, 238u8, 43u8, 191u8,
    107u8, 110u8, 205u8, 212u8, 138u8, 131u8,
]);
...
impl crate::columnar::RelationRow for InferredLawAxesRow {
    ...
    fn builder_allocation_size() -> usize {
        53_760_usize + size_of::<Self::Builder>()
    }
