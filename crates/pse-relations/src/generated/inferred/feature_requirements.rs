...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    43u8, 17u8, 249u8, 40u8, 175u8, 91u8, 128u8, 74u8, 219u8, 217u8, 177u8, 83u8, 211u8,
    160u8, 23u8, 218u8, 244u8, 98u8, 84u8, 241u8, 135u8, 124u8, 173u8, 203u8, 224u8,
    238u8, 230u8, 1u8, 138u8, 222u8, 15u8, 30u8,
]);
...
impl crate::columnar::RelationRow for InferredFeatureRequirementsRow {
    ...
    fn builder_allocation_size() -> usize {
        34_440_usize + size_of::<Self::Builder>()
    }
