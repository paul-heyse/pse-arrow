...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    125u8, 153u8, 39u8, 85u8, 164u8, 198u8, 137u8, 22u8, 179u8, 237u8, 108u8, 138u8,
    56u8, 218u8, 45u8, 98u8, 157u8, 133u8, 75u8, 127u8, 85u8, 78u8, 221u8, 157u8, 68u8,
    239u8, 207u8, 208u8, 99u8, 161u8, 239u8, 151u8,
]);
...
impl crate::columnar::RelationRow for InferredSelectorDecisionsRow {
    ...
    fn builder_allocation_size() -> usize {
        53_776_usize + size_of::<Self::Builder>()
    }
