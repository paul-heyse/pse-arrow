...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    217u8, 117u8, 120u8, 88u8, 105u8, 90u8, 192u8, 76u8, 83u8, 8u8, 9u8, 38u8, 25u8,
    167u8, 242u8, 68u8, 255u8, 253u8, 94u8, 77u8, 174u8, 242u8, 16u8, 204u8, 28u8, 180u8,
    122u8, 189u8, 216u8, 183u8, 139u8, 228u8,
]);
...
impl crate::columnar::RelationRow for InferredSelectorDecisionsRow {
    ...
    fn builder_allocation_size() -> usize {
        54_240_usize + size_of::<Self::Builder>()
    }
