...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    56u8, 23u8, 76u8, 67u8, 74u8, 5u8, 85u8, 173u8, 56u8, 184u8, 86u8, 116u8, 164u8,
    110u8, 202u8, 208u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "feature_checks";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    129u8, 147u8, 230u8, 155u8, 205u8, 191u8, 8u8, 92u8, 78u8, 235u8, 241u8, 224u8, 11u8,
    48u8, 198u8, 105u8, 3u8, 159u8, 182u8, 107u8, 235u8, 5u8, 199u8, 100u8, 134u8, 154u8,
    193u8, 35u8, 89u8, 197u8, 136u8, 137u8,
]);
...
pub struct InferredFeatureChecksRow {
    ///instance_id
...
impl crate::typed::CellCodec for InferredFeatureChecksRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredFeatureChecksRow)));
        };
            ...
            r#instance_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredFeatureChecksRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredFeatureChecksRow {
    fn append(
        &self,
...
pub type Row = InferredFeatureChecksRow;
/// The concrete generated relation view.
pub type View<'a> = InferredFeatureChecksView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredFeatureChecksBuilder;
impl InferredFeatureChecksRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.feature_checks".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredFeatureChecksRow {
    type Builder = InferredFeatureChecksBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredFeatureChecksBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredFeatureChecksView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        52_656_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredFeatureChecksView<'a> {
...
impl<'a> InferredFeatureChecksView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredFeatureChecksRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredFeatureChecksRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredFeatureChecksRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredFeatureChecksBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredFeatureChecksBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredFeatureChecksView<'_>,
    ) -> Result<(), crate::RelationError> {
