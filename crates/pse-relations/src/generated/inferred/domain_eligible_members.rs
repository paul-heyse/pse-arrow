...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    68u8, 41u8, 191u8, 23u8, 103u8, 115u8, 159u8, 59u8, 184u8, 178u8, 14u8, 79u8, 71u8,
    126u8, 61u8, 198u8, 254u8, 228u8, 85u8, 12u8, 87u8, 14u8, 99u8, 46u8, 179u8, 49u8,
    226u8, 215u8, 185u8, 174u8, 85u8, 153u8,
]);
...
impl crate::columnar::RelationRow for InferredDomainEligibleMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        39_256_usize + size_of::<Self::Builder>()
    }
