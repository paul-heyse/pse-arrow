...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    233u8, 175u8, 194u8, 188u8, 105u8, 175u8, 28u8, 9u8, 95u8, 52u8, 104u8, 232u8, 252u8,
    224u8, 154u8, 24u8, 101u8, 203u8, 198u8, 38u8, 126u8, 178u8, 145u8, 118u8, 176u8,
    125u8, 124u8, 246u8, 140u8, 74u8, 248u8, 157u8,
]);
...
impl crate::columnar::RelationRow for InferredPhaseSpeciesRow {
    ...
    fn builder_allocation_size() -> usize {
        55_800_usize + size_of::<Self::Builder>()
    }
...
impl InferredPhaseSpeciesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredPhaseSpeciesView<'_>,
    ) -> Result<(), crate::RelationError> {
