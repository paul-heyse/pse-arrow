...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    6u8, 35u8, 245u8, 36u8, 252u8, 91u8, 85u8, 100u8, 106u8, 99u8, 199u8, 200u8, 252u8,
    223u8, 46u8, 4u8, 159u8, 217u8, 177u8, 91u8, 72u8, 250u8, 136u8, 137u8, 237u8, 128u8,
    147u8, 66u8, 39u8, 209u8, 181u8, 187u8,
]);
...
impl crate::columnar::RelationRow for InferredPhaseSpeciesRow {
    ...
    fn builder_allocation_size() -> usize {
        54_040_usize + size_of::<Self::Builder>()
    }
