...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    66u8, 18u8, 201u8, 181u8, 91u8, 200u8, 235u8, 192u8, 232u8, 240u8, 29u8, 52u8, 184u8,
    58u8, 87u8, 131u8, 9u8, 106u8, 228u8, 97u8, 177u8, 62u8, 24u8, 166u8, 49u8, 70u8,
    184u8, 74u8, 149u8, 136u8, 210u8, 89u8,
]);
...
impl crate::columnar::RelationRow for InferredLawEmptyApplicationsRow {
    ...
    fn builder_allocation_size() -> usize {
        26_328_usize + size_of::<Self::Builder>()
    }
