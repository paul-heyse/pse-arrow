...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    186u8, 14u8, 112u8, 73u8, 116u8, 9u8, 73u8, 82u8, 229u8, 114u8, 44u8, 101u8, 100u8,
    159u8, 61u8, 255u8, 201u8, 86u8, 132u8, 100u8, 243u8, 178u8, 115u8, 32u8, 129u8,
    41u8, 91u8, 244u8, 152u8, 67u8, 51u8, 154u8,
]);
...
impl crate::columnar::RelationRow for InferredRequirementSupportRow {
    ...
    fn builder_allocation_size() -> usize {
        51_224_usize + size_of::<Self::Builder>()
    }
