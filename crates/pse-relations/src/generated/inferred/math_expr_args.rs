...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    206u8, 38u8, 18u8, 236u8, 146u8, 39u8, 26u8, 111u8, 16u8, 215u8, 177u8, 179u8, 94u8,
    189u8, 239u8, 122u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    215u8, 184u8, 150u8, 120u8, 117u8, 151u8, 40u8, 241u8, 39u8, 32u8, 179u8, 203u8,
    49u8, 146u8, 107u8, 5u8, 39u8, 41u8, 71u8, 46u8, 132u8, 196u8, 225u8, 252u8, 159u8,
    38u8, 138u8, 196u8, 155u8, 169u8, 47u8, 46u8,
]);
...
pub struct InferredMathExprArgsRow {
    ///parent_node_id
...
impl crate::typed::CellCodec for InferredMathExprArgsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathExprArgsRow)));
        };
            ...
            r#parent_node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathExprArgsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathExprArgsRow {
    fn append(
        &self,
...
pub type Row = InferredMathExprArgsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathExprArgsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathExprArgsBuilder;
impl InferredMathExprArgsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_expr_args".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathExprArgsRow {
    type Builder = InferredMathExprArgsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathExprArgsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathExprArgsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredMathExprArgsView<'a> {
...
impl<'a> InferredMathExprArgsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathExprArgsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathExprArgsRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredMathExprArgsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathExprArgsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathExprArgsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathExprArgsView<'_>,
    ) -> Result<(), crate::RelationError> {
