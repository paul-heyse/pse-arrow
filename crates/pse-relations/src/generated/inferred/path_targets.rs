...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    147u8, 216u8, 243u8, 172u8, 106u8, 44u8, 60u8, 91u8, 103u8, 173u8, 246u8, 158u8,
    81u8, 110u8, 199u8, 62u8, 206u8, 254u8, 221u8, 131u8, 217u8, 125u8, 217u8, 171u8,
    192u8, 211u8, 58u8, 149u8, 31u8, 130u8, 213u8, 138u8,
]);
...
impl crate::columnar::RelationRow for InferredPathTargetsRow {
    ...
    fn builder_allocation_size() -> usize {
        144_032_usize + size_of::<Self::Builder>()
    }
