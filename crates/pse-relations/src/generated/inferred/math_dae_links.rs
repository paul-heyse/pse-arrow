...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    148u8, 111u8, 147u8, 36u8, 166u8, 229u8, 39u8, 68u8, 203u8, 232u8, 78u8, 23u8, 147u8,
    110u8, 24u8, 94u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    153u8, 8u8, 239u8, 31u8, 141u8, 51u8, 52u8, 25u8, 162u8, 47u8, 251u8, 158u8, 78u8,
    151u8, 102u8, 52u8, 45u8, 117u8, 85u8, 154u8, 102u8, 139u8, 17u8, 108u8, 10u8, 74u8,
    171u8, 39u8, 222u8, 229u8, 243u8, 107u8,
]);
...
pub struct InferredMathDaeLinksRow {
...
impl crate::typed::CellCodec for InferredMathDaeLinksRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathDaeLinksRow)));
        };
...
impl crate::columnar::ArrowValue for InferredMathDaeLinksRow {
    fn append(
        &self,
...
pub type Row = InferredMathDaeLinksRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathDaeLinksView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathDaeLinksBuilder;
impl InferredMathDaeLinksRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_dae_links".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathDaeLinksRow {
    type Builder = InferredMathDaeLinksBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathDaeLinksBuilder::with_registry(registry, capacity)
    }
...
#[derive(Debug)]
pub struct InferredMathDaeLinksView<'a> {
...
impl<'a> InferredMathDaeLinksView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathDaeLinksRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathDaeLinksRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredMathDaeLinksRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathDaeLinksBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathDaeLinksBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathDaeLinksView<'_>,
    ) -> Result<(), crate::RelationError> {
