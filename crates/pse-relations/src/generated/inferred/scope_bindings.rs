...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    127u8, 129u8, 49u8, 40u8, 70u8, 102u8, 4u8, 150u8, 247u8, 32u8, 53u8, 170u8, 225u8,
    203u8, 184u8, 148u8, 192u8, 21u8, 237u8, 170u8, 138u8, 20u8, 29u8, 77u8, 123u8,
    245u8, 148u8, 246u8, 141u8, 65u8, 58u8, 80u8,
]);
