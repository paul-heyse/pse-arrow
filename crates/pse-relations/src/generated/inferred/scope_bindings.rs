...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    199u8, 244u8, 176u8, 149u8, 138u8, 39u8, 156u8, 176u8, 93u8, 20u8, 9u8, 40u8, 128u8,
    8u8, 3u8, 203u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_bindings";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    82u8, 13u8, 60u8, 150u8, 138u8, 228u8, 84u8, 209u8, 121u8, 16u8, 238u8, 108u8, 144u8,
    64u8, 72u8, 99u8, 148u8, 195u8, 236u8, 34u8, 214u8, 249u8, 123u8, 17u8, 16u8, 226u8,
    218u8, 176u8, 96u8, 225u8, 194u8, 88u8,
]);
...
pub struct InferredScopeBindingsRow {
    ///scope_decl_id
...
impl crate::typed::CellCodec for InferredScopeBindingsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredScopeBindingsRow)));
        };
            ...
            r#scope_decl_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredScopeBindingsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredScopeBindingsRow {
    fn append(
        &self,
...
pub type Row = InferredScopeBindingsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredScopeBindingsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredScopeBindingsBuilder;
impl InferredScopeBindingsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.scope_bindings".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredScopeBindingsRow {
    type Builder = InferredScopeBindingsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredScopeBindingsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredScopeBindingsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        50_504_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredScopeBindingsView<'a> {
...
impl<'a> InferredScopeBindingsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredScopeBindingsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredScopeBindingsRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredScopeBindingsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredScopeBindingsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredScopeBindingsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredScopeBindingsView<'_>,
    ) -> Result<(), crate::RelationError> {
