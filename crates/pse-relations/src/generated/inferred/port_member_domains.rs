...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    247u8, 209u8, 200u8, 127u8, 159u8, 89u8, 114u8, 178u8, 157u8, 9u8, 205u8, 253u8,
    144u8, 207u8, 233u8, 13u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_member_domains";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    151u8, 185u8, 184u8, 12u8, 115u8, 3u8, 163u8, 248u8, 51u8, 190u8, 147u8, 99u8, 114u8,
    29u8, 168u8, 69u8, 252u8, 0u8, 128u8, 210u8, 12u8, 252u8, 174u8, 51u8, 23u8, 163u8,
    101u8, 14u8, 131u8, 174u8, 26u8, 77u8,
]);
...
pub struct InferredPortMemberDomainsRow {
    ///port_id
...
impl crate::typed::CellCodec for InferredPortMemberDomainsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredPortMemberDomainsRow)));
        };
            ...
            r#port_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredPortMemberDomainsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredPortMemberDomainsRow {
    fn append(
        &self,
...
pub type Row = InferredPortMemberDomainsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredPortMemberDomainsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredPortMemberDomainsBuilder;
impl InferredPortMemberDomainsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.port_member_domains".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredPortMemberDomainsRow {
    type Builder = InferredPortMemberDomainsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredPortMemberDomainsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredPortMemberDomainsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        67_560_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredPortMemberDomainsView<'a> {
...
impl<'a> InferredPortMemberDomainsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredPortMemberDomainsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredPortMemberDomainsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredPortMemberDomainsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredPortMemberDomainsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredPortMemberDomainsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredPortMemberDomainsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredPortMemberDomainsView<'_>,
    ) -> Result<(), crate::RelationError> {
