...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    23u8, 4u8, 77u8, 57u8, 86u8, 110u8, 71u8, 204u8, 158u8, 254u8, 213u8, 53u8, 113u8,
    71u8, 136u8, 161u8, 64u8, 131u8, 66u8, 28u8, 226u8, 108u8, 199u8, 173u8, 192u8, 67u8,
    4u8, 97u8, 219u8, 13u8, 65u8, 82u8,
]);
...
impl crate::columnar::RelationRow for InferredPortMemberDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_120_usize + size_of::<Self::Builder>()
    }
