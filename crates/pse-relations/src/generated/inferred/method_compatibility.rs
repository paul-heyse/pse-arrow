...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    103u8, 230u8, 48u8, 65u8, 150u8, 44u8, 204u8, 122u8, 46u8, 163u8, 209u8, 56u8, 0u8,
    110u8, 82u8, 203u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "method_compatibility";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    18u8, 163u8, 52u8, 116u8, 17u8, 144u8, 96u8, 223u8, 166u8, 240u8, 133u8, 20u8, 242u8,
    132u8, 221u8, 201u8, 57u8, 169u8, 176u8, 15u8, 184u8, 123u8, 133u8, 248u8, 238u8,
    251u8, 252u8, 117u8, 68u8, 45u8, 129u8, 130u8,
]);
...
pub struct InferredMethodCompatibilityRow {
    ///selection_id
...
impl crate::typed::CellCodec for InferredMethodCompatibilityRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredMethodCompatibilityRow)),
            );
        };
            ...
            r#selection_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMethodCompatibilityRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMethodCompatibilityRow {
    fn append(
        &self,
...
pub type Row = InferredMethodCompatibilityRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMethodCompatibilityView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMethodCompatibilityBuilder;
impl InferredMethodCompatibilityRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.method_compatibility".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMethodCompatibilityRow {
    type Builder = InferredMethodCompatibilityBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMethodCompatibilityBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMethodCompatibilityView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        60_864_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredMethodCompatibilityView<'a> {
...
impl<'a> InferredMethodCompatibilityView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMethodCompatibilityRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMethodCompatibilityRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredMethodCompatibilityRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMethodCompatibilityBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMethodCompatibilityBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMethodCompatibilityRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMethodCompatibilityView<'_>,
    ) -> Result<(), crate::RelationError> {
