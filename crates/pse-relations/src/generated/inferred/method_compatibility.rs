...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    112u8, 9u8, 130u8, 224u8, 112u8, 181u8, 27u8, 108u8, 211u8, 89u8, 124u8, 224u8,
    145u8, 12u8, 191u8, 42u8, 59u8, 154u8, 45u8, 241u8, 255u8, 57u8, 210u8, 162u8, 93u8,
    59u8, 192u8, 183u8, 225u8, 182u8, 178u8, 229u8,
]);
...
impl crate::columnar::RelationRow for InferredMethodCompatibilityRow {
    ...
    fn builder_allocation_size() -> usize {
        61_328_usize + size_of::<Self::Builder>()
    }
