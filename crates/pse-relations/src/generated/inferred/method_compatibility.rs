...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    71u8, 27u8, 166u8, 22u8, 248u8, 97u8, 102u8, 83u8, 3u8, 89u8, 128u8, 84u8, 30u8,
    164u8, 137u8, 72u8, 105u8, 253u8, 113u8, 242u8, 137u8, 214u8, 120u8, 199u8, 101u8,
    131u8, 162u8, 166u8, 3u8, 196u8, 246u8, 144u8,
]);
...
impl crate::columnar::RelationRow for InferredMethodCompatibilityRow {
    ...
    fn builder_allocation_size() -> usize {
        63_088_usize + size_of::<Self::Builder>()
    }
