...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    69u8, 4u8, 86u8, 135u8, 193u8, 43u8, 85u8, 162u8, 140u8, 99u8, 214u8, 251u8, 95u8,
    96u8, 166u8, 89u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "material_member_counts";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    100u8, 109u8, 95u8, 204u8, 121u8, 107u8, 25u8, 63u8, 173u8, 55u8, 241u8, 190u8,
    169u8, 239u8, 190u8, 148u8, 38u8, 58u8, 174u8, 238u8, 106u8, 198u8, 80u8, 197u8, 0u8,
    255u8, 236u8, 134u8, 65u8, 143u8, 247u8, 238u8,
]);
...
pub struct InferredMaterialMemberCountsRow {
    ///material_system_id
...
impl crate::typed::CellCodec for InferredMaterialMemberCountsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredMaterialMemberCountsRow)),
            );
        };
...
impl crate::columnar::ArrowValue for InferredMaterialMemberCountsRow {
    fn append(
        &self,
...
pub type Row = InferredMaterialMemberCountsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMaterialMemberCountsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMaterialMemberCountsBuilder;
impl InferredMaterialMemberCountsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.material_member_counts".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMaterialMemberCountsRow {
    type Builder = InferredMaterialMemberCountsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMaterialMemberCountsBuilder::with_registry(registry, capacity)
    }
    ...
    fn builder_allocation_size() -> usize {
        52_352_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredMaterialMemberCountsView<'a> {
...
impl<'a> InferredMaterialMemberCountsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMaterialMemberCountsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMaterialMemberCountsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredMaterialMemberCountsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMaterialMemberCountsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMaterialMemberCountsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMaterialMemberCountsView<'_>,
    ) -> Result<(), crate::RelationError> {
