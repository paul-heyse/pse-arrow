...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    194u8, 254u8, 29u8, 7u8, 234u8, 159u8, 160u8, 141u8, 92u8, 183u8, 54u8, 124u8, 126u8,
    167u8, 223u8, 217u8, 106u8, 137u8, 161u8, 250u8, 243u8, 240u8, 185u8, 153u8, 245u8,
    133u8, 126u8, 117u8, 193u8, 255u8, 232u8, 225u8,
]);
...
impl crate::columnar::RelationRow for InferredMaterialTemplateChecksRow {
    ...
    fn builder_allocation_size() -> usize {
        49_072_usize + size_of::<Self::Builder>()
    }
