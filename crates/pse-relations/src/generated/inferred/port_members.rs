...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    107u8, 126u8, 11u8, 242u8, 195u8, 73u8, 78u8, 149u8, 207u8, 113u8, 28u8, 236u8,
    238u8, 174u8, 255u8, 191u8, 132u8, 175u8, 182u8, 121u8, 80u8, 49u8, 89u8, 98u8, 94u8,
    220u8, 174u8, 181u8, 156u8, 193u8, 120u8, 178u8,
]);
...
impl crate::columnar::RelationRow for InferredPortMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        59_304_usize + size_of::<Self::Builder>()
    }
