...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    207u8, 248u8, 45u8, 70u8, 5u8, 35u8, 155u8, 116u8, 167u8, 113u8, 138u8, 25u8, 31u8,
    174u8, 104u8, 55u8, 97u8, 99u8, 154u8, 79u8, 15u8, 203u8, 113u8, 111u8, 187u8, 153u8,
    70u8, 208u8, 222u8, 121u8, 207u8, 159u8,
]);
...
impl crate::columnar::RelationRow for InferredPortMembersRow {
    ...
    fn builder_allocation_size() -> usize {
        62_664_usize + size_of::<Self::Builder>()
    }
