...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    255u8, 5u8, 223u8, 77u8, 155u8, 13u8, 114u8, 104u8, 162u8, 42u8, 34u8, 166u8, 236u8,
    17u8, 61u8, 145u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "demand_obligations";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    228u8, 194u8, 158u8, 72u8, 192u8, 169u8, 185u8, 170u8, 107u8, 236u8, 126u8, 109u8,
    181u8, 7u8, 238u8, 26u8, 244u8, 59u8, 134u8, 18u8, 244u8, 165u8, 10u8, 207u8, 240u8,
    7u8, 236u8, 39u8, 33u8, 34u8, 249u8, 112u8,
]);
...
pub struct InferredDemandObligationsRow {
    ///read_id
...
impl crate::typed::CellCodec for InferredDemandObligationsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredDemandObligationsRow)));
        };
            ...
            r#read_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredDemandObligationsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredDemandObligationsRow {
    fn append(
        &self,
...
pub type Row = InferredDemandObligationsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredDemandObligationsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredDemandObligationsBuilder;
impl InferredDemandObligationsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.demand_obligations".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredDemandObligationsRow {
    type Builder = InferredDemandObligationsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredDemandObligationsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredDemandObligationsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        70_560_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredDemandObligationsView<'a> {
...
impl<'a> InferredDemandObligationsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredDemandObligationsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredDemandObligationsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredDemandObligationsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredDemandObligationsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredDemandObligationsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredDemandObligationsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredDemandObligationsView<'_>,
    ) -> Result<(), crate::RelationError> {
