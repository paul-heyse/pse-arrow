...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    183u8, 90u8, 210u8, 214u8, 124u8, 135u8, 41u8, 220u8, 137u8, 34u8, 164u8, 172u8,
    160u8, 156u8, 109u8, 140u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "predicate_axes";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    214u8, 31u8, 205u8, 245u8, 54u8, 152u8, 124u8, 14u8, 137u8, 9u8, 95u8, 170u8, 169u8,
    209u8, 239u8, 132u8, 177u8, 114u8, 248u8, 248u8, 5u8, 107u8, 58u8, 167u8, 96u8, 84u8,
    122u8, 150u8, 219u8, 253u8, 49u8, 143u8,
]);
...
pub struct InferredPredicateAxesRow {
    ///source_id
...
impl crate::typed::CellCodec for InferredPredicateAxesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredPredicateAxesRow)));
        };
            ...
            r#source_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredPredicateAxesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredPredicateAxesRow {
    fn append(
        &self,
...
pub type Row = InferredPredicateAxesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredPredicateAxesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredPredicateAxesBuilder;
impl InferredPredicateAxesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.predicate_axes".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredPredicateAxesRow {
    type Builder = InferredPredicateAxesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredPredicateAxesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredPredicateAxesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        49_392_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredPredicateAxesView<'a> {
...
impl<'a> InferredPredicateAxesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredPredicateAxesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredPredicateAxesRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredPredicateAxesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredPredicateAxesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredPredicateAxesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredPredicateAxesView<'_>,
    ) -> Result<(), crate::RelationError> {
