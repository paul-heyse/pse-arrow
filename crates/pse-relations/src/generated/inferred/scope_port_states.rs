...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    205u8, 192u8, 202u8, 155u8, 243u8, 14u8, 23u8, 30u8, 35u8, 149u8, 44u8, 10u8, 69u8,
    158u8, 48u8, 14u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_port_states";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    26u8, 177u8, 134u8, 192u8, 255u8, 252u8, 210u8, 166u8, 53u8, 65u8, 143u8, 129u8,
    41u8, 209u8, 96u8, 200u8, 24u8, 233u8, 250u8, 172u8, 123u8, 179u8, 46u8, 164u8, 4u8,
    76u8, 187u8, 48u8, 215u8, 110u8, 23u8, 249u8,
]);
...
pub struct InferredScopePortStatesRow {
    ///scope_id
...
impl crate::typed::CellCodec for InferredScopePortStatesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredScopePortStatesRow)));
        };
            ...
            r#scope_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredScopePortStatesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredScopePortStatesRow {
    fn append(
        &self,
...
pub type Row = InferredScopePortStatesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredScopePortStatesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredScopePortStatesBuilder;
impl InferredScopePortStatesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.scope_port_states".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredScopePortStatesRow {
    type Builder = InferredScopePortStatesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredScopePortStatesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredScopePortStatesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        53_360_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredScopePortStatesView<'a> {
...
impl<'a> InferredScopePortStatesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredScopePortStatesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredScopePortStatesRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredScopePortStatesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredScopePortStatesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredScopePortStatesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredScopePortStatesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredScopePortStatesView<'_>,
    ) -> Result<(), crate::RelationError> {
