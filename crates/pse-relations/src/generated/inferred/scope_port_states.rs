...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    109u8, 65u8, 27u8, 43u8, 44u8, 183u8, 239u8, 242u8, 194u8, 66u8, 174u8, 79u8, 147u8,
    255u8, 58u8, 40u8, 229u8, 50u8, 202u8, 17u8, 224u8, 27u8, 79u8, 204u8, 24u8, 184u8,
    214u8, 25u8, 222u8, 55u8, 95u8, 201u8,
]);
...
impl crate::columnar::RelationRow for InferredScopePortStatesRow {
    ...
    fn builder_allocation_size() -> usize {
        52_896_usize + size_of::<Self::Builder>()
    }
