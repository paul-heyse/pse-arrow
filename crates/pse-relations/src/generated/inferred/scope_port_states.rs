...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    209u8, 68u8, 8u8, 184u8, 202u8, 166u8, 33u8, 4u8, 139u8, 145u8, 207u8, 216u8, 49u8,
    219u8, 218u8, 105u8, 49u8, 230u8, 113u8, 118u8, 208u8, 232u8, 223u8, 42u8, 191u8,
    78u8, 86u8, 25u8, 9u8, 171u8, 116u8, 134u8,
]);
...
impl crate::columnar::RelationRow for InferredScopePortStatesRow {
    ...
    fn builder_allocation_size() -> usize {
        55_120_usize + size_of::<Self::Builder>()
    }
