...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    145u8, 127u8, 113u8, 91u8, 170u8, 95u8, 172u8, 157u8, 233u8, 119u8, 25u8, 36u8, 35u8,
    194u8, 80u8, 100u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    94u8, 196u8, 178u8, 202u8, 167u8, 168u8, 202u8, 167u8, 37u8, 147u8, 48u8, 93u8,
    208u8, 24u8, 158u8, 188u8, 54u8, 154u8, 228u8, 214u8, 128u8, 209u8, 139u8, 201u8,
    242u8, 63u8, 12u8, 135u8, 29u8, 15u8, 108u8, 100u8,
]);
...
pub struct InferredMathSmoothOpsRow {
    ///node_id
    pub r#node_id: u64,
    ///eps
    pub r#eps: f64,
...
impl crate::typed::CellCodec for InferredMathSmoothOpsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathSmoothOpsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathSmoothOpsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathSmoothOpsRow {
    fn append(
        &self,
...
pub type Row = InferredMathSmoothOpsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathSmoothOpsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathSmoothOpsBuilder;
impl InferredMathSmoothOpsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_smooth_ops".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathSmoothOpsRow {
    type Builder = InferredMathSmoothOpsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathSmoothOpsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathSmoothOpsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        41_384_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredMathSmoothOpsView<'a> {
...
impl<'a> InferredMathSmoothOpsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathSmoothOpsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathSmoothOpsRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredMathSmoothOpsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathSmoothOpsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathSmoothOpsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathSmoothOpsView<'_>,
    ) -> Result<(), crate::RelationError> {
