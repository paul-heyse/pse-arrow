...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    17u8, 147u8, 63u8, 114u8, 224u8, 14u8, 97u8, 17u8, 200u8, 35u8, 110u8, 133u8, 86u8,
    23u8, 177u8, 195u8, 153u8, 198u8, 234u8, 7u8, 234u8, 38u8, 25u8, 222u8, 63u8, 254u8,
    91u8, 109u8, 149u8, 207u8, 234u8, 188u8,
]);
...
impl crate::columnar::RelationRow for InferredMathSmoothOpsRow {
    ...
    fn builder_allocation_size() -> usize {
        40_920_usize + size_of::<Self::Builder>()
    }
