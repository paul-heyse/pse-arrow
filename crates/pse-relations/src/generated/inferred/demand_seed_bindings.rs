...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    218u8, 137u8, 155u8, 132u8, 90u8, 30u8, 239u8, 168u8, 103u8, 147u8, 204u8, 84u8,
    213u8, 152u8, 200u8, 88u8, 12u8, 43u8, 39u8, 12u8, 181u8, 64u8, 39u8, 95u8, 73u8,
    172u8, 248u8, 236u8, 151u8, 206u8, 143u8, 19u8,
]);
...
impl crate::columnar::RelationRow for InferredDemandSeedBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        107_696_usize + size_of::<Self::Builder>()
    }
