...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    45u8, 44u8, 3u8, 123u8, 114u8, 185u8, 14u8, 87u8, 195u8, 22u8, 213u8, 24u8, 100u8,
    224u8, 188u8, 202u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "demand_seed_bindings";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    158u8, 101u8, 221u8, 103u8, 54u8, 233u8, 251u8, 74u8, 51u8, 185u8, 67u8, 205u8,
    105u8, 161u8, 55u8, 229u8, 111u8, 254u8, 124u8, 224u8, 70u8, 21u8, 131u8, 238u8,
    46u8, 37u8, 40u8, 222u8, 90u8, 157u8, 193u8, 38u8,
]);
...
pub struct InferredDemandSeedBindingsRow {
    ///read_id
...
impl crate::typed::CellCodec for InferredDemandSeedBindingsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredDemandSeedBindingsRow)),
            );
        };
            ...
            r#read_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredDemandSeedBindingsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredDemandSeedBindingsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#index, children[7usize].as_mut())?;
        crate::columnar::ArrowValue::append(
...
pub type Row = InferredDemandSeedBindingsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredDemandSeedBindingsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredDemandSeedBindingsBuilder;
impl InferredDemandSeedBindingsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.demand_seed_bindings".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredDemandSeedBindingsRow {
    type Builder = InferredDemandSeedBindingsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredDemandSeedBindingsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredDemandSeedBindingsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        109_456_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredDemandSeedBindingsView<'a> {
...
impl<'a> InferredDemandSeedBindingsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredDemandSeedBindingsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredDemandSeedBindingsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredDemandSeedBindingsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredDemandSeedBindingsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredDemandSeedBindingsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredDemandSeedBindingsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredDemandSeedBindingsView<'_>,
    ) -> Result<(), crate::RelationError> {
