...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    58u8, 73u8, 121u8, 48u8, 189u8, 83u8, 153u8, 71u8, 200u8, 62u8, 232u8, 120u8, 9u8,
    64u8, 104u8, 202u8, 136u8, 86u8, 166u8, 43u8, 148u8, 24u8, 249u8, 136u8, 174u8,
    178u8, 188u8, 61u8, 14u8, 0u8, 117u8, 242u8,
]);
...
impl crate::columnar::RelationRow for InferredDemandSeedBindingsRow {
    ...
    fn builder_allocation_size() -> usize {
        107_232_usize + size_of::<Self::Builder>()
    }
