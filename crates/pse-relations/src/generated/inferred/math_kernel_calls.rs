...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    2u8, 8u8, 62u8, 146u8, 77u8, 236u8, 82u8, 89u8, 85u8, 94u8, 40u8, 103u8, 2u8, 65u8,
    168u8, 96u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    78u8, 222u8, 142u8, 102u8, 160u8, 16u8, 207u8, 173u8, 145u8, 164u8, 62u8, 223u8,
    178u8, 242u8, 244u8, 189u8, 143u8, 181u8, 33u8, 28u8, 10u8, 46u8, 52u8, 175u8, 186u8,
    229u8, 206u8, 60u8, 112u8, 244u8, 35u8, 101u8,
]);
...
pub struct InferredMathKernelCallsRow {
    ///node_id
    pub r#node_id: u64,
    ///kernel_binding_id
...
impl crate::typed::CellCodec for InferredMathKernelCallsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathKernelCallsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathKernelCallsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathKernelCallsRow {
    fn append(
        &self,
...
pub type Row = InferredMathKernelCallsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathKernelCallsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathKernelCallsBuilder;
impl InferredMathKernelCallsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_kernel_calls".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathKernelCallsRow {
    type Builder = InferredMathKernelCallsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathKernelCallsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathKernelCallsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredMathKernelCallsView<'a> {
...
impl<'a> InferredMathKernelCallsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathKernelCallsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathKernelCallsRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredMathKernelCallsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathKernelCallsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathKernelCallsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMathKernelCallsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathKernelCallsView<'_>,
    ) -> Result<(), crate::RelationError> {
