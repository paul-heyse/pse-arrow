...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    227u8, 66u8, 223u8, 164u8, 8u8, 64u8, 117u8, 80u8, 219u8, 140u8, 148u8, 114u8, 240u8,
    14u8, 30u8, 134u8, 110u8, 77u8, 175u8, 201u8, 167u8, 203u8, 158u8, 110u8, 66u8, 32u8,
    186u8, 15u8, 216u8, 40u8, 214u8, 91u8,
]);
...
impl crate::columnar::RelationRow for InferredValidIndexTuplesRow {
    ...
    fn builder_allocation_size() -> usize {
        44_496_usize + size_of::<Self::Builder>()
    }
