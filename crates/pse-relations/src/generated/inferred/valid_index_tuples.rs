...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    117u8, 218u8, 154u8, 121u8, 76u8, 246u8, 10u8, 169u8, 108u8, 226u8, 69u8, 36u8,
    168u8, 112u8, 162u8, 180u8, 61u8, 42u8, 135u8, 209u8, 64u8, 251u8, 186u8, 66u8,
    118u8, 105u8, 225u8, 233u8, 110u8, 87u8, 254u8, 84u8,
]);
...
impl crate::typed::CellCodec for InferredValidIndexTuplesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredValidIndexTuplesRow)));
        };
            ...
            r#product_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredValidIndexTuplesRow),
                    ))?,
            )?,
            r#tuple: <Vec<
                pse_ids::SemanticId,
...
impl InferredValidIndexTuplesRow {
...
impl crate::columnar::RelationRow for InferredValidIndexTuplesRow {
    ...
    fn builder_allocation_size() -> usize {
        44_960_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredValidIndexTuplesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredValidIndexTuplesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredValidIndexTuplesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredValidIndexTuplesView<'_>,
    ) -> Result<(), crate::RelationError> {
