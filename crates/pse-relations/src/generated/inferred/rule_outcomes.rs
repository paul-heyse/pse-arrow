...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    70u8, 69u8, 90u8, 148u8, 30u8, 177u8, 132u8, 232u8, 145u8, 22u8, 121u8, 176u8, 196u8,
    138u8, 172u8, 189u8, 28u8, 207u8, 122u8, 193u8, 3u8, 3u8, 19u8, 213u8, 91u8, 170u8,
    74u8, 247u8, 151u8, 83u8, 137u8, 211u8,
]);
...
impl crate::columnar::RelationRow for InferredRuleOutcomesRow {
    ...
    fn builder_allocation_size() -> usize {
        68_472_usize + size_of::<Self::Builder>()
    }
