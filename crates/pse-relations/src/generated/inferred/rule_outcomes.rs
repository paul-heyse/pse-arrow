...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    84u8, 157u8, 209u8, 30u8, 64u8, 1u8, 19u8, 82u8, 220u8, 139u8, 107u8, 82u8, 200u8,
    177u8, 205u8, 87u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "rule_outcomes";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    217u8, 160u8, 192u8, 34u8, 22u8, 98u8, 11u8, 121u8, 116u8, 161u8, 132u8, 4u8, 153u8,
    109u8, 215u8, 199u8, 212u8, 160u8, 234u8, 213u8, 167u8, 75u8, 233u8, 220u8, 18u8,
    174u8, 36u8, 84u8, 4u8, 170u8, 231u8, 58u8,
]);
...
pub struct InferredRuleOutcomesRow {
    ///rule_id
    ...
    ///reason
    pub r#reason: crate::generated::enums::RuleOutcomeReason,
}
impl crate::typed::CellCodec for InferredRuleOutcomesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredRuleOutcomesRow)));
        };
        ...
        Ok(Self {
            r#rule_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredRuleOutcomesRow),
                    ))?,
            )?,
            ...
            r#reason: <crate::generated::enums::RuleOutcomeReason as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredRuleOutcomesRow),
...
impl crate::columnar::ArrowValue for InferredRuleOutcomesRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#truth, children[3usize].as_mut())?;
    ...
    fn append_null(
        ...
        <crate::generated::enums::RuleOutcomeReason as crate::columnar::ArrowValue>::append_null(
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#reason: <crate::generated::enums::RuleOutcomeReason as crate::columnar::ArrowValue>::read(
...
pub type Row = InferredRuleOutcomesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredRuleOutcomesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredRuleOutcomesBuilder;
impl InferredRuleOutcomesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.rule_outcomes".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredRuleOutcomesRow {
    type Builder = InferredRuleOutcomesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredRuleOutcomesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredRuleOutcomesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        80_680_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredRuleOutcomesView<'a> {
...
impl<'a> InferredRuleOutcomesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredRuleOutcomesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredRuleOutcomesRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredRuleOutcomesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredRuleOutcomesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredRuleOutcomesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredRuleOutcomesView<'_>,
    ) -> Result<(), crate::RelationError> {
