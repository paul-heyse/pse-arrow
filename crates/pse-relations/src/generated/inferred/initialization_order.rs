...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    224u8, 86u8, 237u8, 11u8, 163u8, 44u8, 76u8, 128u8, 119u8, 146u8, 117u8, 236u8,
    106u8, 108u8, 214u8, 40u8, 235u8, 31u8, 52u8, 137u8, 215u8, 55u8, 39u8, 217u8, 162u8,
    228u8, 25u8, 211u8, 70u8, 92u8, 212u8, 195u8,
]);
...
impl crate::columnar::ArrowValue for InferredInitializationOrderRow {
    fn append(
        &self,
    ...
    fn read(
        ...
        Ok(Self {
            r#instance: <pse_ids::SemanticId as crate::columnar::ArrowValue>::read(
...
impl crate::columnar::RelationRow for InferredInitializationOrderRow {
    type Builder = InferredInitializationOrderBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredInitializationOrderBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredInitializationOrderView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        21_712_usize + size_of::<Self::Builder>()
    }
...
pub struct InferredInitializationOrderView<'a> {
    ...
    instance_column: &'a arrow_array::FixedSizeBinaryArray,
...
impl<'a> InferredInitializationOrderView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            batch,
            instance_column: crate::columnar::array::<
    ...
    pub const fn instance_column(&self) -> &'a arrow_array::FixedSizeBinaryArray {
        self.instance_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "instance", "`.")]
    pub fn instance_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredInitializationOrderRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredInitializationOrderRow {
            r#instance: crate::columnar::ArrowValue::read(self.instance_column, index)?,
...
impl InferredInitializationOrderBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredInitializationOrderView<'_>,
    ) -> Result<(), crate::RelationError> {
