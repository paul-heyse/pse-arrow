...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    15u8, 95u8, 143u8, 137u8, 132u8, 14u8, 210u8, 207u8, 64u8, 59u8, 36u8, 78u8, 134u8,
    80u8, 250u8, 168u8, 247u8, 144u8, 127u8, 178u8, 252u8, 193u8, 232u8, 28u8, 60u8,
    59u8, 226u8, 244u8, 10u8, 67u8, 126u8, 55u8,
]);
...
impl crate::columnar::RelationRow for InferredInvalidIndexTuplesRow {
    ...
    fn builder_allocation_size() -> usize {
        42_432_usize + size_of::<Self::Builder>()
    }
