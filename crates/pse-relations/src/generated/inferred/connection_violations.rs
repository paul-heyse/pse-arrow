...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    124u8, 140u8, 179u8, 53u8, 210u8, 144u8, 236u8, 54u8, 99u8, 34u8, 106u8, 235u8,
    123u8, 243u8, 178u8, 121u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "connection_violations";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    251u8, 101u8, 16u8, 214u8, 67u8, 165u8, 230u8, 202u8, 138u8, 129u8, 26u8, 54u8,
    155u8, 171u8, 177u8, 164u8, 111u8, 253u8, 234u8, 176u8, 68u8, 160u8, 168u8, 165u8,
    1u8, 237u8, 26u8, 253u8, 117u8, 217u8, 205u8, 123u8,
]);
...
pub struct InferredConnectionViolationsRow {
    ///connection_id
...
impl crate::typed::CellCodec for InferredConnectionViolationsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredConnectionViolationsRow)),
            );
        };
            ...
            r#connection_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredConnectionViolationsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredConnectionViolationsRow {
    fn append(
        &self,
...
pub type Row = InferredConnectionViolationsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredConnectionViolationsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredConnectionViolationsBuilder;
impl InferredConnectionViolationsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.connection_violations".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredConnectionViolationsRow {
    type Builder = InferredConnectionViolationsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredConnectionViolationsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredConnectionViolationsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        34_456_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredConnectionViolationsView<'a> {
...
impl<'a> InferredConnectionViolationsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredConnectionViolationsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredConnectionViolationsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredConnectionViolationsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredConnectionViolationsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredConnectionViolationsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredConnectionViolationsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredConnectionViolationsView<'_>,
    ) -> Result<(), crate::RelationError> {
