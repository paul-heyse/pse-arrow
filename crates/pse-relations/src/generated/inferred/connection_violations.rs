...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    74u8, 152u8, 97u8, 141u8, 9u8, 224u8, 122u8, 47u8, 6u8, 63u8, 65u8, 25u8, 254u8,
    253u8, 155u8, 138u8, 79u8, 65u8, 152u8, 165u8, 71u8, 38u8, 167u8, 39u8, 153u8, 61u8,
    211u8, 0u8, 51u8, 132u8, 6u8, 126u8,
]);
...
impl crate::columnar::RelationRow for InferredConnectionViolationsRow {
    ...
    fn builder_allocation_size() -> usize {
        32_696_usize + size_of::<Self::Builder>()
    }
