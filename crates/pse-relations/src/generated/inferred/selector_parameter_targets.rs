...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    212u8, 203u8, 210u8, 38u8, 252u8, 174u8, 235u8, 218u8, 139u8, 41u8, 227u8, 76u8,
    172u8, 118u8, 113u8, 65u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "selector_parameter_targets";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    90u8, 47u8, 115u8, 130u8, 219u8, 213u8, 149u8, 80u8, 4u8, 250u8, 209u8, 138u8, 2u8,
    196u8, 170u8, 194u8, 183u8, 23u8, 94u8, 71u8, 69u8, 216u8, 125u8, 52u8, 73u8, 47u8,
    208u8, 212u8, 11u8, 214u8, 118u8, 140u8,
]);
...
pub struct InferredSelectorParameterTargetsRow {
    ///scope_id
...
impl crate::typed::CellCodec for InferredSelectorParameterTargetsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredSelectorParameterTargetsRow)),
            );
        };
            ...
            r#scope_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredSelectorParameterTargetsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredSelectorParameterTargetsRow {
    fn append(
        &self,
...
pub type Row = InferredSelectorParameterTargetsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredSelectorParameterTargetsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredSelectorParameterTargetsBuilder;
impl InferredSelectorParameterTargetsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.selector_parameter_targets".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredSelectorParameterTargetsRow {
    type Builder = InferredSelectorParameterTargetsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredSelectorParameterTargetsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredSelectorParameterTargetsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        50_080_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredSelectorParameterTargetsView<'a> {
...
impl<'a> InferredSelectorParameterTargetsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredSelectorParameterTargetsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredSelectorParameterTargetsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredSelectorParameterTargetsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredSelectorParameterTargetsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredSelectorParameterTargetsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredSelectorParameterTargetsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredSelectorParameterTargetsView<'_>,
    ) -> Result<(), crate::RelationError> {
