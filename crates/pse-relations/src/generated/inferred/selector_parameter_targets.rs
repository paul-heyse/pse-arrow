...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    240u8, 232u8, 99u8, 16u8, 65u8, 52u8, 227u8, 8u8, 252u8, 252u8, 231u8, 97u8, 82u8,
    180u8, 145u8, 106u8, 76u8, 54u8, 228u8, 141u8, 251u8, 159u8, 25u8, 138u8, 49u8,
    100u8, 195u8, 19u8, 4u8, 20u8, 142u8, 249u8,
]);
...
impl crate::columnar::RelationRow for InferredSelectorParameterTargetsRow {
    ...
    fn builder_allocation_size() -> usize {
        47_856_usize + size_of::<Self::Builder>()
    }
