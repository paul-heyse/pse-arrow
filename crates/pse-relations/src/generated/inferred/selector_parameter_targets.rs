...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    131u8, 218u8, 253u8, 36u8, 121u8, 99u8, 102u8, 162u8, 26u8, 156u8, 137u8, 92u8,
    127u8, 33u8, 133u8, 146u8, 83u8, 145u8, 186u8, 70u8, 89u8, 31u8, 92u8, 250u8, 39u8,
    138u8, 3u8, 234u8, 115u8, 34u8, 202u8, 97u8,
]);
...
impl crate::columnar::RelationRow for InferredSelectorParameterTargetsRow {
    ...
    fn builder_allocation_size() -> usize {
        48_320_usize + size_of::<Self::Builder>()
    }
