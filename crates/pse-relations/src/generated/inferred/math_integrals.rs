...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    59u8, 100u8, 186u8, 172u8, 0u8, 232u8, 180u8, 248u8, 11u8, 145u8, 233u8, 190u8,
    255u8, 222u8, 102u8, 132u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    51u8, 155u8, 108u8, 118u8, 25u8, 232u8, 244u8, 23u8, 113u8, 25u8, 191u8, 224u8, 78u8,
    162u8, 197u8, 157u8, 72u8, 42u8, 174u8, 171u8, 216u8, 160u8, 183u8, 39u8, 21u8,
    195u8, 188u8, 97u8, 80u8, 247u8, 236u8, 230u8,
]);
...
pub struct InferredMathIntegralsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for InferredMathIntegralsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathIntegralsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathIntegralsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathIntegralsRow {
    fn append(
        &self,
...
pub type Row = InferredMathIntegralsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathIntegralsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathIntegralsBuilder;
impl InferredMathIntegralsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_integrals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathIntegralsRow {
    type Builder = InferredMathIntegralsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathIntegralsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathIntegralsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredMathIntegralsView<'a> {
...
impl<'a> InferredMathIntegralsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathIntegralsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathIntegralsRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredMathIntegralsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathIntegralsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathIntegralsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathIntegralsView<'_>,
    ) -> Result<(), crate::RelationError> {
