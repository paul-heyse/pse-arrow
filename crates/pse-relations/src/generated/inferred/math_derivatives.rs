...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    138u8, 184u8, 194u8, 58u8, 42u8, 138u8, 210u8, 181u8, 58u8, 243u8, 95u8, 158u8,
    136u8, 5u8, 171u8, 56u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    195u8, 66u8, 179u8, 13u8, 101u8, 100u8, 174u8, 112u8, 213u8, 86u8, 243u8, 95u8,
    229u8, 108u8, 217u8, 86u8, 180u8, 37u8, 226u8, 161u8, 197u8, 93u8, 171u8, 58u8,
    246u8, 75u8, 118u8, 182u8, 111u8, 188u8, 197u8, 61u8,
]);
...
pub struct InferredMathDerivativesRow {
    ///node_id
    pub r#node_id: u64,
    ///wrt_domain_id
...
impl crate::typed::CellCodec for InferredMathDerivativesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathDerivativesRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathDerivativesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathDerivativesRow {
    fn append(
        &self,
...
pub type Row = InferredMathDerivativesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathDerivativesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathDerivativesBuilder;
impl InferredMathDerivativesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_derivatives".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathDerivativesRow {
    type Builder = InferredMathDerivativesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathDerivativesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathDerivativesView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredMathDerivativesView<'a> {
...
impl<'a> InferredMathDerivativesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathDerivativesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathDerivativesRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredMathDerivativesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathDerivativesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathDerivativesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMathDerivativesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathDerivativesView<'_>,
    ) -> Result<(), crate::RelationError> {
