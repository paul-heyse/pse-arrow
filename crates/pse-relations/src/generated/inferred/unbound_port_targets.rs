...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    134u8, 234u8, 211u8, 189u8, 214u8, 134u8, 52u8, 91u8, 1u8, 185u8, 124u8, 92u8, 175u8,
    228u8, 30u8, 70u8, 253u8, 23u8, 26u8, 181u8, 17u8, 32u8, 248u8, 108u8, 147u8, 42u8,
    148u8, 82u8, 80u8, 222u8, 176u8, 249u8,
]);
...
impl crate::columnar::RelationRow for InferredUnboundPortTargetsRow {
    ...
    fn builder_allocation_size() -> usize {
        52_928_usize + size_of::<Self::Builder>()
    }
