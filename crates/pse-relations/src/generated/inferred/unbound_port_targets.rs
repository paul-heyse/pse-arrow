...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    48u8, 145u8, 45u8, 178u8, 248u8, 2u8, 148u8, 78u8, 241u8, 13u8, 66u8, 34u8, 69u8,
    161u8, 194u8, 37u8, 25u8, 0u8, 78u8, 15u8, 0u8, 36u8, 100u8, 158u8, 61u8, 155u8,
    109u8, 252u8, 187u8, 97u8, 162u8, 167u8,
]);
...
impl crate::columnar::RelationRow for InferredUnboundPortTargetsRow {
    ...
    fn builder_allocation_size() -> usize {
        53_392_usize + size_of::<Self::Builder>()
    }
