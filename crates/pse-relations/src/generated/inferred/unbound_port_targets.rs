...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    214u8, 245u8, 146u8, 136u8, 132u8, 185u8, 150u8, 54u8, 141u8, 55u8, 69u8, 161u8,
    214u8, 82u8, 198u8, 83u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "unbound_port_targets";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    72u8, 9u8, 252u8, 49u8, 180u8, 18u8, 206u8, 246u8, 244u8, 225u8, 237u8, 209u8, 154u8,
    171u8, 170u8, 37u8, 6u8, 204u8, 66u8, 92u8, 117u8, 219u8, 221u8, 148u8, 77u8, 193u8,
    145u8, 201u8, 139u8, 140u8, 217u8, 51u8,
]);
...
pub struct InferredUnboundPortTargetsRow {
    ///port_id
...
impl crate::typed::CellCodec for InferredUnboundPortTargetsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredUnboundPortTargetsRow)),
            );
        };
            ...
            r#port_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredUnboundPortTargetsRow),
                    ))?,
            )?,
            r#state_index: <Vec<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for InferredUnboundPortTargetsRow {
    fn append(
        &self,
...
pub type Row = InferredUnboundPortTargetsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredUnboundPortTargetsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredUnboundPortTargetsBuilder;
impl InferredUnboundPortTargetsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.unbound_port_targets".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredUnboundPortTargetsRow {
    type Builder = InferredUnboundPortTargetsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredUnboundPortTargetsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredUnboundPortTargetsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        55_152_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredUnboundPortTargetsView<'a> {
...
impl<'a> InferredUnboundPortTargetsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredUnboundPortTargetsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredUnboundPortTargetsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredUnboundPortTargetsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredUnboundPortTargetsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredUnboundPortTargetsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredUnboundPortTargetsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredUnboundPortTargetsView<'_>,
    ) -> Result<(), crate::RelationError> {
