...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    45u8, 173u8, 199u8, 137u8, 91u8, 171u8, 1u8, 213u8, 255u8, 4u8, 140u8, 106u8, 127u8,
    83u8, 108u8, 41u8, 35u8, 125u8, 131u8, 193u8, 223u8, 246u8, 45u8, 20u8, 195u8, 142u8,
    123u8, 5u8, 54u8, 160u8, 134u8, 74u8,
]);
...
impl crate::columnar::RelationRow for InferredInstanceTreeRow {
    ...
    fn builder_allocation_size() -> usize {
        42_640_usize + size_of::<Self::Builder>()
    }
