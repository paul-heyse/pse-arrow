...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    176u8, 213u8, 247u8, 3u8, 107u8, 58u8, 106u8, 182u8, 173u8, 197u8, 222u8, 88u8, 97u8,
    74u8, 247u8, 39u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    222u8, 36u8, 242u8, 121u8, 119u8, 135u8, 156u8, 169u8, 202u8, 223u8, 156u8, 40u8,
    129u8, 132u8, 49u8, 251u8, 47u8, 16u8, 148u8, 17u8, 0u8, 33u8, 57u8, 142u8, 155u8,
    1u8, 248u8, 117u8, 29u8, 71u8, 215u8, 105u8,
]);
...
impl crate::columnar::ArrowValue for InferredInstanceTreeRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#depth, children[2usize].as_mut())?;
        crate::columnar::ArrowValue::append(
...
impl crate::columnar::RelationRow for InferredInstanceTreeRow {
    type Builder = InferredInstanceTreeBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredInstanceTreeBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredInstanceTreeView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        43_104_usize + size_of::<Self::Builder>()
    }
...
impl<'a> InferredInstanceTreeView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredInstanceTreeRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredInstanceTreeRow {
...
impl InferredInstanceTreeBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredInstanceTreeView<'_>,
    ) -> Result<(), crate::RelationError> {
