...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    183u8, 100u8, 223u8, 28u8, 206u8, 62u8, 210u8, 247u8, 36u8, 115u8, 20u8, 173u8, 25u8,
    97u8, 19u8, 102u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    162u8, 154u8, 149u8, 47u8, 54u8, 227u8, 14u8, 20u8, 171u8, 77u8, 60u8, 251u8, 225u8,
    179u8, 243u8, 115u8, 234u8, 30u8, 53u8, 207u8, 88u8, 31u8, 155u8, 13u8, 227u8, 11u8,
    104u8, 216u8, 35u8, 221u8, 17u8, 80u8,
]);
...
pub struct InferredMathUnitConvertsRow {
    ///node_id
    pub r#node_id: u64,
    ///scale
...
impl crate::typed::CellCodec for InferredMathUnitConvertsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathUnitConvertsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathUnitConvertsRow),
                    ))?,
            )?,
            r#scale: <Option<
                f64,
...
impl crate::columnar::ArrowValue for InferredMathUnitConvertsRow {
    fn append(
        &self,
...
pub type Row = InferredMathUnitConvertsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathUnitConvertsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathUnitConvertsBuilder;
impl InferredMathUnitConvertsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_unit_converts".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathUnitConvertsRow {
    type Builder = InferredMathUnitConvertsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathUnitConvertsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathUnitConvertsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        57_168_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredMathUnitConvertsView<'a> {
...
impl<'a> InferredMathUnitConvertsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathUnitConvertsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathUnitConvertsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredMathUnitConvertsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathUnitConvertsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathUnitConvertsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMathUnitConvertsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathUnitConvertsView<'_>,
    ) -> Result<(), crate::RelationError> {
