...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    8u8, 251u8, 222u8, 41u8, 89u8, 87u8, 101u8, 50u8, 109u8, 170u8, 232u8, 120u8, 37u8,
    26u8, 2u8, 62u8, 12u8, 224u8, 24u8, 117u8, 15u8, 112u8, 80u8, 23u8, 131u8, 219u8,
    169u8, 243u8, 130u8, 196u8, 130u8, 176u8,
]);
...
impl crate::columnar::RelationRow for InferredMathUnitConvertsRow {
    ...
    fn builder_allocation_size() -> usize {
        57_632_usize + size_of::<Self::Builder>()
    }
