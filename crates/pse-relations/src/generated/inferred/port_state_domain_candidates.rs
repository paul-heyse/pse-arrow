...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    85u8, 103u8, 28u8, 254u8, 31u8, 204u8, 139u8, 180u8, 17u8, 54u8, 244u8, 7u8, 45u8,
    174u8, 176u8, 229u8, 212u8, 127u8, 70u8, 46u8, 46u8, 236u8, 189u8, 109u8, 26u8,
    221u8, 6u8, 116u8, 122u8, 89u8, 197u8, 152u8,
]);
...
impl crate::columnar::RelationRow for InferredPortStateDomainCandidatesRow {
    ...
    fn builder_allocation_size() -> usize {
        63_360_usize + size_of::<Self::Builder>()
    }
