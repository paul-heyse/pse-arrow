...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    67u8, 55u8, 39u8, 172u8, 41u8, 167u8, 30u8, 27u8, 46u8, 100u8, 48u8, 0u8, 236u8,
    132u8, 111u8, 158u8, 52u8, 126u8, 156u8, 187u8, 132u8, 213u8, 162u8, 133u8, 195u8,
    162u8, 227u8, 174u8, 22u8, 132u8, 191u8, 6u8,
]);
...
impl crate::columnar::RelationRow for InferredTopologyEdgesRow {
    ...
    fn builder_allocation_size() -> usize {
        39_320_usize + size_of::<Self::Builder>()
    }
