...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    88u8, 228u8, 151u8, 113u8, 38u8, 202u8, 203u8, 205u8, 155u8, 91u8, 124u8, 210u8,
    203u8, 153u8, 159u8, 186u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_state_candidates";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    7u8, 7u8, 13u8, 71u8, 180u8, 153u8, 244u8, 206u8, 196u8, 117u8, 20u8, 191u8, 34u8,
    17u8, 69u8, 179u8, 174u8, 199u8, 11u8, 131u8, 200u8, 79u8, 167u8, 45u8, 76u8, 203u8,
    98u8, 235u8, 205u8, 194u8, 63u8, 254u8,
]);
...
pub struct InferredPortStateCandidatesRow {
    ///port_id
...
impl crate::typed::CellCodec for InferredPortStateCandidatesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredPortStateCandidatesRow)),
            );
        };
            ...
            r#port_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredPortStateCandidatesRow),
                    ))?,
            )?,
            r#state_index: <Vec<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for InferredPortStateCandidatesRow {
    fn append(
        &self,
...
pub type Row = InferredPortStateCandidatesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredPortStateCandidatesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredPortStateCandidatesBuilder;
impl InferredPortStateCandidatesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.port_state_candidates".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredPortStateCandidatesRow {
    type Builder = InferredPortStateCandidatesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredPortStateCandidatesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredPortStateCandidatesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        55_512_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredPortStateCandidatesView<'a> {
...
impl<'a> InferredPortStateCandidatesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredPortStateCandidatesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredPortStateCandidatesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredPortStateCandidatesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredPortStateCandidatesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredPortStateCandidatesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredPortStateCandidatesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredPortStateCandidatesView<'_>,
    ) -> Result<(), crate::RelationError> {
