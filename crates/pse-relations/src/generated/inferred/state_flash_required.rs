...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    97u8, 156u8, 40u8, 209u8, 223u8, 204u8, 138u8, 85u8, 90u8, 74u8, 182u8, 248u8, 95u8,
    90u8, 252u8, 80u8, 87u8, 143u8, 70u8, 111u8, 204u8, 43u8, 166u8, 50u8, 210u8, 235u8,
    19u8, 80u8, 251u8, 37u8, 69u8, 113u8,
]);
...
impl crate::columnar::RelationRow for InferredStateFlashRequiredRow {
    ...
    fn builder_allocation_size() -> usize {
        17_840_usize + size_of::<Self::Builder>()
    }
