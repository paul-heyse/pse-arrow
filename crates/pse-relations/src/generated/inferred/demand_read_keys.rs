...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    227u8, 84u8, 144u8, 192u8, 3u8, 146u8, 13u8, 226u8, 164u8, 115u8, 57u8, 168u8, 41u8,
    205u8, 248u8, 221u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "demand_read_keys";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    188u8, 1u8, 41u8, 112u8, 132u8, 149u8, 51u8, 124u8, 39u8, 199u8, 254u8, 238u8, 137u8,
    70u8, 6u8, 191u8, 39u8, 137u8, 23u8, 129u8, 193u8, 207u8, 146u8, 171u8, 35u8, 73u8,
    145u8, 171u8, 91u8, 243u8, 90u8, 157u8,
]);
...
pub struct InferredDemandReadKeysRow {
    ///read_id
...
impl crate::typed::CellCodec for InferredDemandReadKeysRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredDemandReadKeysRow)));
        };
            ...
            r#read_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredDemandReadKeysRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredDemandReadKeysRow {
    fn append(
        &self,
...
pub type Row = InferredDemandReadKeysRow;
/// The concrete generated relation view.
pub type View<'a> = InferredDemandReadKeysView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredDemandReadKeysBuilder;
impl InferredDemandReadKeysRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.demand_read_keys".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredDemandReadKeysRow {
    type Builder = InferredDemandReadKeysBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredDemandReadKeysBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredDemandReadKeysView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        135_504_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredDemandReadKeysView<'a> {
...
impl<'a> InferredDemandReadKeysView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredDemandReadKeysRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredDemandReadKeysRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredDemandReadKeysRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredDemandReadKeysBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredDemandReadKeysBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredDemandReadKeysView<'_>,
    ) -> Result<(), crate::RelationError> {
