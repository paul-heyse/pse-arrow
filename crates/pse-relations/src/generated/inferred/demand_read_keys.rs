...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    218u8, 124u8, 99u8, 21u8, 62u8, 19u8, 12u8, 83u8, 95u8, 159u8, 196u8, 224u8, 34u8,
    80u8, 76u8, 17u8, 251u8, 52u8, 75u8, 234u8, 80u8, 250u8, 116u8, 178u8, 98u8, 72u8,
    45u8, 174u8, 208u8, 229u8, 9u8, 131u8,
]);
...
impl crate::columnar::RelationRow for InferredDemandReadKeysRow {
    ...
    fn builder_allocation_size() -> usize {
        140_448_usize + size_of::<Self::Builder>()
    }
