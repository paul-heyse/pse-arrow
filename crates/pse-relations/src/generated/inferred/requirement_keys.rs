...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    6u8, 174u8, 5u8, 23u8, 132u8, 93u8, 200u8, 174u8, 67u8, 121u8, 121u8, 168u8, 95u8,
    127u8, 16u8, 74u8, 102u8, 11u8, 200u8, 219u8, 76u8, 70u8, 96u8, 228u8, 86u8, 213u8,
    165u8, 188u8, 218u8, 36u8, 16u8, 62u8,
]);
...
impl crate::columnar::RelationRow for InferredRequirementKeysRow {
    ...
    fn builder_allocation_size() -> usize {
        120_376_usize + size_of::<Self::Builder>()
    }
