...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    50u8, 97u8, 35u8, 54u8, 121u8, 204u8, 196u8, 1u8, 101u8, 151u8, 135u8, 148u8, 111u8,
    140u8, 58u8, 7u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    6u8, 234u8, 53u8, 120u8, 6u8, 231u8, 63u8, 16u8, 238u8, 169u8, 41u8, 247u8, 121u8,
    54u8, 210u8, 102u8, 177u8, 131u8, 107u8, 30u8, 222u8, 43u8, 34u8, 116u8, 36u8, 128u8,
    123u8, 138u8, 214u8, 207u8, 153u8, 80u8,
]);
...
pub struct InferredMathFloatConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: f64,
...
impl crate::typed::CellCodec for InferredMathFloatConstantsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredMathFloatConstantsRow)),
            );
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathFloatConstantsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathFloatConstantsRow {
    fn append(
        &self,
...
pub type Row = InferredMathFloatConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathFloatConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathFloatConstantsBuilder;
impl InferredMathFloatConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_float_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathFloatConstantsRow {
    type Builder = InferredMathFloatConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathFloatConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathFloatConstantsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredMathFloatConstantsView<'a> {
...
impl<'a> InferredMathFloatConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathFloatConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathFloatConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredMathFloatConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathFloatConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathFloatConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMathFloatConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathFloatConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
