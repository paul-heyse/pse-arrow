...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    123u8, 147u8, 97u8, 12u8, 68u8, 90u8, 49u8, 84u8, 31u8, 152u8, 251u8, 151u8, 82u8,
    80u8, 186u8, 51u8, 217u8, 42u8, 174u8, 226u8, 178u8, 221u8, 87u8, 64u8, 196u8, 99u8,
    49u8, 19u8, 124u8, 145u8, 4u8, 131u8,
]);
...
impl crate::columnar::RelationRow for InferredScopePortDecisionsRow {
    ...
    fn builder_allocation_size() -> usize {
        59_136_usize + size_of::<Self::Builder>()
    }
