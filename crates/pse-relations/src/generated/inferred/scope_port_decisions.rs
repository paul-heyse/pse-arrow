...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    208u8, 80u8, 40u8, 105u8, 1u8, 205u8, 129u8, 164u8, 31u8, 71u8, 110u8, 147u8, 143u8,
    2u8, 84u8, 193u8, 109u8, 205u8, 62u8, 228u8, 128u8, 172u8, 189u8, 170u8, 90u8, 76u8,
    74u8, 122u8, 231u8, 188u8, 89u8, 223u8,
]);
...
impl crate::columnar::RelationRow for InferredScopePortDecisionsRow {
    ...
    fn builder_allocation_size() -> usize {
        58_672_usize + size_of::<Self::Builder>()
    }
