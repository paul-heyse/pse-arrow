...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    36u8, 244u8, 137u8, 109u8, 146u8, 5u8, 173u8, 85u8, 2u8, 19u8, 52u8, 211u8, 211u8,
    250u8, 11u8, 174u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_port_decisions";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    195u8, 59u8, 135u8, 206u8, 213u8, 165u8, 194u8, 13u8, 106u8, 232u8, 222u8, 52u8,
    60u8, 191u8, 143u8, 169u8, 116u8, 242u8, 124u8, 74u8, 46u8, 131u8, 50u8, 163u8,
    147u8, 179u8, 21u8, 251u8, 102u8, 82u8, 8u8, 135u8,
]);
...
pub struct InferredScopePortDecisionsRow {
    ///scope_id
...
impl crate::typed::CellCodec for InferredScopePortDecisionsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredScopePortDecisionsRow)),
            );
        };
            ...
            r#scope_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredScopePortDecisionsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredScopePortDecisionsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#port_id, children[1usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#state_index,
...
pub type Row = InferredScopePortDecisionsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredScopePortDecisionsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredScopePortDecisionsBuilder;
impl InferredScopePortDecisionsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.scope_port_decisions".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredScopePortDecisionsRow {
    type Builder = InferredScopePortDecisionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredScopePortDecisionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredScopePortDecisionsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        60_896_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredScopePortDecisionsView<'a> {
...
impl<'a> InferredScopePortDecisionsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredScopePortDecisionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredScopePortDecisionsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredScopePortDecisionsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredScopePortDecisionsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredScopePortDecisionsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredScopePortDecisionsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredScopePortDecisionsView<'_>,
    ) -> Result<(), crate::RelationError> {
