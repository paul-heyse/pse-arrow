...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    236u8, 127u8, 186u8, 12u8, 241u8, 251u8, 227u8, 54u8, 224u8, 41u8, 33u8, 27u8, 251u8,
    104u8, 246u8, 85u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    171u8, 105u8, 220u8, 179u8, 236u8, 112u8, 103u8, 32u8, 224u8, 162u8, 252u8, 154u8,
    134u8, 43u8, 157u8, 122u8, 172u8, 18u8, 45u8, 215u8, 124u8, 63u8, 161u8, 99u8, 186u8,
    120u8, 208u8, 74u8, 153u8, 74u8, 2u8, 158u8,
]);
...
pub struct InferredMathImplicitRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///implicit_system_id
...
impl crate::typed::CellCodec for InferredMathImplicitRefsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathImplicitRefsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathImplicitRefsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathImplicitRefsRow {
    fn append(
        &self,
...
pub type Row = InferredMathImplicitRefsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathImplicitRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathImplicitRefsBuilder;
impl InferredMathImplicitRefsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_implicit_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathImplicitRefsRow {
    type Builder = InferredMathImplicitRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathImplicitRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathImplicitRefsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredMathImplicitRefsView<'a> {
...
impl<'a> InferredMathImplicitRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathImplicitRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathImplicitRefsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredMathImplicitRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathImplicitRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathImplicitRefsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMathImplicitRefsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathImplicitRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
