...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    150u8, 86u8, 40u8, 56u8, 85u8, 243u8, 112u8, 171u8, 79u8, 17u8, 45u8, 82u8, 183u8,
    16u8, 228u8, 43u8, 131u8, 183u8, 159u8, 128u8, 154u8, 150u8, 233u8, 247u8, 75u8,
    94u8, 36u8, 241u8, 172u8, 63u8, 173u8, 181u8,
]);
...
impl crate::columnar::RelationRow for InferredLawSubjectMatchesRow {
    ...
    fn builder_allocation_size() -> usize {
        37_384_usize + size_of::<Self::Builder>()
    }
