...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    221u8, 140u8, 163u8, 142u8, 149u8, 248u8, 100u8, 100u8, 72u8, 160u8, 125u8, 119u8,
    75u8, 133u8, 155u8, 173u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "law_subject_matches";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    58u8, 191u8, 148u8, 137u8, 250u8, 12u8, 60u8, 155u8, 249u8, 16u8, 191u8, 217u8,
    174u8, 94u8, 222u8, 85u8, 47u8, 157u8, 162u8, 77u8, 101u8, 127u8, 152u8, 229u8, 36u8,
    123u8, 5u8, 171u8, 226u8, 149u8, 102u8, 151u8,
]);
...
pub struct InferredLawSubjectMatchesRow {
    ///application_id
...
impl crate::typed::CellCodec for InferredLawSubjectMatchesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredLawSubjectMatchesRow)));
        };
            ...
            r#application_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredLawSubjectMatchesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredLawSubjectMatchesRow {
    fn append(
        &self,
...
pub type Row = InferredLawSubjectMatchesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredLawSubjectMatchesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredLawSubjectMatchesBuilder;
impl InferredLawSubjectMatchesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.law_subject_matches".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredLawSubjectMatchesRow {
    type Builder = InferredLawSubjectMatchesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredLawSubjectMatchesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredLawSubjectMatchesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        39_608_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredLawSubjectMatchesView<'a> {
...
impl<'a> InferredLawSubjectMatchesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredLawSubjectMatchesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredLawSubjectMatchesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredLawSubjectMatchesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredLawSubjectMatchesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredLawSubjectMatchesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredLawSubjectMatchesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredLawSubjectMatchesView<'_>,
    ) -> Result<(), crate::RelationError> {
