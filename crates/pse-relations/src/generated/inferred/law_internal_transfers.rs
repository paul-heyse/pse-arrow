...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    21u8, 123u8, 126u8, 236u8, 196u8, 13u8, 148u8, 174u8, 199u8, 124u8, 33u8, 215u8,
    23u8, 106u8, 47u8, 19u8, 89u8, 89u8, 224u8, 201u8, 135u8, 33u8, 79u8, 52u8, 47u8,
    171u8, 14u8, 181u8, 123u8, 202u8, 31u8, 85u8,
]);
...
impl crate::columnar::RelationRow for InferredLawInternalTransfersRow {
    ...
    fn builder_allocation_size() -> usize {
        37_872_usize + size_of::<Self::Builder>()
    }
