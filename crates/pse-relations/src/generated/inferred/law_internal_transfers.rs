...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    113u8, 194u8, 211u8, 57u8, 176u8, 42u8, 68u8, 154u8, 205u8, 17u8, 60u8, 61u8, 114u8,
    136u8, 120u8, 251u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "law_internal_transfers";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    52u8, 188u8, 105u8, 116u8, 190u8, 190u8, 34u8, 240u8, 178u8, 149u8, 199u8, 223u8,
    21u8, 40u8, 9u8, 160u8, 191u8, 179u8, 25u8, 23u8, 94u8, 234u8, 104u8, 177u8, 197u8,
    43u8, 161u8, 11u8, 135u8, 78u8, 180u8, 205u8,
]);
...
pub struct InferredLawInternalTransfersRow {
    ///application_id
...
impl crate::typed::CellCodec for InferredLawInternalTransfersRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredLawInternalTransfersRow)),
            );
        };
            ...
            r#application_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredLawInternalTransfersRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredLawInternalTransfersRow {
    fn append(
        &self,
...
pub type Row = InferredLawInternalTransfersRow;
/// The concrete generated relation view.
pub type View<'a> = InferredLawInternalTransfersView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredLawInternalTransfersBuilder;
impl InferredLawInternalTransfersRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.law_internal_transfers".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredLawInternalTransfersRow {
    type Builder = InferredLawInternalTransfersBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredLawInternalTransfersBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredLawInternalTransfersView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        39_632_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredLawInternalTransfersView<'a> {
...
impl<'a> InferredLawInternalTransfersView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredLawInternalTransfersRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredLawInternalTransfersRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredLawInternalTransfersRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredLawInternalTransfersBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredLawInternalTransfersBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredLawInternalTransfersRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredLawInternalTransfersView<'_>,
    ) -> Result<(), crate::RelationError> {
