...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    23u8, 191u8, 193u8, 84u8, 103u8, 167u8, 212u8, 131u8, 184u8, 102u8, 192u8, 66u8,
    248u8, 75u8, 92u8, 185u8, 213u8, 158u8, 163u8, 50u8, 130u8, 52u8, 127u8, 34u8, 73u8,
    55u8, 51u8, 190u8, 10u8, 185u8, 76u8, 35u8,
]);
...
impl crate::columnar::RelationRow for InferredLawInternalTransfersRow {
    ...
    fn builder_allocation_size() -> usize {
        37_408_usize + size_of::<Self::Builder>()
    }
