...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    126u8, 171u8, 249u8, 7u8, 169u8, 171u8, 107u8, 149u8, 35u8, 121u8, 138u8, 32u8,
    216u8, 164u8, 38u8, 101u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    190u8, 41u8, 67u8, 232u8, 193u8, 208u8, 203u8, 153u8, 240u8, 164u8, 223u8, 114u8,
    189u8, 22u8, 222u8, 78u8, 59u8, 220u8, 177u8, 52u8, 41u8, 98u8, 46u8, 231u8, 165u8,
    190u8, 36u8, 140u8, 111u8, 102u8, 85u8, 176u8,
]);
...
pub struct InferredMathBroadcastsRow {
    ///node_id
    pub r#node_id: u64,
    ///domain_id
...
impl crate::typed::CellCodec for InferredMathBroadcastsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathBroadcastsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathBroadcastsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathBroadcastsRow {
    fn append(
        &self,
...
pub type Row = InferredMathBroadcastsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathBroadcastsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathBroadcastsBuilder;
impl InferredMathBroadcastsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_broadcasts".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathBroadcastsRow {
    type Builder = InferredMathBroadcastsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathBroadcastsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathBroadcastsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredMathBroadcastsView<'a> {
...
impl<'a> InferredMathBroadcastsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathBroadcastsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathBroadcastsRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredMathBroadcastsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathBroadcastsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathBroadcastsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathBroadcastsView<'_>,
    ) -> Result<(), crate::RelationError> {
