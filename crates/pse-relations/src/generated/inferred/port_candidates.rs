...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    160u8, 158u8, 24u8, 125u8, 92u8, 244u8, 158u8, 23u8, 71u8, 166u8, 43u8, 252u8, 75u8,
    127u8, 10u8, 151u8, 113u8, 41u8, 49u8, 32u8, 32u8, 68u8, 115u8, 173u8, 181u8, 212u8,
    119u8, 112u8, 140u8, 194u8, 222u8, 82u8,
]);
...
impl crate::columnar::RelationRow for InferredPortCandidatesRow {
    ...
    fn builder_allocation_size() -> usize {
        99_656_usize + size_of::<Self::Builder>()
    }
