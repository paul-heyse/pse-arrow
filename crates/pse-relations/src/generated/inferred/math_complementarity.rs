...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    56u8, 104u8, 245u8, 149u8, 14u8, 119u8, 213u8, 202u8, 58u8, 210u8, 214u8, 141u8, 0u8,
    25u8, 164u8, 239u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    245u8, 101u8, 98u8, 94u8, 131u8, 205u8, 35u8, 105u8, 179u8, 23u8, 22u8, 180u8, 70u8,
    110u8, 2u8, 195u8, 74u8, 2u8, 241u8, 253u8, 168u8, 56u8, 127u8, 177u8, 79u8, 86u8,
    149u8, 163u8, 36u8, 116u8, 24u8, 218u8,
]);
...
pub struct InferredMathComplementarityRow {
    ///pair_id
...
impl crate::typed::CellCodec for InferredMathComplementarityRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredMathComplementarityRow)),
            );
        };
            ...
            r#pair_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathComplementarityRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathComplementarityRow {
    fn append(
        &self,
...
pub type Row = InferredMathComplementarityRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathComplementarityView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathComplementarityBuilder;
impl InferredMathComplementarityRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_complementarity".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathComplementarityRow {
    type Builder = InferredMathComplementarityBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathComplementarityBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathComplementarityView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredMathComplementarityView<'a> {
...
impl<'a> InferredMathComplementarityView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathComplementarityRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathComplementarityRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredMathComplementarityRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathComplementarityBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathComplementarityBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMathComplementarityRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathComplementarityView<'_>,
    ) -> Result<(), crate::RelationError> {
