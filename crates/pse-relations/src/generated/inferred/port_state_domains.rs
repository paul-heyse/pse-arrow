...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    49u8, 182u8, 215u8, 39u8, 229u8, 51u8, 169u8, 103u8, 105u8, 160u8, 240u8, 112u8,
    114u8, 207u8, 83u8, 0u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "port_state_domains";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    174u8, 179u8, 137u8, 204u8, 217u8, 54u8, 186u8, 62u8, 168u8, 193u8, 176u8, 33u8,
    68u8, 14u8, 123u8, 5u8, 57u8, 59u8, 251u8, 225u8, 75u8, 187u8, 229u8, 72u8, 197u8,
    190u8, 129u8, 196u8, 96u8, 196u8, 208u8, 126u8,
]);
...
pub struct InferredPortStateDomainsRow {
    ///port_id
...
impl crate::typed::CellCodec for InferredPortStateDomainsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredPortStateDomainsRow)));
        };
            ...
            r#port_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredPortStateDomainsRow),
                    ))?,
            )?,
            r#domain_ids: <Vec<
                pse_ids::SemanticId,
...
impl crate::columnar::ArrowValue for InferredPortStateDomainsRow {
    fn append(
        &self,
...
pub type Row = InferredPortStateDomainsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredPortStateDomainsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredPortStateDomainsBuilder;
impl InferredPortStateDomainsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.port_state_domains".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredPortStateDomainsRow {
    type Builder = InferredPortStateDomainsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredPortStateDomainsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredPortStateDomainsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        62_952_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredPortStateDomainsView<'a> {
...
impl<'a> InferredPortStateDomainsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredPortStateDomainsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredPortStateDomainsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredPortStateDomainsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredPortStateDomainsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredPortStateDomainsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredPortStateDomainsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredPortStateDomainsView<'_>,
    ) -> Result<(), crate::RelationError> {
