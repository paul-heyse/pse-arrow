...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    94u8, 114u8, 243u8, 131u8, 110u8, 69u8, 108u8, 178u8, 120u8, 131u8, 69u8, 140u8,
    206u8, 21u8, 15u8, 172u8, 153u8, 221u8, 183u8, 226u8, 25u8, 185u8, 110u8, 60u8, 53u8,
    43u8, 147u8, 110u8, 143u8, 6u8, 72u8, 85u8,
]);
...
impl crate::columnar::RelationRow for InferredPortStateDomainsRow {
    ...
    fn builder_allocation_size() -> usize {
        61_192_usize + size_of::<Self::Builder>()
    }
