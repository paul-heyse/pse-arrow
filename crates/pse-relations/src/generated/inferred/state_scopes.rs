...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    110u8, 136u8, 177u8, 25u8, 173u8, 137u8, 106u8, 254u8, 42u8, 242u8, 48u8, 14u8,
    144u8, 146u8, 201u8, 183u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "state_scopes";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    134u8, 47u8, 0u8, 10u8, 168u8, 125u8, 177u8, 198u8, 110u8, 249u8, 211u8, 25u8, 36u8,
    68u8, 182u8, 118u8, 155u8, 242u8, 98u8, 12u8, 181u8, 107u8, 228u8, 241u8, 30u8, 60u8,
    158u8, 159u8, 131u8, 113u8, 16u8, 114u8,
]);
...
pub struct InferredStateScopesRow {
    ///state_scope_id
...
impl crate::typed::CellCodec for InferredStateScopesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredStateScopesRow)));
        };
            ...
            r#state_scope_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredStateScopesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredStateScopesRow {
    fn append(
        &self,
...
pub type Row = InferredStateScopesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredStateScopesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredStateScopesBuilder;
impl InferredStateScopesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.state_scopes".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredStateScopesRow {
    type Builder = InferredStateScopesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredStateScopesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredStateScopesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        48_624_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredStateScopesView<'a> {
...
impl<'a> InferredStateScopesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredStateScopesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredStateScopesRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredStateScopesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredStateScopesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredStateScopesBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredStateScopesView<'_>,
    ) -> Result<(), crate::RelationError> {
