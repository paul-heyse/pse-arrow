...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    56u8, 58u8, 157u8, 229u8, 50u8, 192u8, 23u8, 210u8, 167u8, 57u8, 3u8, 170u8, 60u8,
    45u8, 15u8, 4u8, 203u8, 145u8, 69u8, 204u8, 74u8, 67u8, 49u8, 231u8, 163u8, 131u8,
    192u8, 57u8, 59u8, 130u8, 204u8, 209u8,
]);
...
impl crate::columnar::RelationRow for InferredStateScopesRow {
    ...
    fn builder_allocation_size() -> usize {
        50_848_usize + size_of::<Self::Builder>()
    }
