...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    34u8, 98u8, 51u8, 17u8, 129u8, 59u8, 140u8, 74u8, 181u8, 9u8, 251u8, 15u8, 48u8, 9u8,
    198u8, 190u8, 138u8, 117u8, 25u8, 135u8, 108u8, 19u8, 217u8, 160u8, 244u8, 210u8,
    145u8, 205u8, 6u8, 93u8, 62u8, 173u8,
]);
