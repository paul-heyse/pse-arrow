...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    219u8, 87u8, 170u8, 247u8, 160u8, 89u8, 58u8, 190u8, 173u8, 96u8, 150u8, 72u8, 114u8,
    130u8, 224u8, 136u8, 219u8, 186u8, 36u8, 49u8, 195u8, 103u8, 34u8, 92u8, 158u8, 3u8,
    84u8, 183u8, 251u8, 119u8, 247u8, 173u8,
]);
...
impl crate::columnar::RelationRow for InferredStateScopeKeysRow {
    ...
    fn builder_allocation_size() -> usize {
        38_072_usize + size_of::<Self::Builder>()
    }
