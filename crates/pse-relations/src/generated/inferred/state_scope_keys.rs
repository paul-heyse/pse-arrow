...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    225u8, 14u8, 205u8, 158u8, 140u8, 7u8, 171u8, 15u8, 61u8, 123u8, 129u8, 144u8, 128u8,
    249u8, 175u8, 132u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "state_scope_keys";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    110u8, 156u8, 248u8, 81u8, 210u8, 157u8, 230u8, 96u8, 254u8, 29u8, 58u8, 127u8,
    118u8, 92u8, 127u8, 168u8, 35u8, 104u8, 35u8, 144u8, 252u8, 138u8, 248u8, 58u8,
    205u8, 54u8, 104u8, 226u8, 159u8, 76u8, 220u8, 149u8,
]);
...
pub struct InferredStateScopeKeysRow {
    ///state_instance_id
...
impl crate::typed::CellCodec for InferredStateScopeKeysRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredStateScopeKeysRow)));
        };
            ...
            r#state_instance_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredStateScopeKeysRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredStateScopeKeysRow {
    fn append(
        &self,
...
pub type Row = InferredStateScopeKeysRow;
/// The concrete generated relation view.
pub type View<'a> = InferredStateScopeKeysView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredStateScopeKeysBuilder;
impl InferredStateScopeKeysRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.state_scope_keys".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredStateScopeKeysRow {
    type Builder = InferredStateScopeKeysBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredStateScopeKeysBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredStateScopeKeysView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        37_608_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredStateScopeKeysView<'a> {
...
impl<'a> InferredStateScopeKeysView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredStateScopeKeysRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredStateScopeKeysRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredStateScopeKeysRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredStateScopeKeysBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredStateScopeKeysBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredStateScopeKeysView<'_>,
    ) -> Result<(), crate::RelationError> {
