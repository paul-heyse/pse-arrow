...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    202u8, 50u8, 35u8, 140u8, 43u8, 149u8, 245u8, 152u8, 224u8, 187u8, 171u8, 163u8,
    212u8, 52u8, 247u8, 209u8, 128u8, 3u8, 208u8, 86u8, 88u8, 230u8, 190u8, 179u8, 126u8,
    2u8, 249u8, 5u8, 250u8, 6u8, 240u8, 61u8,
]);
...
impl crate::columnar::RelationRow for InferredPotentialMethodWinnersRow {
    ...
    fn builder_allocation_size() -> usize {
        54_192_usize + size_of::<Self::Builder>()
    }
