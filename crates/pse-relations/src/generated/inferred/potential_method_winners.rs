...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    100u8, 15u8, 34u8, 76u8, 14u8, 154u8, 84u8, 200u8, 45u8, 32u8, 116u8, 249u8, 62u8,
    212u8, 233u8, 155u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "potential_method_winners";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    221u8, 89u8, 84u8, 231u8, 52u8, 205u8, 249u8, 220u8, 132u8, 75u8, 178u8, 95u8, 118u8,
    222u8, 227u8, 166u8, 248u8, 30u8, 87u8, 177u8, 141u8, 155u8, 240u8, 81u8, 103u8,
    237u8, 241u8, 250u8, 225u8, 132u8, 154u8, 109u8,
]);
...
pub struct InferredPotentialMethodWinnersRow {
    ///requirement_id
...
impl crate::typed::CellCodec for InferredPotentialMethodWinnersRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredPotentialMethodWinnersRow)),
            );
        };
            ...
            r#requirement_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredPotentialMethodWinnersRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredPotentialMethodWinnersRow {
    fn append(
        &self,
...
pub type Row = InferredPotentialMethodWinnersRow;
/// The concrete generated relation view.
pub type View<'a> = InferredPotentialMethodWinnersView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredPotentialMethodWinnersBuilder;
impl InferredPotentialMethodWinnersRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.potential_method_winners".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredPotentialMethodWinnersRow {
    type Builder = InferredPotentialMethodWinnersBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredPotentialMethodWinnersBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredPotentialMethodWinnersView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        54_656_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredPotentialMethodWinnersView<'a> {
...
impl<'a> InferredPotentialMethodWinnersView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredPotentialMethodWinnersRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredPotentialMethodWinnersRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredPotentialMethodWinnersRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredPotentialMethodWinnersBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredPotentialMethodWinnersBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredPotentialMethodWinnersRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredPotentialMethodWinnersView<'_>,
    ) -> Result<(), crate::RelationError> {
