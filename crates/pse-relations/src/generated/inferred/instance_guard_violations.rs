...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    139u8, 153u8, 34u8, 183u8, 98u8, 181u8, 57u8, 145u8, 75u8, 98u8, 155u8, 64u8, 64u8,
    40u8, 30u8, 42u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "instance_guard_violations";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    214u8, 167u8, 105u8, 188u8, 199u8, 50u8, 220u8, 138u8, 209u8, 195u8, 254u8, 178u8,
    156u8, 214u8, 129u8, 14u8, 79u8, 47u8, 55u8, 28u8, 151u8, 106u8, 128u8, 24u8, 102u8,
    175u8, 183u8, 146u8, 117u8, 55u8, 81u8, 244u8,
]);
...
pub struct InferredInstanceGuardViolationsRow {
    ///instance_id
...
impl crate::typed::CellCodec for InferredInstanceGuardViolationsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredInstanceGuardViolationsRow)),
            );
        };
            ...
            r#instance_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredInstanceGuardViolationsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredInstanceGuardViolationsRow {
    fn append(
        &self,
...
pub type Row = InferredInstanceGuardViolationsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredInstanceGuardViolationsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredInstanceGuardViolationsBuilder;
impl InferredInstanceGuardViolationsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.instance_guard_violations".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredInstanceGuardViolationsRow {
    type Builder = InferredInstanceGuardViolationsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredInstanceGuardViolationsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredInstanceGuardViolationsView::from_checked(batch)?.rows()
    }
...
#[derive(Debug)]
pub struct InferredInstanceGuardViolationsView<'a> {
...
impl<'a> InferredInstanceGuardViolationsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredInstanceGuardViolationsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredInstanceGuardViolationsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredInstanceGuardViolationsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredInstanceGuardViolationsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredInstanceGuardViolationsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredInstanceGuardViolationsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredInstanceGuardViolationsView<'_>,
    ) -> Result<(), crate::RelationError> {
