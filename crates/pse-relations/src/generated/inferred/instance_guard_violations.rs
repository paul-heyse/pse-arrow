...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    213u8, 169u8, 6u8, 106u8, 46u8, 130u8, 160u8, 183u8, 156u8, 234u8, 38u8, 117u8,
    122u8, 206u8, 35u8, 59u8, 31u8, 120u8, 123u8, 224u8, 214u8, 100u8, 111u8, 15u8, 25u8,
    222u8, 32u8, 242u8, 201u8, 56u8, 71u8, 40u8,
]);
...
impl crate::columnar::RelationRow for InferredInstanceGuardViolationsRow {
    ...
    fn builder_allocation_size() -> usize {
        32_888_usize + size_of::<Self::Builder>()
    }
