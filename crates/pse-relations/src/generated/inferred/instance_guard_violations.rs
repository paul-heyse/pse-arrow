...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    194u8, 34u8, 112u8, 194u8, 229u8, 26u8, 159u8, 234u8, 4u8, 62u8, 51u8, 4u8, 231u8,
    206u8, 25u8, 107u8, 33u8, 149u8, 251u8, 169u8, 69u8, 202u8, 162u8, 233u8, 229u8,
    212u8, 165u8, 140u8, 9u8, 145u8, 58u8, 245u8,
]);
...
impl crate::columnar::RelationRow for InferredInstanceGuardViolationsRow {
    ...
    fn builder_allocation_size() -> usize {
        32_424_usize + size_of::<Self::Builder>()
    }
