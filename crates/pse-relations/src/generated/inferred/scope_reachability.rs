...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    142u8, 7u8, 209u8, 136u8, 73u8, 169u8, 47u8, 138u8, 225u8, 32u8, 232u8, 205u8, 234u8,
    223u8, 34u8, 76u8, 253u8, 150u8, 97u8, 57u8, 26u8, 88u8, 165u8, 253u8, 181u8, 233u8,
    190u8, 183u8, 54u8, 143u8, 28u8, 194u8,
]);
...
impl crate::columnar::RelationRow for InferredScopeReachabilityRow {
    ...
    fn builder_allocation_size() -> usize {
        37_072_usize + size_of::<Self::Builder>()
    }
