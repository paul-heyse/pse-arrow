...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    115u8, 65u8, 51u8, 133u8, 61u8, 191u8, 73u8, 189u8, 242u8, 250u8, 130u8, 46u8, 54u8,
    123u8, 197u8, 102u8, 186u8, 65u8, 147u8, 201u8, 179u8, 126u8, 205u8, 117u8, 238u8,
    222u8, 10u8, 211u8, 94u8, 252u8, 100u8, 174u8,
]);
...
impl crate::columnar::RelationRow for InferredScopeReachabilityRow {
    ...
    fn builder_allocation_size() -> usize {
        37_536_usize + size_of::<Self::Builder>()
    }
