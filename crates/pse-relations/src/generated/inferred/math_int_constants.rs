...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    109u8, 102u8, 211u8, 102u8, 24u8, 89u8, 148u8, 206u8, 58u8, 66u8, 19u8, 200u8, 168u8,
    177u8, 107u8, 235u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    86u8, 230u8, 186u8, 197u8, 69u8, 198u8, 98u8, 202u8, 211u8, 180u8, 244u8, 187u8,
    197u8, 27u8, 101u8, 111u8, 118u8, 220u8, 48u8, 26u8, 127u8, 164u8, 198u8, 146u8,
    96u8, 214u8, 51u8, 35u8, 25u8, 184u8, 121u8, 43u8,
]);
...
pub struct InferredMathIntConstantsRow {
    ///node_id
    pub r#node_id: u64,
    ///value
    pub r#value: i64,
}
impl crate::typed::CellCodec for InferredMathIntConstantsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathIntConstantsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathIntConstantsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathIntConstantsRow {
    fn append(
        &self,
...
pub type Row = InferredMathIntConstantsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathIntConstantsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathIntConstantsBuilder;
impl InferredMathIntConstantsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_int_constants".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathIntConstantsRow {
    type Builder = InferredMathIntConstantsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathIntConstantsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathIntConstantsView::from_checked(batch)?.rows()
    }
...
impl<'a> InferredMathIntConstantsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathIntConstantsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathIntConstantsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredMathIntConstantsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathIntConstantsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathIntConstantsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredMathIntConstantsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathIntConstantsView<'_>,
    ) -> Result<(), crate::RelationError> {
