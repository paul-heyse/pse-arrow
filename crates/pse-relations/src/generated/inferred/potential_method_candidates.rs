...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    180u8, 46u8, 50u8, 59u8, 248u8, 187u8, 99u8, 202u8, 254u8, 176u8, 138u8, 107u8, 10u8,
    138u8, 9u8, 99u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "potential_method_candidates";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    200u8, 60u8, 160u8, 57u8, 29u8, 161u8, 214u8, 227u8, 174u8, 36u8, 93u8, 48u8, 107u8,
    81u8, 124u8, 240u8, 141u8, 104u8, 93u8, 69u8, 203u8, 228u8, 221u8, 192u8, 190u8,
    149u8, 32u8, 158u8, 129u8, 106u8, 213u8, 10u8,
]);
...
pub struct InferredPotentialMethodCandidatesRow {
    ///requirement_id
...
impl crate::typed::CellCodec for InferredPotentialMethodCandidatesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredPotentialMethodCandidatesRow)),
            );
        };
            ...
            r#requirement_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredPotentialMethodCandidatesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredPotentialMethodCandidatesRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#rank, children[4usize].as_mut())?;
...
pub type Row = InferredPotentialMethodCandidatesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredPotentialMethodCandidatesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredPotentialMethodCandidatesBuilder;
impl InferredPotentialMethodCandidatesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.potential_method_candidates".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredPotentialMethodCandidatesRow {
    type Builder = InferredPotentialMethodCandidatesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredPotentialMethodCandidatesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredPotentialMethodCandidatesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        78_160_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredPotentialMethodCandidatesView<'a> {
...
impl<'a> InferredPotentialMethodCandidatesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredPotentialMethodCandidatesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredPotentialMethodCandidatesRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredPotentialMethodCandidatesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredPotentialMethodCandidatesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredPotentialMethodCandidatesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredPotentialMethodCandidatesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredPotentialMethodCandidatesView<'_>,
    ) -> Result<(), crate::RelationError> {
