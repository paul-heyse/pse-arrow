...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    78u8, 148u8, 217u8, 210u8, 242u8, 71u8, 41u8, 200u8, 67u8, 227u8, 112u8, 44u8, 127u8,
    223u8, 3u8, 147u8, 174u8, 95u8, 46u8, 220u8, 243u8, 248u8, 238u8, 222u8, 226u8, 44u8,
    202u8, 187u8, 178u8, 156u8, 229u8, 88u8,
]);
