...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    211u8, 206u8, 225u8, 162u8, 38u8, 90u8, 200u8, 106u8, 54u8, 225u8, 116u8, 127u8,
    13u8, 237u8, 235u8, 180u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    161u8, 18u8, 84u8, 117u8, 59u8, 186u8, 101u8, 59u8, 158u8, 109u8, 163u8, 73u8, 192u8,
    33u8, 123u8, 69u8, 172u8, 203u8, 109u8, 183u8, 193u8, 114u8, 47u8, 249u8, 228u8,
    164u8, 71u8, 10u8, 188u8, 94u8, 113u8, 244u8,
]);
...
pub struct InferredMathSymbolRefsRow {
    ///node_id
    pub r#node_id: u64,
    ///symbol_id
    pub r#symbol_id: pse_ids::SemanticId,
}
impl crate::typed::CellCodec for InferredMathSymbolRefsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredMathSymbolRefsRow)));
        };
            ...
            r#node_id: <u64 as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredMathSymbolRefsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredMathSymbolRefsRow {
    fn append(
        &self,
...
pub type Row = InferredMathSymbolRefsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredMathSymbolRefsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredMathSymbolRefsBuilder;
impl InferredMathSymbolRefsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.math_symbol_refs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredMathSymbolRefsRow {
    type Builder = InferredMathSymbolRefsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredMathSymbolRefsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredMathSymbolRefsView::from_checked(batch)?.rows()
    }
...
impl<'a> InferredMathSymbolRefsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredMathSymbolRefsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredMathSymbolRefsRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredMathSymbolRefsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredMathSymbolRefsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredMathSymbolRefsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &InferredMathSymbolRefsView<'_>,
    ) -> Result<(), crate::RelationError> {
