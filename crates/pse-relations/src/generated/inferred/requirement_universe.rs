...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    191u8, 180u8, 191u8, 230u8, 163u8, 203u8, 209u8, 109u8, 85u8, 46u8, 204u8, 94u8,
    50u8, 18u8, 144u8, 57u8, 85u8, 3u8, 46u8, 47u8, 86u8, 123u8, 64u8, 18u8, 161u8,
    133u8, 106u8, 72u8, 25u8, 91u8, 24u8, 13u8,
]);
...
impl crate::columnar::RelationRow for InferredRequirementUniverseRow {
    ...
    fn builder_allocation_size() -> usize {
        88_184_usize + size_of::<Self::Builder>()
    }
