...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    77u8, 151u8, 97u8, 43u8, 95u8, 52u8, 118u8, 28u8, 187u8, 234u8, 26u8, 85u8, 248u8,
    201u8, 126u8, 252u8, 17u8, 104u8, 139u8, 3u8, 10u8, 90u8, 187u8, 206u8, 12u8, 157u8,
    124u8, 146u8, 104u8, 56u8, 251u8, 134u8,
]);
...
impl crate::columnar::RelationRow for InferredRequirementUniverseRow {
    ...
    fn builder_allocation_size() -> usize {
        85_960_usize + size_of::<Self::Builder>()
    }
