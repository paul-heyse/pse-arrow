...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    203u8, 11u8, 165u8, 39u8, 223u8, 9u8, 244u8, 156u8, 41u8, 135u8, 239u8, 148u8, 227u8,
    230u8, 25u8, 50u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "requirement_universe";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    197u8, 231u8, 230u8, 252u8, 184u8, 241u8, 101u8, 65u8, 172u8, 231u8, 109u8, 28u8,
    132u8, 148u8, 244u8, 206u8, 54u8, 38u8, 117u8, 146u8, 6u8, 219u8, 36u8, 132u8, 62u8,
    86u8, 201u8, 38u8, 132u8, 223u8, 78u8, 122u8,
]);
...
pub struct InferredRequirementUniverseRow {
    ///requirement_id
...
impl crate::typed::CellCodec for InferredRequirementUniverseRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredRequirementUniverseRow)),
            );
        };
            ...
            r#requirement_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredRequirementUniverseRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredRequirementUniverseRow {
    fn append(
        &self,
...
pub type Row = InferredRequirementUniverseRow;
/// The concrete generated relation view.
pub type View<'a> = InferredRequirementUniverseView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredRequirementUniverseBuilder;
impl InferredRequirementUniverseRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.requirement_universe".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredRequirementUniverseRow {
    type Builder = InferredRequirementUniverseBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredRequirementUniverseBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredRequirementUniverseView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        86_424_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredRequirementUniverseView<'a> {
...
impl<'a> InferredRequirementUniverseView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredRequirementUniverseRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredRequirementUniverseRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredRequirementUniverseRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredRequirementUniverseBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredRequirementUniverseBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredRequirementUniverseRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredRequirementUniverseView<'_>,
    ) -> Result<(), crate::RelationError> {
