...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    84u8, 51u8, 110u8, 218u8, 209u8, 53u8, 85u8, 232u8, 19u8, 75u8, 44u8, 106u8, 81u8,
    57u8, 72u8, 190u8, 191u8, 118u8, 211u8, 236u8, 82u8, 202u8, 254u8, 20u8, 246u8,
    229u8, 94u8, 177u8, 166u8, 22u8, 6u8, 52u8,
]);
...
impl crate::columnar::RelationRow for InferredLawParticipationDecisionsRow {
    ...
    fn builder_allocation_size() -> usize {
        71_928_usize + size_of::<Self::Builder>()
    }
