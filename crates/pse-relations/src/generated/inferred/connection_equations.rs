...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    14u8, 208u8, 155u8, 48u8, 242u8, 165u8, 185u8, 135u8, 38u8, 25u8, 235u8, 160u8,
    153u8, 249u8, 217u8, 120u8, 19u8, 84u8, 177u8, 56u8, 81u8, 165u8, 132u8, 157u8,
    103u8, 166u8, 136u8, 196u8, 48u8, 132u8, 90u8, 166u8,
]);
...
impl crate::columnar::RelationRow for InferredConnectionEquationsRow {
    ...
    fn builder_allocation_size() -> usize {
        45_976_usize + size_of::<Self::Builder>()
    }
