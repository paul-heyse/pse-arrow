...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    152u8, 237u8, 105u8, 117u8, 55u8, 63u8, 197u8, 140u8, 158u8, 166u8, 174u8, 31u8,
    210u8, 35u8, 253u8, 23u8, 214u8, 130u8, 15u8, 203u8, 253u8, 56u8, 227u8, 114u8,
    214u8, 209u8, 181u8, 151u8, 69u8, 134u8, 111u8, 127u8,
]);
...
impl crate::columnar::RelationRow for InferredStateDependencyKeysRow {
    ...
    fn builder_allocation_size() -> usize {
        81_816_usize + size_of::<Self::Builder>()
    }
