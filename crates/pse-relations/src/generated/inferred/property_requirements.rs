...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    105u8, 42u8, 6u8, 78u8, 18u8, 131u8, 45u8, 124u8, 84u8, 11u8, 213u8, 4u8, 155u8,
    34u8, 193u8, 88u8, 8u8, 147u8, 157u8, 220u8, 248u8, 227u8, 185u8, 51u8, 168u8, 74u8,
    71u8, 177u8, 2u8, 183u8, 36u8, 49u8,
]);
...
impl crate::columnar::RelationRow for InferredPropertyRequirementsRow {
    ...
    fn builder_allocation_size() -> usize {
        63_976_usize + size_of::<Self::Builder>()
    }
