...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    181u8, 16u8, 6u8, 7u8, 209u8, 95u8, 249u8, 73u8, 8u8, 225u8, 186u8, 192u8, 187u8,
    142u8, 211u8, 224u8, 188u8, 205u8, 110u8, 28u8, 191u8, 181u8, 135u8, 142u8, 34u8,
    59u8, 48u8, 134u8, 95u8, 115u8, 3u8, 222u8,
]);
...
impl crate::columnar::RelationRow for InferredStateMethodSelectionKeysRow {
    ...
    fn builder_allocation_size() -> usize {
        38_312_usize + size_of::<Self::Builder>()
    }
