...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    117u8, 175u8, 174u8, 142u8, 22u8, 159u8, 234u8, 84u8, 70u8, 137u8, 36u8, 186u8,
    182u8, 0u8, 174u8, 23u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "state_method_selection_keys";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    114u8, 211u8, 167u8, 122u8, 45u8, 30u8, 166u8, 214u8, 224u8, 11u8, 68u8, 25u8, 53u8,
    131u8, 23u8, 15u8, 220u8, 173u8, 124u8, 102u8, 28u8, 239u8, 22u8, 50u8, 164u8, 167u8,
    82u8, 234u8, 27u8, 184u8, 164u8, 58u8,
]);
...
pub struct InferredStateMethodSelectionKeysRow {
    ///property_package_id
...
impl crate::typed::CellCodec for InferredStateMethodSelectionKeysRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredStateMethodSelectionKeysRow)),
            );
        };
            ...
            r#property_package_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredStateMethodSelectionKeysRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredStateMethodSelectionKeysRow {
    fn append(
        &self,
...
pub type Row = InferredStateMethodSelectionKeysRow;
/// The concrete generated relation view.
pub type View<'a> = InferredStateMethodSelectionKeysView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredStateMethodSelectionKeysBuilder;
impl InferredStateMethodSelectionKeysRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.state_method_selection_keys".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredStateMethodSelectionKeysRow {
    type Builder = InferredStateMethodSelectionKeysBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredStateMethodSelectionKeysBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredStateMethodSelectionKeysView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        40_072_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredStateMethodSelectionKeysView<'a> {
...
impl<'a> InferredStateMethodSelectionKeysView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredStateMethodSelectionKeysRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredStateMethodSelectionKeysRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredStateMethodSelectionKeysRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredStateMethodSelectionKeysBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredStateMethodSelectionKeysBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredStateMethodSelectionKeysRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredStateMethodSelectionKeysView<'_>,
    ) -> Result<(), crate::RelationError> {
