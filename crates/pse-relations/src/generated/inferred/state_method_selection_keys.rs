...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    234u8, 187u8, 185u8, 13u8, 137u8, 200u8, 175u8, 216u8, 121u8, 57u8, 31u8, 156u8, 5u8,
    195u8, 137u8, 91u8, 35u8, 3u8, 6u8, 114u8, 157u8, 64u8, 248u8, 158u8, 242u8, 184u8,
    13u8, 199u8, 83u8, 225u8, 168u8, 160u8,
]);
...
impl crate::columnar::RelationRow for InferredStateMethodSelectionKeysRow {
    ...
    fn builder_allocation_size() -> usize {
        37_848_usize + size_of::<Self::Builder>()
    }
