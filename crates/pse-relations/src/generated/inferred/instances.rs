...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    82u8, 226u8, 200u8, 77u8, 4u8, 170u8, 116u8, 225u8, 86u8, 67u8, 192u8, 68u8, 126u8,
    78u8, 232u8, 201u8,
]);
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    188u8, 116u8, 200u8, 163u8, 173u8, 208u8, 15u8, 23u8, 75u8, 200u8, 158u8, 104u8,
    42u8, 210u8, 229u8, 168u8, 54u8, 160u8, 3u8, 187u8, 225u8, 231u8, 228u8, 51u8, 33u8,
    227u8, 59u8, 211u8, 187u8, 207u8, 153u8, 223u8,
]);
...
impl crate::columnar::ArrowValue for InferredInstancesRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#path, children[3usize].as_mut())?;
...
impl crate::columnar::RelationRow for InferredInstancesRow {
    type Builder = InferredInstancesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredInstancesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredInstancesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        69_352_usize + size_of::<Self::Builder>()
    }
...
impl<'a> InferredInstancesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredInstancesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredInstancesRow {
