...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    42u8, 65u8, 70u8, 203u8, 147u8, 167u8, 182u8, 164u8, 6u8, 80u8, 156u8, 31u8, 187u8,
    87u8, 226u8, 79u8, 27u8, 170u8, 61u8, 4u8, 199u8, 53u8, 200u8, 245u8, 83u8, 28u8,
    172u8, 101u8, 186u8, 98u8, 172u8, 202u8,
]);
...
impl crate::columnar::RelationRow for InferredInstancesRow {
    ...
    fn builder_allocation_size() -> usize {
        71_112_usize + size_of::<Self::Builder>()
    }
