...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    118u8, 148u8, 187u8, 98u8, 38u8, 5u8, 19u8, 17u8, 102u8, 123u8, 174u8, 127u8, 208u8,
    63u8, 219u8, 175u8, 66u8, 180u8, 239u8, 240u8, 33u8, 202u8, 45u8, 174u8, 11u8, 153u8,
    14u8, 56u8, 241u8, 103u8, 142u8, 2u8,
]);
...
impl crate::columnar::RelationRow for InferredInstancesRow {
    ...
    fn builder_allocation_size() -> usize {
        68_888_usize + size_of::<Self::Builder>()
    }
