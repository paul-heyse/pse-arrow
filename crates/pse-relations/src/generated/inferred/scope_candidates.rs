...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    157u8, 239u8, 97u8, 187u8, 129u8, 192u8, 70u8, 58u8, 56u8, 116u8, 180u8, 137u8, 39u8,
    67u8, 110u8, 203u8, 43u8, 255u8, 156u8, 174u8, 251u8, 224u8, 110u8, 255u8, 252u8,
    119u8, 29u8, 245u8, 128u8, 120u8, 229u8, 247u8,
]);
...
impl crate::columnar::RelationRow for InferredScopeCandidatesRow {
    ...
    fn builder_allocation_size() -> usize {
        47_992_usize + size_of::<Self::Builder>()
    }
