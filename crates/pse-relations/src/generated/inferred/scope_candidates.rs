...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    90u8, 229u8, 122u8, 131u8, 68u8, 108u8, 125u8, 186u8, 100u8, 155u8, 78u8, 250u8,
    119u8, 98u8, 215u8, 222u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "scope_candidates";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    235u8, 57u8, 180u8, 206u8, 34u8, 48u8, 127u8, 114u8, 244u8, 239u8, 77u8, 168u8,
    223u8, 103u8, 171u8, 204u8, 165u8, 124u8, 143u8, 139u8, 64u8, 8u8, 150u8, 186u8,
    186u8, 228u8, 211u8, 107u8, 172u8, 111u8, 96u8, 129u8,
]);
...
pub struct InferredScopeCandidatesRow {
    ///scope_id
...
impl crate::typed::CellCodec for InferredScopeCandidatesRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(InferredScopeCandidatesRow)));
        };
            ...
            r#scope_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredScopeCandidatesRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredScopeCandidatesRow {
    fn append(
        &self,
...
pub type Row = InferredScopeCandidatesRow;
/// The concrete generated relation view.
pub type View<'a> = InferredScopeCandidatesView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredScopeCandidatesBuilder;
impl InferredScopeCandidatesRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.scope_candidates".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredScopeCandidatesRow {
    type Builder = InferredScopeCandidatesBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredScopeCandidatesBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredScopeCandidatesView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        48_456_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredScopeCandidatesView<'a> {
...
impl<'a> InferredScopeCandidatesView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredScopeCandidatesRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredScopeCandidatesRow {
    ...
    pub fn rows(&self) -> Result<Vec<InferredScopeCandidatesRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredScopeCandidatesBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredScopeCandidatesBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredScopeCandidatesRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredScopeCandidatesView<'_>,
    ) -> Result<(), crate::RelationError> {
