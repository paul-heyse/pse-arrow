...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    9u8, 141u8, 125u8, 75u8, 178u8, 16u8, 202u8, 184u8, 44u8, 80u8, 27u8, 4u8, 8u8,
    187u8, 171u8, 0u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "demand_scope_requests";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    186u8, 245u8, 62u8, 130u8, 115u8, 130u8, 221u8, 220u8, 110u8, 78u8, 17u8, 106u8,
    200u8, 65u8, 55u8, 56u8, 182u8, 76u8, 159u8, 35u8, 253u8, 104u8, 146u8, 42u8, 167u8,
    112u8, 122u8, 253u8, 123u8, 234u8, 240u8, 201u8,
]);
...
pub struct InferredDemandScopeRequestsRow {
    ///read_id
...
impl crate::typed::CellCodec for InferredDemandScopeRequestsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(
                crate::typed::mismatch(stringify!(InferredDemandScopeRequestsRow)),
            );
        };
            ...
            r#read_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(InferredDemandScopeRequestsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for InferredDemandScopeRequestsRow {
    fn append(
        &self,
...
pub type Row = InferredDemandScopeRequestsRow;
/// The concrete generated relation view.
pub type View<'a> = InferredDemandScopeRequestsView<'a>;
/// The concrete generated relation builder.
pub type Builder = InferredDemandScopeRequestsBuilder;
impl InferredDemandScopeRequestsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "inferred.demand_scope_requests".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for InferredDemandScopeRequestsRow {
    type Builder = InferredDemandScopeRequestsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        InferredDemandScopeRequestsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        InferredDemandScopeRequestsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        83_400_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct InferredDemandScopeRequestsView<'a> {
...
impl<'a> InferredDemandScopeRequestsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<InferredDemandScopeRequestsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(InferredDemandScopeRequestsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<InferredDemandScopeRequestsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct InferredDemandScopeRequestsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl InferredDemandScopeRequestsBuilder {
    ...
    pub fn push(
        &mut self,
        row: InferredDemandScopeRequestsRow,
    ) -> Result<(), crate::RelationError> {
        self.columns
            .append(move |columns| {
                let row = &row;
    ...
    pub fn append_view(
        &mut self,
        view: &InferredDemandScopeRequestsView<'_>,
    ) -> Result<(), crate::RelationError> {
