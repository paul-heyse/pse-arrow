...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    60u8, 29u8, 254u8, 102u8, 161u8, 27u8, 240u8, 14u8, 16u8, 9u8, 101u8, 250u8, 96u8,
    201u8, 139u8, 188u8, 153u8, 55u8, 53u8, 221u8, 78u8, 87u8, 112u8, 235u8, 146u8, 54u8,
    6u8, 181u8, 137u8, 184u8, 158u8, 125u8,
]);
...
impl crate::columnar::RelationRow for InferredDemandScopeRequestsRow {
    ...
    fn builder_allocation_size() -> usize {
        81_176_usize + size_of::<Self::Builder>()
    }
