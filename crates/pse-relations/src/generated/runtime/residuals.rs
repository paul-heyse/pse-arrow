...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    48u8, 228u8, 224u8, 27u8, 25u8, 62u8, 206u8, 204u8, 181u8, 129u8, 39u8, 119u8, 38u8,
    56u8, 161u8, 37u8, 26u8, 7u8, 156u8, 236u8, 82u8, 44u8, 85u8, 231u8, 81u8, 103u8,
    56u8, 63u8, 20u8, 121u8, 184u8, 7u8,
]);
...
impl crate::columnar::RelationRow for RuntimeResidualsRow {
    ...
    fn builder_allocation_size() -> usize {
        45_864_usize + size_of::<Self::Builder>()
    }
