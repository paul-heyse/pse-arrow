...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    120u8, 146u8, 85u8, 137u8, 181u8, 58u8, 247u8, 83u8, 116u8, 220u8, 242u8, 18u8, 12u8,
    21u8, 140u8, 243u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "residuals";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    57u8, 175u8, 242u8, 128u8, 214u8, 254u8, 45u8, 111u8, 253u8, 137u8, 144u8, 234u8,
    41u8, 205u8, 220u8, 200u8, 168u8, 76u8, 147u8, 169u8, 190u8, 152u8, 250u8, 154u8,
    176u8, 205u8, 226u8, 233u8, 47u8, 38u8, 127u8, 178u8,
]);
...
pub struct RuntimeResidualsRow {
    ///run_id
    ...
    pub r#residual: f64,
    ///scaled_residual
    pub r#scaled_residual: f64,
    ///relative_residual
    pub r#relative_residual: Option<f64>,
}
impl crate::typed::CellCodec for RuntimeResidualsRow {
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#scaled_residual),
                crate::typed::CellCodec::into_cell(self.r#relative_residual),
            ],
        )
    }
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(RuntimeResidualsRow)));
        };
        ...
        Ok(Self {
            ...
            r#residual: <f64 as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(RuntimeResidualsRow),
            ...
            r#scaled_residual: <f64 as crate::typed::CellCodec>::from_cell(
                values
                    .next()
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(RuntimeResidualsRow),
...
impl crate::columnar::ArrowValue for RuntimeResidualsRow {
    fn append(
        &self,
        ...
        crate::columnar::ArrowValue::append(
            &self.r#scaled_residual,
            children[3usize].as_mut(),
        )?;
        crate::columnar::ArrowValue::append(
            &self.r#relative_residual,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#residual: <f64 as crate::columnar::ArrowValue>::read(
                input.column(2usize).as_ref(),
                index,
            )?,
            r#scaled_residual: <f64 as crate::columnar::ArrowValue>::read(
...
pub type Row = RuntimeResidualsRow;
/// The concrete generated relation view.
pub type View<'a> = RuntimeResidualsView<'a>;
/// The concrete generated relation builder.
pub type Builder = RuntimeResidualsBuilder;
impl RuntimeResidualsRow {
...
const COMPILED_DECLARATION: &str = "[\"struct\",[[\"text\",\"compiled_relation_v1\"],[\"id\",\"78925589b53af75374dcf2120c158cf3\"],[\"struct\",[[\"text\",\"runtime\"],[\"text\",\"residuals\"],[\"u64\",1]]],[\"text\",\"derived\"],[\"text\",\"derived\"],[\"text\",\"row\"],[\"text\",\"evolving\"],[\"list\",[[\"text\",\"run_id\"],[\"text\",\"equation_id\"]]],[\"list\",[[\"struct\",[[\"struct\",[[\"text\",\"run_id\"],[\"text\",\"{\\\"FixedSizeBinary\\\":16}\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.domain.doc\"],[\"text\",\"run_id\"]]],[\"struct\",[[\"text\",\"pse.domain.extension\"],[\"text\",\"pse.semantic_id\"]]],[\"struct\",[[\"text\",\"pse.domain.role\"],[\"text\",\"key\"]]]]]]],[\"struct\",[[\"text\",\"run_id\"],[\"text\",\"{\\\"FixedSizeBinary\\\":16}\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"ARROW:extension:metadata\"],[\"text\",\"{\\\"v\\\":1}\"]]],[\"struct\",[[\"text\",\"ARROW:extension:name\"],[\"text\",\"pse.semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"key\"]]]]]]],[\"struct\",[[\"struct\",[[\"text\",\"extension\"],[\"text\",\"semantic_id\"],[\"text\",\"pse.semantic_id\"],[\"text\",\"{\\\"FixedSizeBinary\\\":16}\"],[\"text\",\"version_only\"],[\"u64\",1],[\"text\",\"{\\\"v\\\":1}\"],[\"null\",null],[\"text\",\"128-bit semantic identity (blueprint §5.1).\"]]],[\"list\",[]]]],[\"null\",null]]],[\"struct\",[[\"struct\",[[\"text\",\"equation_id\"],[\"text\",\"{\\\"FixedSizeBinary\\\":16}\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.domain.doc\"],[\"text\",\"equation_id\"]]],[\"struct\",[[\"text\",\"pse.domain.extension\"],[\"text\",\"pse.semantic_id\"]]],[\"struct\",[[\"text\",\"pse.domain.role\"],[\"text\",\"key\"]]]]]]],[\"struct\",[[\"text\",\"equation_id\"],[\"text\",\"{\\\"FixedSizeBinary\\\":16}\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"ARROW:extension:metadata\"],[\"text\",\"{\\\"v\\\":1}\"]]],[\"struct\",[[\"text\",\"ARROW:extension:name\"],[\"text\",\"pse.semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"semantic_id\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"key\"]]]]]]],[\"struct\",[[\"struct\",[[\"text\",\"extension\"],[\"text\",\"semantic_id\"],[\"text\",\"pse.semantic_id\"],[\"text\",\"{\\\"FixedSizeBinary\\\":16}\"],[\"text\",\"version_only\"],[\"u64\",1],[\"text\",\"{\\\"v\\\":1}\"],[\"null\",null],[\"text\",\"128-bit semantic identity (blueprint §5.1).\"]]],[\"list\",[]]]],[\"null\",null]]],[\"struct\",[[\"struct\",[[\"text\",\"residual\"],[\"text\",\"\\\"Float64\\\"\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.domain.doc\"],[\"text\",\"residual\"]]],[\"struct\",[[\"text\",\"pse.domain.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"text\",\"residual\"],[\"text\",\"\\\"Float64\\\"\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"f64\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"null\",null],[\"list\",[]]]],[\"null\",null]]],[\"struct\",[[\"struct\",[[\"text\",\"scaled_residual\"],[\"text\",\"\\\"Float64\\\"\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.domain.doc\"],[\"text\",\"scaled_residual\"]]],[\"struct\",[[\"text\",\"pse.domain.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"text\",\"scaled_residual\"],[\"text\",\"\\\"Float64\\\"\"],[\"bool\",false],[\"list\",[[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"f64\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"null\",null],[\"list\",[]]]],[\"null\",null]]],[\"struct\",[[\"struct\",[[\"text\",\"relative_residual\"],[\"text\",\"\\\"Float64\\\"\"],[\"bool\",true],[\"list\",[[\"struct\",[[\"text\",\"pse.domain.doc\"],[\"text\",\"relative_residual\"]]],[\"struct\",[[\"text\",\"pse.domain.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"text\",\"relative_residual\"],[\"text\",\"\\\"Float64\\\"\"],[\"bool\",true],[\"list\",[[\"struct\",[[\"text\",\"pse.semantic.logical_type\"],[\"text\",\"f64\"]]],[\"struct\",[[\"text\",\"pse.semantic.role\"],[\"text\",\"payload\"]]]]]]],[\"struct\",[[\"null\",null],[\"list\",[]]]],[\"null\",null]]]]],[\"text\",\"blueprint §6.13 execution and evidence: residuals.\"],[\"list\",[[\"struct\",[[\"text\",\"pse.contract.checks\"],[\"text\",\"{}\"]]],[\"struct\",[[\"text\",\"pse.contract.id\"],[\"text\",\"78925589b53af75374dcf2120c158cf3\"]]],[\"struct\",[[\"text\",\"pse.contract.version\"],[\"text\",\"1\"]]],[\"struct\",[[\"text\",\"pse.namespace\"],[\"text\",\"runtime\"]]]]]]]";
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "runtime.residuals".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for RuntimeResidualsRow {
    type Builder = RuntimeResidualsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        RuntimeResidualsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        RuntimeResidualsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        44_104_usize + size_of::<Self::Builder>()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            if (self.r#relative_residual).is_some() {
...
#[derive(Debug)]
pub struct RuntimeResidualsView<'a> {
    ...
    scaled_residual_column: &'a arrow_array::Float64Array,
    relative_residual_column: &'a arrow_array::Float64Array,
}
impl<'a> RuntimeResidualsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            scaled_residual_column: crate::columnar::array::<
                arrow_array::Float64Array,
            >(batch.column(3usize).as_ref())?,
            relative_residual_column: crate::columnar::array::<
                arrow_array::Float64Array,
    ...
    pub const fn scaled_residual_column(&self) -> &'a arrow_array::Float64Array {
        self.scaled_residual_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "scaled_residual", "`.")]
    pub fn scaled_residual_field(&self) -> &'a crate::FieldRef {
    ...
    pub const fn relative_residual_column(&self) -> &'a arrow_array::Float64Array {
        self.relative_residual_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "relative_residual", "`.")]
    pub fn relative_residual_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<RuntimeResidualsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(RuntimeResidualsRow {
            ...
            r#scaled_residual: crate::columnar::ArrowValue::read(
                self.scaled_residual_column,
                index,
            )?,
            r#relative_residual: crate::columnar::ArrowValue::read(
                self.relative_residual_column,
                index,
            )?,
        })
    ...
    pub fn rows(&self) -> Result<Vec<RuntimeResidualsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct RuntimeResidualsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl RuntimeResidualsBuilder {
    ...
    pub fn push(
        ...
        self.columns
            .append(move |columns| {
                ...
                crate::columnar::ArrowValue::append(
                    &row.r#scaled_residual,
                    columns[3usize].as_mut(),
                )?;
                crate::columnar::ArrowValue::append(
                    &row.r#relative_residual,
