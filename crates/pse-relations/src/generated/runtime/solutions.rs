...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    162u8, 100u8, 254u8, 102u8, 52u8, 247u8, 107u8, 251u8, 83u8, 148u8, 18u8, 184u8,
    218u8, 127u8, 212u8, 82u8, 81u8, 46u8, 114u8, 100u8, 100u8, 93u8, 179u8, 45u8, 148u8,
    137u8, 79u8, 87u8, 117u8, 88u8, 223u8, 61u8,
]);
    ...
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#bound_status),
            ],
        )
    }
...
impl crate::columnar::ArrowValue for RuntimeSolutionsRow {
    fn append(
        &self,
    ...
    fn append_null(
        ...
        <crate::generated::enums::BoundStatus as crate::columnar::ArrowValue>::append_null(
            children[4usize].as_mut(),
        )?;
        output.append(false);
        Ok(())
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#bound_status: <crate::generated::enums::BoundStatus as crate::columnar::ArrowValue>::read(
...
impl crate::columnar::RelationRow for RuntimeSolutionsRow {
    type Builder = RuntimeSolutionsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        RuntimeSolutionsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        RuntimeSolutionsView::from_checked(batch)?.rows()
    }
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            crate::columnar::allocation_add(8, (self.r#bound_status).as_str().len())?,
        )?;
        Ok(bytes)
    }
}
...
pub struct RuntimeSolutionsView<'a> {
    ...
    bound_status_column: &'a arrow_array::StringArray,
}
impl<'a> RuntimeSolutionsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            bound_status_column: crate::columnar::array::<
    ...
    pub const fn bound_status_column(&self) -> &'a arrow_array::StringArray {
        self.bound_status_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "bound_status", "`.")]
    pub fn bound_status_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<RuntimeSolutionsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(RuntimeSolutionsRow {
            ...
            r#bound_status: crate::columnar::ArrowValue::read(
                self.bound_status_column,
                index,
            )?,
        })
