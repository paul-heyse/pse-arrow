...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    186u8, 207u8, 58u8, 247u8, 235u8, 36u8, 52u8, 44u8, 197u8, 157u8, 255u8, 229u8,
    249u8, 241u8, 179u8, 77u8, 91u8, 144u8, 164u8, 120u8, 102u8, 111u8, 3u8, 127u8,
    135u8, 24u8, 48u8, 61u8, 39u8, 110u8, 127u8, 202u8,
]);
...
impl crate::columnar::RelationRow for RuntimeSolutionsRow {
    ...
    fn builder_allocation_size() -> usize {
        59_040_usize + size_of::<Self::Builder>()
    }
