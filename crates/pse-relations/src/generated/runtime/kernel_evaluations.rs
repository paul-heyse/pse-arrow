...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    193u8, 239u8, 92u8, 6u8, 22u8, 60u8, 151u8, 185u8, 147u8, 181u8, 8u8, 191u8, 157u8,
    70u8, 102u8, 107u8, 210u8, 114u8, 2u8, 148u8, 98u8, 93u8, 84u8, 207u8, 224u8, 45u8,
    132u8, 191u8, 205u8, 185u8, 167u8, 193u8,
]);
...
impl crate::columnar::RelationRow for RuntimeKernelEvaluationsRow {
    ...
    fn builder_allocation_size() -> usize {
        54_568_usize + size_of::<Self::Builder>()
    }
