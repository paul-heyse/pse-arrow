...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    128u8, 20u8, 183u8, 171u8, 30u8, 98u8, 178u8, 199u8, 90u8, 189u8, 77u8, 124u8, 167u8,
    181u8, 179u8, 5u8, 154u8, 132u8, 160u8, 42u8, 35u8, 84u8, 204u8, 95u8, 43u8, 173u8,
    245u8, 207u8, 119u8, 16u8, 134u8, 32u8,
]);
...
impl crate::columnar::RelationRow for RuntimeKernelEvaluationsRow {
    ...
    fn builder_allocation_size() -> usize {
        52_808_usize + size_of::<Self::Builder>()
    }
