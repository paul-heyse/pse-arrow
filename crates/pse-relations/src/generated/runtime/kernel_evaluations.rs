...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    241u8, 219u8, 177u8, 173u8, 181u8, 66u8, 17u8, 76u8, 180u8, 146u8, 150u8, 57u8,
    200u8, 12u8, 62u8, 43u8, 214u8, 200u8, 164u8, 20u8, 175u8, 100u8, 157u8, 236u8, 93u8,
    247u8, 205u8, 71u8, 96u8, 23u8, 27u8, 207u8,
]);
    ...
    fn into_cell(self) -> pse_schema::model::Cell {
        pse_schema::model::Cell::Struct(
            vec![
                ...
                crate::typed::CellCodec::into_cell(self.r#input_hash),
                crate::typed::CellCodec::into_cell(self.r#output_batch_hash),
            ],
        )
    }
...
impl crate::columnar::ArrowValue for RuntimeKernelEvaluationsRow {
    fn append(
        &self,
    ...
    fn read(
        ...
        Ok(Self {
            ...
            r#input_hash: <pse_ids::ContentHash as crate::columnar::ArrowValue>::read(
                input.column(2usize).as_ref(),
                index,
            )?,
            r#output_batch_hash: <pse_ids::ContentHash as crate::columnar::ArrowValue>::read(
...
impl crate::columnar::RelationRow for RuntimeKernelEvaluationsRow {
    type Builder = RuntimeKernelEvaluationsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        RuntimeKernelEvaluationsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        RuntimeKernelEvaluationsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        52_344_usize + size_of::<Self::Builder>()
    }
...
pub struct RuntimeKernelEvaluationsView<'a> {
    ...
    input_hash_column: &'a arrow_array::FixedSizeBinaryArray,
    output_batch_hash_column: &'a arrow_array::FixedSizeBinaryArray,
}
impl<'a> RuntimeKernelEvaluationsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            input_hash_column: crate::columnar::array::<
                arrow_array::FixedSizeBinaryArray,
            >(batch.column(2usize).as_ref())?,
            output_batch_hash_column: crate::columnar::array::<
                arrow_array::FixedSizeBinaryArray,
    ...
    pub const fn input_hash_column(&self) -> &'a arrow_array::FixedSizeBinaryArray {
        self.input_hash_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "input_hash", "`.")]
    pub fn input_hash_field(&self) -> &'a crate::FieldRef {
    ...
    pub const fn output_batch_hash_column(
        &self,
    ) -> &'a arrow_array::FixedSizeBinaryArray {
        self.output_batch_hash_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "output_batch_hash", "`.")]
    pub fn output_batch_hash_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<RuntimeKernelEvaluationsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(RuntimeKernelEvaluationsRow {
            ...
            r#input_hash: crate::columnar::ArrowValue::read(
                self.input_hash_column,
                index,
            )?,
            r#output_batch_hash: crate::columnar::ArrowValue::read(
                self.output_batch_hash_column,
                index,
            )?,
        })
...
impl RuntimeKernelEvaluationsBuilder {
    ...
    pub fn append_view(
        &mut self,
        view: &RuntimeKernelEvaluationsView<'_>,
    ) -> Result<(), crate::RelationError> {
