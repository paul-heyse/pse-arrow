...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    154u8, 90u8, 179u8, 127u8, 156u8, 223u8, 234u8, 25u8, 140u8, 231u8, 219u8, 101u8,
    71u8, 139u8, 3u8, 102u8, 182u8, 243u8, 26u8, 20u8, 233u8, 196u8, 144u8, 99u8, 242u8,
    182u8, 45u8, 129u8, 247u8, 227u8, 181u8, 3u8,
]);
...
impl crate::columnar::RelationRow for RuntimeKernelEvaluationOutcomesRow {
    ...
    fn builder_allocation_size() -> usize {
        189_096_usize + size_of::<Self::Builder>()
    }
