...
pub const RELATION_ID: pse_ids::SemanticId = pse_ids::SemanticId::from_bytes([
    254u8, 5u8, 189u8, 160u8, 154u8, 60u8, 116u8, 57u8, 89u8, 139u8, 70u8, 235u8, 44u8,
    106u8, 20u8, 188u8,
]);
/// The declared name within its namespace.
pub const NAME: &str = "numerical_programs";
...
pub const FINGERPRINT: pse_ids::ContentHash = pse_ids::ContentHash::from_bytes([
    129u8, 111u8, 67u8, 0u8, 46u8, 254u8, 133u8, 70u8, 147u8, 201u8, 0u8, 229u8, 184u8,
    247u8, 178u8, 27u8, 93u8, 61u8, 168u8, 136u8, 64u8, 31u8, 3u8, 14u8, 117u8, 99u8,
    40u8, 167u8, 76u8, 192u8, 26u8, 155u8,
]);
...
pub struct RuntimeNumericalProgramsRow {
    ///program_id
...
impl crate::typed::CellCodec for RuntimeNumericalProgramsRow {
    ...
    fn from_cell(cell: pse_schema::model::Cell) -> Result<Self, crate::RelationError> {
        let pse_schema::model::Cell::Struct(values) = cell else {
            return Err(crate::typed::mismatch(stringify!(RuntimeNumericalProgramsRow)));
        };
            ...
            r#program_id: <pse_ids::SemanticId as crate::typed::CellCodec>::from_cell(
                values
                    ...
                    .ok_or_else(|| crate::typed::mismatch(
                        stringify!(RuntimeNumericalProgramsRow),
                    ))?,
            )?,
...
impl crate::columnar::ArrowValue for RuntimeNumericalProgramsRow {
    fn append(
        &self,
...
pub type Row = RuntimeNumericalProgramsRow;
/// The concrete generated relation view.
pub type View<'a> = RuntimeNumericalProgramsView<'a>;
/// The concrete generated relation builder.
pub type Builder = RuntimeNumericalProgramsBuilder;
impl RuntimeNumericalProgramsRow {
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "runtime.numerical_programs".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for RuntimeNumericalProgramsRow {
    type Builder = RuntimeNumericalProgramsBuilder;
    fn relation(
    ...
    fn builder(
        ...
        RuntimeNumericalProgramsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        RuntimeNumericalProgramsView::from_checked(batch)?.rows()
    }
    fn builder_allocation_size() -> usize {
        49_632_usize + size_of::<Self::Builder>()
    }
...
#[derive(Debug)]
pub struct RuntimeNumericalProgramsView<'a> {
...
impl<'a> RuntimeNumericalProgramsView<'a> {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<RuntimeNumericalProgramsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(RuntimeNumericalProgramsRow {
    ...
    pub fn rows(
        &self,
    ) -> Result<Vec<RuntimeNumericalProgramsRow>, crate::RelationError> {
...
#[derive(Debug)]
pub struct RuntimeNumericalProgramsBuilder {
    columns: crate::columnar::BatchBuilder,
}
impl RuntimeNumericalProgramsBuilder {
    ...
    pub fn push(
        &mut self,
        row: RuntimeNumericalProgramsRow,
    ) -> Result<(), crate::RelationError> {
    ...
    pub fn append_view(
        &mut self,
        view: &RuntimeNumericalProgramsView<'_>,
    ) -> Result<(), crate::RelationError> {
