...
pub use pse_model::generated::r#runtime::r#solve_constraints::{
    RuntimeSolveConstraintsRow, Row,
};
...
impl crate::columnar::ArrowValue for RuntimeSolveConstraintsRow {
    fn append(
        ...
        crate::columnar::ArrowValue::append(&self.r#dual, children[12usize].as_mut())?;
        crate::columnar::ArrowValue::append(
...
pub type View<'a> = RuntimeSolveConstraintsView<'a>;
/// The concrete generated relation builder.
pub type Builder = RuntimeSolveConstraintsBuilder;
...
pub fn spec(
    ...
    let spec = reg
        ...
        .ok_or_else(|| crate::RelationError::UnknownRegistry {
            relation: "runtime.solve_constraints".to_owned(),
        })?;
...
impl crate::columnar::RelationRow for RuntimeSolveConstraintsRow {
    type Builder = RuntimeSolveConstraintsBuilder;
    fn append_columns(
        &self,
        ...
        crate::columnar::ArrowValue::append(&self.r#dual, columns[12usize].as_mut())?;
        crate::columnar::ArrowValue::append(
            &self.r#dual_qualification,
    ...
    fn builder(
        ...
        RuntimeSolveConstraintsBuilder::with_registry(registry, capacity)
    }
    ...
    fn rows(
        ...
        RuntimeSolveConstraintsView::from_checked(batch)?.rows()
    }
    fn rows_at(
        batch: &crate::columnar::FieldCheckedBatch,
        positions: &[usize],
    ) -> Result<Vec<Self>, crate::RelationError> {
        let view = RuntimeSolveConstraintsView::from_checked(batch)?;
    ...
    fn allocation_size(&self) -> Result<usize, crate::RelationError> {
        ...
        bytes = crate::columnar::allocation_add(
            bytes,
            if (self.r#equality_residual).is_some() {
                crate::columnar::allocation_add(
                    1,
                    Ok::<usize, crate::RelationError>(8usize)?,
                )
...
pub mod columns {
    ...
    ///equality_residual
    pub const EQUALITY_RESIDUAL: crate::columnar::ColumnReference = super::COLUMNS[8usize];
    ///lower_violation
    pub const LOWER_VIOLATION: crate::columnar::ColumnReference = super::COLUMNS[9usize];
    ///upper_violation
    pub const UPPER_VIOLATION: crate::columnar::ColumnReference = super::COLUMNS[10usize];
    ///tolerance
    pub const TOLERANCE: crate::columnar::ColumnReference = super::COLUMNS[11usize];
    ///dual
    pub const DUAL: crate::columnar::ColumnReference = super::COLUMNS[12usize];
    ///dual_qualification
    pub const DUAL_QUALIFICATION: crate::columnar::ColumnReference = super::COLUMNS[13usize];
}
/// Borrowed Arrow columns with checked layout and local values.
/// Keys, references and domain completeness require relational admission.
#[derive(Debug)]
pub struct RuntimeSolveConstraintsView<'a> {
    ...
    equality_residual_column: &'a arrow_array::Float64Array,
    ...
    dual_column: &'a arrow_array::Float64Array,
    dual_qualification_column: &'a arrow_array::StringArray,
}
impl<'a> RuntimeSolveConstraintsView<'a> {
    ...
    fn borrow_columns(
        ...
        Ok(Self {
            ...
            equality_residual_column: crate::columnar::array::<
                arrow_array::Float64Array,
            ...
            dual_column: crate::columnar::array::<
                arrow_array::Float64Array,
    ...
    pub const fn equality_residual_column(&self) -> &'a arrow_array::Float64Array {
        self.equality_residual_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "equality_residual", "`.")]
    pub fn equality_residual_field(&self) -> &'a crate::FieldRef {
    ...
    pub const fn dual_column(&self) -> &'a arrow_array::Float64Array {
        self.dual_column
    }
    #[doc = concat!("Borrows the exact declared field for `", "dual", "`.")]
    pub fn dual_field(&self) -> &'a crate::FieldRef {
    ...
    pub fn row(
        &self,
        index: usize,
    ) -> Result<RuntimeSolveConstraintsRow, crate::RelationError> {
        if index >= self.len() {
            return Err(crate::columnar::mismatch("a row within the generated view"));
        }
        Ok(RuntimeSolveConstraintsRow {
            ...
            r#equality_residual: crate::columnar::ArrowValue::read(
                self.equality_residual_column,
                index,
            )?,
            ...
            r#dual: crate::columnar::ArrowValue::read(self.dual_column, index)?,
    ...
    pub fn rows(&self) -> Result<Vec<RuntimeSolveConstraintsRow>, crate::RelationError> {
        (0..self.len()).map(|index| self.row(index)).collect()
    }
}
/// Shared native column builder for this declaration.
pub type RuntimeSolveConstraintsBuilder = crate::columnar::RowBuilder<
    RuntimeSolveConstraintsRow,
>;
impl crate::columnar::RelationView for RuntimeSolveConstraintsView<'_> {
    type Row = RuntimeSolveConstraintsRow;
