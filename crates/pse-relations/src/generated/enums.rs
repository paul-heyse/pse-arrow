...
impl EntityKind {
    ...
    pub const fn ordinal(self) -> usize {
        match self {
            ...
            Self::Flowsheet => 22usize,
            Self::Scope => 23usize,
            Self::Connection => 24usize,
            Self::Case => 25usize,
            Self::Dataset => 26usize,
            Self::Observation => 27usize,
            Self::SolverProfile => 28usize,
            Self::DiscretizationPolicy => 29usize,
        }
    }
    /// The sanctioned IDAES member name, where applicable.
    #[allow(
...
impl FailureClass {
    ...
    pub const fn ordinal(self) -> usize {
        match self {
            ...
            Self::CompileDiscretization => 7usize,
            Self::CapabilityBackend => 8usize,
            Self::PlanInitialization => 9usize,
            Self::SolveInfeasible => 10usize,
            Self::SolveLocallyInfeasible => 11usize,
            Self::SolveUnbounded => 12usize,
            Self::SolveLimit => 13usize,
            Self::SolveEvaluationError => 14usize,
            Self::SolveSolverError => 15usize,
            Self::RuntimeCancelled => 16usize,
            Self::RuntimeTimeout => 17usize,
            Self::RuntimeResourceLimit => 18usize,
            Self::RuntimeInfrastructure => 19usize,
            Self::ConfigInvalid => 20usize,
            Self::InternalInvariant => 21usize,
            Self::UserModel => 22usize,
        }
    }
    /// The sanctioned IDAES member name, where applicable.
    #[allow(
...
impl RuleExprOp {
    ...
    pub const fn ordinal(self) -> usize {
        match self {
            ...
            Self::Cmp => 5usize,
            Self::IsNull => 6usize,
            Self::IsNotNull => 7usize,
            Self::IsDistinctFrom => 8usize,
            Self::IsNotDistinctFrom => 9usize,
            Self::InList => 10usize,
            Self::Field => 11usize,
            Self::ListLen => 12usize,
            Self::IsTrue => 13usize,
            Self::IsFalse => 14usize,
            Self::IsUnknown => 15usize,
        }
    }
    /// The sanctioned IDAES member name, where applicable.
    #[allow(
...
impl RulePlanOp {
    ...
    pub const fn ordinal(self) -> usize {
        match self {
            ...
            Self::Filter => 1usize,
            Self::Project => 2usize,
            Self::EquiJoin => 3usize,
            Self::AntiJoin => 4usize,
            Self::Union => 5usize,
            Self::Distinct => 6usize,
            Self::Aggregate => 7usize,
            Self::Unnest => 8usize,
            Self::Recursive => 9usize,
            Self::RecursiveRef => 10usize,
        }
    }
    /// The sanctioned IDAES member name, where applicable.
    #[allow(
...
impl SelectorOp {
    ...
    pub const fn ordinal(self) -> usize {
        match self {
            Self::DescendantOf => 0usize,
            Self::KindIs => 1usize,
            Self::TaggedWith => 2usize,
            Self::Union => 3usize,
            Self::Intersection => 4usize,
            Self::Difference => 5usize,
            Self::Include => 6usize,
            Self::Exclude => 7usize,
        }
    }
...
impl VariableLifecycle {
    ...
    pub const fn ordinal(self) -> usize {
        match self {
            Self::Authored => 0usize,
            Self::GeneratedDiscretization => 1usize,
            Self::GeneratedReformulation => 2usize,
            Self::GeneratedRelaxation => 3usize,
            Self::RuntimeArtifact => 4usize,
        }
    }
    /// The sanctioned IDAES member name, where applicable.
    #[allow(
