...
| R-27 | generate the Rust manifest struct from the registry `ManifestSpec` (hand-written in phase 0 with a parity test) | ADR-0051 | wave 2 starts, or the parity test between the hand-written struct and `ManifestSpec` fails | manual: run `just test-package pse-catalog -p pse-relations` and inspect the recursive ManifestSpec parity result; file existence is not parity evidence | paul-heyse | 2026-09-13 | 2026-12-01 | open |
| R-28 | Proposed: Wave 1 B-evidence diagnostic plan capture | ADR-0056 | a supported consumer needs plan attribution or restore diagnostics | manual: qualify noncanonical codec round trips and ordered attribution before enabling capture | paul-heyse | 2026-09-14 | 2026-12-01 | open |
| R-29 | Proposed: R-3 bindgen regeneration | ADR-0056 | native solver implementation or a supported header pin changes | manual: qualify deterministic bindings regeneration against pinned headers; current gate proves hygiene only | paul-heyse | 2026-09-14 | 2026-12-01 | open |
| R-30 | Proposed: incomplete Appendix B contracts and executable P4–P9/P11–P16 registration | ADR-0056 | a consumer needs a contract listed in appendix-b-deferred.toml, or a later pass has complete producer/input/output schema and invariant contracts | manual: specify missing columns, dictionaries and identity/membership rules in an ADR before removing the exact exemption; require closed registry and pass fixtures before executable registration | paul-heyse | 2026-09-14 | 2026-12-01 | open |
