/* SPDX-FileCopyrightText: 2005, 2011 International Business Machines and others */
/* SPDX-License-Identifier: EPL-2.0 */
/* Verbatim copy of examples/hs071_c/hs071_c.c from Ipopt 3.14.20 (see LICENSES.md).
 * Only the two SPDX tags above were added, so `reuse lint` can see the licence. */
